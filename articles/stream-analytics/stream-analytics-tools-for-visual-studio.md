...
* Installieren Sie Visual Studio 2017, Visual Studio 2015, Visual Studio 2013 Update 4. Die Editionen Enterprise (Ultimate/Premium), Professional und Community werden unterstützt; Express Edition wird nicht unterstützt. 
...
5.  Der Service Bus-Namespace sollte der **tollData**-Eintrag in der Dropdownliste sein.
...
1. Klicken Sie in **Server-Explorer** unter **Stream Analytics-Aufträge** mit der rechten Maustaste auf den Auftragsknoten. Klicken Sie im Kontextmenü auf **Export to New Stream Analytics Project** (In neues Stream Analytics-Projekt exportieren).
   ...
   Das erstellte Projekt im **Projektmappen-Explorer**.
