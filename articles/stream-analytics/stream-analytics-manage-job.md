---
title: 'Tutorial: Erstellen und Verwalten eines Stream Analytics-Auftrags über das Azure-Portal | Microsoft-Dokumentation'
...
2. Wählen Sie **Ressource erstellen** > **Internet der Dinge (IoT)** > **Event Hubs**.  
   ...
   ![Erstellen eines Azure Event Hubs](media/stream-analytics-manage-job/find-eh.png)
...
4. Fügen Sie die Verbindungszeichenfolge in einen Texteditor ein. Sie benötigen diese Verbindungszeichenfolge im nächsten Abschnitt.  
   ...
   Beachten Sie, dass die Verbindungszeichenfolge mehrere durch Semikolons getrennte Schlüssel-Wert-Paare enthält: **Endpoint**, **SharedAccessKeyName**, **SharedAccessKey** und **EntityPath**.
...
4. **Speichern** Sie die Abfrage.  
   ...
   ![Definieren der Stream Analytics-Abfrage](media/stream-analytics-manage-job/define-query.png)
