...
| [az sql db show-usage](https://docs.microsoft.com/cli/azure/sql#az-sql-show-usage) | Zeigt die Größennutzungsinformationen für eine Einzeldatenbank oder eine in einem Pool zusammengefasste Datenbank an. |
