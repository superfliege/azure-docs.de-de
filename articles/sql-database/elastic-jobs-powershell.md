...
- Zusätzlich zum Modul „**AzureRM.Sql** 4.8.1-preview“ ist für dieses Tutorial das PowerShell-Modul *sqlserver* PowerShell erforderlich. Ausführliche Informationen finden Sie unter [Installieren des SQL Server PowerShell-Moduls](https://docs.microsoft.com/sql/powershell/download-sql-server-ps-module).
