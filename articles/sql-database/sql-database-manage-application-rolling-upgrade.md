...
2. Erstellen Sie ein Failoverprofil in ATM mit `contoso-1.azurewebsites.net` als Onlineendpunkt und `contoso-2.azurewebsites.net` als Offlineendpunkt.
...
1. Ändern Sie den Onlineendpunkt im ATM-Profil in `contoso-2.azurewebsites.net`, der auf die V2-Version der Website verweist (6). Dieser wird nun zum Produktionsslot mit der V2-Anwendung, und der Endbenutzerdatenverkehr wird an ihn umgeleitet.  
...
> [!NOTE]
> Das Rollback erfordert keine Änderungen im ATM-Profil, da es bereits auf `contoso-1.azurewebsites.net` als aktiven Endpunkt verweist.
...
4. Fügen Sie dem Failoverprofil in ATM die zusätzlichen Endpunkte `contoso-2.azurewebsites.net` und `contoso-3.azurewebsites.net` als Offlineendpunkte hinzu (5).
...
1. Ändern Sie den aktiven Endpunkt im ATM-Profil in `contoso-2.azurewebsites.net`, der nun auf die V2-Version der Website verweist (9). Dieser wird nun zu einem Produktionsslot mit der V2-Anwendung, und der Endbenutzerdatenverkehr wird an ihn umgeleitet.
