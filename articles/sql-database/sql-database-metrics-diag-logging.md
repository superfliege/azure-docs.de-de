...
* **Azure Log Analytics**: Wird für eine einsatzbereite Überwachungslösung mit Funktionen für Berichterstellung, Warnungen und Problemlösung verwendet. Dieses Feature ist Teil der [Operations Management Suite (OMS)](../operations-management-suite/operations-management-suite-overview.md).
...
- [Blocks](sql-database-metrics-diag-logging.md#blockings-dataset): Enthält Informationen zu blockierenden Ereignissen, die für eine Datenbank aufgetreten sind.
...
- **Audit** / **SQLSecurityAuditEvents**: derzeit nicht verfügbar.
...
Informieren Sie sich darüber, wie Sie [Diagnoseeinstellungen mithilfe der Azure Monitor-REST-API ändern](https://docs.microsoft.com/en-us/rest/api/monitor/diagnosticsettings). 
