...
- Ein Beispiel für die Erstellung eines VNET und das anschließende Erstellen einer verwalteten Instanz finden Sie unter [Erstellen einer verwalteten Instanz](sql-database-managed-instance-tutorial-portal.md).
- Informationen zur Konfigurieren des VNET finden Sie unter [VNET-Konfiguration für verwaltete Instanzen](sql-database-managed-instance-vnet-configuration.md).
