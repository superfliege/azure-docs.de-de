...
Die folgenden Berechtigungen der [rollenbasierten Zugriffssteuerung](../role-based-access-control/overview.md) sind für die Verwendung von Query Performance Insight erforderlich: 
