...
* Die dynamische Datenmaskierung können Sie auch mithilfe von [Azure SQL-Datenbank-Cmdlets](https://docs.microsoft.com/powershell/module/azurerm.sql/) oder der [REST-API](https://msdn.microsoft.com/library/dn505719.aspx) implementieren.
