...
## <a name="troubleshooting-sync"></a>Problembehandlung der Synchronisierung
...
## <a name="troubleshooting-the-client-agent"></a>Problembehandlung des Client-Agents
...
-   Erstellen Sie einen neuen Agent in dem Rechenzentrum, in dem sich auch die Synchronisierungsgruppe befindet. Registrieren Sie anschließend die Datenbank bei diesem Agent.
...
## <a name="troubleshooting-setup-and-maintenance"></a>Problembehandlung von Setup und Wartung
