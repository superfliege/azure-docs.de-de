...
description: Erstellen Sie im Azure-Portal einen Azure SQL-Datenbankserver und eine Datenbank, die Sie anschließend abfragen können.
...
Eine Azure SQL-Datenbank verfügt über definierte [Compute- und Speicherressourcen](sql-database-service-tiers-dtu.md). Sie erstellen die Datenbank auf einem [SQL-Datenbankserver](sql-database-features.md) in einer [Azure-Ressourcengruppe](../azure-resource-manager/resource-group-overview.md).
