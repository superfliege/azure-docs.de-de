...
Azure SQL-Datenbank verwaltet die für eine Datenbank verfügbaren Ressourcen anhand von zwei verschiedenen Mechanismen: Ressourcenkontrolle und Durchsetzung von Grenzwerten. Weitere Informationen finden Sie unter
...
* Weitere Informationen: [Schützen Ihrer SQL-Datenbank](sql-database-security-overview.md)
...
- Weitere Informationen: [SQL-Datenbank-Sicherheit: Verwalten von Datenbankzugriff und Anmeldesicherheit](sql-database-manage-logins.md).
...
- Codebeispiele:  Codebeispiele, die Wiederholungslogik veranschaulichen, finden Sie in den Beispielen für die Sprache Ihrer Wahl unter: [Verbindungsbibliotheken für SQL-Datenbank und SQL Server](sql-database-libraries.md)
