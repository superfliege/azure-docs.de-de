...
ms.locfileid: "50911760"
---
# <a name="quickstart-use-net-c-with-visual-studio-to-connect-and-query-an-azure-sql-database"></a>Schnellstart: Herstellen einer Verbindung mit einer Azure SQL-Datenbank und Abfragen der Datenbank mit .NET (C#) und Visual Studio
...
5. Suchen Sie auf der Registerkarte **Durchsuchen** nach ```System.Data.SqlClient```, und wählen Sie das Element aus.
