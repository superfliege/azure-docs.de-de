...
This article describes the limits and configuration details for creating and running automated workflows with Azure Logic Apps. For Microsoft Flow, see [Limits and configuration in Microsoft Flow](https://docs.microsoft.com/flow/limits-and-config).
...
To change the default limit to between 7 days and 90 days, follow these steps. If you need to go above the maximum limit, [contact the Logic Apps team](mailto://logicappsemail@microsoft.com) for help with your requirements.
...
## <a name="ftp-sftp-and-sftp-ssh-limits"></a>FTP, SFTP, and SFTP-SSH limits
...
Here are the limits on the number of artifacts for each integration account. For more information, see [Logic Apps pricing](https://azure.microsoft.com/pricing/details/logic-apps/). 
...
For [Azure Government](../azure-government/documentation-government-overview.md) and [Azure China 21Vianet](/azure/china/china-welcome), reserved IP addresses for connectors aren't currently available.
