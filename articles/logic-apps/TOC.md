...
#### [Erweitern von OpenAPI für benutzerdefinierte Connectors](custom-connector-openapi-extensions.md)
...
#### [Bereitstellen und Aufrufen benutzerdefinierter APIs](logic-apps-custom-api-host-deploy-call.md)
...
### [Senden von EDI-Nachrichten als Batch](logic-apps-scenario-edi-send-batch-messages.md)
...
### [Überwachen des Logik-App-Status in OMS mit Log Analytics](logic-apps-monitor-your-logic-apps-oms.md)
