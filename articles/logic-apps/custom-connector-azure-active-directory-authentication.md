...
1. Melden Sie sich beim [Azure-Portal](https://portal.azure.com) an. Wenn Sie über mehrere Azure Active Directory-Mandanten verfügen, sollten Sie sicherstellen, dass Sie beim richtigen Verzeichnis angemeldet sind, indem Sie das Verzeichnis unter Ihrem Benutzernamen überprüfen. 
...
2. Wählen Sie im Hauptmenü von Azure den Eintrag **Azure Active Directory** aus, um das aktuelle Verzeichnis anzuzeigen.
   ...
   > [!TIP]
   > Wenn der Eintrag **Azure Active Directory** im Hauptmenü von Azure nicht angezeigt wird, wählen Sie **Alle Dienste** aus. Geben Sie „Azure Active Directory“ als Filter in das Feld **Filter** ein, und wählen Sie anschließend **Azure Active Directory** aus.
