...
Simulation wird in Durable Functions über zwei abstrakte Klassen unterstützt:

* [DurableOrchestrationClientBase](https://azure.github.io/azure-functions-durable-extension/api/Microsoft.Azure.WebJobs.DurableOrchestrationClientBase.html) 

* [DurableOrchestrationContextBase](https://azure.github.io/azure-functions-durable-extension/api/Microsoft.Azure.WebJobs.DurableOrchestrationContextBase.html)

Diese Klassen sind die Basisklassen für [DurableOrchestrationClient](https://azure.github.io/azure-functions-durable-extension/api/Microsoft.Azure.WebJobs.DurableOrchestrationClient.html) und [DurableOrchestrationContext](https://azure.github.io/azure-functions-durable-extension/api/Microsoft.Azure.WebJobs.DurableOrchestrationContext.html), die Orchestrierungsclient- und Orchestratormethoden definieren. Die Simulationen legen erwartetes Verhalten für Basisklassenmethoden fest, sodass der Unittest die Geschäftslogik überprüfen kann. Der Unittest der Geschäftslogik wird als Workflow in zwei Schritten im Orchestrierungsclient und Orchestrator durchgeführt:
...
Orchestratorfunktionen sind für Unittests noch interessanter, da sie in der Regel viel mehr Geschäftslogik aufweisen. Orchestratorfunktionen können derzeit nur in C# implementiert werden.
...
Der Unittest von Aktivitätsfunktionen kann in gleicher Weise wie der nicht dauerhafter Funktionen durchgeführt werden. Aktivitätsfunktionen haben keine Basisklasse für die Simulation. Daher verwenden die Unittests die Parametertypen direkt.

In diesem Abschnitt überprüft der Unittest das Verhalten der `E1_SayHello`-Aktivitätsfunktion:

[!code-csharp[Main](~/samples-durable-functions/samples/precompiled/HelloSequence.cs)]

Der Unittest überprüft auch das Format der Ausgabe:
...
> [Weitere Informationen zu xUnit](http://xunit.github.io/docs/getting-started-dotnet-core)
