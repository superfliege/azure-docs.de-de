...
Ein Beispiel für eine Funktion, die Queue Storage-Trigger und -Bindungen verwendet, finden Sie unter [Erstellen einer Funktion, die durch Azure Queue Storage ausgelöst wird](functions-create-storage-queue-triggered-function.md).
