...
| Bindung | Verweis |
|---|---|
| DocumentDB | [DocumentDB-Fehlercodes](https://docs.microsoft.com/en-us/rest/api/documentdb/http-status-codes-for-documentdb) |
