...
Das von Azure Data Lake Storage Gen1 implementierte Zugriffssteuerungsmodell leitet sich von HDFS ab, das wiederum vom POSIX-Zugriffssteuerungsmodell abgeleitet wird. In diesem Artikel werden die Grundlagen des Zugriffssteuerungsmodells für Data Lake Storage Gen1 zusammengefasst. Weitere Informationen zum HDFS-Zugriffssteuerungsmodell finden Sie im [Handbuch zu HDFS-Berechtigungen](https://hadoop.apache.org/docs/current/hadoop-project-dist/hadoop-hdfs/HdfsPermissionsGuide.html).
...
Klicken Sie auf dem Blatt **Daten-Explorer** des Data Lake Storage Gen1-Kontos auf **Zugriff**, um die ACLs für die jeweilige Datei bzw. den Ordner im Daten-Explorer anzuzeigen. Klicken Sie auf **Zugriff**, um die ACLs für den Ordner **catalog** unter dem Konto **mydatastore** anzuzeigen.
...
Ein Data Lake Storage Gen1-Konto besitzt in Azure mehrere Azure-Rollen, z.B.:

* Besitzer
* Mitwirkende
* Leser

Alle Benutzer, die der Rolle **Besitzer** für ein Data Lake Storage Gen1-Konto angehören, sind automatisch auch Administratoren für dieses Konto. Weitere Informationen finden Sie unter [Rollenbasierte Zugriffssteuerung](../role-based-access-control/role-assignments-portal.md).
...
Bei Erstellung eines neuen Dateisystemelements weist Data Lake Storage Gen1 der zuständigen Gruppe einen Wert zu.
...
Die folgende Abbildung zeigt den Zugriffsüberprüfungsalgorithmus für Data Lake Storage Gen1-Konten.

![Algorithmus der Data Lake Storage Gen1-ACLs](./media/data-lake-store-access-control/data-lake-store-acls-algorithm.png)
...
## <a name="advanced-topics-for-understanding-acls-in-data-lake-storage-gen1"></a>Weiterführende Themen zu ACLs in Data Lake Storage Gen1

Im Anschluss finden Sie einige weiterführende Themen, in denen ausführlicher auf die Bestimmung von ACLs für Data Lake Storage Gen1-Dateien oder -Ordner eingegangen wird.
...
In einem HDFS-System handelt es sich bei „umask“ in der Regel um eine standortweite, von Administratoren gesteuerte Konfigurationsoption. Data Lake Storage Gen1 verwendet ein unveränderliches **umask-Element für das gesamte Konto**. Die folgende Tabelle enthält Informationen zum umask-Element für Data Lake Storage Gen1.
...
Die folgende Tabelle veranschaulicht die Funktionsweise des Sticky Bits in Data Lake Storage Gen1.
...
Hier sind einige Fragen aufgeführt, die häufig zu ACLs in Data Lake Storage Gen1 gestellt werden.
...
| mask | umask|
|------|------|
| Die **mask** -Eigenschaft steht für jede Datei und jeden Ordner zur Verfügung. | **umask** ist eine Eigenschaft des Data Lake Storage Gen1-Kontos. Data Lake Storage Gen1 enthält also nur ein einzelnes umask-Element.    |
