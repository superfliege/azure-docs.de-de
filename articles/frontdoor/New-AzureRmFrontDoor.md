...
ms.locfileid: "47046381"
---
# New-AzureRmFrontDoor

Erstellen eines neuen Azure Front Door-Lastenausgleichs
...
## Beschreibung
Das Cmdlet **New-AzureRmFrontDoor** erstellt einen neuen Azure Front Door-Lastenausgleich in der angegebenen Ressourcengruppe unter dem aktuellen Abonnement.

## BEISPIELE

### Beispiel 1: Erstellen einer Front Door-Instanz auf Basis der angegebenen Parameter
```powershell
...
Erstellen einer Front Door-Instanz auf Basis der angegebenen Parameter
...
### -EnabledState
EnabledState des Front Door-Lastenausgleichs.
