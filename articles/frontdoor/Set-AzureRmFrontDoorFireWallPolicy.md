...
## Beschreibung
Das Cmdlet **Set-AzureRmFrontDoor** aktualisiert eine vorhandene WAF-Richtlinie. Wenn keine Eingabeparameter angegeben werden, werden alte Parameter der vorhandenen WAF-Richtlinie verwendet.
...
Folgende Werte sind möglich: „Disabled“, „Enabled“
...
Folgende Werte sind möglich: „Prevention“, „Detection“
...
### -Name
Der Name der zu aktualisierenden FireWallPolicy
...
### -ResourceId
Die Ressourcen-ID der zu aktualisierenden FireWallPolicy
