...
## Beschreibung
Das Cmdlet **Get-AzureRmFrontDoorFireWallPolicy** ruft die WAF-Richtlinie in einer Ressourcengruppe unter dem aktuellen Abonnement ab.

## BEISPIELE

### Beispiel 1: Abrufen einer WAF-Richtlinie „$Name“ in „$resourceGroup“
```powershell
...
Abrufen einer WAF-Richtlinie „$Name“ in „$resourceGroup“
