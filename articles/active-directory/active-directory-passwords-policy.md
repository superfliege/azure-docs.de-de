...
| Unzulässige Zeichen |<ul><li>Unicode-Zeichen</li><li>Leerzeichen</li><li> Nur für sichere Kennwörter: Diese dürfen keinen Punkt (.) unmittelbar vor dem \@\"-Symbol enthalten.</li></ul> |
