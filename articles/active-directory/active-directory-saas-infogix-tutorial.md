...
4. Geben Sie im Suchfeld **Infogix Data3Sixty Govern** ein, wählen Sie **Infogix Data3Sixty Govern** im der Ergebnisbereich aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
    ...
    ![Infogix Data3Sixty Govern in der Ergebnisliste](./media/active-directory-saas-infogix-tutorial/tutorial_infogix_addfromgallery.png)
...
2. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/active-directory-saas-infogix-tutorial/tutorial_infogix_samlbase.png)
...
3. Führen Sie im Abschnitt **Domäne und URLs für Infogix Data3Sixty Govern** die folgenden Schritte aus, wenn Sie die Anwendung im **IDP**-initiierten Modus konfigurieren möchten:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für Infogix Data3Sixty Govern](./media/active-directory-saas-infogix-tutorial/tutorial_infogix_url.png)
...
4. Aktivieren Sie **Erweiterte URL-Einstellungen anzeigen**, und führen Sie die folgenden Schritte aus, wenn Sie die Anwendung im **SP-initiierten Modus** konfigurieren möchten:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für Infogix Data3Sixty Govern](./media/active-directory-saas-infogix-tutorial/tutorial_infogix_url1.png)
...
5. Die Infogix Data3Sixty Govern-Anwendung erwartet die SAML-Assertionen in einem bestimmten Format. Konfigurieren Sie die folgenden Ansprüche für diese Anwendung. Sie können die Werte dieser Attribute im Abschnitt **Benutzerattribute** auf der Anwendungsintegrationsseite verwalten. Der folgende Screenshot zeigt ein Beispiel für diese Attributzuordnungen:
    ...
    ![Einmaliges Anmelden konfigurieren, Attribut](./media/active-directory-saas-infogix-tutorial/tutorial_infogix_attribute.png)
...
6. Konfigurieren Sie das SAML-Tokenattribut im Abschnitt **Benutzerattribute** im Dialogfeld **Einmaliges Anmelden**, wie in der Abbildung gezeigt, und führen Sie die folgenden Schritte aus:
    ...
    ![Einmaliges Anmelden konfigurieren, Hinzufügen](./media/active-directory-saas-infogix-tutorial/tutorial_attribute_04.png)

    ![Einmaliges Anmelden konfigurieren, Attribut hinzufügen](./media/active-directory-saas-infogix-tutorial/tutorial_attribute_05.png)
...
7. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Zertifikat (Rohdaten)**, und speichern Sie die Zertifikatdatei auf Ihrem Computer.
    ...
    ![Downloadlink für das Zertifikat](./media/active-directory-saas-infogix-tutorial/tutorial_infogix_certificate.png)

8. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/active-directory-saas-infogix-tutorial/tutorial_general_400.png)
...
9. Klicken Sie im Abschnitt **Konfiguration von Infogix Data3Sixty Govern** auf **Infogix Data3Sixty Govern konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **Abmelde-URL, die SAML-Entitäts-ID und die URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.
    ...
    ![Konfiguration von Infogix Data3Sixty Govern](./media/active-directory-saas-infogix-tutorial/tutorial_infogix_configure.png) 
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/active-directory-saas-infogix-tutorial/create_aaduser_01.png)

2. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/active-directory-saas-infogix-tutorial/create_aaduser_02.png)

3. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/active-directory-saas-infogix-tutorial/create_aaduser_03.png)

4. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/active-directory-saas-infogix-tutorial/create_aaduser_04.png)
...
2. Wählen Sie in der Anwendungsliste **Infogix Data3Sixty Govern** aus.
    ...
    ![Infogix Data3Sixty Govern-Link in der Anwendungsliste](./media/active-directory-saas-infogix-tutorial/tutorial_infogix_app.png)  
