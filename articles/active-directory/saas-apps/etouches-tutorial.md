...
1. Geben Sie im Suchfeld **etouches** ein, wählen Sie im Ergebnisbereich **etouches** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![etouches in der Ergebnisliste](./media/etouches-tutorial/tutorial_etouches_addfromgallery.png)
...
1. **[Erstellen eines etouches-Testbenutzers](#create-an-etouches-test-user)**, um eine Entsprechung von Britta Simon in etouches zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/etouches-tutorial/tutorial_etouches_samlbase.png)

1. Führen Sie auf der Seite **Domäne und URLs für etouches** die folgenden Schritte aus:

    ![SSO-Informationen zur Domäne und zu den URLs für etouches](./media/etouches-tutorial/tutorial_etouches_url.png)
...
1. Konfigurieren Sie das SAML-Tokenattribut im Abschnitt **Benutzerattribute** im Dialogfeld **Einmaliges Anmelden**, wie in der Abbildung gezeigt, und führen Sie die folgenden Schritte aus:
    ...
    ![Attribut hinzufügen](./media/etouches-tutorial/tutorial_attribute_04.png)

    ![Dialogfeld „Attribut hinzufügen“](./media/etouches-tutorial/tutorial_attribute_05.png)
...
1. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Metadaten-XML**, und speichern Sie die Metadatendatei dann auf Ihrem Computer.
    ...
    ![Downloadlink für das Zertifikat](./media/etouches-tutorial/tutorial_etouches_certificate.png) 

1. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/etouches-tutorial/tutorial_general_400.png)
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/etouches-tutorial/create_aaduser_01.png) 

1. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/etouches-tutorial/create_aaduser_02.png) 

1. Klicken Sie oben im Dialogfeld auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.
 
    ![Schaltfläche „Hinzufügen“](./media/etouches-tutorial/create_aaduser_03.png) 

1. Führen Sie auf der Dialogfeldseite **Benutzer** die folgenden Schritte aus:
 
    ![Dialogfeld „Benutzer“](./media/etouches-tutorial/create_aaduser_04.png) 
...
1. Wählen Sie in der Anwendungsliste **etouches** aus.
    ...
    ![etouches-Link in der Anwendungsliste](./media/etouches-tutorial/tutorial_etouches_app.png) 
