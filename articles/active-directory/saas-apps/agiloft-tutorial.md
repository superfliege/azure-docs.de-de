...
4. Geben Sie im Suchfeld **Agiloft** ein, wählen Sie im Ergebnisbereich **Agiloft** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
    ...
    ![Agiloft in der Ergebnisliste](./media/agiloft-tutorial/tutorial_agiloft_addfromgallery.png)
...
2. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/agiloft-tutorial/tutorial_agiloft_samlbase.png)
...
3. Führen Sie im Abschnitt **Domäne und URLs für Agiloft** die folgenden Schritte aus, wenn Sie die Anwendung im IDP-initiierten Modus konfigurieren möchten:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für Agiloft](./media/agiloft-tutorial/tutorial_agiloft_url.png)
...
4. Aktivieren Sie **Erweiterte URL-Einstellungen anzeigen**, und führen Sie die folgenden Schritte aus, wenn Sie die Anwendung im **SP-initiierten Modus** konfigurieren möchten:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für Agiloft](./media/agiloft-tutorial/tutorial_agiloft_url1.png)
...
5. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Zertifikat (Base64)**, und speichern Sie die Zertifikatdatei auf Ihrem Computer.
    ...
    ![Downloadlink für das Zertifikat](./media/agiloft-tutorial/tutorial_agiloft_certificate.png) 

6. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/agiloft-tutorial/tutorial_general_400.png)
...
11. Ein Dialogfeld für einen Assistenten wird angezeigt. Klicken Sie im Dialogfeld auf die Registerkarte **Identity Provider Details** (Details des Identitätsanbieters), und füllen Sie die folgenden Felder aus:  
    ...
    a. Fügen Sie in das Textfeld  **IdP Entity Id / Issuer (IdP-Entitäts-ID / Aussteller)**  den Wert der  **SAML-Entitäts-ID** ein, den Sie aus dem Azure-Portal kopiert haben.

    b. Fügen Sie in das Textfeld  **IdP Login URL (IdP-Anmelde-URL)**  den Wert der  **Dienst-URL für einmalige Anmeldung** ein, den Sie aus dem Azure-Portal kopiert haben.
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/agiloft-tutorial/create_aaduser_01.png)

2. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/agiloft-tutorial/create_aaduser_02.png)

3. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/agiloft-tutorial/create_aaduser_03.png)

4. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/agiloft-tutorial/create_aaduser_04.png)
...
2. Wählen Sie in der Anwendungsliste **Agiloft** aus.
    ...
    ![Agiloft-Link in der Anwendungsliste](./media/agiloft-tutorial/tutorial_agiloft_app.png)  
