...
1. Geben Sie im Suchfeld das Wort **Kindling**ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/kindling-tutorial/tutorial_kindling_search.png)

1. Wählen Sie im Ergebnisbereich die Option **Kindling** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/kindling-tutorial/tutorial_kindling_addfromgallery.png)
...
1. **[Erstellen eines Kindling-Testbenutzers](#creating-a-kindling-test-user)**, um ein Pendant von Britta Simon in Kindling zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie im Abschnitt **Domäne und URLs für Kindling** die folgenden Schritte aus:
...
1. Klicken Sie im Abschnitt **Kindling-Konfiguration** auf **Kindling konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **Abmelde-URL, die SAML-Entitäts-ID und die URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.

    ![Configure single sign-on](./media/kindling-tutorial/tutorial_kindling_configure.png) 

1. Zum Konfigurieren des einmaligen Anmeldens bei **Kindling** müssen Sie das heruntergeladene **Zertifikat (Base64)**, **Abmelde-URL, SAML-Entitäts-ID und SAML-Dienst-URL für einmalige Anmeldung** an das [Kindling-Supportteam](mailto:support@kindlingapp.com) senden.
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/kindling-tutorial/create_aaduser_01.png) 

1. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Erstellen eines Azure AD-Testbenutzers](./media/kindling-tutorial/create_aaduser_02.png) 

1. Klicken Sie oben im Dialogfeld auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/kindling-tutorial/create_aaduser_03.png) 

1. Führen Sie auf der Dialogfeldseite **Benutzer** die folgenden Schritte aus:
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/kindling-tutorial/create_aaduser_04.png) 
...
1. Wählen Sie in der Anwendungsliste **Kindling**aus.
