...
1. Geben Sie im Suchfeld die Zeichenfolge **Atomic Learning**ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/atomiclearning-tutorial/tutorial_atomiclearning_search.png)

1. Wählen Sie im Ergebnisbereich **Atomic Learning** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/atomiclearning-tutorial/tutorial_atomiclearning_addfromgallery.png)
...
1. **[Erstellen eines Atomic Learning-Testbenutzers](#creating-an-atomic-learning-test-user)**, um eine Entsprechung von Britta Simon in Atomic Learning zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie die folgenden Schritte im Abschnitt **Domäne und URLs für Atomic Learning** durch:
...
1. Zum Konfigurieren des einmaligen Anmeldens bei **Atomic Learning** müssen Sie die heruntergeladene **XML-Metadaten**-Datei an das [Atomic Learning-Supportteam](mailto:cs@atomiclearning.com) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/atomiclearning-tutorial/create_aaduser_01.png) 

1. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Erstellen eines Azure AD-Testbenutzers](./media/atomiclearning-tutorial/create_aaduser_02.png) 

1. Klicken Sie oben im Dialogfeld auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/atomiclearning-tutorial/create_aaduser_03.png) 

1. Führen Sie auf der Dialogfeldseite **Benutzer** die folgenden Schritte aus:
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/atomiclearning-tutorial/create_aaduser_04.png) 
