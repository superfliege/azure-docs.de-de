...
3. Klicken Sie oben im Dialogfeld auf die Schaltfläche **Neue Anwendung**, um Zscaler One hinzuzufügen.

    ![Schaltfläche „Neue Anwendung“][3]

4. Geben Sie im Suchfeld den Namen **Zscaler One** ein.

    ![Screenshot: Bereitstellung von Zscaler One](./media/zscaler-one-provisioning-tutorial/app-search.png)

5. Wählen Sie im Ergebnisbereich **Zscaler One** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um Zscaler One der Liste mit den SaaS-Anwendungen hinzuzufügen.

    ![Screenshot: Bereitstellung von Zscaler One](./media/zscaler-one-provisioning-tutorial/app-search-results.png)

    ![Screenshot: Bereitstellung von Zscaler One](./media/zscaler-one-provisioning-tutorial/app-creation.png)
...
2. Wählen Sie Zscaler One in der Liste mit den SaaS-Anwendungen aus.

    ![Screenshot: Bereitstellung von Zscaler One](./media/zscaler-one-provisioning-tutorial/app-instance-search.png)
