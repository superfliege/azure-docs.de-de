...
1. Geben Sie im Suchfeld als Suchbegriff **Fieldglass**ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/fieldglass-tutorial/tutorial_fieldglass_search.png)

1. Wählen Sie im Ergebnisbereich **Fieldglass** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/fieldglass-tutorial/tutorial_fieldglass_addfromgallery.png)
...
1. **[Erstellen eines Fieldglass-Testbenutzers](#creating-a-fieldglass-test-user)**, um ein Pendant von Britta Simon in Fieldglass zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist
...
1. Führen Sie im Abschnitt **Domäne und URLs für Fieldglass** die folgenden Schritte aus:
...
1. Klicken Sie im Abschnitt **Fieldglass-Konfiguration** auf **Fieldglass konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie **Abmelde-URL und SAML-Entitäts-ID** aus dem **Abschnitt mit der Kurzübersicht**.
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/fieldglass-tutorial/create_aaduser_01.png) 

1. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Erstellen eines Azure AD-Testbenutzers](./media/fieldglass-tutorial/create_aaduser_02.png) 

1. Klicken Sie oben im Dialogfeld auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/fieldglass-tutorial/create_aaduser_03.png) 

1. Führen Sie auf der Dialogfeldseite **Benutzer** die folgenden Schritte aus:
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/fieldglass-tutorial/create_aaduser_04.png) 
