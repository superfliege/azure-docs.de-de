...
1. Geben Sie im Suchfeld als Suchbegriff **GaggleAMP**ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/gaggleamp-tutorial/tutorial_gaggleamp_search.png)

1. Wählen Sie im Ergebnisbereich die Option **GaggleAMP** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/gaggleamp-tutorial/tutorial_gaggleamp_addfromgallery.png)
...
1. **[Erstellen eines GaggleAMP-Testbenutzers](#creating-a-gaggleamp-test-user)**, um ein Pendant von Britta Simon in GaggleAMP zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie im Abschnitt **Domäne und URLs für GaggleAMP** die folgenden Schritte aus, wenn Sie die Anwendung im **IDP**-initiierten Modus konfigurieren möchten:
...
1. Klicken Sie im Abschnitt **GaggleAMP-Konfiguration** auf **GaggleAMP konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **SAML-Entitäts-ID und die URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.
...
1. Führen Sie auf der Seite **SAML-SSO** die folgenden Schritte aus:  
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/gaggleamp-tutorial/create_aaduser_01.png) 

1. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Erstellen eines Azure AD-Testbenutzers](./media/gaggleamp-tutorial/create_aaduser_02.png) 

1. Klicken Sie oben im Dialogfeld auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/gaggleamp-tutorial/create_aaduser_03.png) 

1. Führen Sie auf der Dialogfeldseite **Benutzer** die folgenden Schritte aus:
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/gaggleamp-tutorial/create_aaduser_04.png) 
