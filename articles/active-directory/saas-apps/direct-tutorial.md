...
1. Geben Sie im Suchfeld als Suchbegriff **Direct** ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/direct-tutorial/tutorial_direct_search.png)

1. Wählen Sie im Ergebnisbereich die Option **Direct** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
...
1. **[Erstellen eines Direct-Testbenutzers](#creating-a-direct-test-user)**, um ein Pendant von Britta Simon in Direct zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie im Abschnitt **Domäne und URLs für Direct** die folgenden Schritte aus, wenn Sie die Anwendung im **IDP-initiierten Modus** konfigurieren möchten:
...
1. Zum Konfigurieren des einmaligen Anmeldens bei **Direct** müssen Sie die heruntergeladene **Metadaten-XML**-Datei an das [Direct-Supportteam](https://direct4b.com/ja/support.html#inquiry) senden. 
...
1. Wenn Sie im **SP-initiierten Modus** testen möchten:
