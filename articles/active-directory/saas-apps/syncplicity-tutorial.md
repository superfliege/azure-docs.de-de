...
ms.locfileid: "59270233"
---
# <a name="tutorial-azure-active-directory-integration-with-syncplicity"></a>Tutorial: Azure Active Directory-Integration mit Syncplicity
...
* Sie können es Ihren Benutzern ermöglichen, sich mit ihren Azure AD-Konten automatisch bei Syncplicity anzumelden (einmaliges Anmelden; Single Sign-On, SSO).
...
**Führen Sie die folgenden Schritte aus, um Syncplicity über den Katalog hinzuzufügen:**
...
4. Geben Sie im Suchfeld **Syncplicity** ein, wählen Sie im Ergebnisbereich **Syncplicity** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Syncplicity in der Ergebnisliste](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurieren und Testen des einmaligen Anmeldens in Azure AD

In diesem Abschnitt konfigurieren und testen Sie das einmalige Anmelden von Azure AD mit Syncplicity basierend auf einem Testbenutzer mit dem Namen **Britta Simon**.
Damit einmaliges Anmelden funktioniert, muss eine Linkbeziehung zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in Syncplicity eingerichtet werden.
...
2. **[Konfigurieren des einmaligen Anmeldens für Syncplicity](#configure-syncplicity-single-sign-on)**, um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren
3. **[Erstellen eines Azure AD-Testbenutzers](#create-an-azure-ad-test-user)**, um das einmalige Anmelden mit Azure AD mit dem Testbenutzer Britta Simon zu testen.
4. **[Zuweisen des Azure AD-Testbenutzers](#assign-the-azure-ad-test-user)**, um Britta Simon für das einmalige Anmelden von Azure AD zu aktivieren.
5. **[Erstellen eines Syncplicity-Testbenutzers](#create-syncplicity-test-user)**, um eine Entsprechung von Britta Simon in Syncplicity zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist
...
Führen Sie zum Konfigurieren des einmaligen Anmeldens von Azure AD mit Syncplicity die folgenden Schritte aus:

1. Wählen Sie im [Azure-Portal](https://portal.azure.com/) auf der Anwendungsintegrationsseite für **Syncplicity** die Option **Einmaliges Anmelden** aus.
...
4. Führen Sie im Abschnitt **Grundlegende SAML-Konfiguration** die folgenden Schritte aus:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für Syncplicity](common/sp-identifier.png)
...
### <a name="configure-syncplicity-single-sign-on"></a>Konfigurieren des einmaligen Anmeldens für Syncplicity
...
1. Führen Sie auf der Dialogfeldseite **Einmaliges Anmelden (SSO)** die folgenden Schritte aus:
    ...
    ![Einmaliges Anmelden \((SSO)\)](./media/syncplicity-tutorial/ic769550.png "Single Sign-On \\\(SSO\\\)")
    ...
    c. Fügen Sie in das Textfeld **Entity id** (Entitäts-ID) den Wert für **Azure AD-Bezeichner** ein, den Sie aus dem Azure-Portal kopiert haben.
...
1. Wählen Sie im Azure-Portal **Unternehmensanwendungen** > **Alle Anwendungen** > **Syncplicity** aus.

    ![Blatt „Unternehmensanwendungen“](common/enterprise-applications.png)

2. Wählen Sie in der Anwendungsliste **Syncplicity** aus.

    ![Syncplicity-Link in der Anwendungsliste](common/all-applications.png)
