...
1. Geben Sie im Suchfeld den Suchbegriff **Panopto** ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/panopto-tutorial/tutorial_panopto_search.png)

1. Wählen Sie im Ergebnisbereich die Option **Panopto** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/panopto-tutorial/tutorial_panopto_addfromgallery.png)
...
1. **[Erstellen eines Panopto-Testbenutzers](#creating-a-panopto-test-user)**, um eine Entsprechung von Britta Simon in Panopto zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie auf der Seite **Domäne und URLs für Panopto** die folgenden Schritte aus:
...
1. Klicken Sie im Abschnitt **Panopto-Konfiguration** auf **Panopto konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **SAML-Entitäts-ID und die SAML-Dienst-URL für einmaliges Anmelden** aus dem Abschnitt **Kurzübersicht**.
...
1. Klicken Sie in der Symbolleiste auf der linken Seite auf **System** und dann auf **Identitätsanbieter**.
...
1. Führen Sie im Abschnitt für den SAML-Anbieter die folgenden Schritte aus:
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/panopto-tutorial/create_aaduser_01.png) 

1. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Erstellen eines Azure AD-Testbenutzers](./media/panopto-tutorial/create_aaduser_02.png) 

1. Klicken Sie oben im Dialogfeld auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/panopto-tutorial/create_aaduser_03.png) 

1. Führen Sie auf der Dialogfeldseite **Benutzer** die folgenden Schritte aus:
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/panopto-tutorial/create_aaduser_04.png) 
