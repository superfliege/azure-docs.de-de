...
4. **[Erstellen eines Talent Palette-Testbenutzers](#create-talent-palette-test-user)**, um ein Pendant von Britta Simon in Talent Palette zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist.
