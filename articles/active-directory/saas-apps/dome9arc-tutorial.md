...
1. Geben Sie im Suchfeld **Dome9 Arc** ein, wählen Sie im Ergebnisbereich **Dome9 Arc** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Dome9 Arc in der Ergebnisliste](./media/dome9arc-tutorial/tutorial_dome9arc_addfromgallery.png)
...
1. **[Erstellen eines Dome9 Arc-Testbenutzers](#create-a-dome9-arc-test-user)**, um ein Pendant von Britta Simon in Dome9 Arc zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist
...
1. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/dome9arc-tutorial/tutorial_dome9arc_samlbase.png)

1. Führen Sie im Abschnitt **Domäne und URLs für Dome9 Arc** die folgenden Schritte aus, wenn Sie die Anwendung im **IDP**-initiierten Modus konfigurieren möchten:

    ![SSO-Informationen zur Domäne und zu den URLs für Dome9 Arc](./media/dome9arc-tutorial/tutorial_dome9arc_url.png)
...
1. Aktivieren Sie **Erweiterte URL-Einstellungen anzeigen**, und führen Sie die folgenden Schritte aus, wenn Sie die Anwendung im **SP-initiierten Modus** konfigurieren möchten:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für Dome9 Arc](./media/dome9arc-tutorial/tutorial_dome9arc_url1.png)
...
1. Konfigurieren Sie das SAML-Tokenattribut im Dialogfeld **Einmaliges Anmelden** im Abschnitt **Benutzerattribute**, wie im obigen Bild gezeigt, und führen Sie die folgenden Schritte aus:
    ...
    ![Konfigurieren des einmaligen Anmeldens, Attribut hinzufügen](./media/dome9arc-tutorial/tutorial_dome9_04.png)

    ![Konfigurieren des einmaligen Anmeldens, Attribut bearbeiten](./media/dome9arc-tutorial/tutorial_attribute_05.png)
...
1. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Zertifikat (Base64)**, und speichern Sie die Zertifikatdatei auf Ihrem Computer.
    ...
    ![Downloadlink für das Zertifikat](./media/dome9arc-tutorial/tutorial_dome9arc_certificate.png) 

1. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/dome9arc-tutorial/tutorial_general_400.png)
    
1. Klicken Sie im Abschnitt **Dome9 Arc-Konfiguration** auf **Dome9 Arc konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **SAML-Entitäts-ID und die URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.

    ![Dome9 Arc-Konfiguration](./media/dome9arc-tutorial/tutorial_dome9arc_configure.png) 

1. Melden Sie sich in einem anderen Webbrowserfenster bei der Dome9 Arc -Unternehmenswebsite als Administrator an.

1. Klicken Sie in der oberen rechten Ecke auf **Profileinstellungen** und dann auf **Kontoeinstellungen**. 

    ![Dome9 Arc-Konfiguration](./media/dome9arc-tutorial/configure1.png)

1. Navigieren Sie zu **SSO**, und klicken Sie dann auf **AKTIVIEREN**.

    ![Dome9 Arc-Konfiguration](./media/dome9arc-tutorial/configure2.png)

1. Führen Sie im Abschnitt für die SSO-Konfiguration die folgenden Schritte aus:
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/dome9arc-tutorial/create_aaduser_01.png)

1. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/dome9arc-tutorial/create_aaduser_02.png)

1. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/dome9arc-tutorial/create_aaduser_03.png)

1. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/dome9arc-tutorial/create_aaduser_04.png)
...
1. Klicken Sie auf **Benutzer und Rollen** und dann auf **Benutzer**.
...
1. Wählen Sie in der Anwendungsliste **Dome9 Arc** aus.

    ![Dome9 Arc-Link in der Anwendungsliste](./media/dome9arc-tutorial/tutorial_dome9arc_app.png)  
