...
1. Geben Sie in das Suchfeld den Namen **SCC LifeCycle** ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/scclifecycle-tutorial/tutorial_scclifecycle_search.png)

1. Wählen Sie im Ergebnisbereich **SCC LifeCycle** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/scclifecycle-tutorial/tutorial_scclifecycle_addfromgallery.png)
...
1. **[Erstellen eines SCC LifeCycle-Testbenutzers](#creating-an-scc-lifecycle-test-user)**, um ein Pendant von Britta Simon in SCC LifeCycle zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie auf der Seite **Domäne und URLs für SCC LifeCycle** die folgenden Schritte aus:
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/scclifecycle-tutorial/create_aaduser_01.png) 

1. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Erstellen eines Azure AD-Testbenutzers](./media/scclifecycle-tutorial/create_aaduser_02.png) 

1. Klicken Sie oben im Dialogfeld auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/scclifecycle-tutorial/create_aaduser_03.png) 

1. Führen Sie auf der Dialogfeldseite **Benutzer** die folgenden Schritte aus:
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/scclifecycle-tutorial/create_aaduser_04.png) 
