...
1. Geben Sie im Suchfeld **Nomadic** ein, wählen Sie im Ergebnisbereich **Nomadic** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Nomadic in der Ergebnisliste](./media/nomadic-tutorial/tutorial_nomadic_addfromgallery.png)
...
1. **[Erstellen eines Nomadic-Testbenutzers](#create-a-nomadic-test-user)**, um eine Entsprechung von Britta Simon in Nomadic zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/nomadic-tutorial/tutorial_nomadic_samlbase.png)

1. Führen Sie auf der Seite **Domäne und URLs für Nomadic** die folgenden Schritte aus:

    ![SSO-Informationen zur Domäne und zu den URLs für Nomadic](./media/nomadic-tutorial/tutorial_nomadic_url.png)
...
1. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Metadaten-XML**, und speichern Sie die Metadatendatei dann auf Ihrem Computer.
    ...
    ![Downloadlink für das Zertifikat](./media/nomadic-tutorial/tutorial_nomadic_certificate.png) 

1. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/nomadic-tutorial/tutorial_general_400.png)

1.  Wenden Sie sich an das [Supportteam von Nomadic](mailto:help@nomadic.fm), um SSO für Ihre Anwendung konfigurieren zu lassen, und stellen Sie die heruntergeladenen **Metadaten** bereit.
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/nomadic-tutorial/create_aaduser_01.png)

1. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/nomadic-tutorial/create_aaduser_02.png)

1. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/nomadic-tutorial/create_aaduser_03.png)

1. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/nomadic-tutorial/create_aaduser_04.png)
...
1. Wählen Sie in der Anwendungsliste den Eintrag **Nomadic** aus.

    ![Nomadic-Link in der Anwendungsliste](./media/nomadic-tutorial/tutorial_nomadic_app.png)  
