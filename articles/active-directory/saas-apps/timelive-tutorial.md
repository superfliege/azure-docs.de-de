...
1. Geben Sie im Suchfeld **TimeLive** ein, wählen Sie im Ergebnisbereich **TimeLive** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![TimeLive in der Ergebnisliste](./media/timelive-tutorial/tutorial_timelive_addfromgallery.png)
...
1. **[Erstellen eines TimeLive-Testbenutzers](#create-a-timelive-test-user)**, um ein Pendant von Britta Simon in TimeLive zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/timelive-tutorial/tutorial_timelive_samlbase.png)

1. Führen Sie im Abschnitt **Domäne und URLs für TimeLive** die folgenden Schritte aus:

    ![SSO-Informationen zur Domäne und zu den URLs für TimeLive](./media/timelive-tutorial/tutorial_timelive_url.png)
...
1. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Zertifikat (Base64)**, und speichern Sie die Zertifikatdatei auf Ihrem Computer.
    ...
    ![Downloadlink für das Zertifikat](./media/timelive-tutorial/tutorial_timelive_certificate.png) 

1. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/timelive-tutorial/tutorial_general_400.png)
    
1. Klicken Sie im Abschnitt **TimeLive-Konfiguration** auf **TimeLive konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **Abmelde-URL und die URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.
...
1. Wählen Sie **Preferences** (Einstellungen) unter **Admin Options** (Administratoroptionen) aus.

    ![TimeLive-Konfiguration](./media/timelive-tutorial/configure1.png)

1. Führen Sie im Abschnitt **Anwendungseinstellung** die folgenden Schritte aus:
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/timelive-tutorial/create_aaduser_01.png)

1. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/timelive-tutorial/create_aaduser_02.png)

1. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/timelive-tutorial/create_aaduser_03.png)

1. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/timelive-tutorial/create_aaduser_04.png)
...
1. Wählen Sie in der Anwendungsliste den Eintrag **TimeLive** aus.

    ![TimeLive-Link in der Anwendungsliste](./media/timelive-tutorial/tutorial_timelive_app.png)  
