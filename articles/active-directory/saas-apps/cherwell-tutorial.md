...
1. Geben Sie im Suchfeld als Suchbegriff **Cherwell** ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/cherwell-tutorial/tutorial_cherwell_search.png)

1. Wählen Sie im Ergebnisbereich die Option **Cherwell** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/cherwell-tutorial/tutorial_cherwell_addfromgallery.png)
...
1. **[Erstellen eines Cherwell-Testbenutzers](#creating-a-cherwell-test-user)**, um ein Pendant von Britta Simon in Cherwell zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie im Abschnitt **Domäne und URLs für Cherwell** die folgenden Schritte aus:
...
1. Klicken Sie im Abschnitt **Cherwell-Konfiguration** auf **Cherwell konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **SAML-Entitäts-ID und die SAML-Dienst-URL für einmaliges Anmelden** aus dem Abschnitt **Kurzübersicht**.

    ![Configure single sign-on](./media/cherwell-tutorial/tutorial_cherwell_configure.png) 

1. Zum Konfigurieren des einmaligen Anmeldens bei **Cherwell** müssen Sie das heruntergeladene **Zertifikat (Base64)**, **SAML-Dienst-URL für einmalige Anmeldung** und **SAML-Entitäts-ID** an das [Cherwell-Supportteam](https://csm.cherwell.com/contact) senden. 
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/cherwell-tutorial/create_aaduser_01.png) 

1. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Erstellen eines Azure AD-Testbenutzers](./media/cherwell-tutorial/create_aaduser_02.png) 

1. Klicken Sie oben im Dialogfeld auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/cherwell-tutorial/create_aaduser_03.png) 

1. Führen Sie auf der Dialogfeldseite **Benutzer** die folgenden Schritte aus:
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/cherwell-tutorial/create_aaduser_04.png) 
