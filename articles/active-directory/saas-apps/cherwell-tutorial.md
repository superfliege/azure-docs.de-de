...
4. **[Erstellen eines Cherwell-Testbenutzers](#create-cherwell-test-user)**, um eine Entsprechung von Britta Simon in Cherwell zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
4. Führen Sie im Abschnitt **Grundlegende SAML-Konfiguration** den folgenden Schritt aus:
    ...
    > [!NOTE]
    > Dieser Wert entspricht nicht dem tatsächlichen Wert. Ersetzen Sie diesen Wert durch die tatsächliche Anmelde-URL. Wenden Sie sich an das [Clientsupportteam von Cherwell](https://csm.cherwell.com/contact), um den Wert zu erhalten. Sie können sich auch die Muster im Abschnitt **Grundlegende SAML-Konfiguration** im Azure-Portal ansehen.
...
Zum Konfigurieren des einmaligen Anmeldens aufseiten von **Cherwell** müssen Sie das heruntergeladene **Zertifikat (Base64)** und die kopierten URLs aus dem Azure-Portal an das [Supportteam von Cherwell](https://csm.cherwell.com/contact) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
Damit sich Azure AD-Benutzer bei Cherwell anmelden können, müssen sie in Cherwell bereitgestellt werden. Im Fall von Cherwell müssen die Benutzerkonten vom [Supportteam von Cherwell](https://csm.cherwell.com/contact) erstellt werden.
