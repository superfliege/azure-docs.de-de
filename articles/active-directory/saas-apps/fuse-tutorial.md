...
4. Geben Sie im Suchfeld **Fuse** ein, wählen Sie im Ergebnisbereich **Fuse** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
    ...
    ![Fuse in der Ergebnisliste](./media/fuse-tutorial/tutorial_fuse_addfromgallery.png)
...
2. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/fuse-tutorial/tutorial_fuse_samlbase.png)

3. Führen Sie die folgenden Schritte auf der Seite **Domäne und URLs für Fuse** aus:

    ![SSO-Informationen zur Domäne und zu den URLs für Fuse](./media/fuse-tutorial/tutorial_fuse_url.png)
    
    Geben Sie im Textfeld **Anmelde-URL** eine URL im folgenden Format ein: `https://<tenant name>.fusionuniversal.com/`.
...
4. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Zertifikat (Rohdaten)**, und speichern Sie die Zertifikatdatei auf Ihrem Computer.
    ...
    ![Downloadlink für das Zertifikat](./media/fuse-tutorial/tutorial_fuse_certificate.png) 

5. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/fuse-tutorial/tutorial_general_400.png)
...
6. Klicken Sie im Abschnitt **Fuse-Konfiguration** auf **Fuse konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **Abmelde-URL, die SAML-Entitäts-ID und die URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.
    ...
    ![Fuse-Konfiguration](./media/fuse-tutorial/tutorial_fuse_configure.png) 
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/fuse-tutorial/create_aaduser_01.png)

2. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/fuse-tutorial/create_aaduser_02.png)

3. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/fuse-tutorial/create_aaduser_03.png)

4. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/fuse-tutorial/create_aaduser_04.png)
...
2. Wählen Sie in der Anwendungsliste den Eintrag **Fuse** aus.
    ...
    ![Fuse-Link in der Anwendungsliste](./media/fuse-tutorial/tutorial_fuse_app.png)  
