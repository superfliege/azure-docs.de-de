...
1. Geben Sie im Suchfeld **Trello** ein, wählen Sie im Ergebnisbereich **Trello** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
...
1. **[Erstellen eines Trello-Testbenutzers](#create-a-trello-test-user)**, um ein Pendant von Britta Simon in Trello zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie im Abschnitt **Domäne und URLs für Trello** die folgenden Schritte aus, wenn Sie die Anwendung im **IDP-initiierten Modus** konfigurieren möchten:
...
1. Die Trello-Anwendung erwartet, dass die SAML-Assertionen bestimmte Attribute enthalten. Konfigurieren Sie die folgenden Attribute für diese Anwendung. Sie können die Werte dieser Attribute auf der Registerkarte **Benutzerattribute** der Anwendung verwalten. Der folgende Screenshot zeigt ein Beispiel für diese Attributzuordnungen:
...
1. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Zertifikat (Base64)**, und speichern Sie die Metadatendatei auf Ihrem Computer.
...
1. Klicken Sie im Abschnitt **Trello-Konfiguration** auf **Trello konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.

    ![Trello-Konfiguration](./media/trello-tutorial/tutorial_trello_configure.png) 

1. Zum Konfigurieren des einmaligen Anmeldens auf der Seite von **Trello** müssen Sie zur Seite [Trello Enterprise SSO-Konfiguration](https://trello.com/sso-configuration) wechseln und das heruntergeladene **Zertifikat (Base64)** und die **SAML-Dienst-URL für einmaliges Anmelden** an das [Supportteam von Trello](mailto:support@trello.com) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
