...
1. Geben Sie im Suchfeld **Proofpoint on Demand** ein, wählen Sie im Ergebnisbereich **Proofpoint on Demand** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Proofpoint on Demand in der Ergebnisliste](./media/proofpoint-ondemand-tutorial/tutorial_proofpointondemand_addfromgallery.png)
...
1. **[Erstellen eines Proofpoint on Demand-Testbenutzers](#create-a-proofpoint-on-demand-test-user)**, um in Proofpoint on Demand eine Entsprechung von Britta Simon zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/proofpoint-ondemand-tutorial/tutorial_proofpointondemand_samlbase.png)

1. Führen Sie im Abschnitt **Domäne und URLs für Proofpoint on Demand** die folgenden Schritte aus:

    ![SSO-Informationen zur Domäne und zu den URLs für Proofpoint on Demand](./media/proofpoint-ondemand-tutorial/tutorial_proofpointondemand_url.png)
...
1. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Zertifikat (Base64)**, und speichern Sie die Zertifikatdatei auf Ihrem Computer.
    ...
    ![Downloadlink für das Zertifikat](./media/proofpoint-ondemand-tutorial/tutorial_proofpointondemand_certificate.png) 

1. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/proofpoint-ondemand-tutorial/tutorial_general_400.png)
    
1. Klicken Sie im Abschnitt **Proofpoint on Demand-Konfiguration** auf **Proofpoint on Demand konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **Abmelde-URL, die SAML-Entitäts-ID und die URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.

    ![Konfiguration von Proofpoint on Demand](./media/proofpoint-ondemand-tutorial/tutorial_proofpointondemand_configure.png) 

1. Zum Konfigurieren des einmaligen Anmeldens auf der Seite von **Proofpoint on Demand** müssen Sie das heruntergeladene **Zertifikat (Base64)**, die **Abmelde-URL, die SAML-Entitäts-ID und die SAML-Dienst-URL für einmaliges Anmelden** an das [Supportteam von Proofpoint on Demand](https://www.proofpoint.com/us/support-services) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/proofpoint-ondemand-tutorial/create_aaduser_01.png)

1. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/proofpoint-ondemand-tutorial/create_aaduser_02.png)

1. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/proofpoint-ondemand-tutorial/create_aaduser_03.png)

1. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/proofpoint-ondemand-tutorial/create_aaduser_04.png)
...
1. Wählen Sie in der Liste der Anwendungen **Proofpoint on Demand** aus.
    ...
    ![Der Link „Proofpoint on Demand“ in der Anwendungsliste](./media/proofpoint-ondemand-tutorial/tutorial_proofpointondemand_app.png)  
