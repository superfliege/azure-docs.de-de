...
1. Geben Sie im Suchfeld das Wort **Innotas** ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/innotas-tutorial/tutorial_innotas_search.png)

1. Wählen Sie im Ergebnisbereich die Option **Innotas** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/innotas-tutorial/tutorial_innotas_addfromgallery.png)
...
1. **[Erstellen eines Innotas-Testbenutzers](#creating-an-innotas-test-user)**, um in Innotas einen Gegenpart von Britta Simon zu erhalten, der mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie die folgenden Schritte auf der Seite **Domäne und URLs für Innotas** aus:
...
1. Zum Konfigurieren des einmaligen Anmeldens bei **Innotas** müssen Sie die heruntergeladene **Metadaten-XML**-Datei an das [Innotas-Supportteam](https://www.innotas.com/contact) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/innotas-tutorial/create_aaduser_01.png) 

1. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Erstellen eines Azure AD-Testbenutzers](./media/innotas-tutorial/create_aaduser_02.png) 

1. Klicken Sie oben im Dialogfeld auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/innotas-tutorial/create_aaduser_03.png) 

1. Führen Sie auf der Dialogfeldseite **Benutzer** die folgenden Schritte aus:
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/innotas-tutorial/create_aaduser_04.png) 
