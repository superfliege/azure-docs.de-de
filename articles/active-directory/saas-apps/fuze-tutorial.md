...
1. Geben Sie im Suchfeld als Suchbegriff **Fuze** ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/fuze-tutorial/tutorial_fuze_000.png)

1. Wählen Sie im Ergebnisbereich **Fuze** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
...
1. **[Erstellen eines Fuze-Testbenutzers](#creating-a-fuze-test-user)**, um eine Entsprechung von Britta Simon in Fuze zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie die folgenden Schritte auf der Seite **Domäne und URLs für Fuze** aus:
...
1. Zum Konfigurieren des einmaligen Anmeldens bei **Fuze** müssen Sie die heruntergeladene **Metadaten-XML**-Datei an das [Fuze-Supportteam](https://www.fuze.com/support) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
