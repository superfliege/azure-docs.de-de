...
1. Geben Sie im Suchfeld den Suchbegriff **Mercer BenefitsCentral (MBC)** ein, wählen Sie im Ergebnisbereich **Mercer BenefitsCentral (MBC)** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Mercer BenefitsCentral (MBC) in der Ergebnisliste](./media/mercerhrs-tutorial/tutorial_mercerhrs_addfromgallery.png)
...
1. **[Erstellen eines Mercer BenefitsCentral-Testbenutzers (MBC)](#create-a-mercer-benefitscentral-mbc-test-user)**, um eine Entsprechung von Britta Simon in Mercer BenefitsCentral (MBC) zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/mercerhrs-tutorial/tutorial_mercerhrs_samlbase.png)

1. Führen Sie im Abschnitt **Domäne und URLs für Mercer BenefitsCentral (MBC)** die folgenden Schritte aus:

    ![SSO-Informationen zur Domäne und zu den URLs für Mercer BenefitsCentral (MBC)](./media/mercerhrs-tutorial/tutorial_mercerhrs_url.png)
...
1. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Metadaten-XML**, und speichern Sie die Metadatendatei dann auf Ihrem Computer.
    ...
    ![Downloadlink für das Zertifikat](./media/mercerhrs-tutorial/tutorial_mercerhrs_certificate.png) 

1. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/mercerhrs-tutorial/tutorial_general_400.png)

1. Klicken Sie im Abschnitt **Mercer BenefitsCentral (MBC)-Konfiguration** auf **Mercer BenefitsCentral (MBC) konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.

    ![Konfiguration von Mercer BenefitsCentral (MBC)](./media/mercerhrs-tutorial/tutorial_mercerhrs_configure.png) 

1. Zum Konfigurieren des einmaligen Anmeldens aufseiten von **Mercer BenefitsCentral (MBC)** müssen Sie die heruntergeladene **Metadaten-XML** und die **URL für den SAML-SSO-Dienst** an das [Supportteam von Mercer BenefitsCentral (MBC)](https://www.mercer.com/contact-us.html) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/mercerhrs-tutorial/create_aaduser_01.png)

1. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/mercerhrs-tutorial/create_aaduser_02.png)

1. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/mercerhrs-tutorial/create_aaduser_03.png)

1. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/mercerhrs-tutorial/create_aaduser_04.png)
...
1. Wählen Sie in der Anwendungsliste die Option **Mercer BenefitsCentral (MBC)** aus.

    ![Link für Mercer BenefitsCentral (MBC) in der Anwendungsliste](./media/mercerhrs-tutorial/tutorial_mercerhrs_app.png)  
