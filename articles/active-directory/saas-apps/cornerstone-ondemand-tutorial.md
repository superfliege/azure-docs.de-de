...
1. Geben Sie im Suchfeld als Suchbegriff **Cornerstone OnDemand** ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/cornerstone-ondemand-tutorial/tutorial_cornerstoneondemand_search.png)

1. Wählen Sie im Ergebnisbereich **Cornerstone OnDemand** aus, und klicken Sie dann auf **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/cornerstone-ondemand-tutorial/tutorial_cornerstoneondemand_addfromgallery.png)
...
1. **[Erstellen eines Cornerstone OnDemand-Testbenutzers](#creating-a-cornerstone-ondemand-test-user)**, um ein Pendant von Britta Simon in Cornerstone OnDemand zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie im Abschnitt **Domäne und URLs für Cornerstone OnDemand** die folgenden Schritte aus:
...
1. Klicken Sie im Abschnitt **Cornerstone OnDemand-Konfiguration** auf **Cornerstone OnDemand konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **Abmelde-URL und die URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.

    ![Configure single sign-on](./media/cornerstone-ondemand-tutorial/tutorial_cornerstoneondemand_configure.png) 

1. Zum Konfigurieren des einmaligen Anmeldens bei **Cornerstone OnDemand** müssen Sie das heruntergeladene **Zertifikat**, die **Abmelde-URL** sowie die **SAML-Dienst-URL für einmalige Anmeldung** an das [Cornerstone OnDemand-Supportteam](mailTo:moreinfo@csod.com) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/cornerstone-ondemand-tutorial/create_aaduser_01.png)

1. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/cornerstone-ondemand-tutorial/create_aaduser_02.png) 

1. Klicken Sie oben im Dialogfeld auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/cornerstone-ondemand-tutorial/create_aaduser_03.png)

1. Führen Sie auf der Dialogfeldseite **Benutzer** die folgenden Schritte aus:

    ![Erstellen eines Azure AD-Testbenutzers](./media/cornerstone-ondemand-tutorial/create_aaduser_04.png) 
...
* [Konfigurieren der Benutzerbereitstellung](cornerstone-ondemand-provisioning-tutorial.md)
