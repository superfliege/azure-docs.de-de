...
3. **[Erstellen eines Eli Onboarding-Testbenutzers](#create-an-eli-onboarding-test-user)**, um eine Entsprechung von Britta Simon in Eli Onboarding zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
3. Führen Sie die folgenden Schritte auf der Seite **Domäne und URLs für Eli Onboarding** aus:
...
6. Zum Konfigurieren des einmaligen Anmeldens bei **Eli Onboarding** müssen Sie die heruntergeladene **Metadaten-XML-Datei** an das [Eli Onboarding-Supportteam](mailto:support@geteli.com) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
