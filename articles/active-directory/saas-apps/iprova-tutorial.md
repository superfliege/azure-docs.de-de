...
5. **[Erstellen eines iProva-Testbenutzers](#create-iprova-test-user)**, um ein Pendant von Britta Simon in iProva zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist.
...
In diesem Abschnitt erhalten Sie einige wichtige Informationen von iProva.
Diese Informationen sind zum Konfigurieren des einmaligen Anmeldens bei Azure AD erforderlich

1. Öffnen Sie einen Webbrowser, und navigieren Sie mithilfe des folgenden URL-Musters zur **SAML2-Informationsseite** in iProva:
...
4. Führen Sie im Abschnitt **Grundlegende SAML-Konfiguration** die folgenden Schritte aus:
    ...
    a. Füllen Sie das Feld **Bezeichner** mit dem Wert, der hinter der Bezeichnung **EntityID** auf der **iProva SAML2-Informationsseite** angezeigt wird (auf anderer Browserregisterkarte weiterhin geöffnet).

    b. Füllen Sie das Feld **Antwort-URL** mit dem Wert, der hinter der Bezeichnung **Antwort-URL** auf der **iProva SAML2-Informationsseite** angezeigt wird (auf anderer Browserregisterkarte weiterhin geöffnet).

    c. Füllen Sie das Feld **Anmelde-URL** mit dem Wert, der hinter der Bezeichnung **Anmelde-URL** auf der **iProva SAML2-Informationsseite** angezeigt wird (auf anderer Browserregisterkarte weiterhin geöffnet).
...
4. Klicken Sie im Bereich **Systemeinstellungen** auf **Allgemein**.
...
8. Klicken Sie auf die Schaltfläche **Setup**.

9. Klicken Sie auf die Schaltfläche **Weiter**.

10. Sie werden jetzt von iProva gefragt, ob Sie Verbunddaten von einer URL herunterladen oder aus einer Datei hochladen möchten. Wählen Sie die Option **Von URL** aus.

    ![Herunterladen von Azure AD-Metadaten](media/iprova-tutorial/iprova-download-metadata.png)

11. Fügen Sie jetzt die Metadaten-URL ein, die Sie im letzten Schritt des Kapitels **Konfigurieren des einmaliges Anmeldens bei Azure AD** gespeichert haben.

12. Klicken Sie auf die pfeilförmige Schaltfläche, um die Metadaten von Azure AD herunterzuladen.

13. Wenn der Download abgeschlossen ist, wird die Bestätigungsmeldung **Gültige Verbunddatendatei heruntergeladen** angezeigt.

14. Klicken Sie auf die Schaltfläche **Weiter**.

15. Überspringen Sie vorerst die Option **Anmeldung testen**, und klicken Sie auf die Schaltfläche **Weiter**.

16. Wählen Sie in der Dropdownliste namens **Verwendung beanspruchen** die Option **windowsaccountname** aus.

17. Klicken Sie auf die Schaltfläche **Fertig stellen**.

18. Sie kehren jetzt zum Bildschirm **Allgemeine Einstellungen bearbeiten** zurück. **Scrollen Sie nach unten** zum unteren Seitenrand, und klicken Sie auf die Schaltfläche **OK**, um die Konfiguration zu speichern.
...
3. Führen Sie in den Benutzereigenschaften die folgenden Schritte aus.
    ...
    a. Geben Sie im Feld **Name** einen Namen wie **BrittaSimon** ein.
  
    b. Geben Sie im Feld **Benutzername** **yourname@yourcompanydomain.extension** ein.  
...
4. Klicken Sie im Bereich **Benutzer und Benutzergruppen** auf **Benutzer**.

5. Klicken Sie auf die Schaltfläche **Hinzufügen** .

6. Geben Sie im Feld **Benutzername** **brittasimon@yourcompanydomain.extension** ein.  
    Zum Beispiel, BrittaSimon@contoso.com

7. Geben Sie im Feld **Vollständiger Name** einen vollständigen Namen wie **BrittaSimon** ein.

8. Wählen Sie die Option **Kein Kennwort (einmaliges Anmelden verwenden)** aus.

9. Geben Sie im Feld **E-Mail-Adresse** **yourname@yourcompanydomain.extension** ein. Beispiel: BrittaSimon@contoso.com

10. Scrollen Sie zum Seitenende, und klicken Sie auf die Schaltfläche **Fertig stellen**.
