...
1. Geben Sie im Suchfeld **EFI Digital StoreFront** ein, wählen Sie im Ergebnisbereich **EFI Digital StoreFront** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
...
1. **[Erstellen eines EFI Digital StoreFront-Testbenutzers](#create-a-efi-digital-storefront-test-user)**, um ein Pendant von Britta Simon in EFI Digital StoreFront zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie im Abschnitt **Domäne und URLs für EFI Digital StoreFront** die folgenden Schritte aus:
