...
**Führen Sie zum Hinzufügen von RolePoint aus dem Katalog die folgenden Schritte aus:**
...
4. Geben Sie im Suchfeld **RolePoint** ein, wählen Sie im Ergebnisbereich **RolePoint** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

     ![RolePoint in der Ergebnisliste](common/search-new-app.png)
...
Damit einmaliges Anmelden funktioniert, muss eine Linkbeziehung zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in RolePoint eingerichtet werden.
...
2. **[Konfigurieren des einmaligen Anmeldens für RolePoint](#configure-rolepoint-single-sign-on)**, um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren
3. **[Erstellen eines Azure AD-Testbenutzers](#create-an-azure-ad-test-user)**, um das einmalige Anmelden mit Azure AD mit dem Testbenutzer Britta Simon zu testen.
4. **[Zuweisen des Azure AD-Testbenutzers](#assign-the-azure-ad-test-user)**, um Britta Simon für das einmalige Anmelden von Azure AD zu aktivieren.
5. **[Erstellen eines RolePoint-Testbenutzers](#create-rolepoint-test-user)**, um eine Entsprechung von Britta Simon in RolePoint zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist
...
4. Führen Sie im Abschnitt **Grundlegende SAML-Konfiguration** die folgenden Schritte aus:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für RolePoint](common/sp-identifier.png)

    a. Geben Sie im Textfeld **Anmelde-URL** eine URL im folgenden Format ein: `https://<subdomain>.rolepoint.com/login`

    b. Geben Sie im Textfeld **Bezeichner (Entitäts-ID)** eine URL im folgenden Format ein: `https://app.rolepoint.com/<instancename>`

    > [!NOTE]
    > Hierbei handelt es sich um Beispielwerte. Ersetzen Sie diese Werte durch die tatsächliche Anmelde-URL und den tatsächlichen Bezeichner. Hier empfehlen wir Ihnen, den eindeutigen Wert der Zeichenfolge im Bezeichner zu verwenden. Diese Werte erhalten Sie vom [Supportteam für den RolePoint-Client](mailto:info@rolepoint.com). Sie können sich auch die Muster im Abschnitt **Grundlegende SAML-Konfiguration** im Azure-Portal ansehen.
...
Zum Konfigurieren des einmaligen Anmeldens aufseiten von **RolePoint** müssen Sie die heruntergeladene **Verbundmetadaten-XML** und die kopierten URLs aus dem Azure-Portal an das [Supportteam von RolePoint](mailto:info@rolepoint.com) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
2. Wählen Sie in der Anwendungsliste **RolePoint** aus.
    ...
    ![RolePoint-Link in der Anwendungsliste](common/all-applications.png)
...
### <a name="create-rolepoint-test-user"></a>Erstellen eines RolePoint-Testbenutzers

In diesem Abschnitt erstellen Sie in RolePoint einen Benutzer namens Britta Simon. Wenden Sie sich an das  [Supportteam von RolePoint](mailto:info@rolepoint.com), um die Benutzer auf der RolePoint-Plattform hinzuzufügen. Benutzer müssen erstellt und aktiviert werden, damit Sie einmaliges Anmelden verwenden können.

### <a name="test-single-sign-on"></a>Testen des einmaligen Anmeldens

In diesem Abschnitt testen Sie die Azure AD-Konfiguration für einmaliges Anmelden über den Zugriffsbereich.

Wenn Sie im Zugriffsbereich auf die Kachel „RolePoint“ klicken, sollten Sie automatisch bei der RolePoint-Instanz angemeldet werden, für die Sie einmaliges Anmelden eingerichtet haben. Weitere Informationen zum Zugriffsbereich finden Sie unter [Einführung in den Zugriffsbereich](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
