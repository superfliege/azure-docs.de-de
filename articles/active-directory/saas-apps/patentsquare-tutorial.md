...
1. Geben Sie im Suchfeld **PatentSQUARE** ein, wählen Sie im Ergebnisbereich **PatentSQUARE** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
...
1. **[Erstellen eines PatentSQUARE-Testbenutzers](#create-a-patentsquare-test-user)**, um ein Pendant von Britta Simon in PatentSQUARE zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie im Abschnitt **Domäne und URLs für PatentSQUARE** die folgenden Schritte aus:
...
1. Wählen Sie in der Anwendungsliste **PatentSQUARE** aus.
