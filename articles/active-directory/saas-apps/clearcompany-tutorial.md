...
4. Geben Sie im Suchfeld **ClearCompany** ein, wählen Sie im Ergebnisbereich **ClearCompany** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
    ...
    ![ClearCompany in der Ergebnisliste](./media/clearcompany-tutorial/tutorial_clearcompany_addfromgallery.png)
...
2. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/clearcompany-tutorial/tutorial_clearcompany_samlbase.png)
...
3. Führen Sie im Abschnitt **Domäne und URLs für ClearCompany** die folgenden Schritte aus, wenn Sie die Anwendung im IDP-initiierten Modus konfigurieren möchten:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für ClearCompany](./media/clearcompany-tutorial/tutorial_clearcompany_url1.png)

    Geben Sie im Textfeld **Bezeichner** die folgende URL ein: `https://api.clearcompany.com`.

4. Aktivieren Sie **Erweiterte URL-Einstellungen anzeigen**, und führen Sie die folgenden Schritte aus, wenn Sie die Anwendung im **SP-initiierten Modus** konfigurieren möchten:

    ![SSO-Informationen zur Domäne und zu den URLs für ClearCompany](./media/clearcompany-tutorial/tutorial_clearcompany_url2.png)
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/clearcompany-tutorial/create_aaduser_01.png)

2. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/clearcompany-tutorial/create_aaduser_02.png)

3. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/clearcompany-tutorial/create_aaduser_03.png)

4. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/clearcompany-tutorial/create_aaduser_04.png)
...
2. Wählen Sie in der Anwendungsliste die Option **ClearCompany** aus.
    ...
    ![ClearCompany-Link in der Anwendungsliste](./media/clearcompany-tutorial/tutorial_clearcompany_app.png)  
