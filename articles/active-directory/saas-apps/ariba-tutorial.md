...
1. Geben Sie im Suchfeld als Suchbegriff **Ariba**ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/ariba-tutorial/tutorial_ariba_search.png)

1. Wählen Sie im Ergebnisbereich **Ariba** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/ariba-tutorial/tutorial_ariba_addfromgallery.png)
...
1. **[Erstellen eines Ariba-Testbenutzers](#creating-an-ariba-test-user)**, um eine Entsprechung von Britta Simon in Ariba zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie die folgenden Schritte im Abschnitt **Domäne und URLs für Ariba** durch:
...
1. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Zertifikat (Base64)**, und speichern Sie dann die Zertifikatdatei auf Ihrem Computer.
...
1. Rufen Sie zum Konfigurieren von SSO für Ihre Anwendung das Supportteam von Ariba unter der Nummer **1-866-218-2155** an, und es wird Ihnen helfen, die heruntergeladene Datei **Zertifikat (Base64)** an das Supportteam zu senden.  
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/ariba-tutorial/create_aaduser_01.png) 

1. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Erstellen eines Azure AD-Testbenutzers](./media/ariba-tutorial/create_aaduser_02.png) 

1. Klicken Sie oben im Dialogfeld auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/ariba-tutorial/create_aaduser_03.png) 

1. Führen Sie auf der Dialogfeldseite **Benutzer** die folgenden Schritte aus:
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/ariba-tutorial/create_aaduser_04.png) 
