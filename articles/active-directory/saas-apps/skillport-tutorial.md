...
1. Geben Sie im Suchfeld **Skillport** ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/skillport-tutorial/tutorial_skillport_search.png)

1. Wählen Sie im Ergebnisbereich **Skillport** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
...
1. **[Erstellen eines Skillport-Testbenutzers](#creating-a-skillport-test-user)**, um eine Entsprechung von Britta Simon in Skillport zu erhalten, die mit ihrer Repräsentation in Azure AD verknüpft ist.
...
1. Führen Sie die folgenden Schritte auf der Seite **Domäne und URLs für Skillport** aus:
...
1. Zum Konfigurieren des einmaligen Anmeldens bei **Skillport** müssen Sie die heruntergeladene **Metadaten-XML**-Datei an das [Skillport-Supportteam](https://www.skillsoft.com/contact.asp) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
