...
1. Geben Sie im Suchfeld als Suchbegriff **Origami**ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/origami-tutorial/tutorial_origami_search.png)

1. Wählen Sie im Ergebnisbereich die Option **Origami** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/origami-tutorial/tutorial_origami_addfromgallery.png)
...
1. **[Erstellen eines Origami-Testbenutzers](#creating-an-origami-test-user)**, um in Origami einen Gegenpart von Britta Simon zu erhalten, der mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie auf der Seite **Domäne und URLs für Origami** die folgenden Schritte aus:
...
1. Klicken Sie im Abschnitt **Origami-Konfiguration** auf **Origami konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **Abmelde-URL und die URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/origami-tutorial/create_aaduser_01.png) 

1. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Erstellen eines Azure AD-Testbenutzers](./media/origami-tutorial/create_aaduser_02.png) 

1. Klicken Sie oben im Dialogfeld auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/origami-tutorial/create_aaduser_03.png) 

1. Führen Sie auf der Dialogfeldseite **Benutzer** die folgenden Schritte aus:
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/origami-tutorial/create_aaduser_04.png) 
...
1. Klicken Sie im Dialogfeld **Users and Security** (Benutzer und Sicherheit) auf **Users** (Benutzer).
...
1. Führen Sie im Dialogfeld „Add New User“ folgende Schritte aus:
