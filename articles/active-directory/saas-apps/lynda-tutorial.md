...
1. Geben Sie im Suchfeld **Lynda.com** ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/lynda-tutorial/tutorial_lynda.com_search.png)

1. Wählen Sie im Ergebnisbereich **Lynda.com** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/lynda-tutorial/tutorial_lynda.com_addfromgallery.png)
...
1. **[Erstellen eines Lynda.com-Testbenutzers](#creating-a-lyndacom-test-user)**, um eine Entsprechung von Britta Simon in Lynda.com zu erhalten, die mit ihrer Repräsentation in Azure AD verknüpft ist.
...
1. Führen Sie auf der Seite **Domäne und URLs für Lynda.com** die folgenden Schritte aus:
...
1. Zum Konfigurieren des einmaligen Anmeldens bei **Lynda.com** müssen Sie die heruntergeladene **Metadaten-XML**-Datei an den [Lynda.com-Support](https://www.linkedin.com/help/lynda/ask) senden.
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/lynda-tutorial/create_aaduser_01.png) 

1. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Erstellen eines Azure AD-Testbenutzers](./media/lynda-tutorial/create_aaduser_02.png) 

1. Klicken Sie oben im Dialogfeld auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/lynda-tutorial/create_aaduser_03.png) 

1. Führen Sie auf der Dialogfeldseite **Benutzer** die folgenden Schritte aus:
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/lynda-tutorial/create_aaduser_04.png) 
