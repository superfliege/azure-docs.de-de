...
1. Geben Sie im Suchfeld als Suchbegriff **Kronos**ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/kronos-tutorial/tutorial_kronos_search.png)

1. Wählen Sie im Ergebnisbereich **Kronos** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/kronos-tutorial/tutorial_kronos_addfromgallery.png)
...
1. **[Erstellen eines Kronos-Testbenutzers](#creating-a-kronos-test-user)**, um ein Gegenstück zu Britta Simon in Kronos zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie die folgenden Schritte auf der Seite **Domäne und URLs für Kronos** aus:
...
1. Zum Konfigurieren des einmaligen Anmeldens bei **Kronos** müssen Sie die heruntergeladene **Metadaten-XML**-Datei an das [Kronos-Supportteam](https://www.kronos.in/contact/en-in/form) senden. 
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/kronos-tutorial/create_aaduser_01.png) 

1. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Erstellen eines Azure AD-Testbenutzers](./media/kronos-tutorial/create_aaduser_02.png) 

1. Klicken Sie oben im Dialogfeld auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/kronos-tutorial/create_aaduser_03.png) 

1. Führen Sie auf der Dialogfeldseite **Benutzer** die folgenden Schritte aus:
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/kronos-tutorial/create_aaduser_04.png) 
