...
1. Geben Sie im Suchfeld **Sciforma** ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/sciforma-tutorial/tutorial_sciforma_search.png)

1. Wählen Sie im Ergebnisbereich die Option **Sciforma** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/sciforma-tutorial/tutorial_sciforma_addfromgallery.png)
...
1. **[Erstellen eines Sciforma-Testbenutzers](#creating-a-sciforma-test-user)**, um eine Entsprechung von Britta Simon in Sciforma zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie auf der Seite **Domäne und URLs für Sciforma** die folgenden Schritte aus:
    ...
    > [!NOTE] 
    > Hierbei handelt es sich um Beispielwerte. Ersetzen Sie diese Werte durch die tatsächliche Anmelde-URL und den tatsächlichen Bezeichner. Wenden Sie sich an den [Sciforma-Support](https://www.sciforma.com/about/contact), um diese Werte zu erhalten. 
...
1. Zum Konfigurieren des einmaligen Anmeldens bei **Sciforma** müssen Sie die heruntergeladene **Metadaten-XML**-Datei an das [Sciforma-Supportteam](https://www.sciforma.com/about/contact) senden.
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/sciforma-tutorial/create_aaduser_01.png) 

1. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Erstellen eines Azure AD-Testbenutzers](./media/sciforma-tutorial/create_aaduser_02.png) 

1. Klicken Sie oben im Dialogfeld auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/sciforma-tutorial/create_aaduser_03.png) 

1. Führen Sie auf der Dialogfeldseite **Benutzer** die folgenden Schritte aus:
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/sciforma-tutorial/create_aaduser_04.png) 
