...
4. **[Erstellen eines Firstbird-Testbenutzers](#create-firstbird-test-user)**, um eine Entsprechung von Britta Simon in Firstbird zu erhalten, die mit der Darstellung des Benutzers in Azure AD verknüpft ist
