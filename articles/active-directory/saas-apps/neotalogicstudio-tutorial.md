...
1. Geben Sie im Suchfeld als Suchbegriff **Neota Logic Studio** ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/neotalogicstudio-tutorial/tutorial_neotalogicstudio_search.png)

1. Wählen Sie im Ergebnisbereich die Option **Neota Logic Studio** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/neotalogicstudio-tutorial/tutorial_neotalogicstudio_addfromgallery.png)
...
1. **[Erstellen eines Neota Logic Studio-Testbenutzers](#creating-a-neota-logic-studio-test-user)**, um eine Entsprechung von Britta Simon in Neota Logic Studio zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie auf der Seite **Domäne und URLs für Neota Logic Studio** die folgenden Schritte aus:
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/neotalogicstudio-tutorial/create_aaduser_01.png) 

1. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Erstellen eines Azure AD-Testbenutzers](./media/neotalogicstudio-tutorial/create_aaduser_02.png) 

1. Klicken Sie oben im Dialogfeld auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/neotalogicstudio-tutorial/create_aaduser_03.png) 

1. Führen Sie auf der Dialogfeldseite **Benutzer** die folgenden Schritte aus:
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/neotalogicstudio-tutorial/create_aaduser_04.png) 
...
1. Wählen Sie in der Anwendungsliste **Neota Logic Studio** aus.
