...
3. Klicken Sie oben im Dialogfeld auf die Schaltfläche **Neue Anwendung**, um Bonusly hinzuzufügen.

    ![Schaltfläche „Neue Anwendung“][3]

4. Geben Sie im Suchfeld als Suchbegriff **Bonusly** ein.

    ![Bereitstellung mit Bonusly](./media/bonusly-provisioning-tutorial/AppSearch.png)

5. Wählen Sie im Ergebnisbereich **Bonusly** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um Bonusly der Liste der SaaS-Anwendungen hinzuzufügen.

    ![Bereitstellung mit Bonusly](./media/bonusly-provisioning-tutorial/AppSearchResults.png)

    ![Bereitstellung mit Bonusly](./media/bonusly-provisioning-tutorial/AppCreation.png)
...
2. Wählen Sie Bonusly in der Liste der SaaS-Anwendungen aus.
 
    ![Bereitstellung mit Bonusly](./media/bonusly-provisioning-tutorial/AppInstanceSearch.png)
