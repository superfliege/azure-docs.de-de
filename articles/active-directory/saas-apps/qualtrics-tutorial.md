...
1. Geben Sie im Suchfeld **Qualtrics** ein, wählen Sie im Ergebnisbereich **Qualtrics** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Qualtrics in der Ergebnisliste](./media/qualtrics-tutorial/tutorial_qualtrics_addfromgallery.png)
...
1. **[Erstellen eines Qualtrics-Testbenutzers](#create-a-qualtrics-test-user)**, um ein Pendant von Britta Simon in Qualtrics zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/qualtrics-tutorial/tutorial_qualtrics_samlbase.png)

1. Führen Sie im Abschnitt **Domäne und URLs für Qualtrics** die folgenden Schritte aus:

    ![SSO-Informationen zur Domäne und zu den URLs für Qualtrics](./media/qualtrics-tutorial/tutorial_qualtrics_url.png)
...
1. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Metadaten-XML**, und speichern Sie die Metadatendatei dann auf Ihrem Computer.
    ...
    ![Downloadlink für das Zertifikat](./media/qualtrics-tutorial/tutorial_qualtrics_certificate.png) 

1. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/qualtrics-tutorial/tutorial_general_400.png)

1. Zum Konfigurieren des einmaligen Anmeldens bei **Qualtrics** müssen Sie die heruntergeladene **Metadaten-XML**-Datei an das [Qualtrics-Supportteam](https://www.qualtrics.com/support/) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/qualtrics-tutorial/create_aaduser_01.png)

1. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/qualtrics-tutorial/create_aaduser_02.png)

1. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/qualtrics-tutorial/create_aaduser_03.png)

1. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/qualtrics-tutorial/create_aaduser_04.png)
...
1. Wählen Sie in der Anwendungsliste **Qualtrics**aus.

    ![Der Qualtrics-Link in der Anwendungsliste](./media/qualtrics-tutorial/tutorial_qualtrics_app.png)  
