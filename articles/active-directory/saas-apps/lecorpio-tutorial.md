...
1. Geben Sie im Suchfeld als Suchbegriff **Lecorpio** ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/lecorpio-tutorial/tutorial_lecorpio_search.png)

1. Wählen Sie im Ergebnisbereich die Option **Lecorpio** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
...
1. **[Erstellen eines Lecorpio-Testbenutzers](#creating-a-lecorpio-test-user)**, um eine Entsprechung von Britta Simon in Lecorpio zu erhalten, die mit ihrer Repräsentation in Azure AD verknüpft ist.
...
1. Führen Sie auf der Seite **Domäne und URLs für Lecorpio** die folgenden Schritte aus:
...
1. Zum Konfigurieren des einmaligen Anmeldens bei **Lecorpio** müssen Sie die heruntergeladene **Metadaten-XML**-Datei an das [Lecorpio-Supportteam](mailto:info@lecorpio.com) senden.
...
1. Wählen Sie in der Anwendungsliste **Lecorpio** aus.
