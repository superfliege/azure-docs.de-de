...
1. Geben Sie im Suchfeld **Halosys** ein, wählen Sie im Ergebnisbereich **Halosys** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Halosys in der Ergebnisliste](./media/halosys-tutorial/tutorial_halosys_addfromgallery.png)
...
1. **[Erstellen eines Halosys-Testbenutzers](#create-a-halosys-test-user)**, um in Halosys einen Gegenpart von Britta Simon zu erhalten, der mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/halosys-tutorial/tutorial_halosys_samlbase.png)

1. Führen Sie im Abschnitt **Domäne und URLs für Halosys** die folgenden Schritte aus:

    ![SSO-Informationen zur Domäne und zu den URLs für Halosys](./media/halosys-tutorial/tutorial_halosys_url.png)
    ...
    > [!NOTE] 
    > Hierbei handelt es sich um Beispielwerte. Aktualisieren Sie diese Werte mit dem eigentlichen Bezeichner und der Antwort-URL. Wenden Sie sich an das [Supportteam von Halosys](https://halosys.com/halosys#contact), um diese Werte zu erhalten.
 
1. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Metadaten-XML**, und speichern Sie die Metadatendatei dann auf Ihrem Computer.

    ![Downloadlink für das Zertifikat](./media/halosys-tutorial/tutorial_halosys_certificate.png) 

1. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/halosys-tutorial/tutorial_general_400.png)

1. Klicken Sie im Abschnitt **Halosys-Konfiguration** auf **Halosys konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.

    ![Halosys-Konfiguration](./media/halosys-tutorial/tutorial_halosys_configure.png) 

1. Zum Konfigurieren des einmaligen Anmeldens für **Halosys** müssen Sie die heruntergeladene **XML-Metadatendatei** und die **SAML-Dienst-URL für einmaliges Anmelden** an das [Supportteam von Halosys](https://halosys.com/halosys#contact) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/halosys-tutorial/create_aaduser_01.png)

1. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/halosys-tutorial/create_aaduser_02.png)

1. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/halosys-tutorial/create_aaduser_03.png)

1. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/halosys-tutorial/create_aaduser_04.png)
...
1. Wählen Sie in der Anwendungsliste die Option **Halosys** aus.

    ![Halosys-Link in der Anwendungsliste](./media/halosys-tutorial/tutorial_halosys_app.png)  
