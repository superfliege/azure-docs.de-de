...
1. Geben Sie im Suchfeld **Envoy** ein, wählen Sie im Ergebnisbereich **Envoy** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Envoy in der Ergebnisliste](./media/envoy-tutorial/tutorial_envoy_addfromgallery.png)
...
1. **[Erstellen eines Envoy-Testbenutzers](#create-an-envoy-test-user)**, um eine Entsprechung von Britta Simon in Envoy zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/envoy-tutorial/tutorial_envoy_samlbase.png)

1. Führen Sie im Abschnitt **Domäne und URLs für Envoy** die folgenden Schritte aus:
...
1. Kopieren Sie im Abschnitt **SAML-Signaturzertifikat** den Wert **FINGERABDRUCK** des Zertifikats.
    ...
    ![Downloadlink für das Zertifikat](./media/envoy-tutorial/tutorial_envoy_certificate.png) 

1. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/envoy-tutorial/tutorial_general_400.png)

1. Klicken Sie im Abschnitt **Envoy-Konfiguration** auf **Envoy konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.
...
1. Führen Sie im Konfigurationsabschnitt für die **SAML-Authentifizierung** die folgenden Schritte aus:
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/envoy-tutorial/create_aaduser_01.png)

1. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/envoy-tutorial/create_aaduser_02.png)

1. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/envoy-tutorial/create_aaduser_03.png)

1. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/envoy-tutorial/create_aaduser_04.png)
...
1. Wählen Sie in der Anwendungsliste **Envoy** aus.
    ...
    ![Envoy-Link in der Anwendungsliste](./media/envoy-tutorial/tutorial_envoy_app.png)  
