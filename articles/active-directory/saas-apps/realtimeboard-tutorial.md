...
4. Geben Sie im Suchfeld **RealtimeBoard** ein, wählen Sie im Ergebnisbereich **RealtimeBoard** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
    ...
    ![RealtimeBoard in der Ergebnisliste](./media/realtimeboard-tutorial/tutorial_realtimeboard_addfromgallery.png)
...
2. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/realtimeboard-tutorial/tutorial_realtimeboard_samlbase.png)
...
3. Führen Sie im Abschnitt **Domäne und URLs für RealtimeBoard** die folgenden Schritte aus, wenn Sie die Anwendung im **IDP-initiierten Modus** konfigurieren möchten:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für RealtimeBoard](./media/realtimeboard-tutorial/tutorial_realtimeboard_url.png)
...
5. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Metadaten-XML**, und speichern Sie die Metadatendatei dann auf Ihrem Computer.
    ...
    ![Downloadlink für das Zertifikat](./media/realtimeboard-tutorial/tutorial_realtimeboard_certificate.png) 

6. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/realtimeboard-tutorial/tutorial_general_400.png)

7. Um einmaliges Anmelden auf der **RealtimeBoard**-Seite zu konfigurieren, befolgen Sie die [RealtimeBoard-Anweisungen](https://help.realtimeboard.com/support/solutions/articles/11000023465-saml-based-single-sign-on-), und verwenden Sie die Daten aus der heruntergeladenen **Metadaten-XML-Datei**.
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/realtimeboard-tutorial/create_aaduser_01.png)

2. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/realtimeboard-tutorial/create_aaduser_02.png)

3. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/realtimeboard-tutorial/create_aaduser_03.png)

4. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/realtimeboard-tutorial/create_aaduser_04.png)
...
2. Wählen Sie in der Anwendungsliste **RealtimeBoard** aus.
    ...
    ![RealtimeBoard-Link in der Anwendungsliste](./media/realtimeboard-tutorial/tutorial_realtimeboard_app.png)  
