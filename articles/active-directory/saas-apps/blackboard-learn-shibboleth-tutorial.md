...
1. Geben Sie im Suchfeld als Suchbegriff **Blackboard Learn – Shibboleth**ein.
...
1. Wählen Sie im Ergebnisbereich **Blackboard Learn – Shibboleth** aus, und klicken Sie dann auf **Hinzufügen**, um die Anwendung hinzuzufügen.
...
1. **[Erstellen eines Testbenutzers für Blackboard Learn – Shibboleth](#creating-a-blackboard-learn---shibboleth-test-user)**, um eine Entsprechung von Britta Simon in Blackboard Learn – Shibboleth zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie im Abschnitt **Domäne und URLs für Blackboard Learn - Shibboleth** die folgenden Schritte durch:
...
1. Klicken Sie im Abschnitt **Konfiguration von Blackboard Learn – Shibboleth** auf **Blackboard Learn – Shibboleth konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **Abmelde-URL, die SAML-Entitäts-ID und die URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.

    ![Configure single sign-on](./media/blackboard-learn-shibboleth-tutorial/tutorial_blackboardlearn-shibboleth_configure.png) 

1. Zum Konfigurieren des einmaligen Anmeldens bei **Blackboard Learn – Shibboleth** müssen Sie die heruntergeladene **XML-Metadaten**-Datei und **Abmelde-URL, SAML-Entitäts-ID und SAML-Dienst-URL für einmaliges Anmelden** an das [Supportteam für Blackboard Learn – Shibboleth](https://www.blackboard.com/forms/contact-us_form.aspx) senden.
