...
4. Geben Sie im Suchfeld **Compliance ELF** ein, wählen Sie im Ergebnisbereich **Compliance ELF** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
    ...
    ![Compliance ELF in der Ergebnisliste](./media/complianceelf-tutorial/tutorial_complianceelf_addfromgallery.png)
...
6. Klicken Sie auf die Schaltfläche **Save** .
    ...
    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/complianceelf-tutorial/tutorial_general_400.png)
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/complianceelf-tutorial/create_aaduser_01.png)

2. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/complianceelf-tutorial/create_aaduser_02.png)

3. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/complianceelf-tutorial/create_aaduser_03.png)

4. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/complianceelf-tutorial/create_aaduser_04.png)
...
2. Wählen Sie in der Anwendungsliste die Option **Compliance ELF** aus.
    ...
    ![Compliance ELF-Link in der Anwendungsliste](./media/complianceelf-tutorial/tutorial_complianceelf_app.png)  
