...
1. Geben Sie im Suchfeld **Intacct** als Suchbegriff ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/intacct-tutorial/tutorial_intacct_search.png)

1. Wählen Sie im Ergebnisbereich die Option **Intacct** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/intacct-tutorial/tutorial_intacct_addfromgallery.png)
...
1. **[Erstellen eines Intacct-Testbenutzers](#creating-an-intacct-test-user)**, um ein Gegenstück zu Britta Simon in Intacct zu erhalten, das mit der Darstellung dieses Benutzers in Azure AD verknüpft ist.
...
1. Führen Sie die folgenden Schritte auf der Seite **Domäne und URLs für Intacct** aus:
...
1. Klicken Sie im Abschnitt **Intacct-Konfiguration** auf **Intacct konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **SAML-Entitäts-ID und die URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/intacct-tutorial/create_aaduser_01.png) 

1. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Erstellen eines Azure AD-Testbenutzers](./media/intacct-tutorial/create_aaduser_02.png) 

1. Klicken Sie oben im Dialogfeld auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/intacct-tutorial/create_aaduser_03.png) 

1. Führen Sie auf der Dialogfeldseite **Benutzer** die folgenden Schritte aus:
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/intacct-tutorial/create_aaduser_04.png) 
...
1. Wählen Sie in der Anwendungsliste **Intacct**aus.
