...
1. **Erstellen eines Testbenutzers für Zscaler Private Access (ZPA)**, um eine Entsprechung von Britta Simon in Zscaler Private Access (ZPA) zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
