...
1. Geben Sie im Suchfeld **Infogix Data3Sixty Govern** ein, wählen Sie **Infogix Data3Sixty Govern** im der Ergebnisbereich aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
...
1. **[Erstellen eines Infogix Data3Sixty Govern-Testbenutzers](#create-an-infogix-data3sixty-govern-test-user)**, um ein Pendant von Britta Simon in Infogix Data3Sixty Govern zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie im Abschnitt **Domäne und URLs für Infogix Data3Sixty Govern** die folgenden Schritte aus, wenn Sie die Anwendung im **IDP**-initiierten Modus konfigurieren möchten:
...
1. Klicken Sie im Abschnitt **Konfiguration von Infogix Data3Sixty Govern** auf **Infogix Data3Sixty Govern konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **Abmelde-URL, die SAML-Entitäts-ID und die URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.

    ![Konfiguration von Infogix Data3Sixty Govern](./media/infogix-tutorial/tutorial_infogix_configure.png) 

1. Zum Konfigurieren des einmaligen Anmeldens für **Infogix Data3Sixty Govern** müssen Sie die heruntergeladenen Werte für **Zertifikat (Rohdaten), Abmelde-URL, SAML-Entitäts-ID und SAML-Dienst-URL für einmaliges Anmelden** an das [Infogix Data3Sixty Govern-Supportteam](mailto:data3sixtysupport@infogix.com) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
1. Wählen Sie in der Anwendungsliste **Infogix Data3Sixty Govern** aus.
