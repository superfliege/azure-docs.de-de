...
1. Geben Sie im Suchfeld **Wingspan eTMF** ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/wingspanetmf-tutorial/tutorial_wingspanetmf_search.png)

1. Wählen Sie im Ergebnisbereich die Option **Wingspan eTMF** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/wingspanetmf-tutorial/tutorial_wingspanetmf_addfromgallery.png)
...
1. **[Erstellen eines Wingspan eTMF-Testbenutzers](#creating-a-wingspan-etmf-test-user)**, um eine Entsprechung von „Britta Simon“ in Wingspan eTMF zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie die folgenden Schritte im Bereich **Domäne und URLs für Wingspan eTMF** aus:
...
1. Zum Konfigurieren des einmaligen Anmeldens bei **Wingspan eTMF** müssen Sie die heruntergeladene **Metadaten-XML**-Datei an das [Wingspan eTMF-Supportteam](http://www.wingspan.com/contact-us/) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/wingspanetmf-tutorial/create_aaduser_01.png) 

1. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Erstellen eines Azure AD-Testbenutzers](./media/wingspanetmf-tutorial/create_aaduser_02.png) 

1. Klicken Sie oben im Dialogfeld auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/wingspanetmf-tutorial/create_aaduser_03.png) 

1. Führen Sie auf der Dialogfeldseite **Benutzer** die folgenden Schritte aus:
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/wingspanetmf-tutorial/create_aaduser_04.png) 
...
1. Wählen Sie in der Anwendungsliste **Wingspan eTMF**aus.
