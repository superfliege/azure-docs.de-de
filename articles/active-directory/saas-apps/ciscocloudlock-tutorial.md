...
4. Geben Sie im Suchfeld **Cisco Cloudlock** ein, wählen Sie im Ergebnisbereich **Cisco Cloudlock** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
    ...
    ![Cisco Cloudlock in der Ergebnisliste](./media/ciscocloudlock-tutorial/tutorial_ciscocloudlock_addfromgallery.png)
...
3. Führen Sie im Abschnitt **Domäne und URLs für Cisco Cloudlock** die folgenden Schritte aus:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für Cisco Cloudlock](./media/ciscocloudlock-tutorial/tutorial_ciscocloudlock_url.png)
...
2. Wählen Sie in der Anwendungsliste **Cisco Cloudlock** aus.
    ...
    ![Cisco Cloudlock-Link in der Anwendungsliste](./media/ciscocloudlock-tutorial/tutorial_ciscocloudlock_app.png)  
