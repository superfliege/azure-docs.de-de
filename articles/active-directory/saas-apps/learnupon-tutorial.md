...
1. Klicken Sie auf **Benutzereinstellungen**, und führen Sie die folgenden Schritte aus:
    ...
    a. Geben Sie im Textfeld **First Name Identifier Format** (Format der Vornamen-ID) den Wert ein, der angibt, an welcher Stelle in der SAML-Assertion sich der Vorname des Benutzers befindet, etwa `https://schemas.xmlsoap.org/ws/2005/05/identity/claims/givenname`.
  
    b. Geben Sie im Textfeld **Last Name Identifier Format** (Format der Nachnamen-ID) den Wert ein, der angibt, an welcher Stelle in der SAML-Assertion sich der Nachname des Benutzers befindet, z.B. `https://schemas.xmlsoap.org/ws/2005/05/identity/claims/surname`.
