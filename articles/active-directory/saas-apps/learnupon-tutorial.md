...
1. Geben Sie im Suchfeld als Suchbegriff **LearnUpon**ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/learnupon-tutorial/tutorial_learnupon_search.png)

1. Wählen Sie im Ergebnisbereich **LearnUpon** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/learnupon-tutorial/tutorial_learnupon_addfromgallery.png)
...
1. **[Erstellen eines LearnUpon-Testbenutzers](#creating-a-learnupon-test-user)**, um eine Entsprechung von Britta Simon in LearnUpon zu erhalten, die mit ihrer Entsprechung in Azure AD verknüpft ist.
...
1. Führen Sie auf der Seite **Domäne und URLs für LearnUpon** die folgenden Schritte aus:
...
1. Navigieren Sie im Abschnitt **SAML-Signaturzertifikat** zu **Fingerabdruck**. Dieser Wert wird Ihren SAML-Einstellungen für LearnUpon hinzugefügt.
...
1. Klicken Sie im Abschnitt **LearnUpon-Konfiguration** auf **LearnUpon konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **Abmelde-URL, die SAML-Entitäts-ID und die URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/learnupon-tutorial/create_aaduser_01.png) 

1. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Erstellen eines Azure AD-Testbenutzers](./media/learnupon-tutorial/create_aaduser_02.png) 

1. Klicken Sie oben im Dialogfeld auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/learnupon-tutorial/create_aaduser_03.png) 

1. Führen Sie auf der Dialogfeldseite **Benutzer** die folgenden Schritte aus:
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/learnupon-tutorial/create_aaduser_04.png) 
...
Für Sie steht in diesem Abschnitt kein Aktionselement zur Verfügung. Wenn noch kein Benutzer vorhanden ist, wird beim Zugreifen auf LearnUpon ein neuer Benutzer erstellt. Konfigurieren der einmaligen Anmeldung in Azure AD.
