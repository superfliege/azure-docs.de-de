...
1. Geben Sie im Suchfeld als Suchbegriff **Workfront** ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/workfront-tutorial/tutorial_workfront_search.png)

1. Wählen Sie im Ergebnisbereich **Workfront** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/workfront-tutorial/tutorial_workfront_addfromgallery.png)
...
1. **[Erstellen eines Workfront-Testbenutzers](#creating-a-workfront-test-user)**, um eine Entsprechung von Britta Simon in Workfront zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie im Abschnitt **Domäne und URLs für Workfront** die folgenden Schritte aus:
    ...
    > [!NOTE] 
    > Hierbei handelt es sich um Beispielwerte. Ersetzen Sie diese Werte durch die tatsächliche Anmelde-URL und den tatsächlichen Bezeichner. Wenden Sie sich an das [Supportteam von Workfront](https://www.workfront.com/services-and-support), um diese Werte zu erhalten. 
...
1. Klicken Sie im Abschnitt **Workfront-Konfiguration** auf **Workfront konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **Abmelde-URL und die URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.
...
1. Wechseln Sie zu **Einmaliges Anmelden – Konfiguration**.
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/workfront-tutorial/create_aaduser_01.png) 

1. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Erstellen eines Azure AD-Testbenutzers](./media/workfront-tutorial/create_aaduser_02.png) 

1. Klicken Sie oben im Dialogfeld auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/workfront-tutorial/create_aaduser_03.png) 

1. Führen Sie auf der Dialogfeldseite **Benutzer** die folgenden Schritte aus:
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/workfront-tutorial/create_aaduser_04.png) 
...
1. Melden Sie sich bei Ihrer Workfront-Unternehmenswebsite als Administrator an.
1. Klicken Sie oben im Menü auf **Personen**.
