...
1. Geben Sie **Bridge** in das Suchfeld ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/bridge-tutorial/tutorial_bridge_search.png)

1. Wählen Sie im Ergebnisbereich **Bridge** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/bridge-tutorial/tutorial_bridge_addfromgallery.png)
...
1. **[Erstellen eines Bridge-Testbenutzers](#creating-a-bridge-test-user)**, um ein Pendant von Britta Simon in Bridge zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie im Abschnitt **Domäne und URLs für Bridge** die folgenden Schritte aus:
...
1. Klicken Sie im Abschnitt **Bridge-Konfiguration** auf **Bridge konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **Abmelde-URL, die SAML-Entitäts-ID und die URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.

    ![Configure single sign-on](./media/bridge-tutorial/tutorial_bridge_configure.png) 

1. Zum Konfigurieren des einmaligen Anmeldens bei **Bridge** müssen Sie das heruntergeladene **Zertifikat (Rohdaten)** sowie **SAML-Entitäts-ID, SAML-Dienst-URL für einmalige Anmeldung und Abmelde-URL** an das [Bridge-Supportteam](https://community.bridgeapp.com/community/help) senden. 
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/bridge-tutorial/create_aaduser_01.png) 

1. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Erstellen eines Azure AD-Testbenutzers](./media/bridge-tutorial/create_aaduser_02.png) 

1. Klicken Sie oben im Dialogfeld auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/bridge-tutorial/create_aaduser_03.png) 

1. Führen Sie auf der Dialogfeldseite **Benutzer** die folgenden Schritte aus:
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/bridge-tutorial/create_aaduser_04.png) 
