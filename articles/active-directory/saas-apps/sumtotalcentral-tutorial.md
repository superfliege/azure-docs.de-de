...
1. Geben Sie im Suchfeld **SumTotalCentral** ein, wählen Sie im Ergebnisbereich **SumTotalCentral** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![SumTotalCentral in der Ergebnisliste](./media/sumtotalcentral-tutorial/tutorial_sumtotalcentral_addfromgallery.png)
...
1. **[Erstellen eines SumTotalCentral-Testbenutzers](#create-a-sumtotalcentral-test-user)**, um in SumTotalCentral eine Entsprechung von Britta Simon zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/sumtotalcentral-tutorial/tutorial_sumtotalcentral_samlbase.png)

1. Führen Sie im Abschnitt **Domäne und URLs für SumTotalCentral** die folgenden Schritte aus:

    ![SSO-Informationen zur Domäne und den URLs für SumTotalCentral](./media/sumtotalcentral-tutorial/tutorial_sumtotalcentral_url.png)
...
1. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Metadaten-XML**, und speichern Sie die Metadatendatei dann auf Ihrem Computer.
    ...
    ![Downloadlink für das Zertifikat](./media/sumtotalcentral-tutorial/tutorial_sumtotalcentral_certificate.png) 

1. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/sumtotalcentral-tutorial/tutorial_general_400.png)

1. Zum Konfigurieren des einmaligen Anmeldens bei **SumTotalCentral** müssen Sie die heruntergeladene **Metadaten-XML**-Datei an das [SumTotalCentral-Supportteam](http://www.sumtotalsystems.com/support/) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/sumtotalcentral-tutorial/create_aaduser_01.png)

1. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/sumtotalcentral-tutorial/create_aaduser_02.png)

1. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/sumtotalcentral-tutorial/create_aaduser_03.png)

1. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/sumtotalcentral-tutorial/create_aaduser_04.png)
...
1. Wählen Sie in der Anwendungsliste **SumTotalCentral**aus.
    ...
    ![SumTotalCentral-Link in der Anwendungsliste](./media/sumtotalcentral-tutorial/tutorial_sumtotalcentral_app.png)  
