...
1. Geben Sie im Suchfeld **Litmos** ein, wählen Sie im Ergebnisbereich **Litmos** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Litmos in der Ergebnisliste](./media/litmos-tutorial/tutorial_litmos_addfromgallery.png)
...
1. **[Erstellen eines Litmos-Testbenutzers](#create-a-litmos-test-user)**, um ein Pendant von Britta Simon in Litmos zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/litmos-tutorial/tutorial_litmos_samlbase.png)

1. Führen Sie auf der Seite **Domäne und URLs für Litmos** die folgenden Schritte aus:

    ![SSO-Informationen zur Domäne und zu den URLs für Litmos](./media/litmos-tutorial/tutorial_litmos_url.png)
...
1. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Zertifikat (Base64)**, und speichern Sie die Zertifikatdatei auf Ihrem Computer.
    ...
    ![Downloadlink für das Zertifikat](./media/litmos-tutorial/tutorial_litmos_certificate.png)

1. Im Rahmen der Konfiguration müssen Sie die **SAML-Tokenattribute** für Ihre Litmos-Anwendung anpassen.

    ![Attributabschnitt](./media/litmos-tutorial/tutorial_attribute.png)
    ...
    ![Attribut hinzufügen](./media/litmos-tutorial/tutorial_attribute_04.png)

    ![Dialogfeld „Attribut hinzufügen“](./media/litmos-tutorial/tutorial_attribute_05.png)
...
1. Klicken Sie auf die Schaltfläche **Save** .
    ...
    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/litmos-tutorial/tutorial_general_400.png)
...
1. Scrollen Sie auf der Registerkarte **Integrationen** nach unten zu **Drittanbieterintegrationen**, und klicken Sie dann auf die Registerkarte **SAML 2.0**.
   
    ![SAML 2.0-Abschnitt][24] 

1. Kopieren Sie den Wert unter **The SAML endpoint for litmos is:** (Der SAML-Endpunkt für litmos lautet:), und fügen Sie ihn im Azure-Portal im Abschnitt **Domäne und URLs für Litmos** ins Textfeld **Antwort-URL** ein. 
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/litmos-tutorial/create_aaduser_01.png)

1. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/litmos-tutorial/create_aaduser_02.png)

1. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/litmos-tutorial/create_aaduser_03.png)

1. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/litmos-tutorial/create_aaduser_04.png)
...
1. Aktivieren Sie **Autogenerate Users** (Benutzer automatisch erstellen).
...
1. Wählen Sie in der Anwendungsliste **Litmos**aus.
    ...
    ![Litmos-Link in der Anwendungsliste](./media/litmos-tutorial/tutorial_litmos_app.png)  
