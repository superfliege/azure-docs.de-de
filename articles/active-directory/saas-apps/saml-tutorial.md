...
1. Geben Sie im Suchfeld **Branchenanwendung mit aktiviertem SAML 1.1-Token** ein, wählen Sie im Ergebnisbereich **Branchenanwendung mit aktiviertem SAML 1.1-Token** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
...
1. **[Erstellen eines Testbenutzers für eine Branchenanwendung mit aktiviertem SAML 1.1-Token](#create-a-saml-11-token-enabled-lob-app-test-user)**, um eine Entsprechung für Britta Simon in der Branchenanwendung mit aktiviertem SAML 1.1-Token zu haben, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie im Abschnitt **Domäne und URLs für Branchenanwendung mit aktiviertem SAML 1.1-Token** die folgenden Schritte aus:
...
1. Klicken Sie im Abschnitt **Konfiguration der Branchenanwendung mit aktiviertem SAML 1.1-Token** auf **Branchenanwendung mit aktiviertem SAML 1.1-Token konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **Abmelde-URL, die SAML-Entitäts-ID und die URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.
