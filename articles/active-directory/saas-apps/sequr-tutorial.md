...
1. Geben Sie im Suchfeld **Sequr** ein, wählen Sie im Ergebnisbereich **Sequr** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
...
1. **[Erstellen eines Sequr-Testbenutzers](#create-a-sequr-test-user)**, um eine Entsprechung von Britta Simon in Sequr zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie im Abschnitt **Domäne und URLs für Sequr** die folgenden Schritte aus, wenn Sie die Anwendung im **IDP**-initiierten Modus konfigurieren möchten:
...
1. Klicken Sie im Abschnitt **Sequr-Konfiguration** auf **Sequr konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.
...
1. Wählen Sie in der Anwendungsliste die Option **Sequr**aus.
