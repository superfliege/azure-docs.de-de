...
3. **[Erstellen eines Insight4GRC-Testbenutzers](#create-an-insight4grc-test-user)**, um ein Pendant von Britta Simon in Insight4GRC zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist.
...
3. Führen Sie im Abschnitt **Domäne und URLs für Insight4GRC** die folgenden Schritte aus, wenn Sie die Anwendung im **IDP**-initiierten Modus konfigurieren möchten:
...
7. Zum Konfigurieren des einmaligen Anmeldens bei **Insight4GRC** müssen Sie die kopierte **App-Verbundmetadaten-URL** an das [Insight4GRC-Supportteam](mailto:support.ss@rsmuk.com) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
