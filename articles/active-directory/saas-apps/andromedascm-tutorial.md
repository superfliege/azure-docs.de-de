...
4. Geben Sie im Suchfeld **Andromeda** ein, wählen Sie im Ergebnisbereich **Andromeda** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
    ...
    ![Andromeda in der Ergebnisliste](./media/andromedascm-tutorial/tutorial_andromedascm_addfromgallery.png)
...
2. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/andromedascm-tutorial/tutorial_andromedascm_samlbase.png)
...
3. Führen Sie im Abschnitt **Domäne und URLs für Andromeda** die folgenden Schritte aus, wenn Sie die Anwendung im **IDP-initiierten** Modus konfigurieren möchten:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für Andromeda](./media/andromedascm-tutorial/tutorial_andromedascm_url.png)
...
4. Aktivieren Sie **Erweiterte URL-Einstellungen anzeigen**, und führen Sie die folgenden Schritte aus, wenn Sie die Anwendung im **SP-initiierten Modus** konfigurieren möchten:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für Andromeda](./media/andromedascm-tutorial/tutorial_andromedascm_url1.png)
...
5. Die Andromeda-Anwendung erwartet die SAML-Assertionen in einem bestimmten Format. Konfigurieren Sie die folgenden Ansprüche für diese Anwendung. Sie können die Werte dieser Attribute im Abschnitt **Benutzerattribute** auf der Anwendungsintegrationsseite verwalten. Der folgende Screenshot zeigt ein Beispiel für diese Attributzuordnungen:
    ...
    ![Einmaliges Anmelden konfigurieren, Attribut](./media/andromedascm-tutorial/tutorial_andromedascm_attribute.png)
...
6. Konfigurieren Sie das SAML-Tokenattribut im Abschnitt **Benutzerattribute** im Dialogfeld **Einmaliges Anmelden**, wie in der Abbildung gezeigt, und führen Sie die folgenden Schritte aus:
    ...
    ![Einmaliges Anmelden konfigurieren, Hinzufügen](./media/andromedascm-tutorial/tutorial_attribute_04.png)

    ![Einmaliges Anmelden konfigurieren, Attribut hinzufügen](./media/andromedascm-tutorial/tutorial_attribute_05.png)
...
7. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Zertifikat (Base64)**, und speichern Sie die Zertifikatdatei auf Ihrem Computer.
    ...
    ![Downloadlink für das Zertifikat](./media/andromedascm-tutorial/tutorial_andromedascm_certificate.png) 

8. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/andromedascm-tutorial/tutorial_general_400.png)
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/andromedascm-tutorial/create_aaduser_01.png)

2. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/andromedascm-tutorial/create_aaduser_02.png)

3. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/andromedascm-tutorial/create_aaduser_03.png)

4. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/andromedascm-tutorial/create_aaduser_04.png)
...
2. Wählen Sie in der Anwendungsliste **Andromeda** aus.
    ...
    ![Andromeda-Link in der Anwendungsliste](./media/andromedascm-tutorial/tutorial_andromedascm_app.png)  
