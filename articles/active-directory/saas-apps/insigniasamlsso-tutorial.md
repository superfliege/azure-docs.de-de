...
1. Geben Sie im Suchfeld **Insignia SAML SSO** ein, wählen Sie im Ergebnisbereich **Insignia SAML SSO** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Insignia SAML SSO in der Ergebnisliste](./media/insigniasamlsso-tutorial/tutorial_insigniasamlsso_addfromgallery.png)
...
1. **[Erstellen eines Insignia SAML SSO-Testbenutzers](#create-an-insignia-saml-sso-test-user)**, um in Insignia SAML SSO eine Entsprechung von Britta Simon zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/insigniasamlsso-tutorial/tutorial_insigniasamlsso_samlbase.png)

1. Führen Sie auf der Seite **Domäne und URLs für Insignia SAML SSO** die folgenden Schritte aus:

    ![SSO-Informationen zur Domäne und zu den URLs für Insignia SAML SSO](./media/insigniasamlsso-tutorial/tutorial_insigniasamlsso_url.png)
    ...
    b. Geben Sie im Textfeld **Identifier** (Bezeichner) eine URL nach folgendem Muster ein: `https://<customername>.insigniailsusa.com/<uniqueid>`

    > [!NOTE] 
    > Hierbei handelt es sich um Beispielwerte. Ersetzen Sie diese Werte durch die tatsächliche Anmelde-URL und den tatsächlichen Bezeichner. Wenden Sie sich an das [Supportteam von Insignia SAML SSO](https://www.insigniasoftware.com/insignia/Techsupport.aspx), um diese Werte zu erhalten. 
 

1. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Zertifikat (Base64)**, und speichern Sie die Zertifikatdatei auf Ihrem Computer.

    ![Downloadlink für das Zertifikat](./media/insigniasamlsso-tutorial/tutorial_insigniasamlsso_certificate.png) 

1. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/insigniasamlsso-tutorial/tutorial_general_400.png)

1. Klicken Sie im Abschnitt **Insignia SAML SSO-Konfiguration** auf **Insignia SAML SSO konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **Abmelde-URL und die URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.

    ![Insignia SAML-SSO-Konfiguration](./media/insigniasamlsso-tutorial/tutorial_insigniasamlsso_configure.png) 

1. Zum Konfigurieren des einmaligen Anmeldens bei **Insignia SAML SSO** müssen Sie das heruntergeladene **Zertifikat (Base64)**, die **Abmelde-URL, die SAML-Entitäts-ID und die SAML-Dienst-URL für einmaliges Anmelden** an das [Insignia SAML SSO-Supportteam](https://www.insigniasoftware.com/insignia/Techsupport.aspx) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/insigniasamlsso-tutorial/create_aaduser_01.png)

1. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/insigniasamlsso-tutorial/create_aaduser_02.png)

1. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/insigniasamlsso-tutorial/create_aaduser_03.png)

1. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/insigniasamlsso-tutorial/create_aaduser_04.png)
...
In diesem Abschnitt erstellen Sie in Insignia Library System einen Benutzer mit dem Namen Britta Simon. Arbeiten Sie mit dem [Supportteam von Insignia Library System](https://www.insigniasoftware.com/insignia/Techsupport.aspx) zusammen, um die Benutzer auf der Insignia Library System-Plattform hinzuzufügen.
...
1. Wählen Sie in der Anwendungsliste **Insignia SAML SSO** aus.

    ![Insignia SAML SSO-Link in der Anwendungsliste](./media/insigniasamlsso-tutorial/tutorial_insigniasamlsso_app.png)  
