...
4. Geben Sie im Suchfeld **Carlson Wagonlit Travel** ein, wählen Sie **Carlson Wagonlit Travel** im Ergebnisbereich aus, und klicken Sie dann auf **Hinzufügen**, um die Anwendung hinzuzufügen.
    ...
    ![Carlson Wagonlit Travel in der Ergebnisliste](./media/carlsonwagonlit-tutorial/tutorial_carlsonwagonlittravel_addfromgallery.png)
...
2. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/carlsonwagonlit-tutorial/tutorial_carlsonwagonlittravel_samlbase.png)

3. Führen Sie auf der Seite **Domäne und URLs für Carlson Wagonlit Travel** die folgenden Schritte aus:

    ![SSO-Informationen zur Domäne und zu den URLs für Carlson Wagonlit Travel](./media/carlsonwagonlit-tutorial/tutorial_carlsonwagonlittravel_url.png)

    Geben Sie im Textfeld **Bezeichner** den Wert `cwt-stage` ein.

4. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Metadaten-XML**, und speichern Sie die Metadatendatei dann auf Ihrem Computer.

    ![Downloadlink für das Zertifikat](./media/carlsonwagonlit-tutorial/tutorial_carlsonwagonlittravel_certificate.png) 

5. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/carlsonwagonlit-tutorial/tutorial_general_400.png)
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/carlsonwagonlit-tutorial/create_aaduser_01.png)

2. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/carlsonwagonlit-tutorial/create_aaduser_02.png)

3. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/carlsonwagonlit-tutorial/create_aaduser_03.png)

4. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/carlsonwagonlit-tutorial/create_aaduser_04.png)
...
2. Wählen Sie in der Anwendungsliste **Carlson Wagonlit Travel** aus.
    ...
    ![Carlson Wagonlit Travel-Link in der Anwendungsliste](./media/carlsonwagonlit-tutorial/tutorial_carlsonwagonlittravel_app.png)  
