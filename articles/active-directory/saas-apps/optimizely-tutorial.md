...
1. Geben Sie im Suchfeld als Suchbegriff **Optimizely**ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/optimizely-tutorial/tutorial_optimizely_search.png)

1. Wählen Sie im Ergebnisbereich die Option **Optimizely** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
...
1. **[Erstellen eines Optimizely-Testbenutzers](#creating-an-optimizely-test-user)**, um eine Entsprechung von Britta Simon in Optimizely zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie die folgenden Schritte auf der Seite **Domäne und URLs für Optimizely** aus:
...
1. Klicken Sie im Abschnitt **Optimizely-Konfiguration** auf **Optimizely konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.

    ![Configure single sign-on](./media/optimizely-tutorial/tutorial_optimizely_configure.png) 

1. Um einmaliges Anmelden auf der Seite von **Optimizely** zu konfigurieren, wenden Sie sich an Ihren Kundenbetreuer von Optimizely, und stellen Sie das heruntergeladene **Zertifikat (Base64)** und die **SAML-Dienst-URL für einmaliges Anmelden** bereit. 

1. Als Antwort auf Ihre E-Mail stellt Optimizely Ihnen die Anmelde-URL (SP-initiiertes SSO) und den Bezeichner (ID der Dienstanbieterentität).
...
1. Melden Sie sich in einem anderen Browserfenster in Ihrer Optimizely-Anwendung als Administrator an.

1. Klicken Sie in der rechten oberen Ecke auf den Namen Ihres Kontos und dann auf **Account Settings**.
   
    ![Azure AD – einmaliges Anmelden](./media/optimizely-tutorial/tutorial_optimizely_09.png)

1. Aktivieren Sie auf der Registerkarte „Account“ das Kontrollkästchen **Enable SSO** (SSO aktivieren), das Sie im Abschnitt **Overview (Übersicht)** unter „Single Sign On“ finden.
...
1. Klicken Sie auf **New Collaborator**, um einen neuen Projektmitarbeiter zum Projekt hinzuzufügen.
   
    ![Erstellen eines Azure AD-Testbenutzers](./media/optimizely-tutorial/create_aaduser_10.png)

1. Geben Sie die E-Mail-Adresse ein, und weisen Sie ihr eine Rolle zu. Klicken Sie auf **Einladen**.

    ![Erstellen eines Azure AD-Testbenutzers](./media/optimizely-tutorial/create_aaduser_11.png)

1. Der Benutzer erhält eine E-Mail-Einladung. Der Benutzer muss sich mit der E-Mail-Adresse bei Optimizely anmelden.
