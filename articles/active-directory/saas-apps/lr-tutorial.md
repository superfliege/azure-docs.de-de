...
1. Geben Sie im Suchfeld **LoginRadius** ein, wählen Sie im Ergebnisbereich **LoginRadius** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
...
1. **[Erstellen eines LoginRadius-Testbenutzers](#create-a-loginradius-test-user)**, um eine Entsprechung von Britta Simon in LoginRadius zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie auf der Seite **Domäne und URLs für LoginRadius** die folgenden Schritte aus:
...
1. Zum Konfigurieren des einmaligen Anmeldens bei **LoginRadius** müssen Sie die heruntergeladene **Metadaten-XML**-Datei an das [LoginRadius-Supportteam](mailto:support@loginradius.com) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
