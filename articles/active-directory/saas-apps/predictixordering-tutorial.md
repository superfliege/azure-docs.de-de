...
1. Geben Sie im Suchfeld **Predictix Ordering** ein, wählen Sie im Ergebnisbereich **Predictix Ordering** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Predictix Ordering in der Ergebnisliste](./media/predictixordering-tutorial/tutorial_predictixordering_addfromgallery.png)
...
1. **[Erstellen eines Predictix Ordering-Testbenutzers](#create-a-predictix-ordering-test-user)**, um eine Entsprechung von Britta Simon in Predictix Ordering zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/predictixordering-tutorial/tutorial_predictixordering_samlbase.png)

1. Führen Sie auf der Seite **Domäne und URLs für Predictix Ordering** die folgenden Schritte aus:

    ![SSO-Informationen zur Domäne und zu den URLs für Predictix Ordering](./media/predictixordering-tutorial/tutorial_predictixordering_url.png)
...
1. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Zertifikat (Base64)**, und speichern Sie die Zertifikatdatei auf Ihrem Computer.
    ...
    ![Downloadlink für das Zertifikat](./media/predictixordering-tutorial/tutorial_predictixordering_certificate.png) 

1. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/predictixordering-tutorial/tutorial_general_400.png)

1. Klicken Sie im Abschnitt **Predictix Ordering-Konfiguration** auf **Predictix Ordering konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **Abmelde-URL, die SAML-Entitäts-ID und die URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.

    ![Predictix Ordering-Konfiguration](./media/predictixordering-tutorial/tutorial_predictixordering_configure.png) 

1. Zum Konfigurieren des einmaligen Anmeldens bei **Predictix Ordering** müssen Sie das heruntergeladene **Zertifikat (Base64)** sowie **Abmelde-URL, SAML-Entitäts-ID und SAML-Dienst-URL für einmalige Anmeldung** an das [Predictix Ordering-Supportteam](https://www.predix.io/support/) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/predictixordering-tutorial/create_aaduser_01.png)

1. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/predictixordering-tutorial/create_aaduser_02.png)

1. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/predictixordering-tutorial/create_aaduser_03.png)

1. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/predictixordering-tutorial/create_aaduser_04.png)
...
1. Wählen Sie in der Anwendungsliste **Predictix Ordering**aus.

    ![Predictix Ordering-Link in der Anwendungsliste](./media/predictixordering-tutorial/tutorial_predictixordering_app.png)  
