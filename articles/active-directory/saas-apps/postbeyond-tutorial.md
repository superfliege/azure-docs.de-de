...
1. Geben Sie im Suchfeld die Zeichenfolge **PostBeyond**ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/postbeyond-tutorial/tutorial_postbeyond_search.png)

1. Wählen Sie im Ergebnisbereich die Option **PostBeyond** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/postbeyond-tutorial/tutorial_postbeyond_addfromgallery.png)
...
1. **[Erstellen eines PostBeyond-Testbenutzers](#creating-a-postbeyond-test-user)** , um in PostBeyond einen Gegenpart von Britta Simon zu erhalten, der mit der Darstellung dieses Benutzers in Azure AD verknüpft ist.
...
1. Führen Sie im Abschnitt **Domäne und URLs für PostBeyond** die folgenden Schritte aus:
...
1. Klicken Sie im Abschnitt **PostBeyond-Konfiguration** auf **PostBeyond konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **Abmelde-URL, die SAML-Entitäts-ID und die URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.

    ![Configure single sign-on](./media/postbeyond-tutorial/tutorial_postbeyond_configure.png) 

1. Zum Konfigurieren des einmaligen Anmeldens bei **PostBeyond** müssen Sie das heruntergeladene **Zertifikat (Base64)**, die **SAML-Entitäts-ID**, die **SAML-Dienst-URL für einmaliges Anmelden** und die **Abmelde-URL** an das [Supportteam von PostBeyond](mailto:sso@postbeyond.com) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/postbeyond-tutorial/create_aaduser_01.png) 

1. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Erstellen eines Azure AD-Testbenutzers](./media/postbeyond-tutorial/create_aaduser_02.png) 

1. Klicken Sie oben im Dialogfeld auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/postbeyond-tutorial/create_aaduser_03.png) 

1. Führen Sie auf der Dialogfeldseite **Benutzer** die folgenden Schritte aus:
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/postbeyond-tutorial/create_aaduser_04.png) 
...
1. Wählen Sie in der Anwendungsliste die Option **PostBeyond**aus.
