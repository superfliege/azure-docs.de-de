...
1. Geben Sie im Suchfeld **Zwayam** ein, wählen Sie im Ergebnisbereich **Zwayam** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
...
1. **[Erstellen eines Zwayam-Testbenutzers](#create-a-zwayam-test-user)**, um eine Entsprechung von Britta Simon in Zwayam zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist
...
1. Führen Sie im Abschnitt **Domäne und URLs für Zwayam** die folgenden Schritte aus:
...
1. Klicken Sie im Abschnitt **Zwayam-Konfiguration** auf **Zwayam konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **SAML-Entitäts-ID** aus dem Abschnitt **Kurzübersicht**, und fügen Sie den Wert der **SAML-Entitäts-ID** im Abschnitt **Domäne und URLs für Zwayam** ins Textfeld **Anmelde-URL** ein.

    ![Zwayam-Konfiguration](./media/zwayam-tutorial/tutorial_Zwayam_configure.png) 

1. Zum Konfigurieren des einmaligen Anmeldens bei **Zwayam** müssen Sie die heruntergeladene **Metadaten-XML**-Datei an das [Zwayam-Supportteam](mailto:opendoors@zwayam.com) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
1. Wählen Sie in der Anwendungsliste **Zwayam** aus.
