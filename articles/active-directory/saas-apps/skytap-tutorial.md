...
3. **[Erstellen eines Skytap-Testbenutzers](#create-a-skytap-test-user)**, um eine Entsprechung für Britta Simon in Skytap zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
3. Führen Sie im Abschnitt **Domäne und URLs für Skytap** die folgenden Schritte aus, wenn Sie die Anwendung im **IDP-initiierten Modus** konfigurieren möchten:
...
7. Senden Sie die heruntergeladene **Metadaten-XML**-Datei an das [Skytap-Supportteam](mailto:support@skytap.com), um das einmalige Anmelden bei **Skytap** zu konfigurieren. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
