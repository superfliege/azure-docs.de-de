...
1. Geben Sie im Suchfeld **EasyTerritory** ein, wählen Sie im Ergebnisbereich **EasyTerritory** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
...
1. **[Erstellen eines EasyTerritory-Testbenutzers](#create-a-easyterritory-test-user)**, um eine Entsprechung von Britta Simon in EasyTerritory zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie im Abschnitt **Domäne und URLs für EasyTerritory** die folgenden Schritte aus, wenn Sie die Anwendung im IDP-initiierten Modus konfigurieren möchten:
...
1. Zum Konfigurieren des einmaligen Anmeldens bei **EasyTerritory** müssen Sie die heruntergeladene **Metadaten-XML**-Datei an das [EasyTerritory-Supportteam](mailto:sales@easyterritory.com) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
1. Wählen Sie in der Anwendungsliste den Eintrag **EasyTerritory**aus.
