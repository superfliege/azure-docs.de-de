...
3. **[Erstellen eines Supermood-Testbenutzers](#create-a-supermood-test-user)**, um eine Entsprechung für Britta Simon in Supermood zu haben, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
3. Führen Sie im Abschnitt **Domäne und URLs für Supermood** die folgenden Schritte aus:
...
6. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf die Schaltfläche „Kopieren“, um die **Verbundmetadaten-URL der App** zu kopieren und in Editor einzufügen.
...
8. Melden Sie sich im Supermood.co-Administratorbereich als Sicherheitsadministrator an.

9. Klicken Sie unten links auf **My account** (Mein Konto) und auf **Single Sign On (SSO)** (Einmaliges Anmelden).

    ![SSO-Zertifikat](./media/supermood-tutorial/tutorial_supermood_single.png)
10. Klicken Sie unter **Your SAML 2.0 configurations** (Meine SAML 2.0-Konfigurationen) auf **Add an SAML 2.0 configuration for an email domain** (E-Mail-Domäne eine SAML 2.0-Konfiguration hinzufügen).

    ![Hinzufügen eines Zertifikats](./media/supermood-tutorial/tutorial_supermood_add.png)

11. Führen Sie im Abschnitt **Add an SAML 2.0 configuration for an email domain** (E-Mail-Domäne eine SAML 2.0-Konfiguration hinzufügen) die folgenden Schritte aus:
