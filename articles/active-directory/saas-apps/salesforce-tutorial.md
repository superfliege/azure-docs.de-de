...
4. **[Erstellen eines Salesforce-Testbenutzers](#create-salesforce-test-user)**, um ein Pendant von Britta Simon in Salesforce zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist.
