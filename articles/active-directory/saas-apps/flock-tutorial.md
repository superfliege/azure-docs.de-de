...
3. **[Erstellen eines Flock-Testbenutzers](#create-a-flock-test-user)**, um eine Entsprechung für Britta Simon in Flock zu haben, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
3. Führen Sie im Abschnitt **Domäne und URLs für Flock** die folgenden Schritte aus:
...
6. Klicken Sie im Abschnitt **Flock-Konfiguration** auf **Flock konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **SAML-Entitäts-ID und die URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.

    ![Flock-Konfiguration](./media/flock-tutorial/tutorial_flock_configure.png) 

7. Melden Sie sich in einem anderen Webbrowserfenster auf der Flock-Unternehmenswebsite als Administrator an.

8. Wählen Sie im linken Navigationsbereich die Registerkarte **Authentication** (Authentifizierung) und dann **SAML Authentication** (SAML-Authentifizierung) aus.
