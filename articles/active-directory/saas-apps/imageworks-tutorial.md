...
1. Geben Sie im Suchfeld **IMAGE WORKS** ein, wählen Sie im Ergebnisbereich **IMAGE WORKS** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![IMAGE WORKS in der Ergebnisliste](./media/imageworks-tutorial/tutorial_imageworks_addfromgallery.png)
...
1. **[Erstellen eines IMAGE WORKS-Testbenutzers](#create-a-image-works-test-user)**, um ein Pendant von Britta Simon in IMAGE WORKS zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/imageworks-tutorial/tutorial_imageworks_samlbase.png)

1. Führen Sie im Abschnitt **Domäne und URLs für IMAGE WORKS** die folgenden Schritte aus:

    ![SSO-Informationen zur Domäne und zu den URLs für IMAGE WORKS](./media/imageworks-tutorial/tutorial_imageworks_url.png)
...
1. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Zertifikat (Base64)**, und speichern Sie die Zertifikatdatei auf Ihrem Computer.
    ...
    ![Downloadlink für das Zertifikat](./media/imageworks-tutorial/tutorial_imageworks_certificate.png) 

1. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/imageworks-tutorial/tutorial_general_400.png)

1. Klicken Sie im Abschnitt **IMAGE WORKS-Konfiguration** auf **IMAGE WORKS konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **Abmelde-URL, die SAML-Entitäts-ID und die URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.

    ![IMAGE WORKS-Konfiguration](./media/imageworks-tutorial/tutorial_imageworks_configure.png) 

1. Zum Konfigurieren des einmaligen Anmeldens bei **IMAGE WORKS** müssen Sie das heruntergeladene **Zertifikat (Base64), Abmelde-URL, SAML-Entitäts-ID und SAML-Dienst-URL für einmaliges Anmelden** an das [IMAGE WORKS-Supportteam](mailto:iw-sd-support@fujifilm.com) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/imageworks-tutorial/create_aaduser_01.png)

1. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/imageworks-tutorial/create_aaduser_02.png)

1. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/imageworks-tutorial/create_aaduser_03.png)

1. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/imageworks-tutorial/create_aaduser_04.png)
...
1. Wählen Sie in der Anwendungsliste **IMAGE WORKS** aus.

    ![IMAGE WORKS-Link in der Anwendungsliste](./media/imageworks-tutorial/tutorial_imageworks_app.png)  
