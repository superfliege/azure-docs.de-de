...
1. Geben Sie im Suchfeld den Suchbegriff **InsideView** ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/insideview-tutorial/tutorial_insideview_search.png)

1. Wählen Sie im Ergebnisbereich die Option **InsideView** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/insideview-tutorial/tutorial_insideview_addfromgallery.png)
...
1. Führen Sie die folgenden Schritte auf der Seite **Domäne und URLs für InsideView** aus:
...
1. Klicken Sie im Abschnitt **InsideView-Konfiguration** auf **InsideView konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/insideview-tutorial/create_aaduser_01.png) 

1. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Erstellen eines Azure AD-Testbenutzers](./media/insideview-tutorial/create_aaduser_02.png) 

1. Klicken Sie oben im Dialogfeld auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/insideview-tutorial/create_aaduser_03.png) 

1. Führen Sie auf der Dialogfeldseite **Benutzer** die folgenden Schritte aus:
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/insideview-tutorial/create_aaduser_04.png) 
...
### <a name="creating-an-insideview-test-user"></a>Erstellen eines InsideView-Testbenutzers
...
1. Wählen Sie in der Anwendungsliste **InsideView** aus.
