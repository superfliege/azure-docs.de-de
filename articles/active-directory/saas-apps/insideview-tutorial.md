...
**Führen Sie zum Hinzufügen von InsideView aus dem Katalog die folgenden Schritte aus:**
...
4. Geben Sie im Suchfeld **InsideView** ein, wählen Sie im Ergebnisbereich **InsideView**  aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![InsideView in der Ergebnisliste](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurieren und Testen des einmaligen Anmeldens in Azure AD

In diesem Abschnitt konfigurieren und testen Sie das einmalige Anmelden von Azure AD mit InsideView basierend auf einem Testbenutzer mit dem Namen **Britta Simon**.
Damit einmaliges Anmelden funktioniert, muss eine Linkbeziehung zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in InsideView eingerichtet werden.
...
2. **[Konfigurieren des einmaligen Anmeldens für InsideView](#configure-insideview-single-sign-on)**, um die Einstellungen für einmaliges Anmelden auf der Anwendungsseite zu konfigurieren
3. **[Erstellen eines Azure AD-Testbenutzers](#create-an-azure-ad-test-user)**, um das einmalige Anmelden mit Azure AD mit dem Testbenutzer Britta Simon zu testen.
4. **[Zuweisen des Azure AD-Testbenutzers](#assign-the-azure-ad-test-user)**, um Britta Simon für das einmalige Anmelden von Azure AD zu aktivieren.
5. **[Erstellen eines InsideView-Testbenutzers](#create-insideview-test-user)**, um eine Entsprechung von Britta Simon in InsideView zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist
...
4. Führen Sie im Abschnitt **Grundlegende SAML-Konfiguration** die folgenden Schritte aus:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für InsideView](common/idp-reply.png)

    Geben Sie im Textfeld **Antwort-URL** eine URL im folgenden Format ein: `https://my.insideview.com/iv/<STS Name>/login.iv`.

    > [!NOTE]
    > Dieser Wert entspricht nicht dem tatsächlichen Wert. Aktualisieren Sie den Wert mit der richtigen Antwort-URL. Den Wert erhalten Sie vom [Supportteam für den InsideView-Client](mailto:support@insideview.com). Sie können sich auch die Muster im Abschnitt **Grundlegende SAML-Konfiguration** im Azure-Portal ansehen.
...
1. Melden Sie sich in einem anderen Webbrowserfenster bei der InsideView-Unternehmenswebsite als Administrator an.

1. Klicken Sie oben auf der Symbolleiste auf **Administrator**, **Einstellungen für einmaliges Anmelden** und dann auf **SAML hinzufügen**.
...
1. Führen Sie im Abschnitt **Neue SAML hinzufügen** die folgenden Schritte aus:

    ![Neue SAML hinzufügen](./media/insideview-tutorial/ic794136.png "Neue SAML hinzufügen")

    a. Geben Sie im Textfeld **STS-Name** einen Namen für die Konfiguration ein.

    b. Fügen Sie in das Textfeld  **SamlP/WS-Fed Unsolicited EndPoint** (Unangeforderter SamlP/WS-Fed-Endpunkt) den Wert der **Anmelde-URL** ein, den Sie aus dem Azure-Portal kopiert haben.
...
2. Wählen Sie in der Anwendungsliste **InsideView** aus.
    ...
    ![InsideView-Link in der Anwendungsliste](common/all-applications.png)
...
### <a name="create-insideview-test-user"></a>Erstellen eines InsideView-Testbenutzers
...
Wenn Sie im Zugriffsbereich auf die Kachel „InsideView“ klicken, sollten Sie automatisch bei der InsideView-Instanz angemeldet werden, für die Sie einmaliges Anmelden eingerichtet haben. Weitere Informationen zum Zugriffsbereich finden Sie unter [Einführung in den Zugriffsbereich](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
