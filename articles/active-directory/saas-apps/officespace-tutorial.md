...
1. Geben Sie im Suchfeld **OfficeSpace Software** ein, wählen Sie im Ergebnisbereich **OfficeSpace Software** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![OfficeSpace Software in der Ergebnisliste](./media/officespace-tutorial/tutorial_officespace_addfromgallery.png)
...
1. **[Erstellen eines OfficeSpace Software-Testbenutzers](#create-a-officespace-software-test-user)**, um eine Entsprechung von Britta Simon in OfficeSpace Software zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/officespace-tutorial/tutorial_officespace_samlbase.png)

1. Führen Sie die folgenden Schritte auf der Seite **Domäne und URLs für OfficeSpace Software** aus:

    ![SSO-Informationen zur Domäne und zu den URLs für OfficeSpace Software](./media/officespace-tutorial/tutorial_officespace_url.png)
...
1. Wählen Sie im Dialogfeld **Einmaliges Anmelden** im Abschnitt **Benutzerattribute** den Eintrag **user.mail** als **Benutzerbezeichner** aus, und führen Sie für jede in der folgenden Tabelle aufgeführte Zeile die folgenden Schritte aus:
    ...
    ![Konfigurieren, Hinzufügen ](./media/officespace-tutorial/tutorial_attribute_04.png)

    ![Attribut konfigurieren](./media/officespace-tutorial/tutorial_attribute_05.png)
...
1. Kopieren Sie im Abschnitt **SAML-Signaturzertifikat** den Wert **FINGERABDRUCK** des Zertifikats.
    ...
    ![Downloadlink für das Zertifikat](./media/officespace-tutorial/tutorial_officespace_certificate.png) 

1. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/officespace-tutorial/tutorial_general_400.png)

1. Klicken Sie im Abschnitt mit der **OfficeSpace Software-Konfiguration** auf **OfficeSpace Software konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **Abmelde-URL und die URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.

    ![OfficeSpace Software-Konfiguration](./media/officespace-tutorial/tutorial_officespace_configure.png) 

1. Melden Sie sich in einem anderen Webbrowserfenster beim OfficeSpace Software-Mandanten als Administrator an.

1. Navigieren Sie zu **Einstellungen**, und klicken Sie auf **Connectors**.

    ![Einmaliges Anmelden auf App-Seite konfigurieren](./media/officespace-tutorial/tutorial_officespace_002.png)

1. Klicken Sie auf **SAML-Authentifizierung**.
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/officespace-tutorial/create_aaduser_01.png)

1. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/officespace-tutorial/create_aaduser_02.png)

1. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/officespace-tutorial/create_aaduser_03.png)

1. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/officespace-tutorial/create_aaduser_04.png)
...
1. Wählen Sie in der Anwendungsliste **OfficeSpace Software** aus.
    ...
    ![OfficeSpace Software-Link in der Anwendungsliste](./media/officespace-tutorial/tutorial_officespace_app.png)  
