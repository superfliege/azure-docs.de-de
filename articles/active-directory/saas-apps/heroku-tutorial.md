...
1. Geben Sie im Suchfeld als Suchbegriff **Heroku**ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/heroku-tutorial/tutorial_heroku_search.png)

1. Wählen Sie im Ergebnisbereich die Option **Heroku** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/heroku-tutorial/tutorial_heroku_addfromgallery.png)
...
1. **[Erstellen eines Heroku-Testbenutzers](#creating-a-heroku-test-user)**, um in Heroku einen Gegenpart von Britta Simon zu erhalten, der mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie auf der Seite **Domäne und URLs für Heroku** die folgenden Schritte aus:
...
1. Führen Sie die folgenden Schritte aus, um einmaliges Anmelden in Heroku zu aktivieren:
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/heroku-tutorial/create_aaduser_01.png) 

1. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Erstellen eines Azure AD-Testbenutzers](./media/heroku-tutorial/create_aaduser_02.png) 

1. Klicken Sie oben im Dialogfeld auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/heroku-tutorial/create_aaduser_03.png) 

1. Führen Sie auf der Dialogfeldseite **Benutzer** die folgenden Schritte aus:
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/heroku-tutorial/create_aaduser_04.png) 
