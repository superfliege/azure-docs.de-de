...
3. Klicken Sie oben im Dialogfeld auf die Schaltfläche **Neue Anwendung**, um Zscaler Two hinzuzufügen.

    ![Schaltfläche „Neue Anwendung“][3]

4. Geben Sie im Suchfeld den Namen **Zscaler Two** ein.

    ![Screenshot: Bereitstellung von Zscaler Two](./media/zscaler-two-provisioning-tutorial/app-search.png)

5. Wählen Sie im Ergebnisbereich **Zscaler Two** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um Zscaler Two der Liste der SaaS-Anwendungen hinzuzufügen.

    ![Screenshot: Bereitstellung von Zscaler Two](./media/zscaler-two-provisioning-tutorial/app-search-results.png)

    ![Screenshot: Bereitstellung von Zscaler Two](./media/zscaler-two-provisioning-tutorial/app-creation.png)
...
2. Wählen Sie Zscaler Two in der Liste der SaaS-Anwendungen aus.

    ![Screenshot: Bereitstellung von Zscaler Two](./media/zscaler-two-provisioning-tutorial/app-instance-search.png)
