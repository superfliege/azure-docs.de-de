...
1. Geben Sie im Suchfeld **IriusRisk** ein, wählen Sie im Ergebnisbereich **IriusRisk** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![IriusRisk in der Ergebnisliste](./media/iriusrisk-tutorial/tutorial_iriusrisk_addfromgallery.png)
...
1. **[Erstellen eines IriusRisk-Testbenutzers](#create-an-iriusrisk-test-user)**, um eine Entsprechung von Britta Simon in IriusRisk zu erhalten, die mit der Darstellung des Benutzers in Azure AD verknüpft ist.
...
1. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/iriusrisk-tutorial/tutorial_iriusrisk_samlbase.png)

1. Führen Sie die folgenden Schritte auf der Seite **Domäne und URLs für IriusRisk** aus:

    ![SSO-Informationen zur Domäne und den URLs für IriusRisk](./media/iriusrisk-tutorial/tutorial_iriusrisk_url.png)
...
1. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Metadaten-XML**, und speichern Sie die Metadatendatei dann auf Ihrem Computer.
    ...
    ![Downloadlink für das Zertifikat](./media/iriusrisk-tutorial/tutorial_iriusrisk_certificate.png) 

1. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/iriusrisk-tutorial/tutorial_general_400.png)

1. Zum Konfigurieren des einmaligen Anmeldens bei **IriusRisk** müssen Sie die heruntergeladene **Metadaten-XML**-Datei an das [IriusRisk-Supportteam](mailto:info@continuumsecurity.net) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/iriusrisk-tutorial/create_aaduser_01.png)

1. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/iriusrisk-tutorial/create_aaduser_02.png)

1. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/iriusrisk-tutorial/create_aaduser_03.png)

1. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/iriusrisk-tutorial/create_aaduser_04.png)
...
> [!Note]
> Setzen Sie sich mit dem  [Supportteam von IriusRisk](mailto:info@continuumsecurity.net) in Verbindung, wenn Sie einen Benutzer manuell erstellen müssen.
...
1. Wählen Sie in der Anwendungsliste **IriusRisk** aus.
    ...
    ![IriusRisk-Link in der Anwendungsliste](./media/iriusrisk-tutorial/tutorial_iriusrisk_app.png)  
