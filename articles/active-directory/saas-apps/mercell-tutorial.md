...
4. Geben Sie im Suchfeld **Mercell** ein, wählen Sie im Ergebnisbereich **Mercell** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
    ...
    ![Mercell in der Ergebnisliste](./media/mercell-tutorial/tutorial_mercell_addfromgallery.png)
...
2. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/mercell-tutorial/tutorial_mercell_samlbase.png)

3. Führen Sie im Abschnitt **Domäne und URLs für Mercell** die folgenden Schritte aus:

    ![SSO-Informationen zur Domäne und zu den URLs für Mercell](./media/mercell-tutorial/tutorial_mercell_url.png)

    Geben Sie im Textfeld **Bezeichner** die folgende URL ein: `https://my.mercell.com/`.

4. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf die Schaltfläche „Kopieren“, um die **Verbundmetadaten-URL der App** zu kopieren, und fügen Sie die URL in Editor ein.
    
    ![Configure single sign-on](./media/mercell-tutorial/tutorial_metadataurl.png)
     
5. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/mercell-tutorial/tutorial_general_400.png)
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/mercell-tutorial/create_aaduser_01.png)

2. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/mercell-tutorial/create_aaduser_02.png)

3. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/mercell-tutorial/create_aaduser_03.png)

4. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/mercell-tutorial/create_aaduser_04.png)
...
>[!Note]
>Wenn Sie einen Benutzer manuell erstellen müssen, wenden Sie sich an das [Mercell-Supportteam](mailto:webmaster@mercell.com).
...
2. Wählen Sie in der Anwendungsliste **Mercell**aus.
    ...
    ![Mercell-Link in der Anwendungsliste](./media/mercell-tutorial/tutorial_mercell_app.png)  
