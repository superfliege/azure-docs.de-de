...
1. Geben Sie im Suchfeld als Suchbegriff **M-Files**ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/m-files-tutorial/tutorial_m-files_search.png)

1. Wählen Sie im Ergebnisbereich **M-Files** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/m-files-tutorial/tutorial_m-files_addfromgallery.png)
...
1. **[Erstellen eines M-Files-Testbenutzers](#creating-a-m-files-test-user)**, um eine Entsprechung von Britta Simon in M-Files zu erhalten, die mit der Darstellung dieses Benutzers in Azure AD verknüpft ist.
...
1. Führen Sie die folgenden Schritte auf der Seite **Domäne und URLs für M-Files** aus:
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/m-files-tutorial/create_aaduser_01.png) 

1. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Erstellen eines Azure AD-Testbenutzers](./media/m-files-tutorial/create_aaduser_02.png) 

1. Klicken Sie oben im Dialogfeld auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/m-files-tutorial/create_aaduser_03.png) 

1. Führen Sie auf der Dialogfeldseite **Benutzer** die folgenden Schritte aus:
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/m-files-tutorial/create_aaduser_04.png) 
