...
1. Geben Sie im Suchfeld **YouEarnedIt** ein, wählen Sie im Ergebnisbereich **YouEarnedIt** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![YouEarnedIt in der Ergebnisliste](./media/youearnedit-tutorial/tutorial_youearnedit_addfromgallery.png)
...
1. **[Erstellen eines YouEarnedIt-Testbenutzers](#create-a-youearnedit-test-user)**, um eine Entsprechung von Britta Simon in YouEarnedIt zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/youearnedit-tutorial/tutorial_youearnedit_samlbase.png)

1. Führen Sie auf der Seite **Domäne und URLs für YouEarnedIt** die folgenden Schritte aus:

    ![SSO-Informationen zur Domäne und zu den URLs für YouEarnedIt](./media/youearnedit-tutorial/tutorial_youearnedit_url.png)
...
1. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Zertifikat (Base64)**, und speichern Sie die Zertifikatdatei auf Ihrem Computer.
    ...
    ![Downloadlink für das Zertifikat](./media/youearnedit-tutorial/tutorial_youearnedit_certificate.png) 

1. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/youearnedit-tutorial/tutorial_general_400.png)

1. Klicken Sie im Abschnitt **YouEarnedIt-Konfiguration** auf **YouEarnedIt konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.

    ![YouEarnedIt-Konfiguration](./media/youearnedit-tutorial/tutorial_youearnedit_configure.png) 

1. Zum Konfigurieren des einmaligen Anmeldens bei **YouEarnedIt** müssen Sie das heruntergeladene **Zertifikat (Base64)** und die **SAML-Dienst-URL für einmaliges Anmelden** an das [Supportteam von YouEarnedIt](https://youearnedit.freshdesk.com/support/tickets/new) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/youearnedit-tutorial/create_aaduser_01.png)

1. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/youearnedit-tutorial/create_aaduser_02.png)

1. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/youearnedit-tutorial/create_aaduser_03.png)

1. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/youearnedit-tutorial/create_aaduser_04.png)
...
1. Wählen Sie in der Anwendungsliste die Option **YouEarnedIt**aus.
    ...
    ![YouEarnedIt-Link in der Anwendungsliste](./media/youearnedit-tutorial/tutorial_youearnedit_app.png)  
