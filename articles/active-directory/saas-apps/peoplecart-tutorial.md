...
1. Geben Sie im Suchfeld **Peoplecart** ein, wählen Sie im Ergebnisbereich **Peoplecart** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Peoplecart in der Ergebnisliste](./media/peoplecart-tutorial/tutorial_peoplecart_addfromgallery.png)
...
1. **[Erstellen eines Peoplecart-Testbenutzers](#create-a-peoplecart-test-user)**, um ein Pendant von Britta Simon in Peoplecart zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie im Abschnitt **Domäne und URLs für Peoplecart** die folgenden Schritte aus:

    ![SSO-Informationen zur Domäne und zu den URLs für Peoplecart](./media/peoplecart-tutorial/tutorial_peoplecart_url.png)
...
1. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Metadaten-XML**, und speichern Sie die Metadatendatei dann auf Ihrem Computer.
    ...
    ![Downloadlink für das Zertifikat](./media/peoplecart-tutorial/tutorial_peoplecart_certificate.png) 

1. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/peoplecart-tutorial/tutorial_general_400.png)

1. Klicken Sie im Abschnitt **Peoplecart-Konfiguration** auf **Peoplecart konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.

    ![Peoplecart-Konfiguration](./media/peoplecart-tutorial/tutorial_peoplecart_configure.png) 

1. Zum Konfigurieren des einmaligen Anmeldens auf der Seite von **Peoplecart** müssen Sie die heruntergeladene **Metadaten-XML**-Datei und die **SAML-Dienst-URL für einmaliges Anmelden** an das [Peoplecart-Supportteam](https://peoplecart.com/ContactUs.aspx) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/peoplecart-tutorial/create_aaduser_01.png) 

1. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/peoplecart-tutorial/create_aaduser_02.png) 

1. Klicken Sie oben im Dialogfeld auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.
 
    ![Schaltfläche „Hinzufügen“](./media/peoplecart-tutorial/create_aaduser_03.png) 

1. Führen Sie auf der Dialogfeldseite **Benutzer** die folgenden Schritte aus:
 
    ![Dialogfeld „Benutzer“](./media/peoplecart-tutorial/create_aaduser_04.png) 
...
1. Wählen Sie in der Anwendungsliste den Eintrag **Peoplecart** aus.

    ![Peoplecart-Link in der Anwendungsliste](./media/peoplecart-tutorial/tutorial_peoplecart_app.png) 
