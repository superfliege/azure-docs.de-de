...
1. Geben Sie im Suchfeld den Namen **LockPath Keylight** ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/keylight-tutorial/tutorial_keylight_search.png)

1. Wählen Sie im Ergebnisbereich **LockPath Keylight** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/keylight-tutorial/tutorial_keylight_addfromgallery.png)
...
1. **[Erstellen eines LockPath Keylight-Testbenutzers](#creating-a-lockpath-keylight-test-user)**, um ein Pendant zu Britta Simon in LockPath Keylight zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist
...
1. Führen Sie auf der Seite **Domäne und URLs für LockPath Keylight** die folgenden Schritte aus:
...
1. Klicken Sie im Abschnitt **LockPath Keylight-Konfiguration** auf **LockPath Keylight konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **Abmelde-URL und die URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/keylight-tutorial/create_aaduser_01.png) 

1. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Erstellen eines Azure AD-Testbenutzers](./media/keylight-tutorial/create_aaduser_02.png) 

1. Klicken Sie oben im Dialogfeld auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/keylight-tutorial/create_aaduser_03.png) 

1. Führen Sie auf der Dialogfeldseite **Benutzer** die folgenden Schritte aus:
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/keylight-tutorial/create_aaduser_04.png) 
