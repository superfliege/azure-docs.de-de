...
4. Geben Sie im Suchfeld **Insider Track** ein, wählen Sie im Ergebnisbereich **Insider Track** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
    ...
    ![Insider Track in der Ergebnisliste](./media/insidertrack-tutorial/tutorial_insidertrack_addfromgallery.png)
...
2. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/insidertrack-tutorial/tutorial_insidertrack_samlbase.png)

3. Führen Sie auf der Seite **Domäne und URLs für Insider Track** die folgenden Schritte aus:

    ![SSO-Informationen zur Domäne und zu den URLs für Insider Track](./media/insidertrack-tutorial/tutorial_insidertrack_url.png)
...
4. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Metadaten-XML**, und speichern Sie die Metadatendatei dann auf Ihrem Computer.
    ...
    ![Downloadlink für das Zertifikat](./media/insidertrack-tutorial/tutorial_insidertrack_certificate.png) 

5. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/insidertrack-tutorial/tutorial_general_400.png)
...
6. Klicken Sie im Abschnitt **Insider Track-Konfiguration** auf **Insider Track konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **Abmelde-URL, die SAML-Entitäts-ID und die URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.
    ...
    ![Insider Track-Konfiguration](./media/insidertrack-tutorial/tutorial_insidertrack_configure.png) 
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/insidertrack-tutorial/create_aaduser_01.png)

2. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/insidertrack-tutorial/create_aaduser_02.png)

3. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/insidertrack-tutorial/create_aaduser_03.png)

4. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/insidertrack-tutorial/create_aaduser_04.png)
...
2. Wählen Sie in der Anwendungsliste **Insider Track** aus.
    ...
    ![Insider Track-Link in der Anwendungsliste](./media/insidertrack-tutorial/tutorial_insidertrack_app.png)  
