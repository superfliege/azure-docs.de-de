...
1. Geben Sie im Suchfeld **ChronicX®** ein, wählen Sie im Ergebnisbereich **ChronicX®** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
...
1. **[Erstellen eines ChronicX®-Testbenutzers](#create-a-chronicx®-test-user)**, um eine Entsprechung für Britta Simon in ChronicX® zu haben, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie im Abschnitt **Domäne und URLs für ChronicX®** die folgenden Schritte aus:
...
1. Senden Sie die heruntergeladene **Metadaten-XML**-Datei an das [ChronicX®-Supportteam](https://www.casebank.com/contact-us/), um das einmalige Anmelden bei **ChronicX®** zu konfigurieren. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
1. Wählen Sie in der Anwendungsliste **ChronicX®** aus.
