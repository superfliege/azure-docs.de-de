...
1. Geben Sie im Suchfeld **Skyhigh Networks** ein, wählen Sie im Ergebnisbereich **Skyhigh Networks** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
...
1. **[Erstellen eines Skyhigh Networks-Testbenutzers](#create-a-skyhigh-networks-test-user)**, um eine Entsprechung für Britta Simon in Skyhigh Networks zu haben, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie im Abschnitt **Domäne und URLs für Skyhigh Networks** die folgenden Schritte aus, wenn Sie die Anwendung im **IDP-initiierten Modus** konfigurieren möchten:
...
1. Klicken Sie im Abschnitt **Skyhigh Networks-Konfiguration** auf **Skyhigh Networks konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **Abmelde-URL, die SAML-Entitäts-ID und die URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.
...
1. Wählen Sie in der Anwendungsliste **Skyhigh Networks** aus.
