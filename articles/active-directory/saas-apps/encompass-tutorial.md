...
1. Geben Sie im Suchfeld die Zeichenfolge **Encompass** ein, wählen Sie im Ergebnisbereich die Option **Encompass** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Encompass in der Ergebnisliste](./media/encompass-tutorial/tutorial_encompass_addfromgallery.png)
...
1. **[Erstellen eines Encompass-Testbenutzers](#create-a-encompass-test-user)**, um in Encompass eine Entsprechung von Britta Simon zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/encompass-tutorial/tutorial_encompass_samlbase.png)

1. Führen Sie auf der Seite **Domäne und URLs für Encompass** die folgenden Schritte aus:

    ![SSO-Informationen zur Domäne und zu den URLs für Encompass](./media/encompass-tutorial/tutorial_encompass_url.png)
...
1. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Zertifikat (Base64)**, und speichern Sie die Zertifikatdatei auf Ihrem Computer.
    ...
    ![Downloadlink für das Zertifikat](./media/encompass-tutorial/tutorial_encompass_certificate.png) 

1. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/encompass-tutorial/tutorial_general_400.png)

1. Klicken Sie im Abschnitt **Encompass-Konfiguration** auf **Encompass konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **Abmelde-URL und die URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/encompass-tutorial/create_aaduser_01.png)

1. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/encompass-tutorial/create_aaduser_02.png)

1. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/encompass-tutorial/create_aaduser_03.png)

1. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/encompass-tutorial/create_aaduser_04.png)
...
1. Wählen Sie in der Anwendungsliste die Option **Encompass** aus.
    ...
    ![Encompass-Link in der Anwendungsliste](./media/encompass-tutorial/tutorial_encompass_app.png)  
