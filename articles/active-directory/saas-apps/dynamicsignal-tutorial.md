...
1. Geben Sie im Suchfeld **Dynamic Signal** ein, wählen Sie im Ergebnisbereich **Dynamic Signal** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
...
1. **[Erstellen eines Dynamic Signal-Testbenutzers](#create-a-dynamic-signal-test-user)**, um ein Pendant von Britta Simon in Dynamic Signal zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist
...
1. Führen Sie im Abschnitt **Domäne und URLs für Dynamic Signal** die folgenden Schritte aus:
...
1. Klicken Sie im Abschnitt **Dynamic Signal-Konfiguration** auf **Dynamic Signal konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **Abmelde-URL, die SAML-Entitäts-ID und die URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.

    ![Dynamic Signal-Konfiguration](./media/dynamicsignal-tutorial/tutorial_dynamicsignal_configure.png) 

1. Zum Konfigurieren des einmaligen Anmeldens bei **Dynamic Signal** müssen Sie das heruntergeladene **Zertifikat (Base64) sowie Abmelde-URL, SAML-Entitäts-ID und SAML-Dienst-URL für einmaliges Anmelden** an das [Dynamic Signal-Supportteam](mailto:support@dynamicsignal.com) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
