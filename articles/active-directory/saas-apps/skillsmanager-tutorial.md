...
1. Geben Sie im Suchfeld **Skills Manager** ein, wählen Sie im Ergebnisbereich **Skills Manager** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
...
1. **[Erstellen eines Skills Manager-Testbenutzers](#create-a-skills-manager-test-user)**, um eine Entsprechung von Britta Simon in Skills Manager zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie im Abschnitt **Domäne und URLs für Skills Manager** die folgenden Schritte aus:
...
1. Klicken Sie im Abschnitt **Skills Manager-Konfiguration** auf **Skills Manager konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **Abmelde-URL, die SAML-Entitäts-ID und die URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.

    ![Skills Manager-Konfiguration](./media/skillsmanager-tutorial/tutorial_skillsmanager_configure.png) 

1. Zum Konfigurieren des einmaligen Anmeldens bei **Skills Manager** müssen Sie das heruntergeladene **Zertifikat (Base64)** sowie **Abmelde-URL, SAML-Entitäts-ID und SAML-Dienst-URL für einmaliges Anmelden** an das [Skills Manager-Supportteam](https://www.ibm.com/support/uk/?lnk=msu_uk) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
