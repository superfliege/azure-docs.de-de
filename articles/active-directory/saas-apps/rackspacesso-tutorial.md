...
**Führen Sie die folgenden Schritte aus, um Rackspace SSO aus dem Katalog hinzuzufügen:**
...
Damit einmaliges Anmelden funktioniert, muss eine Linkbeziehung zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in Rackspace SSO eingerichtet werden.
...
5. **[Erstellen eines Rackspace SSO-Testbenutzers](#create-rackspace-sso-test-user)**, um eine Entsprechung von Britta Simon in Rackspace SSO zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist
...
4. Führen Sie im Abschnitt **Grundlegende SAML-Konfiguration** die folgenden Schritte aus:
    ...
    Geben Sie im Textfeld **Anmelde-URL** eine URL ein: `https://login.rackspace.com/federate/`.

5. Klicken Sie auf der Seite **Einmaliges Anmelden (SSO) mit SAML einrichten** im Abschnitt **SAML-Signaturzertifikat** auf **Herunterladen**, um den Ihren Anforderungen entsprechenden **Verbundmetadaten-XML**-Code aus den verfügbaren Optionen herunterzuladen und auf Ihrem Computer zu speichern.

    ![Downloadlink für das Zertifikat](common/metadataxml.png)

6. Kopieren Sie im Abschnitt **Rackspace SSO einrichten** die entsprechenden URLs gemäß Ihren Anforderungen.
...
Zum Konfigurieren des einmaligen Anmeldens aufseiten von **Rackspace SSO** müssen Sie die heruntergeladene **Verbundmetadaten-XML** und die kopierten URLs aus dem Azure-Portal an das [Supportteam von Rackspace SSO](https://support.rackspace.com/) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
### <a name="create-rackspace-sso-test-user"></a>Erstellen eines Rackspace SSO-Testbenutzers

In diesem Abschnitt wird in Rackspace SSO ein Benutzer namens Britta Simon erstellt. Wenden Sie sich an das [Supportteam von Rackspace SSO](https://support.rackspace.com/), um die Benutzer auf der Rackspace SSO-Plattform hinzuzufügen. Benutzer müssen erstellt und aktiviert werden, damit Sie einmaliges Anmelden verwenden können.
