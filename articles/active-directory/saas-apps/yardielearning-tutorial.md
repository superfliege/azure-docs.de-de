...
1. Geben Sie im Suchfeld als Suchbegriff **Yardi eLearning**ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/yardielearning-tutorial/tutorial_yardielearning_search.png)

1. Wählen Sie im Ergebnisbereich die Option **Yardi eLearning** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/yardielearning-tutorial/tutorial_yardielearning_addfromgallery.png)
...
1. **[Erstellen eines Yardi eLearning-Testbenutzers](#creating-a-yardi-elearning-test-user)** , um eine Entsprechung von Britta Simon in Yardi eLearning zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie die folgenden Schritte auf der Seite **Domäne und URLs für Yardi eLearning** aus:
...
1. Zum Konfigurieren des einmaligen Anmeldens bei **Yardi eLearning** müssen Sie die heruntergeladene **Metadaten-XML**-Datei an das [Yardi eLearning-Supportteam](mailto:elearning@yardi.com) senden. 
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/yardielearning-tutorial/create_aaduser_01.png) 

1. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Erstellen eines Azure AD-Testbenutzers](./media/yardielearning-tutorial/create_aaduser_02.png) 

1. Klicken Sie oben im Dialogfeld auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/yardielearning-tutorial/create_aaduser_03.png) 

1. Führen Sie auf der Dialogfeldseite **Benutzer** die folgenden Schritte aus:
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/yardielearning-tutorial/create_aaduser_04.png) 
