...
1. Geben Sie im Suchfeld das Wort **Gigya** ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/gigya-tutorial/tutorial_gigya_search.png)

1. Wählen Sie im Ergebnisbereich die Option **Gigya** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/gigya-tutorial/tutorial_gigya_addfromgallery.png)
...
1. **[Erstellen eines Gigya-Testbenutzers](#creating-a-gigya-test-user)**, um ein Pendant von Britta Simon in Gigya zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie im Abschnitt **Domäne und URLs für Gigya** die folgenden Schritte aus:
...
1. Klicken Sie im Abschnitt **Gigya-Konfiguration** auf **Gigya konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **SAML-Entitäts-ID und die SAML-Dienst-URL für einmaliges Anmelden** aus dem Abschnitt **Kurzübersicht**.
...
1. Navigieren Sie zu **Einstellungen \> SAML-Anmeldung**, und klicken Sie dann auf die Schaltfläche **Hinzufügen**.
   
    ![SAML-Anmeldung](./media/gigya-tutorial/ic789532.png "SAML-Anmeldung")

1. Führen Sie im Abschnitt **SAML-Anmeldung** die folgenden Schritte aus:
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/gigya-tutorial/create_aaduser_01.png) 

1. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Erstellen eines Azure AD-Testbenutzers](./media/gigya-tutorial/create_aaduser_02.png) 

1. Klicken Sie oben im Dialogfeld auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/gigya-tutorial/create_aaduser_03.png) 

1. Führen Sie auf der Dialogfeldseite **Benutzer** die folgenden Schritte aus:
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/gigya-tutorial/create_aaduser_04.png) 
...
1. Navigieren Sie zu **Administrator \> Benutzer verwalten**, und klicken Sie dann auf **Benutzer einladen**.
