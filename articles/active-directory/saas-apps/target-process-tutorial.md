...
1. Geben Sie im Suchfeld **TargetProcess** ein, wählen Sie im Ergebnisbereich **TargetProcess** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Hinzufügen von TargetProcess aus dem Katalog](./media/target-process-tutorial/tutorial_target-process_addfromgallery.png)
...
1. **[Erstellen eines TargetProcess-Testbenutzers](#create-a-targetprocess-test-user)**, um ein Pendant von Britta Simon in TargetProcess zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![SAML-basierte Anmeldung](./media/target-process-tutorial/tutorial_target-process_samlbase.png)

1. Führen Sie auf der Seite **Domäne und URLs für TargetProcess** die folgenden Schritte aus:

    ![Abschnitt „Domäne und URLs für TargetProcess“](./media/target-process-tutorial/tutorial_target-process_url.png)
...
1. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Zertifikat (Base64)**, und speichern Sie die Zertifikatdatei auf Ihrem Computer.
    ...
    ![Abschnitt für SAML-Signaturzertifikat](./media/target-process-tutorial/tutorial_target-process_certificate.png) 

1. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“](./media/target-process-tutorial/tutorial_general_400.png)

1. Klicken Sie im Abschnitt **TargetProcess-Konfiguration** auf **TargetProcess konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.

    ![Abschnitt „TargetProcess-Konfiguration“](./media/target-process-tutorial/tutorial_target-process_configure.png) 
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/target-process-tutorial/create_aaduser_01.png) 

1. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![So zeigen Sie die Liste der Benutzer an](./media/target-process-tutorial/create_aaduser_02.png) 

1. Klicken Sie oben im Dialogfeld auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.
 
    ![Schaltfläche „Hinzufügen“](./media/target-process-tutorial/create_aaduser_03.png) 

1. Führen Sie auf der Dialogfeldseite **Benutzer** die folgenden Schritte aus:
 
    ![Abschnitt „Benutzer“](./media/target-process-tutorial/create_aaduser_04.png) 
...
1. Wählen Sie in der Anwendungsliste **TargetProcess**aus.
    ...
    ![TargetProcess in App-Liste](./media/target-process-tutorial/tutorial_target-process_app.png) 
...
Wenn Sie im Zugriffsbereich auf die Kachel „TargetProcess“ klicken, sollten Sie automatisch bei Ihrer TargetProcess-Anwendung angemeldet werden. Weitere Informationen zum Zugriffsbereich finden Sie unter [Einführung in den Zugriffsbereich](../user-help/active-directory-saas-access-panel-introduction.md).
