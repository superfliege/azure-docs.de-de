...
1. Geben Sie im Suchfeld den Suchbegriff **Learningpool Act** ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/learningpool-tutorial/tutorial_Learningpoolact_search.png)

1. Wählen Sie im Ergebnisbereich **Learningpool Act** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/learningpool-tutorial/tutorial_Learningpoolact_addfromgallery.png)
...
1. **[Erstellen eines Learningpool Act-Testbenutzers](#creating-a-learningpool-act-test-user)**, um in Learningpool Act eine Entsprechung von Britta Simon zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie auf der Seite **Domäne und URLs für Learningpool Act** die folgenden Schritte aus:
...
1. Zum Konfigurieren des einmaligen Anmeldens bei **Learningpool Act** müssen Sie die heruntergeladene **Metadaten-XML**-Datei an das [Learningpool Act-Supportteam](https://www.Learningpool.com/support) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/learningpool-tutorial/create_aaduser_01.png) 

1. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Erstellen eines Azure AD-Testbenutzers](./media/learningpool-tutorial/create_aaduser_02.png) 

1. Klicken Sie oben im Dialogfeld auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/learningpool-tutorial/create_aaduser_03.png) 

1. Führen Sie auf der Dialogfeldseite **Benutzer** die folgenden Schritte aus:
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/learningpool-tutorial/create_aaduser_04.png) 
...
1. Wählen Sie in der Liste mit den Anwendungen die Option **Learningpool Act** aus.
