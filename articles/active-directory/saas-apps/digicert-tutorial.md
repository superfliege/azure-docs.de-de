...
1. Geben Sie im Suchfeld das Wort **DigiCert** ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/digicert-tutorial/tutorial_digicert_search.png)

1. Wählen Sie im Ergebnisbereich die Option **DigiCert** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/digicert-tutorial/tutorial_digicert_addfromgallery.png)
...
1. **[Erstellen eines DigiCert-Testbenutzers](#creating-a-digicert-test-user)**, um ein Pendant von Britta Simon in DigiCert zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist.
...
1. Führen Sie im Abschnitt **Domäne und URLs für DigiCert** die folgenden Schritte aus:
...
1. Zum Konfigurieren des einmaligen Anmeldens bei **DigiCert** müssen Sie die heruntergeladene **Metadaten-XML**-Datei an das [DigiCert-Supportteam](mailto:support@digicert.com) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/digicert-tutorial/create_aaduser_01.png) 

1. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Erstellen eines Azure AD-Testbenutzers](./media/digicert-tutorial/create_aaduser_02.png) 

1. Klicken Sie oben im Dialogfeld auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/digicert-tutorial/create_aaduser_03.png) 

1. Führen Sie auf der Dialogfeldseite **Benutzer** die folgenden Schritte aus:
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/digicert-tutorial/create_aaduser_04.png) 
