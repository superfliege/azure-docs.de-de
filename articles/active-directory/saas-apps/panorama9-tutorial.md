...
1. Geben Sie im Suchfeld den Namen **Panorama9** ein.

    ![Erstellen eines Azure AD-Testbenutzers](./media/panorama9-tutorial/tutorial_panorama9_search.png)

1. Wählen Sie im Ergebnisbereich die Option **Panorama9** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Erstellen eines Azure AD-Testbenutzers](./media/panorama9-tutorial/tutorial_panorama9_addfromgallery.png)
...
1. **[Erstellen eines Panorama9-Testbenutzers](#creating-a-panorama9-test-user)**, um ein Pendant von Britta Simon in Panorama9 zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist
...
1. Führen Sie auf der Seite **Domäne und URLs für Panorama9** die folgenden Schritte aus:
    ...
    b. Geben Sie im Textfeld **Bezeichner** eine URL nach folgendem Muster ein: `https://www.panorama9.com/saml20/<tenant-name>`
...
1. Klicken Sie im Abschnitt **Panorama9-Konfiguration** auf **Panorama9 konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.
...
1. Klicken Sie in der Symbolleiste oben auf **Verwalten** und dann auf **Erweiterungen**.
   
   ![Erweiterungen](./media/panorama9-tutorial/ic790023.png "Erweiterungen")
1. Klicken Sie im Dialogfeld **Erweiterungen** auf **Einmaliges Anmelden**.
   
   ![Einmaliges Anmelden](./media/panorama9-tutorial/ic790024.png "des einmaligen Anmeldens")
1. Führen Sie im Abschnitt **Einstellungen** die folgenden Schritte aus:
...
1. Klicken Sie im linken Navigationsbereich des **Azure-Portals** auf das Symbol für **Azure Active Directory**.
    ...
    ![Erstellen eines Azure AD-Testbenutzers](./media/panorama9-tutorial/create_aaduser_01.png) 

1. Wechseln Sie zu **Benutzer und Gruppen**, und klicken Sie auf **Alle Benutzer**, um die Liste der Benutzer anzuzeigen.
    
    ![Erstellen eines Azure AD-Testbenutzers](./media/panorama9-tutorial/create_aaduser_02.png) 

1. Klicken Sie oben im Dialogfeld auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/panorama9-tutorial/create_aaduser_03.png) 

1. Führen Sie auf der Dialogfeldseite **Benutzer** die folgenden Schritte aus:
 
    ![Erstellen eines Azure AD-Testbenutzers](./media/panorama9-tutorial/create_aaduser_04.png) 
...
1. Klicken Sie im oberen Menü auf **Verwalten** und dann auf **Benutzer**.
   
  ![Benutzer](./media/panorama9-tutorial/ic790027.png "Benutzer")

1. Klicken Sie im Abschnitt „Benutzer“ auf **+**, um einen neuen Benutzer hinzuzufügen.

 ![Benutzer](./media/panorama9-tutorial/ic790028.png "Benutzer")

1. Navigieren Sie zum Abschnitt mit den Benutzerdaten, und geben Sie die E-Mail-Adresse eines gültigen Azure Active Directory-Benutzers, den Sie bereitstellen möchten, in das Textfeld **E-Mail** ein.

1. Klicken Sie im Abschnitt „Benutzer“ auf **Speichern**.
