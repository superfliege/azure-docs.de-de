...
1. Geben Sie im Suchfeld **TurboRater** ein, wählen Sie im Ergebnisbereich **TurboRater** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![TurboRater in der Ergebnisliste](./media/turborater-tutorial/tutorial_turborater_addfromgallery.png)
...
1. **[Erstellen eines TurboRater-Testbenutzers](#create-a-turborater-test-user)**, um ein Pendant von Britta Simon in TurboRater zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist
...
1. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/turborater-tutorial/tutorial_turborater_samlbase.png)

1. Führen Sie im Abschnitt **Domäne und URLs für TurboRater** die folgenden Schritte aus:

    ![SSO-Informationen zur Domäne und zu den URLs für TurboRater](./media/turborater-tutorial/tutorial_turborater_url.png)
...
1. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Metadaten-XML**, und speichern Sie die Metadatendatei dann auf Ihrem Computer.
    ...
    ![Downloadlink für das Zertifikat](./media/turborater-tutorial/tutorial_turborater_certificate.png) 

1. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/turborater-tutorial/tutorial_general_400.png)

1. Zum Konfigurieren des einmaligen Anmeldens bei **TurboRater** müssen Sie die heruntergeladene **Metadaten-XML**-Datei an das [TurboRater-Supportteam](https://www.getitc.com/support) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/turborater-tutorial/create_aaduser_01.png)

1. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/turborater-tutorial/create_aaduser_02.png)

1. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/turborater-tutorial/create_aaduser_03.png)

1. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/turborater-tutorial/create_aaduser_04.png)
...
1. Wählen Sie in der Anwendungsliste **TurboRater** aus.
    ...
    ![TurboRater-Link in der Anwendungsliste](./media/turborater-tutorial/tutorial_turborater_app.png)  
