...
3. **[Erstellen eines Settling music-Testbenutzers](#create-a-settling-music-test-user)**, um eine Entsprechung für Britta Simon in Settling music zu haben, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
3. Führen Sie im Abschnitt **Domäne und URLs für Settling music** die folgenden Schritte aus:
...
6. Klicken Sie im Abschnitt **Settling music-Konfiguration** auf **Settling music konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **Abmelde-URL und die URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.

    ![Settling music-Konfiguration](./media/settlingmusic-tutorial/tutorial_settlingmusic_configure.png) 

7. Melden Sie sich in einem anderen Webbrowserfenster bei Settling music als Sicherheitsadministrator an.

8. Klicken Sie oben auf der Seite auf die Registerkarte **Management** (Verwaltung).

    ![Settling music Schritt 1](./media/settlingmusic-tutorial/tutorial_settlingmusic_step1.png)

9. Klicken Sie auf die Registerkarte **System setting** (Systemeinstellung).

    ![Settling music Schritt 2](./media/settlingmusic-tutorial/tutorial_settlingmusic_step2.png)

10. Wechseln Sie zur Registerkarte **Security** (Sicherheit).

    ![Settling music Schritt 3](./media/settlingmusic-tutorial/tutorial_settlingmusic_step3.png)

11. Führen Sie im Abschnitt **Single sign-on setting** (Einstellung für einmaliges Anmelden) die folgenden Schritte aus:
