...
1. Verwenden Sie einen der folgenden Schnellstarts für virtuelle Azure-Computer, und setzen Sie nur die erforderlichen Abschnitte um („Anmelden bei Azure“, „Erstellen einer Ressourcengruppe“, „Erstellen einer Netzwerkgruppe“, „Erstellen des virtuellen Computers“). 
   ...
   - [Erstellen eines virtuellen Windows-Computers mithilfe von PowerShell](~/articles/virtual-machines/windows/quick-create-powershell.md)
   - [Erstellen eines virtuellen Linux-Computers mithilfe von PowerShell](~/articles/virtual-machines/linux/quick-create-powershell.md)
...
- Die vollständigen Schnellstarts zum Erstellen virtueller Azure-Computer finden Sie unter:
  ...
  - [Erstellen eines virtuellen Windows-Computers mit PowerShell](~/articles/virtual-machines/windows/quick-create-powershell.md) 
  - [Erstellen eines virtuellen Linux-Computers mit PowerShell](~/articles/virtual-machines/linux/quick-create-powershell.md) 
