...
- [Erstellen eines virtuellen Windows-Computers mit dem Azure-Portal](~/articles/virtual-machines/windows/quick-create-portal.md#create-virtual-machine)
- [Erstellen Sie eines virtuellen Linux-Computers mit dem Azure-Portal](~/articles/virtual-machines/linux/quick-create-portal.md#create-virtual-machine)  
...
2. Klicken Sie auf die Seite „Konfiguration“, aktivieren Sie MSI für den virtuellen Computer, indem Sie unter „Verwaltete Dienstidenität“ die Option „Ja“ auswählen, und klicken Sie dann auf **Speichern**. Dieser Vorgang kann 60 Sekunden oder länger dauern:
   ...
   ![Screenshot der Konfigurationsseite](~/articles/active-directory/media/msi-qs-configure-portal-windows-vm/create-windows-vm-portal-configuration-blade.png)  
...
3. Klicken Sie auf die Seite „Konfiguration“, entfernen Sie MSI von dem virtuellen Computer, indem Sie unter „Verwaltete Dienstidenität“ die Option „Nein“ auswählen, und klicken Sie dann auf **Speichern**. Dieser Vorgang kann 60 Sekunden oder länger dauern:
   ...
   ![Screenshot der Konfigurationsseite](~/articles/active-directory/media/msi-qs-configure-portal-windows-vm/create-windows-vm-portal-configuration-blade-disable.png)  
