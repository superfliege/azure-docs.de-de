...
5. Melden Sie sich mit der Anmelde-URL von der Seite **Einmaliges Anmelden** bei Dropbox an.
  ...
  ![Dropbox-Anmeldeseite](media/configure-saas-apps/sign-in-to-dropbox.png)
...
2. Konfigurieren Sie einmaliges Anmelden in der folgenden Reihenfolge:
  ...
  ![Konfigurieren des einmaligen Anmeldens für Box](media/configure-saas-apps/configure-box-sso.png)
