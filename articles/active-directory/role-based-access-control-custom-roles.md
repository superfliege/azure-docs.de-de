...
* Eine Liste der verfügbaren Vorgänge finden Sie unter [Vorgänge für Azure Resource Manager-Ressourcenanbieter](role-based-access-control-resource-provider-operations.md).
