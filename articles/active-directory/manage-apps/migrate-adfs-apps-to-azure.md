...
Zur Überprüfung des Zugriffs sollte Benutzern im [Zugriffsbereich](../active-directory-saas-access-panel-introduction.md) beim Anmelden die SaaS-App angezeigt werden. Sie finden den Zugriffsbereich unter http://myapps.microsoft.com. In diesem Beispiel wurde dem Benutzer erfolgreich sowohl Zugriff auf Salesforce als auch auf ServiceNow zugewiesen.
