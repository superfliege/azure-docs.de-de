...
Diese [Fehlerbedingung](active-directory-licensing-group-problem-resolution-azure-portal.md#conflicting-service-plans) tritt auf, wenn Sie die gruppenbasierte Lizenzierung verwenden. Wenn Sie PowerShell verwenden, wird der Fehler *MutuallyExclusiveViolation* angezeigt.

In diesem Abschnitt sind die am häufigsten verwendeten Servicepläne, die sich gegenseitig ausschließen, nach Servicetyp gruppiert aufgeführt. Mithilfe dieser Informationen können Sie Ihre Lizenzbereitstellung planen und Zuweisungsfehler vermeiden.
