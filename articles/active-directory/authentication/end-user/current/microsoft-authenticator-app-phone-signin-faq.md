...
Antworten auf allgemeine Fragen zur App finden Sie unter [Microsoft Authenticator-App – häufig gestellte Fragen](../../../../multi-factor-authentication/end-user/microsoft-authenticator-app-faq.md).
