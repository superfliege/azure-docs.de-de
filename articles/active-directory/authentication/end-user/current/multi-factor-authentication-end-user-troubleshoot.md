...
Die zweistufige Überprüfung ist eine Sicherheitsfunktion, die von Ihrer Organisation zum Schutz Ihrer Konten ausgewählt wurde. Sie ist sicherer als nur ein Kennwort, da sie auf zwei Formen der Authentifizierung basiert: etwas, das Sie wissen, und etwas, das Sie bei sich tragen. Was Sie wissen, ist Ihr Kennwort. Was Sie bei sich tragen, ist ein Smartphone oder ein anderes Gerät, das Sie häufig mit sich führen. Wird Ihr Konto durch die zweistufige Überprüfung geschützt, so kann sich kein böswilliger Hacker, der auf irgendeine Weise an Ihr Kennwort gelangt ist, als Sie selbst anmelden, da er nicht zugleich Zugriff auf Ihr Smartphone besitzt.
...
4. Fahren Sie mit der zweistufigen Überprüfung fort.
