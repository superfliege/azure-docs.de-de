...
3. Führen Sie im Abschnitt **Domäne und URLs für Cezanne HR Software** die folgenden Schritte aus:
    ...
    a. Geben Sie im Textfeld **Anmelde-URL** diese URL ein: `https://w3.cezanneondemand.com/CezanneOnDemand/-/optyma`

    b. Geben Sie im Textfeld **Bezeichner** die folgende URL ein: `https://w3.cezanneondemand.com/CezanneOnDemand/`

    c. Geben Sie im Textfeld **Antwort-URL** folgende URL ein: `https://w3.cezanneondemand.com:443/cezanneondemand/-/optyma/Saml/samlp`
