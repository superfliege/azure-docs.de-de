...
4. Geben Sie im Suchfeld **Yodeck** ein, wählen Sie im Ergebnisbereich **Yodeck** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
    ...
    ![Yodeck in der Ergebnisliste](./media/active-directory-saas-yodeck-tutorial/tutorial_yodeck_addfromgallery.png)
...
3. **[Erstellen eines Yodeck-Testbenutzers](#create-a-yodeck-test-user)**, um eine Entsprechung von Britta Simon in Yodeck zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
2. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/active-directory-saas-yodeck-tutorial/tutorial_yodeck_samlbase.png)

3. Führen Sie im Abschnitt **Domäne und URLs für Yodeck** die folgenden Schritte aus, wenn Sie die Anwendung im **IDP**-initiierten Modus konfigurieren möchten:

    ![SSO-Informationen zur Domäne und zu den URLs für Yodeck](./media/active-directory-saas-yodeck-tutorial/tutorial_yodeck_url.png)
...
4. Aktivieren Sie **Erweiterte URL-Einstellungen anzeigen**, und führen Sie die folgenden Schritte aus, wenn Sie die Anwendung im **SP-initiierten Modus** konfigurieren möchten:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für Yodeck](./media/active-directory-saas-yodeck-tutorial/tutorial_yodeck_url1.png)
...
5. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf die Schaltfläche „Kopieren“, um die **Verbundmetadaten-URL der App** zu kopieren und in Editor einzufügen.
    ...
    ![Downloadlink für das Zertifikat](./media/active-directory-saas-yodeck-tutorial/tutorial_yodeck_certificate.png)

6. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/active-directory-saas-yodeck-tutorial/tutorial_general_400.png)
    
7. Melden Sie sich in einem anderen Webbrowserfenster bei der Yodeck-Unternehmenswebsite als Administrator an.

8. Klicken Sie oben rechts auf der Seite auf die Option **Benutzereinstellungen**, und wählen Sie **Kontoeinstellungen** aus.

    ![Yodeck-Konfiguration](./media/active-directory-saas-yodeck-tutorial/configure1.png)

9. Wählen Sie **SAML** aus, und führen Sie folgende Schritte aus:

    ![Yodeck-Konfiguration](./media/active-directory-saas-yodeck-tutorial/configure2.png)
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/active-directory-saas-yodeck-tutorial/create_aaduser_01.png)

2. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/active-directory-saas-yodeck-tutorial/create_aaduser_02.png)

3. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/active-directory-saas-yodeck-tutorial/create_aaduser_03.png)

4. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/active-directory-saas-yodeck-tutorial/create_aaduser_04.png)
...
2. Klicken Sie oben rechts auf der Seite auf die Option **Benutzereinstellungen**, und wählen Sie **Benutzer** aus.
    ...
    ![Mitarbeiter hinzufügen](./media/active-directory-saas-yodeck-tutorial/user1.png)

3. Klicken Sie auf **+Benutzer**, um die Registerkarte **Benutzerdetails** zu öffnen.

    ![Mitarbeiter hinzufügen](./media/active-directory-saas-yodeck-tutorial/user2.png)

4. Führen Sie auf der Dialogfeldseite **User Details** die folgenden Schritte aus:

    ![Mitarbeiter hinzufügen](./media/active-directory-saas-yodeck-tutorial/user3.png)
...
2. Wählen Sie in der Anwendungsliste den Eintrag **Yodeck** aus.
    ...
    ![Yodeck-Link in der Anwendungsliste](./media/active-directory-saas-yodeck-tutorial/tutorial_yodeck_app.png)  
