...
Damit Sie die Beispiele in diesem Artikel verwenden können, müssen die [Voraussetzungen für den Zugriff auf die Azure AD-Berichterstellungs-API](active-directory-reporting-api-prerequisites.md) erfüllt sein.  
