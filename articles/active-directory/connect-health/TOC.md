...
## [Diagnostizieren von Synchronisierungsfehlern aufgrund doppelter Attribute](active-directory-aadconnect-health-diagnose-sync-errors.md)

# Problembehandlung
## [Azure AD Connect Health – FAQ](active-directory-aadconnect-health-faq.md)
## [Die Daten des Integritätsdiensts sind nicht aktuell.](active-directory-aadconnect-health-data-freshness.md)
...
## [Azure AD Connect Health – Warnungskatalog](active-directory-aadconnect-health-alert-catalog.md)
## [Benutzerdatenschutz und Azure AD Connect Health](active-directory-aadconnect-health-gdpr.md)
