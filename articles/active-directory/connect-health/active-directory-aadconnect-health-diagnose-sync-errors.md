...
Weitere Informationen zu Azure AD finden Sie unter [Identitätssynchronisierung und Resilienz bei doppelten Attributen](https://aka.ms/dupattributeresdocs).
...
![Diagnoseschritte bei Synchronisierungsfehlern](./media/active-directory-aadconnect-health-sync-iidfix/IIdFixSteps.png)
...
![Diagnostizieren von Synchronisierungsfehlern – Szenario mit verwaistem Objekt (Benutzer vorhanden?)](./media/active-directory-aadconnect-health-sync-iidfix/IIdFixOrphanedCase.png)
...
![Diagnostizieren von Synchronisierungsfehlern – Szenario mit verwaistem Objekt (Benutzer identisch?)](./media/active-directory-aadconnect-health-sync-iidfix/IIdFixOrphanedCase.png)
