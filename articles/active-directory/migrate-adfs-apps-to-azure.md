...
- Ansprüche in Tokenfunktionen
    ...
    - Komplexe Transformationsregeln für die Ausstellung von Ansprüchen (Informationen zur Zuordnung von unterstützten Ansprüchen finden Sie in diesem [Dokument](https://docs.microsoft.com/azure/active-directory/active-directory-claims-mapping) und [hier](https://docs.microsoft.com/azure/active-directory/develop/active-directory-saml-claims-customization))
