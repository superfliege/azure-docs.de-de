...
6. Melden Sie sich nach Abschluss der Installation ab und erneut wieder an, ehe Sie den Synchronization Service Manager oder Synchronisierungsregel-Editor verwenden.
...
4. Überprüfen Sie, ob die neuen Benutzer in der ![Synchronisieren](media/tutorial-password-hash-sync/synch1.png) unseres Mandanten angezeigt werden.
