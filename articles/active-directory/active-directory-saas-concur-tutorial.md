...
5. Klicken Sie auf die Schaltfläche **Save** .
    ...
    ![Konfigurieren des einmaligen Anmeldens](./media/active-directory-saas-concur-tutorial/tutorial_general_400.png)
<CS>
...
* [Konfigurieren der Benutzerbereitstellung](active-directory-saas-concur-provisioning-tutorial.md)
