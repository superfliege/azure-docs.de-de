...
4. Geben Sie im Suchfeld **Secret Server (On-Premises)** ein, wählen Sie im Ergebnisbereich **Secret Server (On-Premises)** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Secret Server (On-Premises) in der Ergebnisliste](./media/active-directory-saas-secretserver-on-premises-tutorial/tutorial_secretserver_addfromgallery.png)
...
3. **[Erstellen eines Secret Server (On-Premises)-Testbenutzers](#create-a-secret-server-on-premises-test-user)**, um eine Entsprechung von Britta Simon in Secret Server (On-Premises) zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist
...
2. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/active-directory-saas-secretserver-on-premises-tutorial/tutorial_secretserver_samlbase.png)

3. Führen Sie im Abschnitt **Domäne und URLs für Secret Server (On-Premises)** die folgenden Schritte aus, wenn Sie die Anwendung im **IDP-initiierten** Modus konfigurieren möchten:

    ![SSO-Informationen zur Domäne und zu den URLs für Secret Server (On-Premises)](./media/active-directory-saas-secretserver-on-premises-tutorial/tutorial_secretserver_url.png)
...
4. Aktivieren Sie **Erweiterte URL-Einstellungen anzeigen**, und führen Sie die folgenden Schritte aus, wenn Sie die Anwendung im **SP-initiierten Modus** konfigurieren möchten:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für Secret Server (On-Premises)](./media/active-directory-saas-secretserver-on-premises-tutorial/tutorial_secretserver_url1.png)
...
5. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Zertifikat (Base64)**, und speichern Sie die Zertifikatdatei auf Ihrem Computer.
    ...
    ![Downloadlink für das Zertifikat](./media/active-directory-saas-secretserver-on-premises-tutorial/tutorial_secretserver_certificate.png)
...
6. Aktivieren Sie **Erweiterte Einstellungen für die Zertifikatsignatur**, und wählen Sie unter **Signaturoption** die Option **SAML-Antwort und-Assertion signieren** aus.
    ...
    ![Signaturoptionen](./media/active-directory-saas-secretserver-on-premises-tutorial/signing.png)

7. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/active-directory-saas-secretserver-on-premises-tutorial/tutorial_general_400.png)
    
8. Klicken Sie im Abschnitt **Secret Server (On-Premises)-Konfiguration** auf **Secret Server (On-Premises) konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **Abmelde-URL, die SAML-Entitäts-ID und die URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.

    ![Secret Server (On-Premises)-Konfiguration](./media/active-directory-saas-secretserver-on-premises-tutorial/tutorial_secretserver_configure.png)

9. Zum Konfigurieren des einmaligen Anmeldens bei **Secret Server (On-Premises)** müssen Sie das heruntergeladene **Zertifikat (Base64), Abmelde-URL und SAML-Dienst-URL für einmaliges Anmelden** sowie die **SAML-Entitäts-ID** an das [Secret Server (On-Premises)-Supportteam](https://thycotic.force.com/support/s/) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/active-directory-saas-secretserver-on-premises-tutorial/create_aaduser_01.png)

2. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/active-directory-saas-secretserver-on-premises-tutorial/create_aaduser_02.png)

3. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/active-directory-saas-secretserver-on-premises-tutorial/create_aaduser_03.png)

4. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/active-directory-saas-secretserver-on-premises-tutorial/create_aaduser_04.png)
...
2. Wählen Sie in der Anwendungsliste **Secret Server (On-Premises)** aus.

    ![Secret Server (On-Premises)-Link in der Anwendungsliste](./media/active-directory-saas-secretserver-on-premises-tutorial/tutorial_secretserver_app.png)
