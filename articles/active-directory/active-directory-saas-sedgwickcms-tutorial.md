...
4. Geben Sie im Suchfeld **Sedgwick CMS** ein, wählen Sie im Ergebnisbereich **Sedgwick CMS** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
    ...
    ![Sedgwick CMS in der Ergebnisliste](./media/active-directory-saas-sedgwickcms-tutorial/tutorial_sedgwickcms_addfromgallery.png)
...
3. **[Erstellen eines Sedgwick CMS-Testbenutzers](#create-a-sedgwick-cms-test-user)**, um ein Pendant von Britta Simon in Sedgwick CMS zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist
...
2. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/active-directory-saas-sedgwickcms-tutorial/tutorial_sedgwickcms_samlbase.png)

3. Führen Sie im Abschnitt **Domäne und URLs für Sedgwick CMS** die folgenden Schritte aus:

    ![SSO-Informationen zur Domäne und zu den URLs für Sedgwick CMS](./media/active-directory-saas-sedgwickcms-tutorial/tutorial_sedgwickcms_url.png)
    ...
    > [!NOTE] 
    > Hierbei handelt es sich um Beispielwerte. Aktualisieren Sie diese Werte mit dem eigentlichen Bezeichner und der Antwort-URL. Wenden Sie sich an das [Supportteam von Sedgwick CMS](https://www.sedgwick.com/contact/Pages/contactform.aspx), um diese Werte zu erhalten.
 

4. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Metadaten-XML**, und speichern Sie die Metadatendatei dann auf Ihrem Computer.

    ![Downloadlink für das Zertifikat](./media/active-directory-saas-sedgwickcms-tutorial/tutorial_sedgwickcms_certificate.png) 

5. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/active-directory-saas-sedgwickcms-tutorial/tutorial_general_400.png)

6. Zum Konfigurieren des einmaligen Anmeldens bei **Sedgwick CMS** müssen Sie die heruntergeladene **Metadaten-XML**-Datei an das [Sedgwick CMS-Supportteam](https://www.sedgwick.com/contact/Pages/contactform.aspx) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/active-directory-saas-sedgwickcms-tutorial/create_aaduser_01.png)

2. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/active-directory-saas-sedgwickcms-tutorial/create_aaduser_02.png)

3. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/active-directory-saas-sedgwickcms-tutorial/create_aaduser_03.png)

4. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/active-directory-saas-sedgwickcms-tutorial/create_aaduser_04.png)
...
2. Wählen Sie in der Anwendungsliste **Sedgwick CMS** aus.
    ...
    ![Sedgwick CMS-Link in der Anwendungsliste](./media/active-directory-saas-sedgwickcms-tutorial/tutorial_sedgwickcms_app.png)  
