---
title: Übersicht über die Kennwortzurücksetzung – Azure Active Directory | Microsoft-Dokumentation
description: Erfahren Sie, wie Sie sich registrieren und Ihr Kennwort zurücksetzen, ohne dass Sie die Unterstützung eines Administrators benötigen.
...
|------|------------|
|[Registrieren für die Self-Service-Kennwortzurücksetzung](active-directory-passwords-reset-register.md)| Beschreibt, wie Sie registrieren, damit Sie Ihr Kennwort zurücksetzen können.|
|[Zurücksetzen Ihres Kennworts](user-help-reset-password.md)| Beschreibt, wie Ihr Kennwort zurückzusetzen.|