...
description: Weitere Informationen zum Einrichten und Verwenden der Sicherheitsinformation.
...
Richten Sie unter **Sicherheitsinformation** die zweistufige Überprüfung und Informationen zur Kennwortzurücksetzung ein. Die Sicherheitsinformation muss nur einmal eingerichtet werden. Sie können Ihre Informationen jedoch bearbeiten und die Standardmethode jederzeit ändern.

Sie können eine der folgenden Methoden hinzufügen, einschließlich:
...
|[Einrichten der Sicherheitsinformation zur Verwendung von SMS](security-info-setup-text-msg.md)|Beschreibt, wie Sie Ihre Telefonnummer als Ihre Methode einrichten.|
|[Einrichten der Sicherheitsinformation zur Verwendung einer Authentifikator-App](security-info-setup-auth-app.md)|Beschreibt, wie Sie eine Authentifikator-App als Ihre Methode einrichten.|
...
|[Verwalten der Sicherheitsinformation](security-info-manage-settings.md)|Beschreibt, wie Sie Ihre Sicherheitsinformation aktualisieren und mit Ihren App-Kennwörtern arbeiten.|
