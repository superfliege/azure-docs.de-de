...
|------|------------|
|[Add your work or school accounts](microsoft-authenticator-app-add-work-account.md) (Hinzufügen Ihrer Geschäfts-, Schul- oder Unikonten)|Beschreibt, wie Sie Ihr Geschäfts-, Schul- oder Unikonto zur Microsoft Authenticator-App hinzufügen, um die zweistufige Überprüfung zu nutzen.|
|[Add your personal Microsoft account](microsoft-authenticator-app-add-personal-account.md) (Hinzufügen Ihres persönlichen Microsoft-Kontos)|Beschreibt, wie Sie Ihre persönlichen Microsoft-Konten hinzufügen, um die zweistufige Überprüfung und Anmeldung per Telefon zu nutzen (auch bekannt als Anmeldung ohne Kennwort).|
|[Add your personal non-Microsoft account](microsoft-authenticator-app-add-non-microsoft-account.md) (Hinzufügen Ihres persönlichen, nicht von Microsoft stammenden Kontos)|Beschreibt, wie Sie Ihre persönlichen, nicht von Microsoft stammenden Konten hinzufügen, um die zweistufige Überprüfung zu nutzen.|
|[Manually add your accounts](microsoft-authenticator-app-add-account-manual.md) (Manuelles Hinzufügen Ihrer Konten)|Beschreibt, wie Sie Ihr Konto manuell zur Microsoft Authenticator-App hinzufügen, wenn Ihre Kamera den QR-Code nicht erfassen kann.|
