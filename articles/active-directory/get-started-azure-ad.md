...
### <a name="verification-step"></a>Überprüfungsschritt
Vergewissern Sie sich nach dem Hinzufügen einer benutzerdefinierten Domäne, dass im Azure AD-Portal auf dem Blatt **Benutzerdefinierte Domänennamen** der Status **Bestätigt** angezeigt wird.
