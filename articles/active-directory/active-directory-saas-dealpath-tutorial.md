...
4. Geben Sie im Suchfeld **Dealpath** ein, wählen Sie im Ergebnisbereich **Dealpath** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
    ...
    ![Dealpath in der Ergebnisliste](./media/active-directory-saas-dealpath-tutorial/tutorial_dealpath_addfromgallery.png)
...
3. **[Erstellen eines Dealpath-Testbenutzers](#create-a-dealpath-test-user)**, um eine Entsprechung für Britta Simon in Dealpath zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
2. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/active-directory-saas-dealpath-tutorial/tutorial_dealpath_samlbase.png)

3. Führen Sie im Abschnitt **Domäne und URLs für Dealpath** die folgenden Schritte aus:

    ![SSO-Informationen zur Domäne und zu den URLs für Dealpath](./media/active-directory-saas-dealpath-tutorial/tutorial_dealpath_url.png)
...
4. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Zertifikat (Base64)**, und speichern Sie die Zertifikatsdatei auf Ihrem Computer.
    ...
    ![Downloadlink für das Zertifikat](./media/active-directory-saas-dealpath-tutorial/tutorial_dealpath_certificate.png) 

5. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/active-directory-saas-dealpath-tutorial/tutorial_general_400.png)

6. Klicken Sie im Abschnitt **Dealpath-Konfiguration** auf **Dealpath konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **SAML-Entitäts-ID und die URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.

    ![Dealpath-Konfiguration](./media/active-directory-saas-dealpath-tutorial/tutorial_dealpath_configure.png) 

7. Melden Sie sich in einem anderen Webbrowserfenster als Administrator bei Dealpath an.

8. Klicken Sie oben rechts auf **Verwaltungstools**, navigieren Sie zu **Integrationen**, und klicken Sie dann im Abschnitt **SAML 2.0 Authentication** (SAML 2.0-Authentifizierung) auf **Einstellungen aktualisieren**:

    ![Dealpath-Konfiguration](./media/active-directory-saas-dealpath-tutorial/tutorial_dealpath_admin.png)

9. Führen Sie auf der Seite **Set up SAML 2.0 authentication** (SAML 2.0-Authentifizierung einrichten) die folgenden Schritte aus:
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/active-directory-saas-dealpath-tutorial/create_aaduser_01.png)

2. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/active-directory-saas-dealpath-tutorial/create_aaduser_02.png)

3. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/active-directory-saas-dealpath-tutorial/create_aaduser_03.png)

4. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/active-directory-saas-dealpath-tutorial/create_aaduser_04.png)
...
2. Wählen Sie in der Anwendungsliste die Option **Dealpath**.
    ...
    ![Dealpath-Link in der Anwendungsliste](./media/active-directory-saas-dealpath-tutorial/tutorial_dealpath_app.png)  
