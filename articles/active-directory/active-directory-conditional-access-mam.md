...
- Der Vorgehensweise zum [Konfigurieren einer Richtlinie zum bedingten Zugriff](conditional-access/app-based-mfa.md)

- Der [Migration von Richtlinien für bedingten Zugriff](conditional-access/best-practices.md#policy-migration)
