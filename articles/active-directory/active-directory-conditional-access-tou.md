...
![Richtlinie erstellen](./media/active-directory-conditional-access-tou/5555.png)
...
5. Klicken Sie auf der Seite **Azure Active Directory** im Abschnitt **Verwalten** auf **Bedingter Zugriff**.
    ...
    ![Bedingter Zugriff](./media/active-directory-conditional-access-tou/03.png) 

6. Klicken Sie im Bereich **Verwalten** auf **Nutzungsbedingungen**.

    ![Nutzungsbedingungen](./media/active-directory-conditional-access-tou/04.png) 

7. Klicken Sie oben im Menü auf **Neue Bedingungen**.

    ![Nutzungsbedingungen](./media/active-directory-conditional-access-tou/05.png) 

8. Gehen Sie auf der Seite **Neue Nutzungsbedingungen** folgendermaßen vor:

    ![Nutzungsbedingungen](./media/active-directory-conditional-access-tou/112.png) 
...
![Richtlinie erstellen](./media/active-directory-conditional-access-tou/1234.png)
...
2. Klicken Sie im Abschnitt **Zuweisung** auf **Benutzer und Gruppen**.
    ...
    ![Benutzer und Gruppen](./media/active-directory-conditional-access-tou/06.png)

3. Gehen Sie auf der Seite **Benutzer und Gruppen** folgendermaßen vor:

    ![Benutzer und Gruppen](./media/active-directory-conditional-access-tou/24.png)
...
5. Gehen Sie auf der Seite **Cloud-Apps** folgendermaßen vor:
    ...
    ![Auswählen der Cloud-Apps](./media/active-directory-conditional-access-tou/26.png)
...
6. Klicken Sie im Abschnitt **Zugriffssteuerungen** auf **Gewähren**.
    ...
    ![Zugriffssteuerung](./media/active-directory-conditional-access-tou/10.png)

7. Gehen Sie auf der Seite **Gewähren** folgendermaßen vor:

    ![Gewährung](./media/active-directory-conditional-access-tou/111.png)
...
8. Klicken Sie im Abschnitt **Richtlinie aktivieren** auf **Ein**.
    ...
    ![Richtlinie aktivieren](./media/active-directory-conditional-access-tou/18.png)
...
![What If-Richtlinientool](./media/active-directory-conditional-access-tou/79.png)
...
2. Klicken Sie auf **Benutzer**, wählen Sie **Isabella Simonsen** aus, und klicken Sie dann auf **Auswählen**.
    ...
    ![Benutzer](./media/active-directory-conditional-access-tou/15.png)
...
![Nutzungsbedingungen](./media/active-directory-conditional-access-tou/57.png)
...
> [Erfordern von mehrstufiger Authentifizierung für bestimmte Apps](./active-directory-conditional-access-app-based-mfa.md)
