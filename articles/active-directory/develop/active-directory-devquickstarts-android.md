...
Zu Beginn benötigen Sie einen Azure AD-Mandanten zum Erstellen von Benutzern und zum Registrieren der Anwendung. Wenn Sie über noch keinen Mandanten verfügen, [erfahren Sie hier, wie Sie einen erhalten](active-directory-howto-tenant.md).
...
### <a name="get-the-sample-code"></a>Abrufen des Beispielcodes
