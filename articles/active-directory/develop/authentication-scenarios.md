...
Sehen Sie sich die Codebeispiele für Szenarien vom Typ „Webbrowser zu Webanwendung“ an. Schauen Sie außerdem regelmäßig vorbei: Es kommen immer wieder neue Beispiele hinzu. [Webanwendung](sample-v1-code.md#web-applications)
...
![Single-Page-Anwendung – Diagramm](./media/authentication-scenarios/single_page_app.png)
...
Sehen Sie sich die Codebeispiele für Szenarien vom Typ „Single-Page-Anwendung (SPA)“ an. Schauen Sie außerdem regelmäßig vorbei: Es kommen immer wieder neue Beispiele hinzu. [Single-Page-Anwendung (SPA)](sample-v1-code.md#single-page-applications).
