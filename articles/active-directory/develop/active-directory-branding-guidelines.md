...
| ------------------------------------ | ---------- | ---------- |
| Microsoft-Logo  | ![Microsoft-Logo als PNG](./media/active-directory-branding-guidelines/MS-SymbolLockup_MSSymbol_19.png) | ![Microsoft-Logo als SVG](./media/active-directory-branding-guidelines/MS-SymbolLockup_MSSymbol_19.svg) |
...
![Redlines für „Mit Microsoft anmelden“](./media/active-directory-branding-guidelines/Sign-in-with-Microsoft-redlines.png)
...
| Asset                                | PNG-Format | SVG-Format |
| ------------------------------------ | ---------- | ---------- |
| Mit Microsoft anmelden (dunkles Design)  | ![Schaltfläche „Anmelden“, dunkles Design, PNG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_dark.png) | ![Schaltfläche „Mit Microsoft anmelden“, dunkles Design, SVG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_dark.svg) |
| Mit Microsoft anmelden (helles Design) | ![Schaltfläche „Anmelden“, helles Design, PNG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_light.png) | ![Schaltfläche „Mit Microsoft anmelden“, helles Design, SVG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_light.svg) |
| Anmelden (dunkles Design)                 | ![Schaltfläche „Anmelden“, dunkles Design, PNG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_dark_short.png) | ![Schaltfläche „Anmelden“, dunkles Design, SVG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_dark_short.svg) |
| Anmelden (helles Design)                | ![Schaltfläche „Anmelden“, helles Design, PNG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_light_short.png) | ![Schaltfläche „Anmelden“, helles Design, SVG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_light_short.svg) |
