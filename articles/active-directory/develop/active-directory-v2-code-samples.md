...
> [!NOTE]
> Wenn Sie an Beispielen zu v1 interessiert sind, lesen Sie [Azure Active Directory-Codebeispiele](active-directory-code-samples.md).

Informationen zum grundlegenden Szenario für die einzelnen Beispieltypen finden Sie unter [App-Typen für den Azure Active Directory v2.0-Endpunkt](active-directory-v2-flows.md).
