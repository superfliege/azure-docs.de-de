...
> [!NOTE]
> Diese geführte Einrichtung hilft Ihnen bei der Aktivierung von Anmeldungen über Geschäfts-, Schul- oder Unikonten in Ihrer ASP.NET-Anwendung. Wenn Sie die Anmeldung über persönliche Konten neben Geschäfts-, Schul- oder Unikonten aktivieren möchten, verwenden Sie den [v2-Endpunkt](azure-ad-endpoint-comparison.md). Lesen Sie [diese geführte ASP.NET-Einrichtung für den v2-Endpunkt](tutorial-v2-asp-webapp.md) sowie [dieses Dokument](active-directory-v2-limitations.md), in dem die aktuellen Einschränkungen des v2-Endpunkts erläutert werden.
<br/><br/>
...
Weitere Informationen zu dieser Einstellung und zum Konzept von Anwendungen mit mehreren Mandanten finden Sie in [diesem Artikel](howto-convert-app-to-be-multi-tenant.md "Übersicht über mehrinstanzenfähige Anwendungen").
