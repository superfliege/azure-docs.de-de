...
2. Wählen Sie Ihren Azure AD-Mandanten aus, indem Sie auf der Seite oben rechts auf Ihr Konto klicken. Klicken Sie anschließend auf das Navigationselement **Verzeichnis wechseln**, und wählen Sie dann den entsprechenden Mandanten aus.
