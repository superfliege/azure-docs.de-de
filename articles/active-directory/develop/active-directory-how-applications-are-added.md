...
Das Anwendungsobjekt beschreibt die Anwendung gegenüber Azure AD (dem mehrinstanzenfähigen Dienst). Es kann unter anderem folgende Elemente enthalten (beachten Sie, dass diese Liste *nicht* vollständig ist):
