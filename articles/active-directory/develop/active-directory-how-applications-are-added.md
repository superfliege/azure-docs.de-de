...
Das Anwendungsobjekt beschreibt die Anwendung für Azure AD (dem mehrinstanzenfähigen Dienst). Es kann folgende Elemente enthalten: (*Hinweis*: Dies ist keine vollständige Liste.)
