...
Dabei werden Kenntnisse über [einzel](quickstart-v1-integrate-apps-with-azure-ad.md)- und [mehrinstanzenfähige](active-directory-devhowto-multi-tenant-overview.md) Apps sowie über [allgemeine Authentifizierungsmuster](authentication-scenarios.md) vorausgesetzt.
