...
Informationen zu allen Arten von Token und Ansprüchen, die für eine App zur Verfügung stehen, finden Sie in der [v2.0-Tokenreferenz](v2-id-and-access-tokens.md).
...
![Authentifizierungsablauf für eine Web-API](/media/v2-protocols-oidc/convergence_scenarios_webapi.png)
