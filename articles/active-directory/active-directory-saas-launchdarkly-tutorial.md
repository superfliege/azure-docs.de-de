...
4. Geben Sie im Suchfeld **LaunchDarkly** ein, wählen Sie im Ergebnisbereich **LaunchDarkly** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
    ...
    ![LaunchDarkly in der Ergebnisliste](./media/active-directory-saas-launchdarkly-tutorial/tutorial_launchdarkly_addfromgallery.png)
...
3. **[Erstellen eines LaunchDarkly-Testbenutzers](#create-a-launchdarkly-test-user)**, um eine Entsprechung von Britta Simon in LaunchDarkly zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist.
...
2. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/active-directory-saas-launchdarkly-tutorial/tutorial_launchdarkly_samlbase.png)

3. Führen Sie im Abschnitt **Domäne und URLs für LaunchDarkly** die folgenden Schritte aus, wenn Sie die Anwendung im **IDP**-initiierten Modus konfigurieren möchten:

    ![Informationen zur Domäne und zu den URLs für LaunchDarkly für das einmalige Anmelden](./media/active-directory-saas-launchdarkly-tutorial/tutorial_launchdarkly_url.png)
...
4. Aktivieren Sie **Erweiterte URL-Einstellungen anzeigen**, und führen Sie die folgenden Schritte aus, wenn Sie die Anwendung im **SP-initiierten Modus** konfigurieren möchten:
    ...
    ![Informationen zur Domäne und zu den URLs für LaunchDarkly für das einmalige Anmelden](./media/active-directory-saas-launchdarkly-tutorial/tutorial_launchdarkly_url1.png)
...
5. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Zertifikat (Base64)**, und speichern Sie die Zertifikatdatei auf Ihrem Computer.
    ...
    ![Downloadlink für das Zertifikat](./media/active-directory-saas-launchdarkly-tutorial/tutorial_launchdarkly_certificate.png) 

6. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/active-directory-saas-launchdarkly-tutorial/tutorial_general_400.png)
    
7. Klicken Sie im Abschnitt **LaunchDarkly-Konfiguration** auf **LaunchDarkly konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **Dienst-URL für einmalige Anmeldung** aus dem Abschnitt **Kurzübersicht**.

    ![LaunchDarkly-Konfiguration](./media/active-directory-saas-launchdarkly-tutorial/tutorial_launchdarkly_configure.png)

8. Melden Sie sich in einem anderen Webbrowserfenster bei der LaunchDarkly-Unternehmenswebsite als Administrator an.

9. Wählen Sie **Account Settings** (Kontoeinstellungen) im linken Navigationsbereich aus.

    ![LaunchDarkly-Konfiguration](./media/active-directory-saas-launchdarkly-tutorial/configure1.png)

10. Klicken Sie auf die Registerkarte **Security** (Sicherheit).

    ![LaunchDarkly-Konfiguration](./media/active-directory-saas-launchdarkly-tutorial/configure2.png)

11. Klicken Sie auf **ENABLE SSO** (SSO aktivieren) und dann auf **EDIT SAML CONFIGURATION** (SAML-Konfiguration bearbeiten).

    ![LaunchDarkly-Konfiguration](./media/active-directory-saas-launchdarkly-tutorial/configure3.png)

12. Führen Sie im Abschnitt **Edit your SAML Configuration** (SAML-Konfiguration bearbeiten) die folgenden Schritte aus:
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/active-directory-saas-launchdarkly-tutorial/create_aaduser_01.png)

2. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/active-directory-saas-launchdarkly-tutorial/create_aaduser_02.png)

3. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/active-directory-saas-launchdarkly-tutorial/create_aaduser_03.png)

4. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/active-directory-saas-launchdarkly-tutorial/create_aaduser_04.png)
...
2. Wählen Sie in der Anwendungsliste **LaunchDarkly** aus.
    ...
    ![LaunchDarkly-Link in der Anwendungsliste](./media/active-directory-saas-launchdarkly-tutorial/tutorial_launchdarkly_app.png)  
