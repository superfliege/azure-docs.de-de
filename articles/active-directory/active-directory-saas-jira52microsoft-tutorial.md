---
title: 'Tutorial: Azure Active Directory-Integration mit Microsoft Azure Active Directory single sign-on for JIRA 5.2 | Microsoft-Dokumentation'
description: Hier erfahren Sie, wie Sie einmaliges Anmelden zwischen Azure Active Directory und Microsoft Azure Active Directory single sign-on for JIRA 5.2 konfigurieren.
...
---
# <a name="tutorial-azure-active-directory-integration-with-microsoft-azure-active-directory-single-sign-on-for-jira-52"></a>Tutorial: Azure Active Directory-Integration mit Microsoft Azure Active Directory single sign-on for JIRA 5.2

In diesem Tutorial lernen Sie, wie Sie Microsoft Azure Active Directory single sign-on for JIRA 5.2 in Azure Active Directory (Azure AD) integrieren.

Die Integration von Microsoft Azure Active Directory single sign-on for JIRA 5.2 in Azure AD bietet die folgenden Vorteile:

- Sie können in Azure AD steuern, wer Zugriff auf Microsoft Azure Active Directory single sign-on for JIRA 5.2 hat.
- Sie können es Benutzern ermöglichen, sich mit ihren Azure AD-Konten automatisch bei Microsoft Azure Active Directory single sign-on for JIRA 5.2 anzumelden.
...
Um die Azure AD-Integration mit Microsoft Azure Active Directory single sign-on for JIRA 5.2 konfigurieren zu können, benötigen Sie Folgendes:
...
*   Außerdem werden in JIRA 6.0 und 7.2.0 unterstützt. Um weitere Einzelheiten anzuzeigen, klicken Sie auf [Microsoft Azure Active Directory single sign-on for JIRA](./active-directory-saas-jiramicrosoft-tutorial.md).

## <a name="scenario-description"></a>Beschreibung des Szenarios
In diesem Tutorial testen Sie das einmalige Anmelden für Azure AD in einer Testumgebung. Das in diesem Tutorial beschriebene Szenario besteht aus zwei Hauptbestandteilen:

1. Hinzufügen von Microsoft Azure Active Directory single sign-on for JIRA 5.2 aus dem Katalog
2. Konfigurieren und Testen der einmaligen Anmeldung von Azure AD

## <a name="adding-microsoft-azure-active-directory-single-sign-on-for-jira-52-from-the-gallery"></a>Hinzufügen von Microsoft Azure Active Directory single sign-on for JIRA 5.2 aus dem Katalog
Um die Integration von Microsoft Azure Active Directory single sign-on for JIRA 5.2 in Azure AD konfigurieren zu können, müssen Sie Microsoft Azure Active Directory single sign-on for JIRA 5.2 aus dem Katalog zur Liste der verwalteten SaaS-Apps hinzufügen.

**Wenn Sie Microsoft Azure Active Directory single sign-on for JIRA 5.2 aus dem Katalog hinzufügen möchten, führen Sie die folgenden Schritte aus**:
...
4. Geben Sie in das Suchfeld **Microsoft Azure Active Directory single sign-on for JIRA 5.2** ein, wählen Sie **Microsoft Azure Active Directory single sign-on for JIRA 5.2** im Ergebnisbereich aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.

    ![Microsoft Azure Active Directory single sign-on for JIRA 5.2 in der Ergebnisliste](.\media\active-directory-saas-msaadssojira5.2-tutorial\tutorial_singlesign-onforjira5.2_addfromgallery.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurieren und Testen des einmaligen Anmeldens in Azure AD

In diesem Abschnitt konfigurieren und testen Sie das einmalige Anmelden mit Azure AD bei Microsoft Azure Active Directory single sign-on for JIRA 5.2 mithilfe eines Testbenutzers namens „Britta Simon“.

Damit einmaliges Anmelden funktioniert, muss Azure AD wissen, welcher Benutzer in Microsoft Azure Active Directory single sign-on for JIRA 5.2 als Pendant zu einem Benutzer in Azure AD fungiert. Anders ausgedrückt: Zwischen einem Azure AD-Benutzer und dem entsprechenden Benutzer in Microsoft Azure Active Directory single sign-on for JIRA 5.2 muss eine Verknüpfungsbeziehung eingerichtet werden.

Zum Konfigurieren und Testen des einmaligen Anmeldens mit Azure AD bei Microsoft Azure Active Directory single sign-on for JIRA 5.2 müssen die folgenden Schritte ausgeführt werden:

1. **[Konfigurieren des einmaligen Anmeldens von Azure AD](#configure-azure-ad-single-sign-on)**, um Ihren Benutzern das Verwenden dieses Features zu ermöglichen.
2. **[Erstellen eines Azure AD-Testbenutzers](#create-an-azure-ad-test-user)**, um das einmalige Anmelden mit Azure AD mit dem Testbenutzer Britta Simon zu testen.
3. **[Erstellen eines Testbenutzers für Microsoft Azure Active Directory single sign-on for JIRA 5.2](#create-a-singlesign-onforjira5.2-test-user)**, um ein Pendant von Britta Simon in Microsoft Azure Active Directory single sign-on for JIRA 5.2 zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist
4. **[Zuweisen des Azure AD-Testbenutzers](#assign-the-azure-ad-test-user)**, um Britta Simon für das einmalige Anmelden von Azure AD zu aktivieren.
5. **[Testen der einmaligen Anmeldung](#test-single-sign-on)**, um zu überprüfen, ob die Konfiguration funktioniert.

### <a name="configure-azure-ad-single-sign-on"></a>Konfigurieren des einmaligen Anmeldens in Azure AD

In diesem Abschnitt ermöglichen Sie das einmalige Anmelden mit Azure AD im Azure-Portal und konfigurieren es in Ihrer Anwendung für Microsoft Azure Active Directory single sign-on for JIRA 5.2.

**Um einmaliges Anmelden mit Azure AD bei Microsoft Azure Active Directory single sign-on for JIRA 5.2 konfigurieren zu können, müssen Sie folgende Schritte ausführen**:

1. Klicken Sie im Azure-Portal auf der Anwendungsintegrationsseite für **Microsoft Azure Active Directory single sign-on for JIRA 5.2** auf **Einmaliges Anmelden**.

    ![Konfigurieren des Links für einmaliges Anmelden][4]

2. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
 
    ![Dialogfeld „Einmaliges Anmelden“](.\media\active-directory-saas-msaadssojira5.2-tutorial\tutorial_singlesign-onforjira5.2_samlbase.png)

3. Führen Sie im Abschnitt **Domäne und URLs für Microsoft Azure Active Directory single sign-on for JIRA 5.2** die folgenden Schritte aus:

    ![SSO-Informationen zur Domäne und zu den URLs für Microsoft Azure Active Directory single sign-on for JIRA 5.2](.\media\active-directory-saas-msaadssojira5.2-tutorial\tutorial_singlesign-onforjira5.2_url.png)
...
4. Zum Generieren der **Metadaten**-URL führen Sie die folgenden Schritte aus:
    ...
    d. Kehren Sie nun zur Eigenschaftenseite von **Microsoft Azure Active Directory single sign-on for JIRA 5.2** zurück, kopieren Sie die **Anwendungs-ID** mithilfe der Schaltfläche **Kopieren**, und fügen Sie sie in Editor ein.
...
11. Führen Sie auf der Konfigurationsseite die folgenden Schritte aus:
    ...
    b. Kopieren Sie die Werte von **Identifier, Reply URL and Sign on URL** (Bezeichner, Antwort-URL und Anmelde-URL). Fügen Sie sie anschließend im Azure-Portal im Abschnitt **Microsoft Azure Active Directory single sign-on for JIRA 5.2 Domain and URLs** (Domäne und URLs für Microsoft Azure Active Directory single sign-on for JIRA 5.2) in die Textfelder **Identifier, Reply URL and Sign on URL** (Bezeichner, Antwort-URL und Anmelde-URL) ein.
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](.\media\active-directory-saas-msaadssojira5.2-tutorial\create_aaduser_01.png)

2. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](.\media\active-directory-saas-msaadssojira5.2-tutorial\create_aaduser_02.png)

3. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](.\media\active-directory-saas-msaadssojira5.2-tutorial\create_aaduser_03.png)

4. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](.\media\active-directory-saas-msaadssojira5.2-tutorial\create_aaduser_04.png)
...
### <a name="create-a-microsoft-azure-active-directory-single-sign-on-for-jira-52-test-user"></a>Erstellen eines Testbenutzers für Microsoft Azure Active Directory single sign-on for JIRA 5.2

Um es Azure AD-Benutzern zu ermöglichen, sich auf dem lokalen JIRA-Server anzumelden, müssen sie in Microsoft Azure Active Directory single sign-on for JIRA 5.2 bereitgestellt werden. Bei Microsoft Azure Active Directory single sign-on for JIRA 5.2 ist die Bereitstellung eine manuelle Aufgabe.
...
2. Fahren Sie mit dem Mauszeiger über das Zahnrad, und klicken Sie auf **Benutzerverwaltung**.
    ...
    ![Mitarbeiter hinzufügen](.\media\active-directory-saas-msaadssojira5.2-tutorial\user1.png) 
...
3. Sie werden zur Seite „Administratorzugriff“ umgeleitet, um Ihr **Kennwort** einzugeben. Klicken Sie anschließend auf die Schaltfläche **Bestätigen**.
    ...
    ![Mitarbeiter hinzufügen](.\media\active-directory-saas-msaadssojira5.2-tutorial\user2.png) 

4. Klicken Sie im Registerkartenabschnitt **Benutzerverwaltung** auf **Benutzer erstellen**.

    ![Mitarbeiter hinzufügen](.\media\active-directory-saas-msaadssojira5.2-tutorial\user3.png) 

5. Führen Sie auf der Dialogfeldseite **Neuen Benutzer erstellen** die folgenden Schritte durch:

    ![Mitarbeiter hinzufügen](.\media\active-directory-saas-msaadssojira5.2-tutorial\user4.png) 
...
In diesem Abschnitt ermöglichen Sie Britta Simon das einmalige Anmelden bei Azure, indem Sie ihr Zugriff auf Microsoft Azure Active Directory single sign-on for JIRA 5.2 gewähren.

![Zuweisen der Benutzerrolle][200] 

**Wenn Sie Britta Simon zu Microsoft Azure Active Directory single sign-on for JIRA 5.2 hinzufügen möchten, führen Sie die folgenden Schritte aus**:

1. Öffnen Sie im Azure-Portal die Anwendungsansicht, navigieren Sie zur Verzeichnisansicht, wechseln Sie dann zu **Unternehmensanwendungen**, und klicken Sie auf **Alle Anwendungen**.

    ![Benutzer zuweisen][201] 

2. Wählen Sie in der Anwendungsliste **Microsoft Azure Active Directory single sign-on for JIRA 5.2** aus.

    ![Der Link für Microsoft Azure Active Directory single sign-on for JIRA 5.2 in der Anwendungsliste](.\media\active-directory-saas-msaadssojira5.2-tutorial\tutorial_singlesign-onforjira5.2_app.png)  
...
Wenn Sie im Zugriffsbereich auf die Kachel für Microsoft Azure Active Directory single sign-on for JIRA 5.2 klicken, sollten Sie automatisch bei der Anwendung für Microsoft Azure Active Directory single sign-on for JIRA 5.2 angemeldet werden.
