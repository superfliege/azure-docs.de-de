...
4. Geben Sie im Suchfeld **Schoox** ein, wählen Sie im Ergebnisbereich **Schoox** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
    ...
    ![Schoox in der Ergebnisliste](./media/active-directory-saas-schoox-tutorial/tutorial_schoox_addfromgallery.png)
...
2. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/active-directory-saas-schoox-tutorial/tutorial_schoox_samlbase.png)
...
3. Führen Sie im Abschnitt **Domäne und URLs für Schoox** die folgenden Schritte aus, wenn Sie die Anwendung im **IDP**-initiierten Modus konfigurieren möchten:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für Schoox](./media/active-directory-saas-schoox-tutorial/tutorial_schoox_url.png)

    Geben Sie im Textfeld **Bezeichner** eine URL ein: `https://saml.schoox.com/saml/adfsmetadata`

4. Aktivieren Sie **Erweiterte URL-Einstellungen anzeigen**, und führen Sie die folgenden Schritte aus, wenn Sie die Anwendung im **SP-initiierten Modus** konfigurieren möchten:

    ![SSO-Informationen zur Domäne und zu den URLs für Schoox](./media/active-directory-saas-schoox-tutorial/tutorial_schoox_url1.png)
...
5. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Metadaten-XML**, und speichern Sie die Metadatendatei dann auf Ihrem Computer.
    ...
    ![Downloadlink für das Zertifikat](./media/active-directory-saas-schoox-tutorial/tutorial_schoox_certificate.png) 

6. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/active-directory-saas-schoox-tutorial/tutorial_general_400.png)
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/active-directory-saas-schoox-tutorial/create_aaduser_01.png)

2. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/active-directory-saas-schoox-tutorial/create_aaduser_02.png)

3. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/active-directory-saas-schoox-tutorial/create_aaduser_03.png)

4. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/active-directory-saas-schoox-tutorial/create_aaduser_04.png)
...
2. Wählen Sie in der Anwendungsliste den Eintrag **Schoox**aus.
    ...
    ![Schoox-Link in der Anwendungsliste](./media/active-directory-saas-schoox-tutorial/tutorial_schoox_app.png)  
