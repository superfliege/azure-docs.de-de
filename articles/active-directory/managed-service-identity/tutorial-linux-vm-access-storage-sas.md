...
- Wenn Sie dieses gleiche Tutorial mit Speicherkontoschlüsseln ausführen möchten, lesen Sie [Verwenden einer Linux-VM-MSI für den Zugriff auf Azure Storage](tutorial-linux-vm-access-storage.md).
