...
- [Bewährte Methoden für den bedingten Zugriff in Azure Active Directory](conditional-access/best-practices.md), um hilfreiche Informationen zum Bereitstellen von bedingtem Zugriff in Ihrer Organisation zu erhalten.

- [Schnellstart: Anfordern der mehrstufigen Authentifizierung (Multi-Factor Authentication, MFA) für bestimmte Apps über den bedingten Zugriff von Azure Active Directory](conditional-access/app-based-mfa.md), um sich mit der Benutzeroberfläche im Azure-Portal vertraut zu machen.
