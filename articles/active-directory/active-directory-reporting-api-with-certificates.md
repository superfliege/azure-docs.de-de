...
1. Stellen Sie zuerst sicher, dass Sie die [Voraussetzungen für den Zugriff auf die Azure Active Directory-Berichtserstellungs-API](active-directory-reporting-api-prerequisites-azure-portal.md) erfüllen. 
...
2. Befolgen Sie dann die Anweisungen zum [Registrieren Ihres Zertifikats bei Azure AD](https://docs.microsoft.com/en-us/azure/active-directory/develop/active-directory-certificate-credentials#register-your-certificate-with-azure-ad) für die Anwendung. 
...
* [Verschaffen eines ersten Eindrucks über die Berichterstellungs-APIs](active-directory-reporting-api-getting-started-azure-portal.md)
