...
5. Klicken Sie auf die Schaltfläche **Save** .
    ...
    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/active-directory-saas-zoho-mail-tutorial/tutorial_general_400.png)
