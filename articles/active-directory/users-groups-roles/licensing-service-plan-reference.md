...
description: Bezeichnerzuordnung zum Verwalten der Azure Active Directory-Lizenzierung im Azure-Portal, im Microsoft 365 Admin Center, in PowerShell oder in Microsoft Graph
...
Diese [Fehlerbedingung](licensing-groups-resolve-problems.md#conflicting-service-plans) tritt auf, wenn Sie die gruppenbasierte Lizenzierung verwenden. Wenn Sie PowerShell verwenden, wird der Fehler *MutuallyExclusiveViolation* angezeigt.
