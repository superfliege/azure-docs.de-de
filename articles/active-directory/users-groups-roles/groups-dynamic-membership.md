...
ms.locfileid: "39248888"
---
# <a name="create-dynamic-groups-with-attribute-based-membership-in-azure-active-directory"></a>Erstellen dynamischer Gruppen mit attributbasierter Mitgliedschaft in Azure Active Directory
...
Der GUID-Bezeichner kennzeichnet den von Exchange Online-Serviceplan (Plan 2).
...
Benutzerdefinierte Attribute werden von einer lokalen Windows Server AD-Instanz oder von einer verbundenen SaaS-Anwendung aus synchronisiert und erhalten das Format „user.extension_[GUID]\__[Attribute]“. Dabei ist [GUID] der eindeutige Bezeichner in AAD für die Anwendung, die das Attribut in Azure AD erstellt hat, und [Attribute] ist der Name des Attributs bei seiner Erstellung. Beispiel für eine Regel, die ein benutzerdefiniertes Attribut verwendet:
