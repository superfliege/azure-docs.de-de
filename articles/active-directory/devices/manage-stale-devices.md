...
- **Windows 7/8**: Deaktivieren oder löschen Sie Windows 10-Geräte in Azure AD. Sie können Azure AD Connect nicht verwenden, um Windows 7/8-Geräte in Azure AD zu deaktivieren oder zu löschen.
