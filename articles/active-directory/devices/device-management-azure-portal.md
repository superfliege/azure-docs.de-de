...
- Setzt voraus, dass Sie die [Einführung in die Geräteverwaltung in Azure Active Directory](overview.md) gelesen haben.
...
- Ausführen von Geräteverwaltungsaufgaben
