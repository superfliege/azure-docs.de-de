...
4. Geben Sie im Suchfeld **FloQast** ein, wählen Sie im Ergebnisbereich **FloQast** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
    ...
    ![FloQast in der Ergebnisliste](./media/active-directory-saas-floqast-tutorial/tutorial_floqast_addfromgallery.png)
...
3. **[Erstellen eines Front-Testbenutzers](#create-a-floqast-test-user)**, um ein Pendant von Britta Simon in FloQast zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist.
...
2. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/active-directory-saas-floqast-tutorial/tutorial_floqast_samlbase.png)

3. Führen Sie im Abschnitt **Domäne und URLs für FloQast** die folgenden Schritte aus, wenn Sie die Anwendung im **IDP**-initiierten Modus konfigurieren möchten:

    ![SSO-Informationen zur Domäne und zu den URLs für FloQast](./media/active-directory-saas-floqast-tutorial/tutorial_floqast_url.png)

     Geben Sie im Textfeld **Bezeichner** eine URL ein: `https://go.floqast.com/`

4. Aktivieren Sie **Erweiterte URL-Einstellungen anzeigen**, und führen Sie die folgenden Schritte aus, wenn Sie die Anwendung im **SP-initiierten Modus** konfigurieren möchten:

    ![SSO-Informationen zur Domäne und zu den URLs für FloQast](./media/active-directory-saas-floqast-tutorial/tutorial_floqast_url1.png)

     Geben Sie im Textfeld **Anmelde-URL** eine URL wie die Folgende ein: `https://go.floqast.com/login/sso`.
     
5. Die FloQast-Anwendung erwartet die SAML-Assertionen in einem bestimmten Format. Konfigurieren Sie die folgenden Ansprüche für diese Anwendung. Sie können die Werte dieser Attribute im Abschnitt **Benutzerattribute** auf der Anwendungsintegrationsseite verwalten. Der folgende Screenshot zeigt ein Beispiel für diese Attributzuordnungen:
    
    ![Konfigurieren des SSO-Attributs](./media/active-directory-saas-floqast-tutorial/tutorial_floqast_attribute.png)
...
6. Konfigurieren Sie das SAML-Tokenattribut im Abschnitt **Benutzerattribute** im Dialogfeld **Einmaliges Anmelden**, wie in der Abbildung gezeigt, und führen Sie die folgenden Schritte aus:
    ...
    ![Einmaliges Anmelden konfigurieren, Hinzufügen](./media/active-directory-saas-floqast-tutorial/tutorial_attribute_04.png)

    ![Einmaliges Anmelden konfigurieren, Attribut hinzufügen](./media/active-directory-saas-floqast-tutorial/tutorial_attribute_05.png)
...
7. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Metadaten-XML**, und speichern Sie die Metadatendatei dann auf Ihrem Computer. Führen Sie anschließend die folgenden Schritte aus:

    ![Downloadlink für das Zertifikat](./media/active-directory-saas-floqast-tutorial/tutorial_floqast_certificate.png)

    a. Aktivieren Sie **Erweiterte Einstellungen für die Zertifikatsignatur**.

    ![Die Zertifikat-Assertion](./media/active-directory-saas-floqast-tutorial/tutorial_floqast_certificateassertion.png)

    b. Wählen Sie **Signaturoption** als **SAML-Antwort und -Assertion signieren** aus.

8. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/active-directory-saas-floqast-tutorial/tutorial_general_400.png)
    
9. Zum Konfigurieren des einmaligen Anmeldens bei **FloQast** müssen Sie die heruntergeladene **Metadaten-XML**-Datei an das [FloQast-Supportteam](mailto:support@floqast.com) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/active-directory-saas-floqast-tutorial/create_aaduser_01.png)

2. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/active-directory-saas-floqast-tutorial/create_aaduser_02.png)

3. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/active-directory-saas-floqast-tutorial/create_aaduser_03.png)

4. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/active-directory-saas-floqast-tutorial/create_aaduser_04.png)
...
2. Wählen Sie in der Anwendungsliste **FloQast**aus.
    ...
    ![FloQast-Link in der Anwendungsliste](./media/active-directory-saas-floqast-tutorial/tutorial_floqast_app.png)  
