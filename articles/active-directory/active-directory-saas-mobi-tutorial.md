...
4. Geben Sie im Suchfeld **MOBI** ein, wählen Sie im Ergebnisbereich **MOBI** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
    ...
    ![MOBI in der Ergebnisliste](./media/active-directory-saas-mobi-tutorial/tutorial_mobi_addfromgallery.png)
...
3. **[Erstellen eines MOBI-Testbenutzers](#create-a-mobi-test-user)**, um eine Entsprechung von Britta Simon in MOBI zu erhalten, die mit ihrer Darstellung in Azure AD verknüpft ist
...
2. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/active-directory-saas-mobi-tutorial/tutorial_mobi_samlbase.png)

3. Führen Sie im Abschnitt **Domäne und URLs für MOBI** die folgenden Schritte aus, wenn Sie die Anwendung im IDP-initiierten Modus konfigurieren möchten:

    ![SSO-Informationen zur Domäne und zu den URLs für MOBI](./media/active-directory-saas-mobi-tutorial/tutorial_mobi_url.png)
...
4. Aktivieren Sie **Erweiterte URL-Einstellungen anzeigen**, und führen Sie die folgenden Schritte aus, wenn Sie die Anwendung im **SP-initiierten Modus** konfigurieren möchten:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für MOBI](./media/active-directory-saas-mobi-tutorial/tutorial_mobi_url1.png)
...
5. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Metadaten-XML**, und speichern Sie die Metadatendatei dann auf Ihrem Computer.
    ...
    ![Downloadlink für das Zertifikat](./media/active-directory-saas-mobi-tutorial/tutorial_mobi_certificate.png) 

6. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/active-directory-saas-mobi-tutorial/tutorial_general_400.png)
    
7. Zum Konfigurieren des einmaligen Anmeldens bei **MOBI** müssen Sie die heruntergeladene **Metadaten-XML**-Datei an das [MOBI-Supportteam](mailto:sso@mobiwm.com) senden. Es führt die Einrichtung durch, damit die SAML-SSO-Verbindung auf beiden Seiten richtig festgelegt ist.
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/active-directory-saas-mobi-tutorial/create_aaduser_01.png)

2. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/active-directory-saas-mobi-tutorial/create_aaduser_02.png)

3. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/active-directory-saas-mobi-tutorial/create_aaduser_03.png)

4. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/active-directory-saas-mobi-tutorial/create_aaduser_04.png)
...
2. Wählen Sie in der Anwendungsliste **MOBI** aus.
    ...
    ![MOBI-Link in der Anwendungsliste](./media/active-directory-saas-mobi-tutorial/tutorial_mobi_app.png)  
