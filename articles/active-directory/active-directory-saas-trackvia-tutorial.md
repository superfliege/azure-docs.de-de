...
4. Geben Sie **TrackVia** in das Suchfeld ein, wählen Sie im Ergebnisbereich **TrackVia** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
    ...
    ![TrackVia in der Ergebnisliste](./media/active-directory-saas-trackvia-tutorial/tutorial_trackvia_addfromgallery.png)
...
3. **[Erstellen eines TrackVia-Testbenutzers](#create-a-trackvia-test-user)**, um in TrackVia ein Pendant von Britta Simon zu erhalten, das mit ihrer Darstellung in Azure AD verknüpft ist.
...
2. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/active-directory-saas-trackvia-tutorial/tutorial_trackvia_samlbase.png)

3. Führen Sie im Abschnitt **Domäne und URLs für TrackVia** die folgenden Schritte aus, wenn Sie die Anwendung im **IDP**-initiierten Modus konfigurieren möchten:

    ![SSO-Informationen zur Domäne und zu den URLs für TrackVia](./media/active-directory-saas-trackvia-tutorial/tutorial_trackvia_url.png)

    Geben Sie im Textfeld **Bezeichner** den Wert `TrackVia` ein.

4. Aktivieren Sie **Erweiterte URL-Einstellungen anzeigen**, und führen Sie die folgenden Schritte aus, wenn Sie die Anwendung im **SP-initiierten Modus** konfigurieren möchten:

    ![SSO-Informationen zur Domäne und zu den URLs für TrackVia](./media/active-directory-saas-trackvia-tutorial/tutorial_trackvia_url1.png)
...
5. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Metadaten-XML**, und speichern Sie die Metadatendatei dann auf Ihrem Computer.
    ...
    ![Downloadlink für das Zertifikat](./media/active-directory-saas-trackvia-tutorial/tutorial_trackvia_certificate.png) 
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/active-directory-saas-trackvia-tutorial/create_aaduser_01.png)

2. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/active-directory-saas-trackvia-tutorial/create_aaduser_02.png)

3. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/active-directory-saas-trackvia-tutorial/create_aaduser_03.png)

4. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/active-directory-saas-trackvia-tutorial/create_aaduser_04.png)
...
2. Wählen Sie in der Anwendungsliste **TrackVia** aus.
    ...
    ![TrackVia-Link in der Anwendungsliste](./media/active-directory-saas-trackvia-tutorial/tutorial_trackvia_app.png)  
