...
6. Klicken Sie auf die Schaltfläche **Save** .
    ...
    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/active-directory-saas-textmagic-tutorial/tutorial_general_400.png)
