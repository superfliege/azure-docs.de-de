...
Weitere Informationen über dieses Risikoereignis finden Sie unter [Anmeldungen von anonymen IP-Adressen](active-directory-reporting-risk-events.md#sign-ins-from-anonymous-ip-addresses). 
...
Weitere Informationen über dieses Risikoereignis finden Sie unter [Anmeldungen von unbekannten Standorten](active-directory-reporting-risk-events.md#sign-in-from-unfamiliar-locations). 
...
Weitere Informationen zu diesem Risikoereignis finden Sie unter [Unmöglicher Ortswechsel zu atypischen Orten](active-directory-reporting-risk-events.md#impossible-travel-to-atypical-locations). 
...
Weitere Informationen finden Sie unter [Benutzerrisiko-Sicherheitsrichtlinie](active-directory-identityprotection.md#user-risk-security-policy).

![Benutzerrisiko](./media/active-directory-identityprotection-playbook/02.png "Playbook")
...
4. Wählen Sie im Abschnitt **Zuweisungen** die gewünschten Benutzer (und Gruppen) und die gewünschte Benutzerrisikostufe.
    ...
    ![Benutzerrisiko](./media/active-directory-identityprotection-playbook/03.png "Playbook")
...
![Anmelderisiko](./media/active-directory-identityprotection-playbook/01.png "Playbook")
...
4. Wählen Sie im Abschnitt **Zuweisungen** die gewünschten Benutzer (und Gruppen) und die gewünschte Anmelderisikostufe.
    ...
    ![Anmelderisiko](./media/active-directory-identityprotection-playbook/04.png "Playbook")
