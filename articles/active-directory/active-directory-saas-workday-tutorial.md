...
4. Geben Sie im Suchfeld **Workday** ein, wählen Sie im Ergebnisbereich **Workday** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
    ...
    ![Workday in der Ergebnisliste](./media/active-directory-saas-workday-tutorial/tutorial_workday_addfromgallery.png)
...
2. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/active-directory-saas-workday-tutorial/tutorial_workday_samlbase.png)

3. Führen Sie auf der Seite **Domäne und URLs für Workday** die folgenden Schritte aus:

    ![SSO-Informationen zur Domäne und zu den URLs für Workday](./media/active-directory-saas-workday-tutorial/tutorial_workday_url.png)
...
4. Aktivieren Sie **Erweiterte URL-Einstellungen anzeigen**, und führen Sie den folgenden Schritt aus:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für Workday](./media/active-directory-saas-workday-tutorial/tutorial_workday_url1.png)
...
5. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Zertifikat (Base64)**, und speichern Sie die Zertifikatdatei auf Ihrem Computer.
    ...
    ![Downloadlink für das Zertifikat](./media/active-directory-saas-workday-tutorial/tutorial_workday_certificate.png) 

6. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/active-directory-saas-workday-tutorial/tutorial_general_400.png)
...
7. Klicken Sie im Abschnitt **Workday-Konfiguration** auf **Workday konfigurieren**, um das Fenster **Anmeldung konfigurieren** zu öffnen. Kopieren Sie die **Abmelde-URL, die SAML-Entitäts-ID und die URL für den SAML-SSO-Dienst** aus dem Abschnitt **Kurzübersicht**.
    ...
    ![Workday-Konfiguration](./media/active-directory-saas-workday-tutorial/tutorial_workday_configure.png) 
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/active-directory-saas-workday-tutorial/create_aaduser_01.png)

2. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/active-directory-saas-workday-tutorial/create_aaduser_02.png)

3. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/active-directory-saas-workday-tutorial/create_aaduser_03.png)

4. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/active-directory-saas-workday-tutorial/create_aaduser_04.png)
...
2. Wählen Sie in der Anwendungsliste **Workday** aus.
    ...
    ![Workday-Link in der Anwendungsliste](./media/active-directory-saas-workday-tutorial/tutorial_workday_app.png)  
