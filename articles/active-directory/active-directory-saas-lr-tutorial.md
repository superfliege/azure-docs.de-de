...
4. Geben Sie im Suchfeld **LoginRadius** ein, wählen Sie im Ergebnisbereich **LoginRadius** aus, und klicken Sie dann auf die Schaltfläche **Hinzufügen**, um die Anwendung hinzuzufügen.
    ...
    ![LoginRadius in der Ergebnisliste](./media/active-directory-saas-lr-tutorial/tutorial_LoginRadius_addfromgallery.png)
...
2. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/active-directory-saas-lr-tutorial/tutorial_LoginRadius_samlbase.png)

3. Führen Sie auf der Seite **Domäne und URLs für LoginRadius** die folgenden Schritte aus:

    ![SSO-Informationen zur Domäne und zu den URLs für LoginRadius](./media/active-directory-saas-lr-tutorial/tutorial_LoginRadius_url.png)
...
5. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Metadaten-XML**, und speichern Sie die Metadatendatei dann auf Ihrem Computer.
    ...
    ![Downloadlink für das Zertifikat](./media/active-directory-saas-lr-tutorial/tutorial_LoginRadius_certificate.png) 
...
2. Wählen Sie in der Anwendungsliste **LoginRadius** aus.
    ...
    ![LoginRadius-Link in der Anwendungsliste](./media/active-directory-saas-lr-tutorial/tutorial_LoginRadius_app.png)  
