...
Die Protokollseite wird verwendet, um den Kennwortsynchronisierungsstatus und den Verlauf anzuzeigen. Weitere Informationen finden Sie unter [Problembehandlung bei der Kennworthashsynchronisierung](active-directory-aadconnectsync-troubleshoot-password-hash-synchronization.md).
