...
![Diagnoseausgabe für die Kennworthashsynchronisierung](./media/active-directory-aadconnectsync-troubleshoot-password-hash-synchronization/phsglobalgeneral.png)
...
![Kennworthashsynchronisierung ist nicht aktiviert](./media/active-directory-aadconnectsync-troubleshoot-password-hash-synchronization/phsglobaldisabled.png)
...
![Azure AD Connect-Server befindet sich im Stagingmodus](./media/active-directory-aadconnectsync-troubleshoot-password-hash-synchronization/phsglobalstaging.png)
...
![Kein Kennworthashsynchronisierungs-Taktereignis](./media/active-directory-aadconnectsync-troubleshoot-password-hash-synchronization/phsglobalnoheartbeat.png)
...
![Falsche Anmeldeinformationen](./media/active-directory-aadconnectsync-troubleshoot-password-hash-synchronization/phsglobalaccountincorrectpermission.png)
...
![Falsche Anmeldeinformationen](./media/active-directory-aadconnectsync-troubleshoot-password-hash-synchronization/phsglobalaccountincorrectcredential.png)
...
![Diagnoseausgabe für die Kennworthashsynchronisierung – einzelnes Objekt](./media/active-directory-aadconnectsync-troubleshoot-password-hash-synchronization/phssingleobjectgeneral.png)
...
![Azure AD-Objekt fehlt](./media/active-directory-aadconnectsync-troubleshoot-password-hash-synchronization/phssingleobjectnotexported.png)
...
![Temporäres Kennwort wurde nicht exportiert](./media/active-directory-aadconnectsync-troubleshoot-password-hash-synchronization/phssingleobjecttemporarypassword.png)
...
![Diagnoseausgabe für ein einzelnes Objekt – kein Kennwortsynchronisierungsverlauf](./media/active-directory-aadconnectsync-troubleshoot-password-hash-synchronization/phssingleobjectnohistory.png)
...
2. Führen Sie das Skript im Abschnitt [Abrufen des Status der Kennwortsynchronisierungseinstellungen](#get-the-status-of-password-sync-settings) aus. Dadurch erhalten Sie eine Übersicht über die Konfiguration der Kennwortsynchronisierung.  
    ...
    ![PowerShell-Skriptausgabe aus den Kennwortsynchronisierungseinstellungen](./media/active-directory-aadconnectsync-troubleshoot-password-hash-synchronization/psverifyconfig.png)  
...
4. Navigieren Sie zu **Mit Active Directory-Gesamtstruktur verbinden**.  
    ...
    ![Vom Active Directory-Connector verwendetes Konto](./media/active-directory-aadconnectsync-troubleshoot-password-hash-synchronization/connectoraccount.png)  
...
6. Sind die Domänencontroller durch Azure AD Connect erreichbar? Wenn der Connect-Server mit keinem der Domänencontroller eine Verbindung herstellen kann, konfigurieren Sie **Nur bevorzugten Domänencontroller verwenden**.  
    ...
    ![Vom Active Directory-Connector verwendeter Domänencontroller](./media/active-directory-aadconnectsync-troubleshoot-password-hash-synchronization/preferreddc.png)  
...
1. Suchen Sie unter **Active Directory-Benutzer und -Computer** nach dem Benutzer, und überprüfen Sie dann, ob das Kontrollkästchen **Benutzer muss Kennwort bei der nächsten Anmeldung ändern** deaktiviert ist.  
    ...
    ![Produktive Active Directory-Kennwörter](./media/active-directory-aadconnectsync-troubleshoot-password-hash-synchronization/adprodpassword.png)  
...
2. Wenn das Kennwort in Active Directory korrekt aussieht, folgen Sie dem Benutzer im Synchronisierungsmodul. Indem Sie dem Benutzer vom lokalen Active Directory nach Azure AD folgen, können Sie feststellen, ob eine beschreibende Fehlermeldung für das Objekt vorhanden ist.
    ...
    ![Suchen nach dem Benutzer im Connectorbereich anhand des DN](./media/active-directory-aadconnectsync-troubleshoot-password-hash-synchronization/searchcs.png)  
    ...
    ![Objektprotokolldetails](./media/active-directory-aadconnectsync-troubleshoot-password-hash-synchronization/csobjectlog.png)  
    ...
    ![Herkunftsinformationen zu einem Benutzer](./media/active-directory-aadconnectsync-troubleshoot-password-hash-synchronization/cspasswordsync.png)  

    i. Klicken Sie auf **Metaverseobjekteigenschaften**, um eine Liste von Benutzerattributen anzuzeigen.  

    ![Metaverseinformationen](./media/active-directory-aadconnectsync-troubleshoot-password-hash-synchronization/mvpasswordsync.png)  
    ...
    ![Metaverseinformationen](./media/active-directory-aadconnectsync-troubleshoot-password-hash-synchronization/mvconnectors.png)  
    ...
    ![Dialogfeld „Eigenschaften von Connectorbereichsobjekten“](./media/active-directory-aadconnectsync-troubleshoot-password-hash-synchronization/cspasswordsync2.png)  
...
* [Implementieren der Kennworthashsynchronisierung mit der Azure AD Connect-Synchronisierung](active-directory-aadconnectsync-implement-password-hash-synchronization.md)
