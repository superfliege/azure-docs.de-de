...
![Azure AD Connect-Seite mit einer Meldung über eine vorhandene Sicherung der Azure AD-Vertrauensstellung](media/active-directory-azure-ad-connect-azure-ad-trust/backup2.png)
...
![Eine Momentaufnahme einer Beispielsicherung einer Azure AD-Vertrauensstellung](media/active-directory-azure-ad-connect-azure-ad-trust/backup.png)
...
* [Verwaltung und Anpassung der Active Directory-Verbunddienste mit Azure AD Connect](active-directory-aadconnect-federation-management.md)