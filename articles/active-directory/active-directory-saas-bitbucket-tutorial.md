...
4. Geben Sie im Suchfeld **SAML SSO for Bitbucket by resolution GmbH** ein, wählen Sie im Ergebnisbereich **SAML SSO for Bitbucket by resolution GmbH** aus, und klicken Sie dann auf **Hinzufügen**, um die Anwendung hinzuzufügen.
    ...
    ![SAML SSO for Bitbucket by resolution GmbH in der Ergebnisliste](./media/active-directory-saas-bitbucket-tutorial/tutorial_bitbucket_addfromgallery.png)
...
2. Wählen Sie im Dialogfeld **Einmaliges Anmelden** als **Modus** die Option **SAML-basierte Anmeldung** aus, um einmaliges Anmelden zu aktivieren.
    ...
    ![Dialogfeld „Einmaliges Anmelden“](./media/active-directory-saas-bitbucket-tutorial/tutorial_bitbucket_samlbase.png)
...
3. Führen Sie im Abschnitt **Domäne und URLs für SAML SSO for Bitbucket by resolution GmbH** die folgenden Schritte aus, wenn Sie die Anwendung im IDP-initiierten Modus konfigurieren möchten:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für SAML SSO for Bitbucket by resolution GmbH](./media/active-directory-saas-bitbucket-tutorial/tutorial_bitbucket_url.png)
...
4. Aktivieren Sie **Erweiterte URL-Einstellungen anzeigen**, und führen Sie die folgenden Schritte aus, wenn Sie die Anwendung im **SP-initiierten Modus** konfigurieren möchten:
    ...
    ![SSO-Informationen zur Domäne und zu den URLs für SAML SSO for Bitbucket by resolution GmbH](./media/active-directory-saas-bitbucket-tutorial/tutorial_bitbucket_url1.png)
...
5. Klicken Sie im Abschnitt **SAML-Signaturzertifikat** auf **Metadaten-XML**, und speichern Sie die Metadatendatei dann auf Ihrem Computer.
    ...
    ![Downloadlink für das Zertifikat](./media/active-directory-saas-bitbucket-tutorial/tutorial_bitbucket_certificate.png) 

6. Klicken Sie auf die Schaltfläche **Save** .

    ![Schaltfläche „Speichern“ beim Konfigurieren des einmaligen Anmeldens](./media/active-directory-saas-bitbucket-tutorial/tutorial_general_400.png)
...
10. Klicken Sie auf der Seite **SAML SingleSignOn Plugin Configuration** (Konfiguration des SAML-SingleSignOn-Plug-Ins) auf **Add IdP** (IdP hinzufügen). 
    ...
    ![Add IdP (IdP hinzufügen)](./media/active-directory-saas-bitbucket-tutorial/tutorial_bitbucket_addidp.png)
...
11. Führen Sie auf der Seite **Choose your SAML Identity Provider** (SAML-Identitätsanbieter auswählen) die folgenden Schritte aus:
    ...
    ![Identitätsanbieter](./media/active-directory-saas-bitbucket-tutorial/tutorial_bitbucket_identityprovider.png)
...
12. Klicken Sie auf der Seite **Identity provider configuration** (Identitätsanbieterkonfiguration) auf die Schaltfläche **Next** (Weiter).
    ...
    ![Identitätsanbieterkonfiguration](./media/active-directory-saas-bitbucket-tutorial/tutorial_bitbucket_identityconfig.png)
...
13.  Klicken Sie auf der Seite **Import SAML IdP Metadata** (SAML-IdP-Metadaten importieren) auf **Load File** (Datei laden), um die **METADATA-XML**-Datei hochzuladen, die Sie im Azure-Portal heruntergeladen haben.
    ...
    ![IPD-Metadaten](./media/active-directory-saas-bitbucket-tutorial/tutorial_bitbucket_idpmetadata.png)
    
14. Klicken Sie auf **Weiter**.

15. Klicken Sie auf **Save settings** (Einstellungen speichern).

    ![Save settings (Einstellungen speichern)](./media/active-directory-saas-bitbucket-tutorial/tutorial_bitbucket_save.png)
...
1. Klicken Sie im linken Bereich des Azure-Portals auf die Schaltfläche **Azure Active Directory**.
    ...
    ![Schaltfläche „Azure Active Directory“](./media/active-directory-saas-bitbucket-tutorial/create_aaduser_01.png)

2. Navigieren Sie zu **Benutzer und Gruppen**, und klicken Sie dann auf **Alle Benutzer**, um die Liste mit den Benutzern anzuzeigen.

    ![Links „Benutzer und Gruppen“ und „Alle Benutzer“](./media/active-directory-saas-bitbucket-tutorial/create_aaduser_02.png)

3. Klicken Sie oben im Dialogfeld **Alle Benutzer** auf **Hinzufügen**, um das Dialogfeld **Benutzer** zu öffnen.

    ![Schaltfläche „Hinzufügen“](./media/active-directory-saas-bitbucket-tutorial/create_aaduser_03.png)

4. Führen Sie im Dialogfeld **Neuer Benutzer** die folgenden Schritte aus:

    ![Dialogfeld „Benutzer“](./media/active-directory-saas-bitbucket-tutorial/create_aaduser_04.png)
...
2. Wählen Sie in der Anwendungsliste **SAML SSO for Bitbucket by resolution GmbH** aus.
    ...
    ![SAML SSO for Bitbucket by resolution GmbH-Link in der Anwendungsliste](./media/active-directory-saas-bitbucket-tutorial/tutorial_bitbucket_app.png)  
