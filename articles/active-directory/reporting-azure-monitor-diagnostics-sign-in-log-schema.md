...
| Eigenschaften | Listet alle Eigenschaften auf, die mit Anmeldungen verknüpft sind. Weitere Informationen finden Sie in der [Microsoft Graph-API-Referenz](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/resources/signin). Dieses Schema verwendet zur besseren Lesbarkeit die gleichen Attributnamen wie die Anmelderessource.
...
* [Informieren Sie sich ausführlicher über Azure-Diagnoseprotokolle](/azure/monitoring-and-diagnostics/monitoring-overview-of-diagnostic-logs.md)
