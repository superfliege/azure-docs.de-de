...
![Richtlinie erstellen](./media/app-based-mfa/32.png)
...
![Richtlinie erstellen](./media/app-based-mfa/31.png)
...
4. Klicken Sie auf der Seite **Bedingter Zugriff** auf der Symbolleiste am oberen Rand auf **Neue Richtlinie**.
