...
4. Sie können den Auftrag auf der Registerkarte **Aufträge** überwachen.      ![Auftragsliste](media/vmm-to-azure-walkthrough-architecture/image1.png)![Drilldown für „Schutz aktivieren“](media/vmm-to-azure-walkthrough-architecture/image2.png)
