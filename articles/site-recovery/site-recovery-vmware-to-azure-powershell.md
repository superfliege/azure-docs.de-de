---
title: "Replizieren virtueller VMware-Computer in VMM-Clouds und Ausführen eines Failovers mithilfe von Azure Site Recovery-PowerShell | Microsoft-Dokumentation"
description: "Replizieren virtueller VMware-Computer in VMM-Clouds und Ausführen eines Failovers mithilfe von Azure Site Recovery-PowerShell"
...
---
# <a name="replicate-and-failover-vmware-virtual-machines-to-azure-using-azure-site-recovery-powershell"></a>Replizieren virtueller VMware-Computer in VMM-Clouds und Ausführen eines Failovers mithilfe von Azure Site Recovery-PowerShell
...
Vorbereitung:
- Stellen Sie sicher, dass Sie die [Architektur und die Komponenten des Szenarios](concepts-vmware-to-azure-architecture.md) verstehen.
...
* [Auswählen Ihrer Schutzziele](site-recovery-set-up-vmware-to-azure.md#choose-your-protection-goals)
* [Einrichten der Quellumgebung](site-recovery-set-up-vmware-to-azure.md#set-up-the-source-environment) 
...
## <a name="add-a-vcenter-server-and-discover-vmware-virtual-machines"></a>Hinzufügen eines vCenter-Servers und Durchführen einer Erkennung virtueller VMware-Computer
