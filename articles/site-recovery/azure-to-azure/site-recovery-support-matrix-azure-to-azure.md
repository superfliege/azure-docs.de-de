...
>[!NOTE]
>
> - Das Replizieren virtueller Azure-Computer zwischen Abonnements für Notfallwiederherstellungsszenarien wird nicht unterstützt.
> - Die abonnementübergreifende Migration virtueller Azure-Computer wird nicht unterstützt.
> - Die Migration virtueller Azure-Computer in derselben Region wird nicht unterstützt.
> - Die Migration virtueller Azure-Computer vom klassischen Bereitstellungsmodell zum Resource Manager-Bereitstellungsmodell wird nicht unterstützt.
...
- Schützen von Workloads durch die [Replikation virtueller Azure-Computer](azure-to-azure-quickstart.md)
