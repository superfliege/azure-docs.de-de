...
Wenn Ihre Azure-VM bei der Auswahl zur Aktivierung der Replikation nicht angezeigt wird, kann dies an einer veralteten Site Recovery-Konfiguration auf der Azure-VM liegen. Die veraltete Konfiguration kann in den folgenden Fällen auf einer Azure-VM verbleiben:
