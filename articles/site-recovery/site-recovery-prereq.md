...
Richten Sie einen lokalen Computer als Konfigurationsserver zum Orchestrieren der Kommunikation zwischen dem lokalen Standort und Azure ein. In der Tabelle unten finden Sie die System- und Softwareanforderungen für eine VM, die als Konfigurationsserver konfiguriert werden kann.
...
### <a name="vmware-vcenter-or-vsphere-host-prerequisites"></a>Anforderungen für den VMware vCenter- oder vSphere-Host
