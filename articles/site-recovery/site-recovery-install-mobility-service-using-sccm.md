...
Sie können jetzt für Ihre virtuellen Computer [Schutz aktivieren](https://docs.microsoft.com/azure/site-recovery/site-recovery-vmware-to-azure#step-6-replicate-applications).
