...
![On-premises Summary (Lokale Zusammenfassung)](media/site-recovery-hyper-v-deployment-planner-analyze-report/on-premises-summary-h2a.png)
...
![Erforderliche Azure-Speicherkonten](media/site-recovery-hyper-v-deployment-planner-analyze-report/required-storage-accounts-h2a.png)
...
![Details zur IR-Batchverarbeitung](media/site-recovery-hyper-v-deployment-planner-analyze-report/ir-batching-for-rpo-h2a.png)

![Zusätzliche Details zur IR-Batchverarbeitung](media/site-recovery-hyper-v-deployment-planner-analyze-report/ir-batching-for-rpo2-h2a.png)
