...
1. Klicken Sie im Menü des [Azure-Portals](https://portal.azure.com) auf **Ressource erstellen** > **Storage** > **Speicherkonto**.
...
1. Klicken Sie im [Azure-Portal](https://portal.azure.com) im linken Navigationsbereich auf **Alle Dienste**, suchen Sie nach dem Eintrag **Recovery Services-Tresore**, und wählen Sie ihn aus.
...
1. Klicken Sie im [Azure-Portal](https://portal.azure.com) auf **Ressource erstellen** > **Netzwerk** >
   **Virtuelles Netzwerk**.
