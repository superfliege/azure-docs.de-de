...
Führen Sie die Schritte im Artikel [Durchführen der Migration von virtuellen Azure IaaS-Computern zu Azure mit Azure Site Recovery](site-recovery-migrate-azure-to-azure.md) aus, um die Replikation einzurichten und die lokalen Hyper-V-, VMware- und physischen Workloads in Azure zu migrieren. 
