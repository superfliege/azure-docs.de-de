...
Informationen zu den Grenzwerten beim Erstellen von Sicherheitsregeln finden Sie unter [Einschränkungen bei Azure](../azure-subscription-service-limits.md?toc=%2fazure%2fvirtual-network%2ftoc.json#azure-resource-manager-virtual-networking-limits).
...
> [!NOTE]
> Mit Diensttags von Azure-Diensten werden die Adresspräfixe der spezifischen verwendeten Cloud angegeben. Regionale Diensttags werden in nationalen Clouds nicht unterstützt, sondern nur im globalen Format, z.B. Storage, Sql.
