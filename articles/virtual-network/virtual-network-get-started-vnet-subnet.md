...
1. Klicken Sie im [Azure-Portal](https://portal.azure.com) auf **Ressource erstellen** > **Compute** > **Windows Server 2016 Datacenter**.
...
3. Geben Sie auf dem daraufhin angezeigten Blatt **Grundlagen** die folgenden Werte ein (oder wählen Sie sie aus), und klicken Sie anschließend auf **OK**:
    ...
    |**Location**|*USA, Westen*|Hierbei muss es sich um den Standort handeln, den Sie in Schritt 5 des Abschnitts [Erstellen eines virtuellen Netzwerks mit zwei Subnetzen](#create-vnet) in diesem Artikel angegeben haben. Virtuelle Computer und die VNets, mit denen sie eine Verbindung herstellen, müssen sich am gleichen Standort befinden.|
...
3.  Geben Sie auf dem Blatt **Grundlagen** die folgenden Werte ein (oder wählen Sie sie aus), und klicken Sie anschließend auf **OK**:
    ...
    |**Ressourcengruppe**|**Vorhandene verwenden:** Wählen Sie *MyRG* aus.|Wir verwenden zwar die gleiche Ressourcengruppe wie für das VNet, die Ressourcen müssen sich jedoch nicht in der gleichen Ressourcengruppe befinden.|
    |**Location**|*USA, Westen*|Hierbei muss es sich um den Standort handeln, den Sie in Schritt 5 des Abschnitts [Erstellen eines virtuellen Netzwerks mit zwei Subnetzen](#create-vnet) in diesem Artikel angegeben haben.|
