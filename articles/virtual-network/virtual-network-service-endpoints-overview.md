...
- **[Azure Key Vault](../key-vault/key-vault-overview-vnet-service-endpoints.md)**: Allgemein verfügbar in allen Azure-Regionen mit öffentlichen Clouds.
