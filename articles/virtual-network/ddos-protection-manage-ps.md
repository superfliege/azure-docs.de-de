---
title: Verwalten von Azure DDoS Protection Standard mithilfe von Azure PowerShell | Microsoft-Dokumentation
description: Erfahren Sie, wie Sie Azure DDoS Protection Standard mithilfe von Azure PowerShell verwalten.
...
---
# <a name="manage-azure-ddos-protection-standard-using-azure-powershell"></a>Verwalten von Azure DDoS Protection Standard mithilfe von Azure PowerShell
...
Führen Sie das folgende Beispiel aus, um ein virtuelles Netzwerk mit aktiviertem DDoS Protection-Dienst zu erstellen:
...
> [!WARNING]
> Beim Auswählen einer Region wählen Sie eine unterstützte Region aus der Liste in der [Übersicht über Azure DDoS Protection Standard](ddos-protection-overview.md) aus.

## <a name="enable-ddos-protection-on-an-existing-virtual-network"></a>Aktivieren von DDoS Protection in einem vorhandenen virtuellen Netzwerk

Führen Sie das folgende Beispiel aus, um DDoS Protection in einem vorhandenen virtuellen Netzwerk zu aktivieren:
...
Führen Sie das folgende Beispiel aus, um DDoS Protection in einem virtuellen Netzwerk zu deaktivieren:
...
Durch die Nutzung der Warnungskonfiguration von Azure Monitor können Sie jede der verfügbaren DDoS Protection-Metriken zum Warnen auswählen, wenn während eines Angriffes eine aktive Entschärfung vorhanden ist.
...
## <a name="configure-logging-on-ddos-protection-metrics"></a>Konfigurieren der Protokollierung von DDoS Protection-Metriken
