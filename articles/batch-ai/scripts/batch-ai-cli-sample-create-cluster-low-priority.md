---
title: 'Azure CLI-Skriptbeispiel: Erstellen eines Batch AI-Clusters mit niedriger Priorität | Microsoft-Dokumentation'
description: 'Azure CLI-Skriptbeispiel: Erstellen und Verwalten eines Batch AI-Clusters mit Knoten mit niedriger Priorität (virtuelle Computer)'
services: batch-ai
documentationcenter: ''
author: dlepow
manager: jeconnoc
...
ms.locfileid: "55697848"
---
# <a name="cli-example-create-and-manage-a-batch-ai-cluster-of-low-priority-nodes"></a>CLI-Beispiel: Erstellen und Verwalten eines Batch AI-Clusters mit Knoten mit niedriger Priorität

[!INCLUDE [batch-ai-retiring](../../../includes/batch-ai-retiring.md)]

Dieses Skript zeigt einige der in der Azure CLI verfügbaren Befehle zum Erstellen und Verwalten eines Batch-AI-Clusters, der aus Knoten mit niedriger Priorität (virtuellen Computern) besteht.
