---
title: Trainieren eines CNTK-Modells mit Azure Batch AI – Python | Microsoft-Dokumentation
description: Trainieren eines neuronalen Microsoft Cognitive Toolkit (CNTK)-Netzwerks mit Azure Batch AI und dem Python SDK
services: batch-ai
...
Dieser Artikel zeigt Ihnen, wie Sie das Azure Python SDK verwenden können, um ein beispielhaftes Microsoft Cognitive Toolkit (CNTK)-Modell mit dem Batch AI-Dienst zu trainieren.
...
Weitere Informationen zur Verwendung von Batch AI mit verschiedenen Frameworks finden Sie in den [Trainingsrezepten](https://github.com/Azure/BatchAI).