...
1. Erstellen Sie eine Dateifreigabe namens `batchaiquickstart`.
...
2. Erstellen Sie in der Freigabe ein Verzeichnis namens `mnistcntksample`.
...
Konfigurieren Sie nach der Clustererstellung den Lernauftrag, und übermitteln Sie ihn:
