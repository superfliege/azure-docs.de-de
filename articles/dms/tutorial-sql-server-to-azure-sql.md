---
title: 'Tutorial: Verwenden von Azure Database Migration Service zur Offlinemigration von SQL Server zu Azure SQL-Datenbank | Microsoft-Dokumentation'
