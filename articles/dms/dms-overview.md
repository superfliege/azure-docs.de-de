...
![Regionale Verfügbarkeit von Azure Database Migration Service](media\overview\dms-regional-availability.png)

> [!NOTE]
> Onlinemigrationen und SKU-Empfehlungen sind zurzeit nur in den Regionen **USA, Mitte**, **USA, Osten 2** und **Europa, Westen** verfügbar.
