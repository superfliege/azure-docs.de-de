...
ms.locfileid: "53537398"
---
# <a name="azure-database-for-postgresql-use-net-c-to-connect-and-query-data"></a>Azure Database for PostgreSQL: Verwenden von .NET (C#) zum Herstellen einer Verbindung und Abfragen von Daten
