---
title: Tarife in Azure Database for PostgreSQL
description: In diesem Artikel werden die Tarife in Azure Database for PostgreSQL beschrieben.
services: postgresql
author: jan-eng
ms.author: janeng
manager: kfile
...
- Informieren Sie sich, wie Sie [im Portal einen PostgreSQL-Server erstellen](tutorial-design-database-using-azure-portal.md)
