...
Wenn Sie Ihre LUIS-App erstellt und getestet haben, können Sie sie veröffentlichen. Nach der Veröffentlichung der App zeigt die Seite der Veröffentlichung alle zugeordneten HTTP-[Endpunkte](luis-glossary.md#endpoint) an. Diese Endpunkte pro [Azure-Region](luis-reference-regions.md) und pro [Schlüssel](Manage-Keys.md) werden dann in einen beliebigen Client, Chatbot oder eine beliebige Back-End-Anwendung integriert. 
...
* einen LUIS-Abonnementschlüssel
* die LUIS-App-ID
...
* Weitere Informationen, wie Sie Schlüssel zu Ihrer LUIS-App hinzufügen und wie Schlüssel Azure-Regionen zugeordnet sind, finden Sie unter [Verwalten von Schlüsseln](./Manage-Keys.md).
