...
Um den Endpunkt aufzurufen, können Sie Ihr Endpunktschlüsselargument und Ihre Abfragezeichenfolge an den Endpunkt anfügen. 
...
Sie können die URL in einen Webbrowser einfügen und anstelle des Felds `{YOUR-SUBSCRIPTION-KEY}` Ihren Endpunktschlüssel einsetzen.
