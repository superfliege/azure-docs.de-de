...
Sie können Ihre App vor einer Veröffentlichung immer [testen](luis-interactive-test.md). 
...
Wenn in den **URL-Einstellungen für den Endpunkt** das Kontrollkästchen **Enable Bing spell checker** (Bing-Rechtschreibprüfung aktivieren) aktiviert ist, kann LUIS falsch geschriebene Wörter vor der Vorhersage korrigieren. Erstellen Sie einen **[Bing-Rechtschreibprüfungs-Schlüssel](https://azure.microsoft.com/try/cognitive-services/?api=spellcheck-api)**. Nach der Erstellung des Schlüssels werden zwei Abfragezeichenfolgenparameter zur Endpunkt-URL auf der Seite der Veröffentlichung hinzugefügt. 
