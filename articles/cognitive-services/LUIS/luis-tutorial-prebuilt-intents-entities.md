...
ms.locfileid: "36266378"
---
# <a name="use-prebuilt-intents-and-entities-to-handle-common-intents-and-data"></a>Verwenden von vordefinierten Absichten und Entitäten zum Verarbeiten allgemeiner Absichten und Daten
Fügen Sie der Personal-App aus dem Schnellstart vordefinierte Absichten und Entitäten hinzu, um schnell Absichtsvorhersagen und extrahierte Daten zu erhalten. 
...
Falls Sie nicht über die Personal-App aus dem Schnellstart zu [benutzerdefinierten Domänen](luis-quickstart-intents-only.md) verfügen, [importieren](create-new-app.md#import-new-app) Sie den JSON-Code auf der [LUIS][LUIS]-Website über das GitHub-Repository mit [LUIS-Beispielen](https://github.com/Microsoft/LUIS-Samples/blob/master/documentation-samples/quickstarts/custom-domain-intent-only-HumanResources.json) in eine neue App.
