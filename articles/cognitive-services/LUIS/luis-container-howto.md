...
Eine vollständige Beschreibung der verfügbaren Tags, wie das im vorherigen Befehl verwendete `latest`, finden Sie unter [LUIS](https://hub.docker.com/r/microsoft/azure-cognitive-services-luis/) im Docker-Hub.
