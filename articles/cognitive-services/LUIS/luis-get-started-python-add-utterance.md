---
title: 'Tutorial: Informationen zum Hinzufügen von Äußerungen zu einer LUIS-App mithilfe von Python | Microsoft-Dokumentation'
description: In diesem Tutorial erfahren Sie, wie Sie eine LUIS-App mithilfe von Python aufrufen.
...
ms.locfileid: "36264300"
---
# <a name="tutorial-add-utterances-to-app-using-python"></a>Tutorial: Hinzufügen von Äußerungen zu einer App mithilfe von Python
In diesem Tutorial schreiben Sie mithilfe der Erstellungs-APIs in Python ein Programm, um einer Absicht eine Äußerung hinzuzufügen.
...
* Erstellen einer neuen Projektdatei mit dem Namen `add-utterances-3-6.py` in VSCode

> [!NOTE] 
> Die vollständige `add-utterances-3-6.py`-Datei steht im [Github-Repository mit **LUIS-Beispielen**](https://github.com/Microsoft/LUIS-Samples/tree/master/documentation-samples/authoring-api-samples/python) zur Verfügung.


## <a name="write-the-python-code"></a>Schreiben des Python-Codes

1. Kopieren Sie die folgenden Codeausschnitte:
