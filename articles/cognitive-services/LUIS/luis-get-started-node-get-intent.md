...
ms.locfileid: "36263651"
---
# <a name="tutorial-call-a-luis-endpoint-using-nodejs"></a>Tutorial: Aufrufen eines LUIS-Endpunkts mithilfe von Node.js
...
## <a name="consume-a-luis-result-using-the-endpoint-api-with-nodejs"></a>Nutzen eines LUIS-Ergebnisses mithilfe der Endpunkt-API und Node.js
...
2. Legen Sie die Umgebungsvariable `LUIS_APP_ID` wie in den Codekommentaren beschrieben fest. 

3. Legen Sie die Umgebungsvariable `LUIS_SUBSCRIPTION_KEY` auf Ihren Cognitive Services-Abonnementschlüssel fest.

4. Führen Sie den Code aus. Es werden die gleichen Werte wie zuvor im Browserfenster angezeigt.
<!-- 
