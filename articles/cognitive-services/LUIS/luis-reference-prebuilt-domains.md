...
ms.locfileid: "37061963"
---
# <a name="prebuilt-domain-reference"></a>Referenz für vordefinierte Domänen
...
[Benutzerdefinierte Domänen](create-new-app.md) weisen im Gegensatz dazu anfänglich keine Absichten und Modelle auf. Sie können einem benutzerdefinierten Modell beliebige Absichten und Entitäten aus einer vordefinierten Domäne hinzufügen.
...
| ---------------- |-----------------------|:------:|
| Calendar | Die Kalenderdomäne stellt Absichten und Entitäten zum Hinzufügen, Löschen oder Bearbeiten von Terminen, Überprüfen der Verfügbarkeit von Teilnehmern und Suchen von Informationen über ein Kalenderereignis bereit.| en-US<br/> zh-CN |
...
| Communication | Senden von Nachrichten und Tätigen von Telefonanrufen.| en-US <br/> zh-CN |
| Entertainment  | Behandlung von Abfragen im Zusammenhang mit Musik, Videos und TV.| en-US |
| Events | Buchung von Tickets für Konzerte, Festivals, Sportveranstaltungen und Comedyaufführungen.| en-US |
| Fitness | Behandlung von Anforderungen, die sich auf das Nachverfolgen von Fitnessaktivitäten beziehen.| en-US |
| Gaming | Behandlung von Anforderungen im Zusammenhang mit einer Spielparty in einem Multiplayer-Spiel.| en-US |
...
| Music | Wiedergeben von Musik auf einem Musikabspielgerät.| en-US<br/> zh-CN |
| Note | Die Note-Domäne bietet Absichten und Entitäten im Zusammenhang mit dem Erstellen, Bearbeiten und Suchen von Notizen.| en-US<br/> zh-CN |
...
| Places  | Behandlung von Abfragen im Zusammenhang mit Orten wie Geschäften, Institutionen, Restaurants, öffentlichen Räumen und Adressen.| en-US<br/> zh-CN |
...
| Utilities  | Behandlung von Anforderungen, die in vielen Domänen häufig sind, wie etwa „Hilfe“, „Wiederholen“, „Von vorn beginnen“:| en-US |
...
| ---------------- |-----------------------|----|
| Add | Hinzufügen eines neuen einmaligen Elements zum Kalender| Mache einen Termin mit Lisa am Sonntag um 14:00 Uhr. <br/><br/>Ich möchte eine Besprechung planen.<br/><br/>Ich muss eine Besprechung einrichten.|
...
| Delete | Anforderung der Löschung eines Kalendereintrags| Storniere meinen Termin mit Helga. <br/><br/>Lösche meine Besprechung um 9 Uhr.<br/>|
| Edit | Anforderung zum Ändern einer vorhandenen Besprechung oder eines Kalendereintrags| Verschiebe meine Besprechung von 9 Uhr auf 10 Uhr.<br/><br/>Ich möchte meinen Zeitplan aktualisieren.<br/><br/>Plane meine Besprechung mit Lorenz neu.|
| Find | Meinen Wochenkalender anzeigen| Suche den Termin für die Nachuntersuchung beim Zahnarzt. <br/><br/>Zeige meinen Kalender an.<br/>|

### <a name="entities"></a>Entitäten
| Name der Entität | Beschreibung | Beispiele |
| ---------------- |-----------------------|----|
| Location | Ort des Kalenderelements, der Besprechung oder des Termins Adressen, Städte und Regionen sind gute Beispiele für Speicherorte.| Fitnesscenter Detmold <br/><br/>Pfannkuchenwelt<br/><br/>Garage|
| Subject | Der Titel einer Besprechung oder eines Termins| Zahnarzttermin <br/><br/>Mittagessen mit Jule<br/><br/>Arzttermin|
...
| Answer| Beantworten eines eingehenden Telefonanrufs|Antwort beantworten <br/><br/>Abheben|
...
| Ignore| Ignorieren eines eingehenden Anrufs|Nicht beantworten<br/>Anruf ignorieren|
...
| StartOver| Nochmals von vorn anfangen oder neue Sitzung starten|Von vorn beginnen<br/>Neue Sitzung<br/>Neu starten|
...
| Name der Entität | Beschreibung | Beispiele |
| ---------------- |-----------------------|----|
| AudioDeviceType | Typ des Audiogeräts (Lautsprecher, Headset, Mikrofon usw.).| Lautsprecher<br/>Freihändig<br/>Bluetooth|
| Category | Die Kategorie einer Nachricht oder E-Mail.| Wichtig<br/>Hohe Priorität|
...
| Line | Die Leitung, die der Benutzer verwenden möchte, um einen Anruf zu tätigen oder eine SMS/E-Mail zu senden.| Büroleitung<br/>D-Netz<br/>Skype|
...
| MessageType | Der Name eines Kontakts oder Nachrichtenempfängers| SMS<br/>E-Mail|
| OrderReference | Die Ordnungszahl oder relative Position in einer Liste, die ein abzurufendes Element angibt. Beispiel: „Letzte“ oder „vor Kurzem“ in „Welche Nachricht habe ich als letzte gesendet?“| Letzte<br/>Vor Kurzem|
...
| Name der Absicht | Beschreibung | Beispiele |
| ---------------- |-----------------------|----|
| Search| Suche nach Filmen, Musik, Apps, Spielen und Fernsehsendungen.|Suche im Store nach „Halo“.<br/>Suche nach „Avatar“.|
...
| Keyword| Ein allgemeines Stichwort für die Suche, das ein Attribut angibt, das in den spezifischeren Medienkategorien nicht vorkommt.|Soundtracks<br/>Moon River<br/>Elly Beinhorn|
| Language | Medieninhaltsbewertung, wie FSK 0 oder 18 für Filme.|Französisch<br/>Englisch<br/>Koreanisch|
...
| Role| Die Rolle, die eine Person bei der Erstellung des Mediums gespielt hat.|Singt<br/>Regie<br/>von|
| Title| Der Name eines Films, einer App, eines Spiels, einer Fernsehsendung oder eines Musiktitels.|Friends<br/>Minecraft|
...
| Name der Absicht | Beschreibung | Beispiele |
| ---------------- |-----------------------|----|
| Book| Kauf von Tickets für eine Veranstaltung.|Ich möchte eine Karte für die Symphonie an diesem Wochenende kaufen.|


### <a name="entities"></a>Entitäten
| Name der Entität | Beschreibung | Beispiele |
| ---------------- |-----------------------|----|
| Address | Ort oder Adresse der Veranstaltung. |Garmisch-Partenkirchen<br/>Südstr. 12 <br/> Düsseldorf |
...
| Name der Entität | Beschreibung | Beispiele |
| ---------------- |-----------------------|----|
| ActivityType | Der Typ der nachzuverfolgenden Aktivität. |Laufen<br/>Gehen<br/>Schwimmen<br/>Radfahren |
| Food | Ein Nahrungsmittel zur Nachverfolgung in einer Fitness-App. |Banane<br/>Lachs<br/>Eiweiß-Shake|
...
| Measurement| Ein Typ von Messungen von Zeit, Entfernung oder Gewicht für die Verwendung in einer Gesundheits- oder Fitness-App.|Kilometer<br/>Meilen<br/>Minuten<br/>Kilogramm|
| Number | Eine numerische Mengenangabe zur Verwendung in einer Gesundheits- oder Fitness-App.|19<br/>drei<br/>200<br/>ein|
...
| Name der Entität | Beschreibung | Beispiele |
| ---------------- |-----------------------|----|
| Contact| Der Name eines Kontakts für die Verwendung in einem Multiplayer-Spiel.|Helga<br/>Klaus|
...
| Name der Entität | Beschreibung | Beispiele |
| ---------------- |-----------------------|----|
| Device | Eine Art von Gerät, die ein- oder ausgeschaltet werden kann.|Kaffeemaschine<br/>Thermostat<br/>Leuchten|
| Operation | Der Status, der für das Gerät festgelegt werden soll.|sperren<br/>öffnen<br/>ein<br/>aus|
| Room | Der Ort oder Raum, in dem sich das Gerät befindet.|Wohnzimmer<br/>Schlafzimmer<br/>Küche|
...
| Name der Absicht | Beschreibung | Beispiele |
| ---------------- |-----------------------|----|
| Book | Kauf von Filmtickets.|Buche mir zwei Karten für Captain Omar und die zwei Musketiere<br/>Ich möchte ein Ticket für den Film Morgen kaufen<br/>Ich möchte ein Ticket für Captain Omar Teil 2 am nächsten Mittwoch|
...
| Name der Entität | Beschreibung | Beispiele |
| ---------------- |-----------------------|----|
| Address | Die Adresse eines Kinos.|Garmisch-Partenkirchen<br/>Südstr. 12<br/>Düsseldorf|
...
| PlaceType | Die Art von Ort, an dem ein Film gezeigt wird.|Kino<br/>Multiplex<br/>IMAX-Kino|
...
| Resume | Fortsetzen der Musikwiedergabe.|Titel fortsetzen<br/>Musik wieder starten<br/>Pause Ende|
...
| Stop | Beenden einer Aktion für die Musikwiedergabe. |Wiedergabe dieses Albums beenden.|
...
| Delete | Löschen einer gesamten Notiz. |Meine Urlaubsliste löschen <br/>Lösche meine Einkaufsliste|
...
| ShowNext | Anzeigen des nächsten Elements in einer Notizenliste|Nächstes anzeigen.<br/>Nächste Seite<br/>Nächster|
...
| DataType | Der Typ der Datei oder des Dokuments, normalerweise bestimmten Softwareprogrammen zugeordnet.|Folien<br/>Kalkulationstabelle<br/>Arbeitsblatt|
| Text | Der Text einer Notiz oder Erinnerung.|Dehnen vor dem Lauf<br/>Morgen Langlauf|
| Title | Der Titel einer Notiz.|Lebensmittel<br/>Anzurufende Personen<br/>Aufgabe|
...
|Help| Anfordern von Hilfe|Hilf mir bitte<br/>Hallo<br/>Wie kannst du mir helfen?<br/>Ich brauche Hilfe| 
...
|Restart|Neustart des Geräts|Bitte neu starten|
...
| DeviceType | Der Typ des Geräts. |Telefon<br/>Kindle<br/>Laptop|
...
|Exit|Aktion zum Beenden einer Aufgabe, die sich auf einen Ort bezieht.|Bitte Ruhe<br/>Gib mir keine Wegbeschreibungen mehr|
...
|ShowPrevious|Anzeigen des vorhergehenden Elements in einer Reihe|Vorheriges anzeigen<br/>Vorheriges<br/>Zum Vorhergehenden wechseln|
...
| Name der Entität | Beschreibung | Beispiele |
| ---------------- |-----------------------|----|
| AbsoluteLocation | Der Ort oder die Adresse eines Orts.|Garmisch-Partenkirchen<br/>Südstr. 12<br/>Düsseldorf|
...
| DestinationAddress| Ein Zielort oder eine Adresse.|Garmisch-Partenkirchen<br/>Südstr. 12<br/>Düsseldorf|
...
| DestinationPlaceType | Der Typ eines Ziels, der ein ortsansässiges Unternehmen, ein Restaurant, eine öffentliche Sehenswürdigkeit oder eine Institution darstellt. |Restaurant<br/>Oper<br/>Kino|
...
| OpenStatus | Anzeige, ob ein Ort offen oder geschlossen ist.|Offen<br/>Geschlossen<br/>Öffnungszeiten|
| PlaceName | Der Name eines Orts.|Käsekuchenfabrik|
| PlaceType | Der Typ eines Orts.|Cafe<br/>Kino<br/>Bibliothek|
| PreferredRoute | Der vom Benutzer angegebene bevorzugte Weg. | B9 <br/>B1 <br/>B37|
...
| TransportationType | Die Transportart|Bus<br/>Zug<br/>Fahren|
...
| Create| Neuen Bericht erstellen|Einen Bericht erstellen<br/>Erinnere mich daran, Milch zu kaufen<br/>Ich möchte daran erinnert werden, Rebekka anzurufen, wenn ich nach Hause komme|
| Delete | Erinnerung löschen|Lösche meine Bilderinnerung<br/>Lösche diese Erinnerung|
| Find | Suchen einer Erinnerung|Habe ich eine Erinnerung zu meinem Jubiläum festgelegt?<br/>Kannst du nachsehen, ob ich eine Erinnerung für Christines Geburtstag eingerichtet habe?|
...
| Name der Entität | Beschreibung | Beispiele |
| ---------------- |-----------------------|----|
| Adresse| Ein Veranstaltungsort oder die Adresse für eine Reservierung|Garmisch-Partenkirchen<br/>Südstr. 12<br/>Düsseldorf|
...
| Name der Absicht | Beschreibung | Beispiele |
| ---------------- |-----------------------|----|
| Book | Rufen eines Taxis. |Ruf mir ein Taxi<br/>Finde ein Taxi<br/>Buche mir einen Funkmietwagen|
| Cancel | Stornieren einer Aktion mit Bezug auf das Buchen eines Taxis|Storniere mein Taxi<br/>Bestelle den Funkmietwagen ab|
| Track | Nachverfolgen einer Taxiroute|Wie lange muss ich noch auf mein Taxi warten?<br/>Wo bleibt mein Funkmietwagen?|

### <a name="entities"></a>Entitäten
| Name der Entität | Beschreibung | Beispiele |
| ---------------- |-----------------------|----|
| Adresse| Die der Buchung eines Taxis zugeordnete Adresse |Garmisch-Partenkirchen<br/>Südstr. 12<br/>Düsseldorf|
| DestinationAddress| Ein Zielort oder eine Adresse. |Garmisch-Partenkirchen<br/>Südstr. 12<br/>Düsseldorf|
...
| PlaceType| Die Art des Orts in einer Buchungsanforderung für ein Taxi.|Restaurant<br/>Oper<br/>Kino|
| TransportationCompany | Der Name eines Transportanbieters.|DB<br/>NordWestBahn<br/>Flixbus|
| TransportationType | Die Transportart|Bus<br/>Zug<br/>Fahren|
...
| Name der Absicht | Beschreibung | Beispiele |
| ---------------- |-----------------------|----|
| Cancel | Abbrechen einer Aktion|Storniere die Nachricht<br/>Ich möchte die E-Mail nicht mehr senden|
...
| Help | Anforderung von Hilfe|Hilfe, bitte<br/>Hilfe öffnen<br/>Hilfe|
...
| Stop | Beenden einer Aktion| Bitte sag das nicht<br/>Halt den Mund<br/>Hör bitte auf|
...
| Name der Entität | Beschreibung | Beispiele |
| ---------------- |-----------------------|----|
| Speicherort| Der absolute Standort für eine Wetteranfrage|Düsseldorf<br/>Paris<br/>Garmisch-Partenkirchen|
