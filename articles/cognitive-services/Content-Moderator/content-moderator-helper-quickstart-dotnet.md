---
title: 'Schnellstart: Erstellen eines Moderationsclients für .NET – Content Moderator'
...
Informationen zum Abrufen des Schlüssels finden Sie unter [Schnellstart: Erste Schritte mit Content Moderator](quick-start.md).
