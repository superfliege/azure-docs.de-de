...
### <a name="how-many-review-teams-can-a-user-join-can-the-user-switch-between-teams"></a>Wie vielen Überprüfungsteams kann ein Benutzen beitreten? Kann ein Benutzer zwischen den Teams wechseln?

Ein Benutzer kann jeweils nur einem Team beitreten.

### <a name="what-kind-of-team-member-roles-are-supported-by-the-review-tool-how-are-they-different"></a>Welche Teammitgliederrollen werden vom Prüfungstool unterstützt? Inwiefern unterscheiden sie sich?

Die Prüfungstools ermöglichen aktuell die Zuweisung von Administrator- und Prüferrollen. Die Administratoren können andere Benutzer einladen und auf die Konfigurationseinstellungen zugreifen, Prüfer hingegen können nur die Moderationsergebnisse überprüfen und Inhalte markieren oder die Markierung entfernen.
...
Es können maximal fünf Teammitglieder (einschließlich des Administrators) zu einem Team hinzugefügt werden.
