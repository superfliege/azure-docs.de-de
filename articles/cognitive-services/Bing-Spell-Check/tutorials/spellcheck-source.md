...
ms.locfileid: "55186517"
---
# <a name="tutorial-single-page-web-app"></a>Tutorial: Einzelseiten-Web-App

Hier finden Sie den vollständigen Quellcode, der im [Tutorial zu Einzelseiten-Apps](spellcheck.md) für die Bing-Rechtschreibprüfungs-API vorgestellt wird. Kopieren Sie zum Ausführen der App den Quellcode in einen Text-Editor, und speichern Sie die Datei als `spellcheck.html`. Öffnen Sie dann die gespeicherte Datei in Ihrem Webbrowser.
