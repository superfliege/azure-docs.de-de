...
1. Wählen Sie das NuGet-Paket aus, und installieren Sie es. Unter Umständen müssen Sie vorerst ein Downgrade auf v2.8.0 ausführen (Stand 18.03.2019), bis der Beispielcode mit v3.0.0 aktualisiert wurde.
