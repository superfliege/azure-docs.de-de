---
title: Übersicht über die Textanalyse-API – Azure Cognitive Services | Microsoft-Dokumentation
description: Textanalyse-API in Azure Cognitive Services für Standpunktanalyse, Schlüsselbegriffserkennung und Sprachenerkennung.
...
ms.locfileid: "35377818"
---
# <a name="what-is-text-analytics-api-version-20"></a>Worum handelt es sich bei Version 2.0 der Textanalyse-API?
...
|[**Entitätsverknüpfung**](how-tos/text-analytics-how-to-entity-linking.md) | Identifizieren Sie bekannte Entitäten in Ihrem Text, und fügen Sie Links zu weiteren Informationen im Internet hinzu. Die Entitätsverknüpfung erkennt und unterscheidet, wenn ein Begriff als eine von mehreren voneinander unterscheidbaren Entitäten, Verben oder anderen Wortformen verwendet wird. | [REST](https://westus.dev.cognitive.microsoft.com/docs/services/TextAnalytics.V2.0/operations/5ac4251d5b4ccd1554da7634) | 
