---
title: 'Schnellstart: Erkennen von Gesichtern in einem Bild – Gesichtserkennungs-API, JavaScript'
...
ms.locfileid: "49340187"
---
# <a name="quickstart-detect-faces-in-an-image-using-javascript"></a>Schnellstart: Erkennen von Gesichtern in einem Bild mit JavaScript
...
3. Ändern Sie den Wert von `uriBase`, um ggf. die Region zu verwenden, in der Sie Ihre Abonnementschlüssel erhalten haben.
4. Ziehen Sie die Datei per Drag & Drop in Ihren Browser.
5. Klicken Sie auf die Schaltfläche `Analyze faces`.
