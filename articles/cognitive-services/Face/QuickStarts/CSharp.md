...
Fügen Sie der **Program**-Klasse die folgende Methode hinzu. Dadurch wird die JSON-Antwort formatiert, sodass sie leichter lesbar ist. Ihre App schreibt diese Zeichenfolgendaten in die Konsole.
