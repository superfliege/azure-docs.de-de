---
title: Gesichtsidentifikation in Bildern mit der Gesichtserkennungs-API | Microsoft-Dokumentation
titleSuffix: Microsoft Cognitive Services
description: Verwenden Sie die Gesichtserkennungs-API in Cognitive Services, um Gesichter in Bildern zu identifizieren.
...
ms.locfileid: "35378082"
---
# <a name="how-to-identify-faces-in-images"></a>Gesichtsidentifikation in Bildern
...
## <a name="step1"></a> Schritt 1: Autorisieren des API-Aufrufs
...
Alternativ dazu können Sie den Abonnementschlüssel auch im HTTP-Anforderungsheader angeben: **ocp-apim-subscription-key: &lt;Subscription Key&gt;**. Bei Verwendung einer Clientbibliothek wird der Abonnementschlüssel vom Konstruktor der Klasse „FaceServiceClient“ übergeben. Beispiel: 
...
## <a name="step2"></a> Schritt 2: Erstellen der PersonGroup
...
### <a name="step2-1"></a> 2.1 Definieren von Personen für die PersonGroup
...
## <a name="step3"></a> Schritt 3: Trainieren der PersonGroup
...
## <a name="step4"></a> Schritt 4: Identifizieren eines Gesichts über eine definierte PersonGroup
...
## <a name="step5"></a> Schritt 5: Anforderung für die Verarbeitung in großem Umfang
