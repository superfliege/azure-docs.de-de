...
Fügen Sie der Klasse `BreakSentence` die folgenden Zeilen hinzu. Zusätzlich zu `api-version` können Sie die Eingabesprache definieren. In diesem Beispiel ist die Eingabesprache Englisch.
