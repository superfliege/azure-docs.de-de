...
ms.locfileid: "49648478"
---
# <a name="quickstart-translate-text-with-the-translator-text-rest-api-nodejs"></a>Schnellstart: Übersetzen von Text mit der Textübersetzungs-REST-API (Node.js)
