---
title: 'Schnellstart: Ermitteln der Textsprache, PHP – Textübersetzungs-API'
...
ms.locfileid: "57535976"
---
# <a name="quickstart-identify-language-from-text-with-the-translator-text-rest-api-php"></a>Schnellstart: Ermitteln der Textsprache mit der Textübersetzungs-REST-API (PHP)
