---
title: 'Textübersetzung: Ermitteln der Satzlänge mit Python | Microsoft-Dokumentation'
titleSuffix: Microsoft Cognitive Services
description: In dieser Schnellstartanleitung ermitteln Sie die Länge von Sätzen im Text. Dazu verwenden Sie die Textübersetzungs-API mit Python in Cognitive Services.
...
ms.locfileid: "43769653"
---
# <a name="quickstart-get-sentence-lengths-with-python"></a>Schnellstart: Abrufen von Satzlängen mit Python
