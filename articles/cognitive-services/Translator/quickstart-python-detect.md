---
title: 'Schnellstart: Identifizieren der Textsprache, Python: Textübersetzungs-API'
titleSuffix: Azure Cognitive Services
description: In diesem Schnellstart bestimmen Sie die Sprache des Quelltexts. Dazu verwenden Sie die Textübersetzungs-API mit Python.
...
ms.locfileid: "49644907"
---
# <a name="quickstart-identify-language-from-text-with-the-translator-text-rest-api-python"></a>Schnellstart: Identifizieren der Textsprache mit der Textübersetzungs-REST-API (Python)
