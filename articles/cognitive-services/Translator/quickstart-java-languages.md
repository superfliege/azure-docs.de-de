...
ms.locfileid: "52889003"
---
# <a name="quickstart-use-the-translator-text-api-to-get-a-list-of-supported-languages-using-java"></a>Schnellstart: Verwenden der Textübersetzungs-API zum Abrufen einer Liste mit unterstützten Sprachen per Java
...
Als Nächstes erstellen Sie die GET-Anforderung.
