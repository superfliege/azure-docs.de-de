...
1. Wählen Sie im Abschnitt **Ressourcenverwaltung** die Option **Einstellungen** aus.
    ...
    ![Melden Sie sich beim Azure-Portal an. Suchen Sie Ihre Personalisierungsressource. Wählen Sie im Abschnitt „Ressourcenverwaltung“ die Option „Einstellungen“ aus.](media/settings/how-to-configure.png)

### <a name="reward-settings-for-the-feedback-loop"></a>Belohnungseinstellungen für die Feedbackschleife
