---
title: 'Schnellstart: Ausführen einer Bildersuche mit Java – Bing-Bildersuche-API'
titleSuffix: Azure Cognitive Services
description: Verwenden Sie diesen Schnellstart, um die Bing-Bildersuche-API zum ersten Mal aufzurufen und eine JSON-Antwort zu erhalten. Diese einfache Java-Anwendung sendet eine Suchabfrage an die API und zeigt die Rohdatenergebnisse an.
...
ms.locfileid: "46295341"
---
# <a name="quickstart-send-search-queries-using-the-bing-image-search-rest-api-and-java"></a>Schnellstart: Senden von Suchabfragen mithilfe der Bing-Bildersuche-REST-API und Java

Verwenden Sie diesen Schnellstart, um die Bing-Bildersuche-API zum ersten Mal aufzurufen und eine JSON-Antwort zu erhalten. Diese einfache Java-Anwendung sendet eine Suchabfrage an die API und zeigt die Rohdatenergebnisse an.
...
Der Quellcode dieses Beispiels ist auf [GitHub](https://github.com/Azure-Samples/cognitive-services-REST-api-samples/blob/master/java/Search/BingImageSearchv7Quickstart.java) mit zusätzlichen Fehlerbehandlungen und Codehinweisen verfügbar.

## <a name="prerequisites"></a>Voraussetzungen

* Das [Java Development Kit (JDK) 7 oder 8](http://www.oracle.com/technetwork/java/javase/downloads/jdk8-downloads-2133151.html)
...
3. Schließen Sie den Stream, und analysieren Sie die Antwort. Rufen Sie die Gesamtzahl der zurückgegebenen Suchergebnisse und die Miniaturansicht-URL für das erste Bildergebnis ab.
    ...
    ```
4. Denken Sie daran, Ihren Abonnementschlüssel aus dem Anwendungscode zu entfernen.
