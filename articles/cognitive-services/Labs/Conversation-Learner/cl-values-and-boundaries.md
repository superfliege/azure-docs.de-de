...
Max. Anzahl benutzerdefinierter (nicht programmgesteuerter) Entitäten pro Anwendung | Weitere Informationen im Artikel [LUIS-Grenzen](https://docs.microsoft.com/en-us/azure/cognitive-services/luis/luis-boundaries); in der Praxis kann die tatsächliche Anzahl etwas kleiner ausfallen
Max. Anzahl vorgefertigter Entitäten pro Anwendung | Weitere Informationen im Artikel [LUIS-Grenzen](https://docs.microsoft.com/en-us/azure/cognitive-services/luis/luis-boundaries)
Max. Anzahl von Entitäten (insgesamt) pro Anwendung | 100
Max. Anzahl von Aktionen pro Anwendung | 32
Max. Anzahl von Trainingsdialogen pro Anwendung | 1000
Max. Anzahl von Benutzeraktionen pro Trainingsdialog | 100
Max. Anzahl der protokollierten Dialoge pro Anwendung | Kein voreingestelltes Limit, allerdings werden protokollierte Dialoge nur für einen bestimmten Zeitraum beibehalten, bevor Sie verworfen werden.  Außerdem zeigt die Benutzeroberfläche des Unterhaltungslernmoduls 100 protokollierte Dialoge gleichzeitig an. 
Max. Anzahl von Anwendungen pro Benutzer | Kein voreingestelltes Limit
