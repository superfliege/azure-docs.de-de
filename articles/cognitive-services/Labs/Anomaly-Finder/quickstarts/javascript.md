---
title: Verwenden der API für die Suche nach Anomalien mit Javascript – Microsoft Cognitive Services | Microsoft-Dokumentation
description: Informationen und Codebeispiele für den schnellen Einstieg in die Verwendung der API für die Suche nach Anomalien mit Javascript in Cognitive Services
...
In diesem Artikel finden Sie Informationen und Codebeispiele, die Ihnen bei der Nutzung der API für die Anomalieerkennung mit Javascript helfen, damit Sie Ergebnisse der Anomalieerkennung für Zeitreihendaten erfassen können.

## <a name="prerequisites"></a>Voraussetzungen

[!INCLUDE [GetSubscriptionKey](../includes/get-subscription-key.md)]

## <a name="getting-anomaly-points-with-anomaly-detection-api-using-javascript"></a>Abrufen von Anomaliepunkten mithilfe der API für die Anomalieerkennung mit Javascript

[!INCLUDE [DataContract](../includes/datacontract.md)]

### <a name="example-of-time-series-data"></a>Beispiel für Zeitreihendaten

So sieht ein Beispiel für die Datenpunkte der Zeitreihen aus: [!INCLUDE [Request](../includes/request.md)]

### <a name="analyze-data-and-get-anomaly-points-javascript-example"></a>Beispiel zum Analysieren von Daten und Abrufen von Anomaliepunkten mit Javascript

Sie können das Beispiel folgendermaßen anwenden:

1. Erstellen Sie eine neue HTML-Datei.
2. Ersetzen Sie die HTML-Datei durch den folgenden Code.
3. Ersetzen Sie den Wert `[YOUR_SUBSCRIPTION_KEY]` durch Ihren gültigen Abonnementschlüssel.
4. Ersetzen Sie die Daten in requestTextArea durch Ihre Datenpunkte.
5. Öffnen Sie die HTML-Datei in einem Webbrowser, und klicken Sie auf die `Anomaly Detection`-Schaltfläche.
