---
title: Dokumentation zur Speech-Dienst-SDK-API – Tutorials, API-Referenz
titleSuffix: Azure Cognitive Services
description: Erfahren Sie, wie Sie Apps mit dem Speech-Dienst-SDK erstellen.
