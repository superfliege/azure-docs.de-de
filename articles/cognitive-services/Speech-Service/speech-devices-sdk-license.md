...
## <a name="microsoft-software-license-termsbrmicrosoft-cognitive-services-speech-devices-sdkbrpurpose--for-use-only-with-azure-cognitive-speech-services"></a>MICROSOFT-SOFTWARE-LIZENZBEDINGUNGEN<br>MICROSOFT COGNITIVE SERVICES SPEECH DEVICES SDK<br>Zweck: Nur zur Verwendung mit Azure Cognitive Services-Sprachdiensten
...
1. FÜR DIE VERBREITUNG ZUGELASSENER CODE. Die Software kann Codes enthalten, die Sie in den von Ihnen entwickelten Anwendungen verbreiten (d.h. für Dritte zur Verfügung stellen) dürfen, wie in diesem Abschnitt beschrieben wird.
    ...
    i. REDIST.TXT-Dateien. Sie dürfen den Code, der ggf. auf der REDIST-Liste in der Software oder unter https://aka.ms/sdsdk-redist aufgeführt ist, in Objektcodeform kopieren und verbreiten;
...
Hinweis: Da diese Software in Kanada vertrieben wird, sind einige Klauseln in dieser Vereinbarung nachfolgend in Französisch aufgeführt.
