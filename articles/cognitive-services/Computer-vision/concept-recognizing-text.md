...
Die Texterkennung spart Zeit und Aufwand. Sie können produktiver sein, indem Sie ein Bild von einem Text aufnehmen, anstatt ihn zu transkribieren. Dank der Texterkennung können Notizen digitalisiert werden. Diese Digitalisierung ermöglicht das Implementieren schneller und einfacher Suchen. Außerdem wird die Papiermenge reduziert.
...
- Die Größe des Bilds muss zwischen 40 x 40 und 3200 x 3200 Pixel liegen.
...
Erfahren Sie mehr über Konzepte zum [Extrahieren von Text mit OCR](concept-extracting-text-ocr.md).