---
title: Python-Schnellstart für handschriftlichen Text mit der Maschinelles Sehen-API | Microsoft-Dokumentation
titleSuffix: Microsoft Cognitive Services
description: In dieser Schnellstartanleitung extrahieren Sie handschriftlichen Text aus einem Bild, indem Sie die Maschinelles Sehen-API mit Python in Cognitive Services verwenden.
...
ms.locfileid: "43770124"
---
# <a name="quickstart-extract-handwritten-text---rest-python"></a>Schnellstart: Extrahieren von handschriftlichem Text – REST, Python
...
## <a name="extract-handwritten-text"></a>Extrahieren von handschriftlichem Text
