---
title: PHP-Schnellstart für OCR mit der Maschinelles Sehen-API | Microsoft-Dokumentation
titleSuffix: Microsoft Cognitive Services
description: In dieser Schnellstartanleitung extrahieren Sie gedruckten Text aus einem Bild, indem Sie die Maschinelles Sehen-API mit PHP in Cognitive Services verwenden.
...
ms.locfileid: "43770135"
---
# <a name="quickstart-extract-printed-text-ocr---rest-php"></a>Schnellstart: Extrahieren von gedrucktem Text (OCR) – REST, PHP
