...
description: In dieser Schnellstartanleitung analysieren Sie ein Bild mithilfe der Maschinelles Sehen-API mit JavaScript in Cognitive Services.
...
ms.locfileid: "43770271"
---
# <a name="quickstart-analyze-a-remote-image---rest-javascript"></a>Schnellstart: Analysieren eines Remotebilds – REST und JavaScript

In dieser Schnellstartanleitung analysieren Sie ein Bild mithilfe der Maschinelles Sehen-API.
...
1. Kopieren Sie das folgende Skript, und speichern Sie es in einer Datei wie `analyze.html`.
...
1. Klicken Sie auf die Schaltfläche `Analyze image`.

In diesem Beispiel wird jQuery 1.9.0 verwendet. Ein Beispiel, in dem JavaScript ohne jQuery verwendet wird, finden Sie unter [Intelligently generate a thumbnail](javascript-thumb.md) (Intelligentes Generieren einer Miniaturansicht).
