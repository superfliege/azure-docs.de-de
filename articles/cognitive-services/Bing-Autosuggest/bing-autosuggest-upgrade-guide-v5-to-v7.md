---
title: Upgrade der Bing-Vorschlagssuche-API von v5 auf v7 | Microsoft-Dokumentation
...
ms.locfileid: "35376954"
---
# <a name="autosuggest-api-upgrade-guide"></a>Upgradeleitfaden für die Vorschlagssuche-API

In diesem Upgradeleitfaden sind die Änderungen zwischen Version 5 und Version 7 der Bing-Vorschlagssuche-API angegeben. Anhand dieses Upgradeleitfadens können Sie die Teile Ihrer Anwendung ermitteln, die Sie zur Verwendung von Version 7 aktualisieren müssen.
...
- Alle Anforderungen mit Fehler sollte nun ein `ErrorResponse`-Objekt im Antworttext enthalten.

- Folgende Felder wurden zum `Error`-Objekt hinzugefügt:  
  - `subCode`&mdash;Teilt den Fehlercode nach Möglichkeit in diskrete Buckets
  - `moreDetails`&mdash;Zusätzliche Informationen über den Fehler, der im `message`-Feld beschrieben ist

- Die v5-Fehlercodes mit folgenden möglichen `code`- und `subCode`-Werten wurden ersetzt.
...
|Version 5-Code|Version 7-Code.Untercode
|-|-
