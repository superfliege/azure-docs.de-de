---
title: Erstellen von ausführenden Azure Automation-Konten
...
* Sie erstellen ein Automation-Konto, aber kein ausführendes Konto.
...
* Ihr AD-Benutzerkonto muss zu einer Rolle mit Berechtigungen hinzugefügt werden, die der Rolle „Mitwirkender“ für Microsoft.Automation-Ressourcen entspricht. Dies wird im Artikel [Rollenbasierte Zugriffssteuerung in Azure Automation](automation-role-based-access-control.md#contributor) erläutert.  
...
![Abonnementmitwirkende](media/automation-create-runas-account/automation-account-remove-subscription.png)
