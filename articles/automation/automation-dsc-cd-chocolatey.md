...
Geben Sie an einer authentifizierten (Connect-AzureRmAccount) PowerShell-Befehlszeile Folgendes ein: (Die Einrichtung des Pull-Servers kann einige Minuten dauern.)
