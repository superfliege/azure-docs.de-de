...
![Senden von Transaktionen an einen verteilten Ledger](media/blockchain-workbench-integration-patterns/send-transactions-ledger.png)
...
![Abfragen von Metadaten](media/blockchain-workbench-integration-patterns/querying-metadata.png)
...
![Unidirektionale Ereignisübermittlung](media/blockchain-workbench-integration-patterns/one-way-event-delivery.png)
...
![Direkte Übermittlung](media/blockchain-workbench-integration-patterns/direct-delivery.png)
...
![Unbekanntes Nachrichtenformat](media/blockchain-workbench-integration-patterns/unknown-message-format.png)
...
![Übergabe der Steuerung an den externen Prozess](media/blockchain-workbench-integration-patterns/transition-external-process.png)
...
![IoT-Nachrichten](media/blockchain-workbench-integration-patterns/iot.png)
...
![Datenintegration](media/blockchain-workbench-integration-patterns/data-integration.png)
