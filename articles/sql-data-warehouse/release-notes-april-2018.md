...
ms.locfileid: "34738952"
---
# <a name="whats-new-in-azure-sql-data-warehouse-april-2018"></a>Neuigkeiten zu Azure SQL Data Warehouse (April 2018)
...
## <a name="behavior-changes"></a>Behavior Changes

### <a name="dbcc-commands-do-not-consume-concurrency-slots"></a>Nichtbelegung von Parallelitätsslots durch Datenbankkonsolenbefehle
...
### <a name="updated-error-message-for-excessive-literals"></a>Aktualisierte Fehlermeldung bei übermäßigen Literalen
...
### <a name="removed-the-syspdwdatabasemappings-view"></a>Entfernen der Ansicht SYS.PDW_DATABASE_MAPPINGS
