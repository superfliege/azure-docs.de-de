...
Sie können Daten an jeder beliebigen Stelle in einem Datenfluss schreiben. Diese Schreibvorgänge werden dem Ergebnisdatenfluss als Schritte hinzugefügt und jedes Mal beim Ausführen des Datenflusses ausgeführt. Daten werden in mehrere Partitionsdateien geschrieben, um parallele Schreibvorgänge zuzulassen.
...
In diesem Abschnitt sehen Sie anhand eines Beispiels, wie Sie mit der Funktion `write_to_csv` Schreibvorgänge mit einer durch Trennzeichen getrennten Datei ausführen können.
...
In der vorhergehenden Ausgabe ist zu sehen, dass mehrere Fehler in den numerischen Spalten auftreten, weil Zahlen nicht korrekt analysiert wurden. Beim Schreiben in eine CSV-Datei werden diese Nullwerte standardmäßig durch die Zeichenfolge „ERROR“ ersetzt. 

Sie können Parameter als Teil Ihres Schreibaufrufs hinzufügen und eine Zeichenfolge angeben, die zur Darstellung von Nullwerten verwendet werden soll. Beispiel: 
...
Als Nächstes können Sie den Datenfluss ausführen, um den Schreibvorgang zu starten.
