...
+ **Benutzerforum**: Hier können Sie Fragen stellen, Fragen beantworten und sich mit anderen Benutzern über das [Supportforum zu den Azure Machine Learning-Diensten auf der MSDN-Website](https://aka.ms/aml-forum-service) austauschen.
...
+ **Teilen Sie Produktvorschläge** und Funktionsanfragen über unseren [Azure Machine Learning-Feedbackkanal](https://feedback.azure.com/forums/257792-machine-learning). Sie können hierauf auch jeweils über den Link am Ende jedes Artikels zugreifen. 
