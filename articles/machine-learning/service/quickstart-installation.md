...
Die Azure Machine Learning-Befehlszeilenschnittstelle (CLI) wird ebenfalls installiert. Die CLI-Schnittstelle ermöglicht den Zugriff auf und die Interaktion mit Ihren Azure Machine Learning-Diensten mithilfe der `az`-Befehle, um alle erforderlichen Aufgaben für einen vollständigen Data Science-Workflow durchzuführen. [Weitere Informationen.](../desktop-workbench/tutorial-iris-azure-cli.md)
