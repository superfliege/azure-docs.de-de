...
Ein Tutorial für das Erstellen eines TDSP-Projekts in Azure Machine Learning finden Sie unter [Tutorial für den Team Data Science-Prozess: Klassifizieren von Einkommen in Azure Machine Learning Workbench anhand von UCI-Daten](../preview/scenario-tdsp-classifying-us-incomes.md). 
...
Ein Beispiel, das ein in TDSP instanziiertes Projekt in Azure Machine Learning verwendet, finden Sie unter [Erkennung von biomedizinischen Entitäten mithilfe von Natural Language Processing mit Deep Learning](../preview/scenario-tdsp-biomedical-recognition.md).
