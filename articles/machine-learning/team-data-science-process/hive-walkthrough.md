...
1. [Erstellen eines Speicherkontos](../../storage/common/storage-create-storage-account.md): Mit diesem Speicherkonto werden Daten in Azure Blob Storage gespeichert. Die in HDInsight-Clustern verwendeten Daten werden ebenfalls hier gespeichert.
