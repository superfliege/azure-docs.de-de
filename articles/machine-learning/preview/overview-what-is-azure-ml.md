...
Weitere Informationen finden Sie unter [Configuring Azure Machine Learning Experimentation Service](experimentation-service-configuration.md) (Konfigurieren des Azure Machine Learning-Experimentieren-Diensts).
...
Neben Azure Machine Learning gibt es in Azure eine Vielzahl von Optionen zum Erstellen, Bereitstellen und Verwalten von Machine Learning-Modellen. [Weitere Informationen dazu finden sie hier.](overview-more-machine-learning.md)
