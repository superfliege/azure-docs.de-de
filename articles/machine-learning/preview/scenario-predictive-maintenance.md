...
* Eine installierte Kopie von [Azure Machine Learning Workbench](./overview-what-is-azure-ml.md). Gehen Sie zum Installieren des Programms und zum Erstellen eines Arbeitsbereichs nach der [Schnellstartanleitung für die Installation](./quickstart-installation.md) vor.
...
* [Deep Learning für Predictive Maintenance](https://docs.microsoft.com/en-us/azure/machine-learning/preview/scenario-deep-learning-for-predictive-maintenance)
