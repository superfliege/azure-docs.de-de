...
- Azure Machine Learning Workbench-Anwendung, die gemäß der Anleitung unter [Quickstart: Install and get started with Azure Machine Learning services](quickstart-installation.md) (Schnellstartanleitung: Installieren und Verwenden von Azure Machine Learning-Diensten) installiert ist. 
