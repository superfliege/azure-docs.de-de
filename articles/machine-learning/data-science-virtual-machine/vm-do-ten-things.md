...
* Um Daten in einen Container hochzuladen, wählen Sie den Zielcontainer aus, und klicken Sie auf die Schaltfläche **Hochladen**.![Hochladen in den Speicher-Explorer](./media/vm-do-ten-things/storage-accounts.png)
