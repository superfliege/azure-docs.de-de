...
* Machine Learning und Datenanalysetools
  * [Microsoft Cognitive Toolkit](https://github.com/Microsoft/CNTK): Ein Deep Learning-Softwaretoolkit von Microsoft Research.
...
Ein [CentOS](linux-dsvm-intro.md)-Image ist ebenfalls verfügbar, das viele gleiche Tools wie das Windows-Image bietet. Ein [Ubuntu](dsvm-ubuntu-intro.md)-Image ist ebenfalls verfügbar, das viele ähnliche Tools sowie umfangreiche Lerngerüste bietet.
...
Wir haben mehrere Beispiele für Notebooks in Python und R zusammengestellt. Die Jupyter Notebooks zeigen Ihnen, wie Sie mit Microsoft R Server, SQL Server 2016 R Services (datenbankinterne Analyse), Python, Microsoft Cognitive ToolKit für Deep Learning und anderen Azure-Technologien arbeiten, nachdem Sie sich bei Jupyter angemeldet haben. Der Link zu den Beispielen wird Ihnen auf der Startseite für die Notebooks angezeigt, nachdem Sie sich mit dem im vorherigen Schritt festgelegten Passwort am Jupyter Notebook authentifiziert haben. 
