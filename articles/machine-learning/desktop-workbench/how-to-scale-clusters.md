...
Sie können die Anzahl der Podreplikate, die dem Cluster zugeordnet sind, mithilfe der Azure Machine Learning-CLI oder dem [Kubernetes-Dashboard](https://kubernetes.io/docs/tasks/access-application-cluster/web-ui-dashboard/) skalieren.
