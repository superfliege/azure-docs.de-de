...
Diese Abbildung zeigt die Beziehung zwischen einem Azure DevOps-Git-Repository und einem Machine Learning-Projekt:
...
> [!NOTE]
> Azure Machine Learning unterstützt zurzeit nur Git-Repositorys in Azure DevOps-Organisationen.
...
## <a name="step-2-create-an-azure-devops-project-or-use-an-existing-project"></a>Schritt 2: Erstellen eines Azure DevOps-Projekts oder Verwenden eines vorhandenen Projekts
Erstellen Sie im [Azure-Portal](https://portal.azure.com/) ein neues Projekt:
1. Wählen Sie **+** aus.
...
![Erstellen eines Projekts im Azure-Portal](media/using-git-ml-project/create_vsts_team.png)
...
Um direkt zum erstellten Projekt zu gelangen, verwenden Sie die URL https://\<Projektname\>.visualstudio.com.
...
- Zuordnen eines vorhandenen Machine Learning-Projekts zu einem Azure DevOps-Git-Repository
...
Öffnen Sie Machine Learning Workbench, und erstellen Sie ein neues Projekt. Geben Sie im Feld **Git-Repository** die URL des Azure DevOps-Git-Repositorys aus Schritt 2 ein. In der Regel sieht diese wie folgt aus: https://\<Azure DevOps-Organisation\>.visualstudio.com/_git/\<Projektname\>.
...
Es wird ein neues Machine Learning-Projekt mit aktivierter Integration des Git-Remoterepositorys erstellt. Der Projektordner wird immer mit Git als lokalem Git-Repository initialisiert. Das Git-Remoterepository ist auf das Azure DevOps-Git-Remoterepository festgelegt, damit Commits in das Git-Remoterepository gepusht werden können.

### <a name="associate-an-existing-machine-learning-project-with-an-azure-devops-git-repo"></a>Zuordnen eines vorhandenen Machine Learning-Projekts zu einem Azure DevOps-Git-Repository
Sie können ein Machine Learning-Projekt ohne ein Azure DevOps-Git-Repository erstellen und sich für die Ausführung von Ausführungsverlauf-Momentaufnahmen auf das lokale Git-Repository verlassen. Später können Sie ein Azure DevOps-Git-Repository über den folgenden Befehl mit diesem vorhandenen Machine Learning-Projekt verknüpfen:
