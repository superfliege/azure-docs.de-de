...
>[!Note]
>**Dieser Artikel ist veraltet.** Die Unterstützung für frühere Versionen dieses Diensts wird nach und nach beendet. [Sehen Sie sich die Zeitleiste für die Unterstützung an](../service/overview-what-happened-to-workbench.md#timeline). Lesen Sie den [neuesten Artikel](../service/how-to-export-delete-data.md) zu diesem Thema.
