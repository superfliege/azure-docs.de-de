...
* Bei dieser Lösung wird davon ausgegangen, dass Sie die Azure Machine Learning Workbench unter Windows 10 mit einer lokal installierten Docker-Engine ausführen. Wenn Sie macOS verwenden, sind die Anweisungen weitgehend identisch.
...
3. Modellierung und Auswertung ohne „.dprep“: Die Hauptdatei für diese Aufgabe im Stammordner heißt `CATelcoCustomerChurnModelingWithoutDprep.py`.
