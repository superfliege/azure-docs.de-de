...
Während die Azure-Statusseite immer die aktuellen Integritätsinformationen anzeigt, finden Sie ältere Ereignisse auf der [Azure Status-Verlaufsseite](https://azure.microsoft.com/status/history/).
...
Außerdem bietet Azure-Status [einen RSS-Feed](https://azure.microsoft.com/status/feed/) von Änderungen der Integrität von Azure-Diensten, den Sie abonnieren können.
