...
1. [Installieren Sie auf dem NPS-Server die NPS-Erweiterung für Azure MFA](../multi-factor-authentication/multi-factor-authentication-nps-extension.md#install-the-nps-extension).
...
- [Integrieren Ihrer vorhandenen NPS-Infrastruktur in Azure Multi-Factor Authentication – Public Preview](../multi-factor-authentication/multi-factor-authentication-nps-extension.md)
