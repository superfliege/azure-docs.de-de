...
| [Add-AzureRmVpnClientRootCertificate](/powershell/module/azurerm.network/add-azurermvpnclientrootcertificate) | Lädt die Informationen des öffentlichen Schlüssels des Stammzertifikats in das VPN-Gateway hoch.|
...
| [New-SelfSignedCertificate](/powershell/module/azurerm.resources/new-selfsignedcertificate) | Erstellt ein neues selbstsigniertes Stammzertifikat. |
