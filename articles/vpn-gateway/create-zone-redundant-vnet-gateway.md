...
Die aktuelle Liste der verfügbaren Regionen finden Sie unter [Verfügbarkeitszonen](../availability-zones/az-overview.md#regions-that-support-availability-zones).
