...
![Azure AD Admin Center – Eigenschaften – Ein globaler Administrator kann Azure-Abonnements verwalten – Screenshot](./media/elevate-access-global-admin/aad-azure-portal-global-admin-can-manage-azure-subscriptions.png)
...
- Weitere Informationen finden Sie unter [Verwalten der rollenbasierten Zugriffssteuerung mit REST](role-assignments-rest.md).

- [Verwalten von Zugriffszuweisungen](role-assignments-users.md) im Azure-Portal
