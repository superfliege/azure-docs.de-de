...
- Informieren Sie sich über das [Erstellen einer benutzerdefinierten Rolle](custom-roles.md).
- Machen Sie sich mit den [integrierten RBAC-Rollen](built-in-roles.md) vertraut.
- Informieren Sie sich über das Verwalten von Zugriffszuweisungen [nach Benutzer](role-assignments-users.md) oder [nach Ressource](role-assignments-portal.md). 
