...
![Änderungsprotokoll als Arbeitsblatt – Screenshot](./media/change-history-report/change-history-spreadsheet.png)

## <a name="next-steps"></a>Nächste Schritte
* Arbeiten mit [benutzerdefinierten Rollen in Azure RBAC](custom-roles.md)
* Erfahren Sie, wie Sie [Azure RBAC mit PowerShell](role-assignments-powershell.md) verwalten.
