...
# Schnellstarts
## [Erstellen von Vorlagen – Portal](resource-manager-quickstart-create-templates-use-the-portal.md)
## [Erstellen von Vorlagen – VS Code](resource-manager-quickstart-create-templates-use-visual-studio-code.md)
## [Erstellen von Vorlagen – Visual Studio](vs-azure-tools-resource-groups-deployment-projects-create-deploy.md)
