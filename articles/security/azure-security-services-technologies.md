...
---
# <a name="security-services-and-technologies-available-on-azure"></a>Security services and technologies available on Azure
...
## <a name="general-azure-security"></a>General Azure security
|Service|Description|
|--------|--------|
...
## <a name="storage-security"></a>Storage security
|Service|Description|
|------|--------|
...
## <a name="database-security"></a>Database security
|Service|Description|
|------|--------|
