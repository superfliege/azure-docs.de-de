...
![Alternativer Text](images/fedramp-iaaswa-architecture.png?raw=true "Azure Security and Compliance Blueprint – Automatisierung von Webanwendungen für FedRAMP")
