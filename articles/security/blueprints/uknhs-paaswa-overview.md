...
ms.locfileid: "37343196"
---
# <a name="azure-security-and-compliance-blueprint-paas-web-application-for-uk-nhs"></a>Azure Security and Compliance Blueprint: PaaS-Webanwendungen gemäß NHS (Vereinigtes Königreich)
...
**App Service-Umgebung v2:** Die Azure App Service-Umgebung ist ein App Service-Feature, das eine vollständig isolierte und dedizierte Umgebung zur sicheren Ausführung von App Service-Anwendungen in größerem Umfang bereitstellt.
