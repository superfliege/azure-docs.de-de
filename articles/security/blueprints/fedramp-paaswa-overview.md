...
Die Operations Management Suite bietet umfassende Protokollierung von System- und Benutzeraktivitäten sowie der Systemintegrität. Die Lösung [Log Analytics](https://azure.microsoft.com/services/log-analytics/) der Operations Management Suite erfasst und analysiert Daten, die von Ressourcen in Azure- und lokalen Umgebungen generiert werden.
...
Darüber hinaus sind in dieser Architektur die folgenden Operations Management Suite-Lösungen enthalten:
