...
| [az appconfig create](/cli/azure/ext/appconfig/appconfig#ext-appconfig-az-appconfig-create) | Erstellt eine App-Konfigurationsspeicherressource. |
| [az appconfig key list](/cli/azure/ext/appconfig/appconfig/key#ext-appconfig-az-appconfig-key-list) | Führt die in einem App-Konfigurationsspeicher gespeicherten Schlüssel auf. |
