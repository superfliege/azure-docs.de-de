...
-   Derzeit können Sie Tresore, die Azure Files-, Azure File Sync- oder SQL-in-IaaS-VMs enthalten, nicht zwischen Abonnements und Ressourcengruppen verschieben. Unterstützung für diese Szenarien wird in zukünftigen Releases hinzugefügt.
...
## <a name="register-the-subscription-to-move-your-recovery-services-vault"></a>Registrieren des Abonnements zum Verschieben Ihres Recovery Services-Tresors

Um das Abonnement für das **Verschieben** Ihres Recovery Services-Tresors zu registrieren, führen Sie die folgenden Cmdlets im PowerShell-Terminal aus:
