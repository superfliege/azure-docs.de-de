...
- [Fügen Sie wiederhergestellte Datenträger](https://docs.microsoft.com/azure/virtual-machines/windows/attach-managed-disk-portal#option-2-attach-an-existing-disk) an eine vorhandene VM an.
