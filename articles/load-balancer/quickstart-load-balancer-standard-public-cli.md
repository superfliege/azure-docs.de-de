...
ms.locfileid: "46955128"
---
# <a name="quickstart-create-a-standard-load-balancer-to-load-balance-vms-using-azure-cli"></a>Schnellstart: Erstellen eines Load Balancer Standard für den Lastenausgleich virtueller Computer mit Azure CLI
