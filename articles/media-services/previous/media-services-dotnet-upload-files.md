...
ms.locfileid: "55984221"
---
# <a name="upload-files-into-a-media-services-account-using-net-legacy"></a>Hochladen von Dateien in ein Media Services-Konto mit .NET (veraltet)
