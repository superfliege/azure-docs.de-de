...
Das folgenden Codebeispiel zeigt eine **SubmitSubclipCallback**-Beispielmethode. Bei dieser Methode implementieren Sie HTTP POST für die MES-Codierungsvoreinstellung. Wenn POST erfolgreich ausgeführt wurde (**result**), wird **Promise** aufgelöst. Andernfalls erfolgt eine Ablehnung mit Fehlerdetails.
...
```
Die Ausgabe der Auftragsübermittlung ist entweder die MES-Codierungsvoreinstellung für gerenderte Aufträge oder die REST-API-Nutzlast für Filter für dynamische Manifeste.

## <a name="rendered-output"></a>Gerenderte Ausgabe
...
## <a name="filter-output"></a>Filterausgabe
Die Ausgabe für eine Filterbeschneidung ist ein JSON-Objekt mit den folgenden Eigenschaften:
