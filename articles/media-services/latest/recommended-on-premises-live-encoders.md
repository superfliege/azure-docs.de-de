...
Media Services empfiehlt die Verwendung eines der nachfolgenden Liveencoder, der Smooth Streaming mit Mehrfachbitrate (fragmentiertes MP4) ausgibt. Die unterstützten URL-Schemas sind `rtmp://` und `rtmps://`.
