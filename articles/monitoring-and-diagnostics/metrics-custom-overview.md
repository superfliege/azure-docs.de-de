...
- Installieren des [InfluxData Telegraf-Agents](metrics-store-custom-linux-telegraf.md) auf Ihrer Azure-Linux-VM und Senden der Metriken mithilfe des Ausgabe-Plug-Ins von Azure Monitor
...
Verwenden benutzerdefinierter Metriken von verschiedenen Diensten: 
 - [Virtuelle Computer](metrics-store-custom-guestos-resource-manager-vm.md)
 - [VM-Skalierungsgruppe](metrics-store-custom-guestos-resource-manager-vmss.md)
 - [Azure Virtual Machines (klassisch)](metrics-store-custom-guestos-classic-vm.md)
 - [Virtueller Linux-Computer mit Telegraf-Agent](metrics-store-custom-linux-telegraf.md)
 - [REST-API](metrics-store-custom-rest-api.md)
 - [Cloud Services (klassisch)](metrics-store-custom-guestos-classic-cloud-service.md)
