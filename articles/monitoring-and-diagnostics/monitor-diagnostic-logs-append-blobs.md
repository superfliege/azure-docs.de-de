...
> [!WARNING]
> Wenn Sie [mithilfe von Ressourcendiagnoseeinstellungen Azure-Ressourcendiagnoseprotokolle oder -metriken an ein Speicherkonto](./monitoring-archive-diagnostic-logs.md) oder [Aktivitätsprotokolle mithilfe von Protokollprofilen an ein Speicherkonto](./monitoring-archive-activity-log.md) senden, ändert sich das Format der Daten im Speicherkonto am 1. November 2018 in JSON Lines. Unten wird beschrieben, welche Auswirkungen sich ergeben und wie Sie Ihre Tools für die Verarbeitung des neuen Formats aktualisieren. 
>
> 
...
![Blatt „Diagnoseeinstellungen“ von Azure Monitor](./media/monitor-diagnostic-logs-append-blobs\portal-diag-settings.png)
...
![Aktiviertes Speicherkonto](./media/monitor-diagnostic-logs-append-blobs\portal-storage-enabled.png)
...
* Informieren Sie sich über das [Archivieren von Azure-Diagnoseprotokollen](./monitoring-archive-diagnostic-logs.md).
* Informieren Sie sich über das [Archivieren des Azure-Aktivitätsprotokolls](./monitoring-archive-activity-log.md).
