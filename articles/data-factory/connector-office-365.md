...
|:--- |:--- |:--- |
| type | Die type-Eigenschaft muss auf **Office365** festgelegt werden. | JA |
...
| Eigenschaft | BESCHREIBUNG | Erforderlich |
|:--- |:--- |:--- |
| type | Die type-Eigenschaft des Datasets muss auf **Office365Table** festgelegt werden. | JA |
