...
ms.locfileid: "58878360"
---
# <a name="mapping-data-flow-data-transformation-expressions"></a>Zuordnen von Ausdrücken zur Datentransformation in Datenflüssen
...
Addiert ein Paar Zeichenfolgen oder Zahlen. Addiert ein Datum zu einer Anzahl von Tagen. Fügt ein Array mit ähnlichem Typ an ein anderes an. Entspricht dem Operator +:
* ``add(10, 20) -> 30``
* ``10 + 20 -> 30``
...
Addiert Monate zu einem Datum oder einem Zeitstempel:
...
Wendet basierend auf alternierenden Bedingungen einen Wert oder den anderen an. Wenn die Anzahl von Eingaben gerade ist, ist der andere Wert NULL für die letzte Bedingung:
...
Ruft den aktuellen Zeitstempel als UTC ab. Sie können eine optionale Zeitzone in der Form „GMT“, „PST“, „UTC“, „America/Cayman“ übergeben. Der Standardwert ist die aktuelle Zeitzone:
...
Gibt immer den Wert FALSE zurück. Verwenden Sie die Funktionssyntax „false()“, wenn eine Spalte mit dem Namen „false“ vorhanden ist:
* ``isDiscounted == false()``
* ``isDiscounted() == false``
*********************************
<code>first</code>
...
Gibt den größten Wert in der Liste der Werte als Eingabe zurück. Gibt NULL zurück, wenn alle Eingaben NULL sind:
...
Subtrahiert Zahlen. Subtrahiert eine Anzahl von Tagen von einem Datum. Entspricht dem Operator -:
* ``minus(20, 10) -> 10``
* ``20 - 10 -> 10``
...
Ersetzt alle Vorkommen einer Teilzeichenfolge durch eine andere Teilzeichenfolge in der angegebenen Zeichenfolge:
...
Subtrahiert Monate von einem Datum. Entspricht dem Operator - für Datumsangaben:
...
Wandelt eine Zeichenfolge in ein Datum mit einem optionalen Datumsformat um. Alle zulässigen Formate finden Sie unter „Java SimpleDateFormat“. Wenn das Datumsformat nicht angegeben ist, werden Kombinationen der folgenden Formate akzeptiert. [ jjjj, jjjj-[M]M, jjjj-[M]M-[t]t, jjjj-[M]M-[t]t, jjjj-[M]M-[t]t, jjjj-[M]M-[t]tZ* ]
...
Wandelt beliebige numerische oder Zeichenfolgenwerte in einen float-Wert um. Ein optionales Java-Dezimalzahlenformat kann für die Umwandlung verwendet werden. Schneidet alle Werte des Typs „double“ ab:
...
Konvertiert beliebige numerische oder Zeichenfolgenwerte in einen Integer-Wert. Ein optionales Java-Dezimalzahlenformat kann für die Umwandlung verwendet werden. Schneidet alle Werte der Typen „long“, „float“ und „double“ ab:
* ``toInteger(123) -> 123``
* ``toInteger('123') -> 123``
* ``toInteger('$123', '$###') -> 123``
*********************************
...
Wandelt beliebige numerische oder Zeichenfolgenwerte in einen long-Wert um. Ein optionales Java-Dezimalzahlenformat kann für die Umwandlung verwendet werden. Schneidet alle Werte der Typen „float“ und „double“ ab:
* ``toLong(123) -> 123``
* ``toLong('123') -> 123``
* ``toLong('$123', '$###') -> 123``
*********************************
...
Wandelt beliebige numerische oder Zeichenfolgenwerte in einen short-Wert um. Ein optionales Java-Dezimalzahlenformat kann für die Umwandlung verwendet werden. Schneidet alle Werte der Typen „long“, „integer“, „float“ und „double“ ab:
* ``toShort(123) -> 123``
* ``toShort('123') -> 123``
* ``toShort('$123', '$###') -> 123``
*********************************
...
Wandelt eine Zeichenfolge in ein Datum mit einem optionalen Zeitstempelformat um. Alle zulässigen Formate finden Sie unter „Java SimpleDateFormat“. Wenn das Zeitstempelformat nicht angegeben ist, wird das Standardmuster jjjj-[M]M-[t]t hh:mm:ss[.f...] verwendet:
...
Wandelt den Zeitstempel in UTC um. Sie können eine optionale Zeitzone in der Form „GMT“, „PST“, „UTC“, „America/Cayman“ übergeben. Der Standardwert ist die aktuelle Zeitzone:
