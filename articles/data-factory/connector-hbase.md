...
|:--- |:--- |:--- |
| Typ | Die „type“-Eigenschaft muss auf **HBase** festgelegt werden. | Ja |
...
| Eigenschaft | Beschreibung | Erforderlich |
|:--- |:--- |:--- |
| Typ | Die „type“-Eigenschaft der Quelle der Kopieraktivität muss auf **HBaseSource** festgelegt werden. | Ja |
