...
> * [Version 1: Allgemein verfügbare Version](v1/data-factory-pig-activity.md)
...
> [!NOTE]
> Dieser Artikel bezieht sich auf Version 2 von Data Factory, die zurzeit als Vorschauversion verfügbar ist. Wenn Sie Version 1 des Data Factory-Diensts verwenden, der allgemein verfügbar (GA) ist, lesen Sie [Pig-Aktivität in V1](v1/data-factory-pig-activity.md).
