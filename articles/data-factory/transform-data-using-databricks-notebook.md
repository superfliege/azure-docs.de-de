...
1.  Wählen Sie im Menü auf der linken Seite die Option **Ressource erstellen** und dann **Analyse** und **Data Factory**.
...
1.  Führen Sie unter **Ressourcengruppe** einen der folgenden Schritte aus:
    ...
    Bei einigen Schritten dieses Tutorials wird davon ausgegangen, dass Sie eine Ressourcengruppe mit dem Namen **ADFTutorialResourceGroup** verwenden. Weitere Informationen zu Ressourcengruppen finden Sie unter [Verwenden von Ressourcengruppen zum Verwalten von Azure-Ressourcen](https://docs.microsoft.com/azure/azure-resource-manager/resource-group-overview).
...
1.  Wählen Sie im Fenster **New Linked Service** (Neuer verknüpfter Dienst) die Optionen **Compute** \> **Azure Databricks** und dann **Weiter**.
...
1.  Erweitern Sie in der Toolbox **Aktivitäten** die Option **Databricks**. Ziehen Sie die Aktivität **Notebook** aus der Toolbox mit den **Aktivitäten** auf die Oberfläche des Pipeline-Designers.
...
1.  Führen Sie in den Eigenschaften im unteren Bereich des Fensters für das **Databricks**-**Notebook** die folgenden Schritte aus:
    ...
    b. Wählen Sie **AzureDatabricks\_LinkedService** (wie oben erstellt).
...
1.  Wechseln Sie zur Registerkarte **Monitor**. Vergewissern Sie sich, dass eine Pipelineausführung angezeigt wird. Die Erstellung eines Databricks-Auftragsclusters, in dem das Notebook ausgeführt wird, dauert ca. fünf bis acht Minuten.
...
1.  Wählen Sie in der Spalte **Aktionen** die Option  **View Activity Runs** (Aktivitätsausführungen anzeigen), wenn Sie mit der Pipelineausführung verknüpfte Aktivitätsausführungen anzeigen möchten.
