...
|:--- |:--- |:--- |
| Typ | Die „type“-Eigenschaft muss auf **HubSpot** festgelegt werden. | Ja |
...
| Eigenschaft | Beschreibung | Erforderlich |
|:--- |:--- |:--- |
| Typ | Die „type“-Eigenschaft der Quelle der Kopieraktivität muss auf **HubspotSource** festgelegt werden. | Ja |
