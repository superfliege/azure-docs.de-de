---
title: Authentifizierung, Registrierung, Profilbearbeitung in Azure Active Directory B2C | Microsoft-Dokumentation
...
Bevor Sie Azure AD B2C verwenden können, müssen Sie ein Verzeichnis oder einen Mandanten erstellen. Ein Verzeichnis ist ein Container für all Ihre Benutzer, Apps, Gruppen usw. Wenn Sie noch keines verwenden, sollten Sie [ein B2C-Verzeichnis erstellen](tutorial-create-tenant.md) , bevor Sie die weiteren Schritte in diesem Leitfaden ausführen.
...
Nachdem Sie die Richtlinien erfolgreich erstellt haben, können Sie Ihre App erstellen.
