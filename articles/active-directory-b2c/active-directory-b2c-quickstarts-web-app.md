---
title: Testversion einer Azure AD-B2C-fähigen Web-App
description: Schnellstart zum Testen einer ASP.NET-Web-App (Beispiel-App), für die Azure Active Directory B2C zum Bereitstellen einer Benutzeranmeldung genutzt wird.
...
---
# <a name="quickstart-test-drive-an-azure-ad-b2c-enabled-web-app"></a>Schnellstart: Testen einer Azure AD B2C-fähigen Web-App
