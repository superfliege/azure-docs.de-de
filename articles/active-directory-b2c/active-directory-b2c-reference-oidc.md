---
title: Webanmeldungen mit OpenID Connect in Azure Active Directory B2C | Microsoft-Dokumentation
...
[OpenID Connect](https://openid.net/specs/openid-connect-core-1_0.html) erweitert das OAuth 2.0-Protokoll für die *Autorisierung*, damit es als Protokoll für die *Authentifizierung* verwendet werden kann. Dadurch können Sie einmaliges Anmelden mithilfe von OAuth ausführen. Dabei wird das Konzept eines *ID-Token* eingeführt, eines Sicherheitstokens, mit dem der Client die Identität des Benutzers überprüfen und grundlegende Profilinformationen über den Benutzer erhalten kann.
