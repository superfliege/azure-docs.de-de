...
Die HTTP-Beispielanforderungen im nächsten Abschnitt verwenden unser B2C-Beispielverzeichnis „fabrikamb2c.onmicrosoft.com“ sowie unsere Beispielanwendung https://aadb2cplayground.azurewebsites.net und die Richtlinien. Sie können selbst Anforderungen mit diesen Werten testen oder eigene Werte verwenden.
...
`https://login.microsoftonline.com/fabrikamb2c.onmicrosoft.com/discovery/v2.0/keys?p=b2c_1_sign_in`(Fixierte Verbindung) festgelegt ist(Fixierte Verbindung) festgelegt ist.
