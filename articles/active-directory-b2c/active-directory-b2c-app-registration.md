...
Weitere Informationen zur Verwendung von Zugriffstoken durch Anwendungen, die Berechtigungen für APIs gewähren, finden Sie unter [Zugriffstoken werden angefordert](active-directory-b2c-access-tokens.md).
