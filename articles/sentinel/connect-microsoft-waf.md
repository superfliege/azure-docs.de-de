---
title: Sammeln von Microsoft Web Application Firewall-Daten in Azure Sentinel Preview | Microsoft-Dokumentation
description: Erfahren Sie, wie Sie Microsoft Web Application Firewall-Daten in Azure Sentinel sammeln.
services: sentinel
...
ms.locfileid: "58580865"
---
# <a name="collect-data-from-microsoft-web-application-firewall"></a>Sammeln von der Microsoft Web Application Firewall-Daten
...
5. Wählen Sie im Azure Sentinel-Portal **Datenconnectors** aus.
5. Wählen Sie auf der Seite „Datenconnectors“ die Kachel **WAF** aus.
...
6. Um in Log Analytics das relevante Schema für die Microsoft Web Application Firewall-Warnungen zu verwenden, suchen Sie nach **AzureDiagnostics**.
