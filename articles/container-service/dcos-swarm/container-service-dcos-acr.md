---
title: Verwenden von ACR mit einem Azure DC/OS-Cluster
...
Erstellen Sie bei Bedarf mit dem Befehl [az acr create](/cli/azure/acr#az_acr_create) eine Azure Container Registry-Instanz. 
