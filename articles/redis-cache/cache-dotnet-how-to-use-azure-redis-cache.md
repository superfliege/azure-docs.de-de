...
Sie können auch `RedisValue`, wie im folgenden Beispiel gezeigt. `RedisValue`verfügt über implizite Operatoren zum Arbeiten mit ganzzahligen Datentypen und kann nützlich sein, wenn `null` erwartender Wert für das zwischengespeicherte Element.
