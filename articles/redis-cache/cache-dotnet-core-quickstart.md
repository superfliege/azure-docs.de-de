---
title: 'Schnellstart: Verwenden von Azure Redis Cache mit .NET Core-Apps | Microsoft-Dokumentation'
description: In dieser Schnellstartanleitung wird beschrieben, wie Sie in Ihren .NET Core-Apps auf Azure Redis Cache zugreifen.
...
In dieser Schnellstartanleitung wird beschrieben, wie Sie in die Nutzung von Microsoft Azure Redis Cache mit .NET Core einsteigen. Microsoft Azure Redis Cache basiert auf dem beliebten Open-Source-Redis Cache. Sie erhalten Zugriff auf einen sicheren dedizierten Redis Cache, der von Microsoft verwaltet wird. Ein mit Azure Redis Cache erstellter Cache ist für beliebige Anwendungen in Microsoft Azure erreichbar.
...
Fügen Sie der `Program`-Klasse in *Program.cs* die folgenden Member hinzu. Mit diesem Code wird eine Konfiguration für den Zugriff auf das Benutzergeheimnis für die Redis Cache-Verbindungszeichenfolge initialisiert.
