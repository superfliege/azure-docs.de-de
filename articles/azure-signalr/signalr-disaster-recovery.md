...
Abb. 1: Vor dem Failover ![Vor dem Failover](media/signalr-disaster-recovery/before-failover.png)

Abb. 2: Nach dem Failover ![Nach dem Failover](media/signalr-disaster-recovery/after-failover.png)

Abb. 3: Kurz nach der Wiederherstellung der primären Instanz ![Kurz nach der Wiederherstellung der primären Instanz](media/signalr-disaster-recovery/after-recover.png)
...
In diesem Artikel haben Sie erfahren, wie Sie Ihre Anwendung konfigurieren, um Resilienz für SignalR Service zu erreichen. Weitere Details zur Server-/Clientverbindung und zum Verbindungsrouting in SignalR Service finden Sie in [diesem Artikel](signalr-internals.md).