...
> [!TIP]
> Wenn Sie diesen Befehl über Azure Cloud Shell ausführen, fügen Sie den Parameter `--enable-cloud-console-aks-browse` hinzu, damit das Dashboard ordnungsgemäß geöffnet wird.
