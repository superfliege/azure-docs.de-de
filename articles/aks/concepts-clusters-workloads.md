...
Wenn Sie den Clustermaster auf eine bestimmte Weise konfigurieren müssen oder direkten Zugriff benötigen, können Sie mit [acs-engine][acs-engine] selbst einen Kubernetes-Cluster bereitstellen.
