...
In diesem Artikel erfahren Sie, wie Sie die Voraussetzungen für AKS und Azure AD bereitstellen, anschließend einen Azure AD-fähigen Cluster bereitstellen und eine einfache RBAC-Rolle im AKS-Cluster erstellen.
