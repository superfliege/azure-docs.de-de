...
Wenn Sie die Gerätesimulation noch nicht bereitgestellt haben, sollten Sie zunächst das Tutorial [Bereitstellen der Azure-IoT-Gerätesimulation](iot-accelerators-device-simulation-deploy.md) durcharbeiten.
...
![IoT-Zielhub](./media/iot-accelerators-device-simulation-explore/targethub.png)
...
![IoT-Zielhub](./media/iot-accelerators-device-simulation-explore/connectionstring.png)
...
![Gerätemodell](./media/iot-accelerators-device-simulation-explore/devicemodel.png)
...
![Sensoren hinzufügen](./media/iot-accelerators-device-simulation-explore/customsensors.png)
...
![Anzahl von Geräten](./media/iot-accelerators-device-simulation-explore/numberofdevices.png)
...
![Telemetriefrequenz](./media/iot-accelerators-device-simulation-explore/frequency.png)
...
![Simulationsdauer](./media/iot-accelerators-device-simulation-explore/duration.png)
...
![Simulation starten](./media/iot-accelerators-device-simulation-explore/start.png)
...
![Simulation beenden](./media/iot-accelerators-device-simulation-explore/stop.png)
