...
Weitere Informationen zu den Azure-Administratorrollen finden Sie im Artikel [Hinzufügen oder Ändern von Azure-Abonnementadministratoren][lnk-admin-roles].
