...
Der Abschnitt [Simulation](iot-accelerators-remote-monitoring-device-schema.md#simulation) des Gerätemodellschemas definiert den internen Status eines simulierten Geräts:
...
Der Abschnitt [CloudToDeviceMethods](iot-accelerators-remote-monitoring-device-schema.md#cloudtodevicemethods) des Gerätemodellschemas definiert die Methoden, auf die ein simuliertes Gerät reagiert.
...
Im Artikel [Testen der Lösung mit simulierten Geräten](iot-accelerators-remote-monitoring-test.md) erfahren Sie, wie Sie den Gerätesimulationsdienst lokal ausführen können. Die lokale Ausführung des Diensts erleichtert das Debuggen Ihrer simulierten Geräte, bevor Sie sie in der Cloud bereitstellen.
