...
[Fehler] Ausnahme beim Abrufen des BitLocker-Schlüssels für das Volume M abgefangen:
...
([Fehler] Eine Ausnahme wurde ausgelöst: Fehler beim WMI-Vorgang:
...
([Fehler] Eine Ausnahme wurde ausgelöst: Auf dem Ziellaufwerk befindet sich eine Datei vom Typ „DriveManifest.xml“.
