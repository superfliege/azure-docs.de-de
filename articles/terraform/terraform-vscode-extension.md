...
1. Navigieren Sie zu [azurerm_resource_group](https://www.terraform.io/docs/providers/azurerm/r/resource_group.html#), und kopieren Sie den Code im Codeblock **Beispielverwendung**.
