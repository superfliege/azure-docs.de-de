...
Dieser Artikel zeigt, wie Sie eine Logik-App als eine API importieren. Der Artikel zeigt, wie Sie die APIM-API testen.
...
+ Stellen Sie sicher, dass Ihr Abonnement eine Logik-App enthält. Weitere Informationen finden Sie unter [Erstellen Ihrer ersten Logik-App](../logic-apps/logic-apps-create-a-logic-app.md).
