...
|Beschreibung|Zeichenfolge|Beschreibung der API. Darf nicht leer sein. Kann HTML-Formatierungstags umfassen. Die maximale Länge beträgt 1000 Zeichen.|  
...
|Titel|Zeichenfolge|Der Titel der Anwendung.|  
|BESCHREIBUNG|Zeichenfolge|Die Beschreibung der Anwendung.|  
...
|Typ|Zeichenfolge|Der Typ der Anlage.|  
...
|Vorlage|Zeichenfolge|Der Name dieser Codebeispielvorlage.|  
...
|Parameter|Sammlung von [Parameter](#Parameter)-Entitäten.|Parameter, die für diesen Vorgang definiert sind.|  
...
|Titel|Zeichenfolge|Der Titel des Problems.|  
|BESCHREIBUNG|Zeichenfolge|Die Beschreibung des Problems.|  
...
|Eigenschaft|Typ|BESCHREIBUNG|  
|--------------|----------|-----------------|  
|Muster|Zeichenfolge|Der aktuelle Suchbegriff oder `null`, wenn kein Suchbegriff vorliegt.|  
|Platzhalter|Zeichenfolge|Der Text, der im Suchfeld angezeigt werden soll, wenn kein Suchbegriff angegeben ist.|  
...
|Beschreibung|Zeichenfolge|Beschreibung des Parameters.|  
...
|Eigenschaft|Typ|BESCHREIBUNG|  
|--------------|----------|-----------------|  
|Beschreibung|Zeichenfolge|Vorgangsanforderungsbeschreibung.|  
|Headers|Array von [Header](#Header)-Entitäten.|Anforderungsheader.|  
|Parameter|Array von [Parametern](#Parameter)|Die Sammlung von Vorgangsanforderungsparametern.|  
...
|Beschreibung|Zeichenfolge|Vorgangsantwortbeschreibung.|  
...
|Beschreibung|Zeichenfolge|Beschreibung des Vorgangs. Darf nicht leer sein. Kann HTML-Formatierungstags umfassen. Die maximale Länge beträgt 1000 Zeichen.|  
...
|Titel|Zeichenfolge|Die Beschreibung des Vorgangs.|  
...
|Titel|Zeichenfolge|Der Name des Produkts. Darf nicht leer sein. Die maximale Länge beträgt 100 Zeichen.|  
|BESCHREIBUNG|Zeichenfolge|Beschreibung des Produkts. Darf nicht leer sein. Kann HTML-Formatierungstags umfassen. Die maximale Länge beträgt 1000 Zeichen.|  
|Begriffe|Zeichenfolge|Nutzungsbedingungen für das Produkt. Diese Bedingungen werden Entwicklern angezeigt, die das Produkt abonnieren möchten. Sie müssen die Bedingungen akzeptieren, um den Abonnementvorgang abschließen zu können.|  
...
|Beispiel|Zeichenfolge|Ein Beispiel für die Darstellung.|  
