---
title: Codeausschnitte zum Migrieren von Inhalten aus Power BI-Arbeitsbereichssammlungen | Microsoft-Dokumentation
description: Hier sind einige Codeausschnitte von grundlegenden Vorgängen, die für die Inhaltsmigration benötigt werden.
...
ms.locfileid: "31407713"
---
# <a name="code-snippets-for-migrating-content-from-power-bi-workspace-collections"></a>Codeausschnitte zum Migrieren von Inhalten aus Power BI-Arbeitsbereichssammlungen

Dieser Artikel bietet Codeausschnitte von grundlegenden Vorgängen, die für die Inhaltsmigration benötigt werden. Dazugehörige Flows für bestimmte Berichtstypen finden Sie unter [Migrieren von Inhalten aus Power BI Embedded-Arbeitsbereichsammlungen zu Power BI](migrate-from-power-bi-workspace-collections.md#content-migration).

Zur Unterstützung des Kopierens von Inhalten aus Power BI-Arbeitsbereichssammlungen zu Power BI Embedded steht Ihnen ein **Migrationstool** zur Verfügung. Dies ist besonders nützlich, wenn Sie das Inhaltsvolumen sehr groß ist. Weitere Informationen finden Sie unter [Power BI Embedded-Migrationstool](migrate-tool.md).

Für die Beispiele im folgenden Code werden C# und das [Power BI .NET SDK](https://www.nuget.org/profiles/powerbi) verwendet.
...
## <a name="export-report-from-a-power-bi-workspace-collection-workspace"></a>Erstellen eines Berichts aus einem zu Power BI-Arbeitsbereichsammlungen gehörigen Arbeitsbereich
...
## <a name="import-report-to-power-bi-embedded"></a>Importieren eines Berichts in Power BI Embedded
...
## <a name="extract-directquery-connection-string-from-power-bi-workspace-collections"></a>Extrahieren der DirectQuery-Verbindungszeichenfolge aus Power BI-Arbeitsbereichssammlungen

Diese dient zum Aktualisieren der PBIX-Datei nach der Migration zu Power BI Embedded.
...
## <a name="update-directquery-connection-string-in-power-bi-embedded"></a>Aktualisieren der DirectQuery-Verbindungszeichenfolge in Power BI Embedded
...
## <a name="set-directquery-credentials-in-power-bi-embedded"></a>Festlegen von DirectQuery-Anmeldeinformationen in Power BI Embedded

In diesem Ausschnitt verwenden wir zur Vereinfachung unverschlüsselte Anmeldeinformationen. Das Senden verschlüsselter Anmeldeinformationen wird ebenfalls unterstützt.
...
## <a name="push-dataset-and-report"></a>Übertragen von Dataset und Bericht per Push

Sie müssen den Bericht für das erstellte Dataset neu erstellen.

In diesem Ausschnitt wird davon ausgegangen, dass sich das für Push geeignete Dataset bereits in einem App-Arbeitsbereich innerhalb von Power BI befindet. Informationen zur Push-API finden Sie unter [Übertragen von Daten in ein Power BI-Dataset per Push](https://powerbi.microsoft.com/documentation/powerbi-developer-walkthrough-push-data/).
...
Informationen zum Migrationsprozess finden Sie unter [Migrieren von Power BI-Arbeitsbereichssammlungsinhalten zu Power BI Embedded](migrate-from-power-bi-workspace-collections.md).
