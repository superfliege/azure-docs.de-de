...
2. Klicken Sie unter **Traffic Manager-Profil** im Abschnitt **Einstellungen** auf **Endpunkte**.
...
4. Gehen Sie wie folgt weiter vor:
    ...
    4. Klicken Sie für **Zielressource** auf **App Service auswählen**, um die Auflistung der Web Apps im gleichen Abonnement anzuzeigen. Wählen Sie unter **Ressource** den App Service aus, den Sie als ersten Endpunkt hinzufügen möchten.
...
6.  Wenn Sie das Hinzufügen beider Endpunkte abgeschlossen haben, werden diese unter **Traffic Manager-Profil** zusammen mit ihrem Überwachungsstatus als **Online** angezeigt.
...
Wenn es nicht mehr benötigt wird, löschen Sie die Ressourcengruppe und das erstellte Traffic Manager-Profil. Wählen Sie zu diesem Zweck die Ressourcengruppe unter **Traffic Manager-Profil** aus, und klicken Sie auf **Löschen**.
