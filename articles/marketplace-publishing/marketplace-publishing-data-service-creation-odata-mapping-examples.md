...
Verwenden Sie PUT-Rohdaten zum Erstellen einer neuen Unterordnung oder zum Aktualisieren der gesamten Unterordnung einer serverdefinierten URL.  Dabei ist die Unterordnung ein Datenstrom, der unstrukturiert ist, beispielsweise eine Textdatei.  PUT ist idempotent, weshalb mehrere Vorkommnisse zum selben Zustand führen, d.h. x=5.  PUT sollte mit dem gesamten Inhalt der angegebenen Ressource verwendet werden.
