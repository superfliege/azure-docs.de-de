...
description: Es wird beschrieben, wie Sie für Service Fabric-Cluster das horizontale und zentrale Hoch- und Herunterskalieren durchführen.
...
## <a name="scaling-an-azure-cluster-in-or-out"></a>Horizontales Hoch- oder Herunterskalieren eines Azure-Clusters
...
## <a name="scaling-a-standalone-cluster-in-or-out"></a>Horizontales Herunter- oder Hochskalieren eines eigenständigen Clusters
...
## <a name="scaling-an-azure-cluster-up-or-down"></a>Zentrales Hoch- oder Herunterskalieren eines Azure-Clusters
