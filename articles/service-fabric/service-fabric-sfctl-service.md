...
| --int-scheme-count | Die Anzahl von Partitionen, die im Ganzzahlschlüsselbereich erstellt werden sollen, wenn ein einheitliches ganzzahliges Partitionsschema verwendet wird. |
