...
| --end-time-utc   | Die Anzahl von Takten (Ticks), die die Endzeit des Zeitraums angeben, für den ein
...
| --start-time-utc | Die Anzahl von Takten (Ticks), die die Startzeit des Zeitraums angeben, für den ein Chaos-Bericht generiert werden soll. Ausführliche Informationen zu Ticks finden Sie unter [DateTime.Ticks-Eigenschaft](https://msdn.microsoft.com/en- us/library/system.datetime.ticks%28v=vs.110%29).| | --timeout -t     | Servertimeout in Sekunden.  Standardwert: 60.|
