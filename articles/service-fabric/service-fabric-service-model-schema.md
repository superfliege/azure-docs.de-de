...
|Keine|http://schemas.microsoft.com/2011/01/fabric|

## <a name="component-summary"></a>Komponentenzusammenfassung 
Die folgenden Komponenten werden im http://schemas.microsoft.com/2011/01/fabric-Namespace in ServiceFabricServiceModel.xsd definiert:
- [293 Elemente](service-fabric-service-model-schema-elements.md)
- [103 komplexe Typen](service-fabric-service-model-schema-complex-types.md)
