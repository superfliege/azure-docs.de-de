...
description: Übersicht über die Funktion von Azure Marketplace und AppSource für App- und den Dienstherausgeber
...
Der Azure Marketplace und AppSource sind die Startrampe für gemeinsame Markteinführungsaktivitäten mit Microsoft und das Tor zu Co-Selling-Partnerschaften. Mit Einführungsaktionen, Nachfragegenerierung und gemeinsamem Verkauf und Marketing können Sie Ihre Marketplace-Auflistungen zum Kernstück Ihres Cloudgeschäftsmoduls und zur Triebfeder für Ihr Geschäftswachstum machen. Es werden keine Gebühren für Ihre Teilnahme am Marketplace berechnet. Unser Ziel ist, Microsoft-Kunden mit den besten Lösungen und Diensten zu verbinden, die unser Partnerökosystem bietet.
...
Jede Storefront verfügt über spezielle Veröffentlichungsoptionen, die bewirken sollen, dass sich Ihre Investitionen in die Veröffentlichung noch besser amortisieren. Diese Optionen sind in der folgenden Tabelle zusammengefasst:
...
## <a name="how-to-publish-on-cloud-marketplace"></a>Veröffentlichen im Cloud Marketplace

Ein Cloud Marketplace-Herausgeber zu werden, umfasst drei einfache Schritte:
1.  Bestimmen des idealen Listingtyps für Ihr Angebot
2.  Registrieren als Cloud Marketplace-Herausgeber
3.  Erfüllen der technischen und inhaltlichen Voraussetzungen für das Angebot und den Listingtyp
...
|**Transaktion**     |   Virtual Machine, Lösungsvorlage, verwaltete Anwendung, Container, SaaS-Abonnements      |    Azure Marketplace     |



**2.    Registrieren als Cloudpartnerherausgeber**

Gehen Sie folgendermaßen vor, um sich als Herausgeber in unserem Cloud Marketplace zu registrieren. Abhängig von Ihrem derzeitigen Engagement bei Microsoft und vom ausgewählten Listingtyp sind einige Schritte möglicherweise nicht erforderlich: 

|Schritt für die Marketplace-Registrierung  |Zeit  |BESCHREIBUNG  |
|---------|---------|---------|
| 1. Registrieren im Microsoft Partner Network | 15 Min. | Treten Sie dem Microsoft Partner Network (MPN) bei, um ein offizieller Microsoft-Partner zu werden. Sie erhalten damit weitere Vorteile und Support als Azure Marketplace-Herausgeber. Um die MPN-Registrierung durchzuführen, besuchen Sie das Microsoft Partner Network und klicken auf „Registrieren“. Sie können bei der Registrierung ggf. die vorhandene Mitgliedschaft Ihrer Organisation verwenden. Notieren Sie nach der Registrierung die MPN-ID Ihrer Organisation: Sie werden danach gefragt, wenn Sie Ihr Herausgeberprofil im Cloud-Partnerportal (Schritt 3) aktivieren.      |
|2. Erstellen einer Microsoft-ID     |   15 Minuten      |  Diese Microsoft-ID wird für den Zugriff auf das Cloud-Partnerportal benötigt. Diese E-Mail-Adresse muss als Microsoft-ID registriert werden und wird sowohl für das Cloud-Partnerportal (Schritt 3) als auch das Microsoft Developer Center (Schritt 4) verwendet. Die ausgewählte E-Mail-Adresse sollte idealerweise zu Ihrer Unternehmensdomäne gehören und von Ihrem IT-Team verwaltet werden. Richtlinien zur Erstellung einer ID finden Sie in den Abschnitten unter „Richtlinien und Leitfäden“. |
|3. Übermitteln des Marketplace-Antragsformulars     |  1 - 3 Tage       | Schlagen Sie Ihre Organisation als Microsoft Cloud Marketplace-Herausgeber vor. Das Formular enthält Informationen zu Ihrer Organisation, zum ersten Anwendungs- oder Dienstangebot, das Sie veröffentlichen möchten, und zum Supportgrad, den Sie bereitstellen möchten. <ul><li>[Antragsformular für Azure Marketplace](https://azuremarketplace.microsoft.com/sell/signup)</li><li>[Antragsformular für AppSource](http://aka.ms/listonappsource)</li></ul> Nachdem Sie das Formular übermittelt haben, überprüft das Marketplace-Team die Anwendung und die Anforderung. Nachdem die Anforderung überprüft wurde, werden Sie per E-Mail über die nächsten Schritte informiert, mit denen Sie ein bestätigter Partner werden und auf das Cloud-Partnerportal Zugriff erhalten. Dort können Sie die Auflistung Ihres ersten Angebots abschließen und weitere Angebote erstellen. Nach der Genehmigung erhalten Sie außerdem einen Aktionscode, durch den die Registrierungsgebühr für das Microsoft Developer Center (Schritt 4) entfällt. |
|4. Registrieren im Developer Center     |    5 - 10 Tage     | Das Microsoft Developer Center ist zum Veröffentlichen von Anwendungen im Marketplace erforderlich, die über Transaktionsfunktionen verfügen, z.B. virtuelle Computer, Lösungsvorlagen und verwaltete Azure-Apps. Aufgrund dieser Anforderung kann Microsoft die Informationen zu den rechtlichen, steuerlichen und bankbezogenen Entitäten Ihres Unternehmens überprüfen. Die Person, die das Konto registriert, muss ein offizieller Vertreter der Organisation sein und ihre persönlichen Informationen zur Identitätsüberprüfung bereitstellen. Diese Person muss eine Microsoft-ID (Schritt 2) verwenden, die für das Unternehmen freigegeben ist. Das gleiche Konto muss im Cloud-Partnerportal verwendet werden. <ul>Beachten Sie Folgendes: Wenn Sie das Antragsformular für den Marketplace nicht ausgefüllt haben, fällt eine Registrierungsgebühr in Höhe von 99 USD an. Füllen Sie das Marketplace-Antragsformular aus, um einen Werbeaktionscode per E-Mail zu erhalten und diese Gebühr zu umgehen. Wichtig: Stellen Sie sicher, das Ihr Unternehmen nicht bereits über ein Microsoft Developer Center-Konto verfügt, bevor Sie versuchen, die Erstellung durchzuführen. Eine ausführliche Beschreibung dieses Prozesses finden Sie in den Anweisungen zur Registrierung im Developer Center.</ul>   |
|5. Anmelden am Cloud-Partnerportal     |  15 Minuten       |  Nachdem Ihr Antrag genehmigt wurde und Sie sich beim [Microsoft Partner Network](https://partner.microsoft.com/en-us/membership/) und beim [Microsoft Developer Center](https://dev.windows.com/) registriert haben, wird für Sie ein Konto für den Zugriff auf das [Cloud-Partnerportal](https://cloudpartner.azure.com/) erstellt. Anmeldeinformationen für die erstmalige Anmeldung sind in der E-Mail zur Genehmigung des Antrags enthalten. Ausführliche Informationen zum Verwenden des Cloud-Partnerportals erhalten Sie, wenn Sie sich im Portal im Menü [Lernen](https://cloudpartner.azure.com/#Learn) den Abschnitt „Dokumentation“ durchlesen.    |

**3.    Abschließen der Voraussetzungen für das Angebot und den Listingtyp:**

Die technischen und inhaltlichen (Marketing) Anforderungen variieren je nach Storefront, Angebotstyp und Listingtyp. Die folgenden Spezifikationen müssen erfüllt werden:
-   Storefront-Anforderungen: Azure Marketplace und AppSource
-   Listingtyp-Anforderungen: Listing, Testversion und Transaktion
-   Angebotstyp-Anforderungen: 
 -  App – Virtual Machine, Containers oder SaaS
 -  Beratungsangebot
...
### <a name="go-to-market-benefits"></a>Vorteile bei der Markteinführung

Der Azure Marketplace und AppSource bieten Herausgebern die Möglichkeit, ihre Lösungen Millionen von Kunden zu zeigen. Für neue Listings im Marketplace wird automatisch eine Reihe kostenloser Ressourcen für die Markteinführung angeboten, um Ihr Angebot in unserem Kundenökosystem bekannt zu machen.

Das Listen Ihres Angebots im Marketplace-Storefront ist die Startrampe für gemeinsame Markteinführungsaktivitäten mit Microsoft und das Tor zu Co-Selling-Partnerschaften. Für alle neuen Listings wird automatisch eine Reihe kostenloser Ressourcen für die Markteinführung angeboten, um Ihr Angebot in unserem Kundenökosystem bekannt zu machen. Die Vorteile für die Markteinführung umfassen eine Reihe von Co-Marketing- und Co-Selling-Aktivitäten, die unsere Marke, unsere Kanäle und unser Ökosystem nutzen, um Partnern dabei zu helfen, ihre Lösung bekannt zu machen und Umsätze zu generieren. Von den Partnern ist hier keine Aktion erforderlich. Sobald ein Angebot veröffentlicht wurde, kontaktiert unser Markteinführungsteam den Partner, um mit der Auslieferung zu beginnen.
Weitere Informationen zu unseren Vorteilen für die Markteinführung und den Möglichkeiten, Ihr Business im Marketplace auszubauen, finden Sie unter [Microsoft Go-To-Market Services](https://partner.microsoft.com/en-US/reach-customers/gtm).
...
**AppSource: Voraussetzungen für Veröffentlichungsoptionen**

|**Anforderung**  |**Details**  |**Erforderlich oder empfohlen**  |
|---------|---------|---------|
|**Azure Active Directory (AAD)**    |  Ihre App muss einmalige Azure Active Directory-Verbundanmeldung (AAD federated SSO, Azure Active Directory federated Single Sign-On) mit aktivierter Zustimmung zulassen. Hier finden Sie weitere Informationen zum Aktivieren der AAD-SSO-Verbundanmeldung     |    Erforderlich   |
|**Integration in Microsoft Cloud-Dienste**    |  Ihre App sollte auch in andere Microsoft Cloud-Dienste wie z.B. Microsoft Power BI, Cortana Intelligence oder in Microsoft Azure-Dienste wie z.B. Internet der Dinge (IoT) integriert sein.       |    Empfohlen    |
|**Zielgruppe**    |  AppSource-Angebote müssen für Line-of-Business-Benutzer und Geschäftsinhaber gelten     |    Erforderlich   |
|**SaaS-App (Software-as-a-Service) für Unternehmen**    |  Ihre App muss: <ul><li>eine Line-of-Business-SaaS-App sein</li><li>den Fokus auf Geschäftsprozesse legen</li><li>an Geschäftskunden gerichtet sein</li><li>Benutzern erlauben, sich mit ihren Unternehmensanmeldeinformationen (Benutzername und Kennwort) anzumelden</li></ul>       |    Erforderlich    |
|**Kostenloser Testzeitraum und Testversion**    |  Ein Kunde muss Ihre App für begrenzte Zeit kostenlos verwenden können. Ihre kostenlose Testversion kann eine von zwei Formen annehmen: <ul><li>Stellen Sie eine Testoption bereit, damit Kunden eine Testversion aus AppSource heraus starten können.</li><li>Geben Sie Kunden die Möglichkeit, in AppSource eine Testversion anzufordern.</li></ul> Bei beiden Methoden muss die kostenlose Testversion dem Kunden ausreichend Zeit lassen, die App ohne zusätzliche Kosten zu testen.      |    Erforderlich    |
|**Leicht konfigurierbare, schlüsselfertige Lösung**    |  Ihre App muss sich einfach und schnell konfigurieren und einrichten lassen (keine Anpassung erforderlich).     |    Erforderlich   |
|**Leadverwaltung**    |  Um Leads vom Marketplace zu erhalten, müssen Sie Ihr Kundenbeziehungsmanagement (Customer Relationship Management, CRM) (Marketo, Microsoft Dynamics oder Salesforce) für den Empfang von Leaddaten aktivieren.       |    Erforderlich    |
|**Datenschutz- und Nutzungsrichtlinien**    |  Ihre Datenschutzrichtlinie muss über eine öffentliche URL verfügbar sein. Die Nutzungsbedingungen müssen während der Veröffentlichung als Text eingegeben werden.     |    Erforderlich   |
|**Unterstützung**    |  Ihr Angebot muss eine öffentlich zugängliche Support-URL enthalten, unter der Kunden Hilfe bekommen können. Für Testversionen muss der Support im Testzeitraum ohne zusätzliche Kosten geleistet werden.     |    Erforderlich   |

**Azure Marketplace: Voraussetzungen für Veröffentlichungsoptionen**
...
#### <a name="prerequisites-specific-to-transaction-publishing-for-containers"></a>Besondere Voraussetzungen für die Transaktionsveröffentlichung für Container
...
|**Partneranforderungen für Beratungsdienste**    |  *Nur Azure Marketplace:* <br>Partner müssen zudem über eine **Silver- oder Gold-Kompetenz** im entsprechenden Bereich für ihren Dienst verfügen. Die Berechtigungskompetenzen sind im Folgenden aufgeführt:</br><br><ul><li> **Kompetenz:** Cloudplattform und -infrastruktur <br>**Lösungsbereich:** Cloudplattform, Rechenzentrum</li><br><li>**Kompetenz:** Anwendungsentwicklung und ISV <br>**Lösungsbereich:** Anwendungsentwicklung, Anwendungsintegration, DevOps</li><br><li>**Kompetenz:** Datenverwaltung und -analyse <br>**Lösungsbereich:** Datenanalyse, Datenplattform </li></br></ul>Weitere Informationen finden Sie unter [Kompetenzen über das Microsoft Partner Network](https://partner.microsoft.com/en-US/membership/competencies).</br><br>Weitere Informationen zum Listing finden Sie unter [Beratungsdienste in Azure Marketplace](https://docs.microsoft.com/en-us/azure/marketplace/consulting-services) |    Auflisten     | 
...
|Erforderliches Veröffentlichungsartefakt  |Angebotstyp  |
|---------|---------|
|**Titel (max. 50 Zeichen)**    |  Transaktion: Virtuelle Computer, Azure-Apps (Lösungsvorlagen und verwaltete Apps), Container, SaaS-Abonnements       |
|**Zusammenfassung (max. 200 Zeichen)**    |  Transaktion: Virtuelle Computer, Azure-Apps (Lösungsvorlagen und verwaltete Apps), Container, SaaS-Abonnements       |
|**Lange Zusammenfassung (max. 256 Zeichen)**     |   Transaktion: Virtuelle Computer, Azure-Apps (Lösungsvorlagen und verwaltete Apps), Container, SaaS-Abonnements      |
|**HTML-basierte Beschreibung (max. 3.000 Zeichen)**    |  Transaktion: Virtuelle Computer, Azure-Apps (Lösungsvorlagen und verwaltete Apps), Container, SaaS-Abonnements      |
|**Unternehmenslogos (40 x 40, 90 x 90, 115 x 115, 255 x 115, 815 x 290)**    |  Transaktion: Virtuelle Computer, Azure-Apps (Lösungsvorlagen und verwaltete Apps), Container, SaaS-Abonnements     |
...
|**Repositorydetails zum ACR-Image (Azure Container Registry), einschließlich Abonnement-ID, Ressourcengruppenname, Registrierungsname, Repositoryname, Benutzername, Kennwort und Imagetags (optional)** | Transaktion: Container |
...
**Zertifizieren Ihrer Azure AD-Integration für den Marketplace: Mehrinstanzenfähige Anwendungen**
...
**Zertifizieren Ihrer Azure AD-Integration für den Marketplace: Anwendungen mit nur einem Mandanten**
...
In diesem Abschnitt werden die folgenden Schritte beschrieben: <ul><li>Der Weg zum Herausgeber im Azure Marketplace und AppSource.</li><li>Zugreifen auf das Cloud-Partnerportal. Sie nutzen dieses Portal zum Erstellen, Veröffentlichen und Verwalten Ihres Angebots.</li></ul>
...
|2. Erstellen einer Microsoft-ID     |   15 Minuten      |  Diese Microsoft-ID wird für den Zugriff auf das Cloud-Partnerportal benötigt. Diese E-Mail-Adresse muss als Microsoft-ID registriert werden und wird sowohl für das Cloud-Partnerportal (Schritt 3) als auch das Microsoft Developer Center (Schritt 4) verwendet. Die ausgewählte E-Mail-Adresse sollte idealerweise zu Ihrer Unternehmensdomäne gehören und von Ihrem IT-Team verwaltet werden. Richtlinien zur Erstellung einer ID finden Sie in den Abschnitten unter „Richtlinien und Leitfäden“. |
|3. Übermitteln des Marketplace-Antragsformulars     |  1 - 3 Tage       | Schlagen Sie Ihre Organisation als Microsoft Cloud Marketplace-Herausgeber vor. Das Formular enthält Informationen zu Ihrer Organisation, zum ersten Anwendungs- oder Dienstangebot, das Sie veröffentlichen möchten, und zum Supportgrad, den Sie bereitstellen möchten. <ul><li>[Antragsformular für Azure Marketplace](https://azuremarketplace.microsoft.com/sell/signup)</li><li>[Antragsformular für AppSource](http://aka.ms/listonappsource)</li></ul> Nachdem Sie das Formular übermittelt haben, überprüft das Marketplace-Team die Anwendung und die Anforderung. Nachdem die Anforderung überprüft wurde, werden Sie per E-Mail über die nächsten Schritte informiert, mit denen Sie ein bestätigter Partner werden und auf das Cloud-Partnerportal Zugriff erhalten. Dort können Sie die Auflistung Ihres ersten Angebots abschließen und weitere Angebote erstellen. Nach der Genehmigung erhalten Sie außerdem einen Aktionscode, durch den die Registrierungsgebühr für das Microsoft Developer Center (Schritt 4) entfällt. |
|4. Registrieren im Developer Center     |    5 - 10 Tage     | Das Microsoft Developer Center ist zum Veröffentlichen von Anwendungen im Marketplace erforderlich, die über Transaktionsfunktionen verfügen, z.B. virtuelle Computer, Lösungsvorlagen, verwaltete Azure-Apps, Container und SaaS-Abonnements. Aufgrund dieser Anforderung kann Microsoft die Informationen zu den rechtlichen, steuerlichen und bankbezogenen Entitäten Ihres Unternehmens überprüfen. Die Person, die das Konto registriert, muss ein offizieller Vertreter der Organisation sein und ihre persönlichen Informationen zur Identitätsüberprüfung bereitstellen. Diese Person muss eine Microsoft-ID (Schritt 2) verwenden, die für das Unternehmen freigegeben ist. Das gleiche Konto muss im Cloud-Partnerportal verwendet werden. <ul>Beachten Sie Folgendes: Wenn Sie das Antragsformular für den Marketplace nicht ausgefüllt haben, fällt eine Registrierungsgebühr in Höhe von 99 USD an. Füllen Sie das Marketplace-Antragsformular aus, um einen Werbeaktionscode per E-Mail zu erhalten und diese Gebühr zu umgehen. Wichtig: Stellen Sie sicher, das Ihr Unternehmen nicht bereits über ein Microsoft Developer Center-Konto verfügt, bevor Sie versuchen, die Erstellung durchzuführen. Eine ausführliche Beschreibung dieses Prozesses finden Sie in den Anweisungen zur Registrierung im Developer Center.</ul>   |
|5. Anmelden am Cloud-Partnerportal     |  15 Minuten       |  Nachdem Ihr Antrag genehmigt wurde und Sie sich beim [Microsoft Partner Network](https://partner.microsoft.com/en-us/membership/) und beim [Microsoft Developer Center](https://dev.windows.com/) registriert haben, wird für Sie ein Konto für den Zugriff auf das [Cloud-Partnerportal](https://cloudpartner.azure.com/) erstellt. Anmeldeinformationen für die erstmalige Anmeldung sind in der E-Mail zur Genehmigung des Antrags enthalten. Ausführliche Informationen zum Verwenden des Cloud-Partnerportals erhalten Sie, wenn Sie sich im Portal im Menü [Lernen](https://cloudpartner.azure.com/#Learn) den Abschnitt „Dokumentation“ durchlesen.    |


#### <a name="guidelines-and-how-tos"></a>Richtlinien und Leitfäden

**Richtlinien zur Erstellung einer Microsoft-ID für die Verwaltung eines Azure Marketplace-Kontos**
...
**Kommerzielle Aspekte im Marketplace**
...
**Abrechnungsoptionen „Nutzungsbasierte Zahlung“ und „BYOL“**
...
**Einzelabrechnung und Zahlungsmethoden**
...
### <a name="azure-marketplace-vs-appsource"></a>Azure Marketplace und AppSource
...
Die Auswahl einer Storefront beginnt mit dem Identifizieren der Zielgruppe für Ihr Angebot. Falls sich Ihre Lösung an beide Zielgruppen richtet, müssen Sie für die Auflistung in beiden Storefronts nur eine Veröffentlichung durchführen.
