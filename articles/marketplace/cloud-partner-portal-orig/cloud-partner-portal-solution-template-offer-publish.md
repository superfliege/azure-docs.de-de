---
title: Veröffentlichen einer Azure-Lösungsvorlage | Microsoft-Dokumentation
description: Veröffentlichen Sie eine Lösungsvorlage im Azure Marketplace.
...
- [Grundlegendes zu Azure Resource Manager-Vorlagen](https://docs.microsoft.com/azure/azure-resource-manager/resource-group-authoring-templates).
- Azure-Schnellstartvorlagen:
 ...
 - Aktivieren Sie die [Zuordnung der Nutzung durch Kunden](./../azure-partner-customer-usage-attribution.md), um die Azure-Nutzung durch Kundenbereitstellungen von Software in Azure besser verfolgen zu können.
...
- Stellen Sie Inhalte bereit, welche die notwendigen Kriterien erfüllen, damit Ihr Angebot im Azure Marketplace und im Azure-Portal gelistet wird.
...
1. Wählen Sie **SKUs** aus. 
    ...
    Die SKU-ID ist ein eindeutiger Bezeichner für die SKU in einem Angebot. Diese ID ist in den Produkt-URLs, den Ressourcen-Manager-Vorlagen und in den Abrechnungsberichten sichtbar. Die SKU-ID:
...
-   Vermeiden Sie die Platzierung von Text auf dem Logo. Diese Richtlinie gilt auch für Ihren Firmen- oder Markennamen. Das Erscheinungsbild Ihres Logos sollte *klar und direkt* und frei von Farbverläufen sein.
