---
title: Konfigurieren von SKUs für ein Azure-Anwendungsangebot | Microsoft-Dokumentation
...
- **SKU-Typ:** eine Dropdownliste mit den folgenden Werten: „Lösungsvorlage“ und „Verwaltete Anwendung“. Wählen Sie für dieses Szenario **Lösungsvorlage** aus.
- **Cloudverfügbarkeit:** der Standort der SKU. Der Standardwert ist **Azure, öffentlich**.
Azure, öffentlich: Dieser virtuelle Computer kann für Kunden in allen öffentlichen Azure-Regionen bereitgestellt werden, die über Marketplace-Integration verfügen.
- **Azure Government Cloud:** Dieser virtuelle Computer wird in der Azure Government Cloud bereitgestellt. Den Herausgebern wird von Microsoft empfohlen, vor der Veröffentlichung in [Azure Government](https://docs.microsoft.com/azure/azure-government/documentation-government-manage-marketplace-partners) zu testen und zu überprüfen, ob ihre Lösung in der Umgebung erwartungsgemäß funktioniert. Fordern Sie zum Bereitstellen und Testen ein [Testkonto](https://azure.microsoft.com/offers/ms-azr-usgov-0044p/) an.
...
Konfigurieren Sie die folgenden SKU-Einstellungen:

- **Titel:** ein Titel für die SKU. Dieser Titel wird im Katalog für dieses Element angezeigt.
- **Zusammenfassung:** eine kurze Beschreibung der SKU. (Die maximale Länge beträgt 100 Zeichen.)
- **Beschreibung:** eine ausführliche Beschreibung der SKU.
- **SKU-Typ:** eine Dropdownliste mit den folgenden Werten: „Lösungsvorlage“ und „Verwaltete Anwendung“. Wählen Sie für dieses Szenario die Option **Verwaltete Anwendung** aus.
- **Cloudverfügbarkeit:** der Standort der SKU. Der Standardwert ist **Azure, öffentlich**.
- **Azure, öffentlich:** Dieser virtuelle Computer kann für Kunden in allen öffentlichen Azure-Regionen bereitgestellt werden, die über Marketplace-Integration verfügen.
- **Azure Government Cloud:** Dieser virtuelle Computer wird in der Azure Government Cloud bereitgestellt. Den Herausgebern wird von Microsoft empfohlen, vor der Veröffentlichung in [Azure Government](https://docs.microsoft.com/azure/azure-government/documentation-government-manage-marketplace-partners) zu testen und zu überprüfen, ob ihre Lösung in der Umgebung erwartungsgemäß funktioniert. Fordern Sie zum Bereitstellen und Testen ein [Testkonto](https://azure.microsoft.com/offers/ms-azr-usgov-0044p/) an.
...
Fügen Sie die Richtlinien hinzu, denen die verwaltete Anwendung entspricht. Weitere Informationen zu Azure-Ressourcenrichtlinien finden Sie unter [Was ist Azure Policy?](https://docs.microsoft.com/azure/azure-policy/azure-policy-introduction) 
