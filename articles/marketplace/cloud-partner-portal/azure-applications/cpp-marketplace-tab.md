---
title: Registerkarte „Marketplace“ für ein Azure-Anwendungsangebot | Microsoft-Dokumentation
...
In der folgenden Tabelle sind die Einstellungen beschrieben, mit denen eine digitale Ladenzeile (Storefront) für das Angebot erstellt wird.
...
|         Nützliche Links           |        Sie können für Benutzer Ihres Angebots Links zu verschiedenen Ressourcen bereitstellen, z. B. Support, Dokumentation, Foren usw. Sie müssen mindestens einen Link hinzufügen, der zu Ihrer Dokumentation führt.            |
...
|       Breite             |        PNG-Format, 255 x 115 Pixel           |
|       Hero             |        PNG-Format, 815 x 290 Pixel Optional. **Hinweis:** Nachdem das Herologo hochgeladen wurde, kann es nicht mehr gelöscht werden.           |
