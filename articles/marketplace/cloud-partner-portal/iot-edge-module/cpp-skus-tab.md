---
title: SKUs für ein Azure IoT Edge-Modul | Microsoft-Dokumentation
...
In der folgenden Tabelle werden der Zweck, der Inhalt und die Formatierung der Felder unter **SKU-Details** beschrieben.
...
| **Hide this SKU** (Diese SKU ausblenden) | Behalten Sie die Standardeinstellung **Nein** bei. |
...
In der folgenden Tabelle werden der Zweck, der Inhalt und die Formatierung der Felder in folgenden Abschnitten beschrieben:
...
### <a name="help-your-customers-launch-your-iot-edge-module-by-using-default-settings"></a>Unterstützung Ihrer Kunden beim Starten Ihres IoT Edge-Moduls durch Verwenden von Standardeinstellungen
...
<br/> Wählen Sie **Speichern** aus, um die SKU-Einstellungen zu speichern. 
