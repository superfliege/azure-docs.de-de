---
title: Dynamics 365 for Customer Engagement-Angebot – Registerkarte „Details der digitalen Ladenzeile“ – Azure Marketplace | Microsoft-Dokumentation
...
|  Beschreibung des Angebots    | Beschreibung, die auf der Detailseite Ihrer App angezeigt wird. Das Format ist einfacher HTML-Code (einschließlich p, em, ul, li, ol und Kopfzeilentag) mit maximal 1.300 Zeichen.  |
|  |  | 
...
|  Categories           | Wählen Sie die Kategorien aus, die für die App relevant sind. Wählen Sie eine bis drei Optionen aus.  |
...
|      Feld            |    BESCHREIBUNG                 |
|  ---------------      |  ---------------               |
| Angebotslogo (PNG-Format, 48 x 48) | Laden Sie ein Bild hoch, das auf der Suchseite Ihrer App angezeigt wird. Das Format ist PNG, und die Größe muss 48 x 48 Pixel betragen. |
| Angebotslogo (PNG-Format, 216 x 216) | Laden Sie ein Bild hoch, das auf der Detailseite Ihrer App angezeigt wird. Das Format ist PNG, und die Größe muss 216 x 216 Pixel betragen. |
...
|      Feld            |    BESCHREIBUNG                 |
|  ---------------      |  ---------------               |
| Datenschutzrichtlinien-URL    | URL der Online-Datenschutz-Richtlinie für Ihre App.  |
