---
title: Selbsttestclient zur Vorabüberprüfung einer Azure-SaaS-Anwendung | Microsoft-Dokumentation
description: Erstellen eines Selbsttestclients für die Vorabüberprüfung einer Azure-SaaS-Anwendung.
...
ms.locfileid: "54082361"
---
# <a name="create-a-self-test-client-to-pre-validate-an-azure-saas-application"></a>Erstellen eines Selbsttestclients für die Vorabüberprüfung einer Azure-SaaS-Anwendung
...
Die API hat die folgende Struktur.
...
|          DNSName          |         Der DNS-Name des virtuellen Computers, den Sie testen möchten.          |
|          Benutzer          |          Benutzername für das Herstellen einer Verbindung mit der VM und Anmelden bei der VM.         |
|           Kennwort         |         Das Kennwort für das Herstellen einer Verbindung mit der VM und Anmelden bei der VM.          |
|          Betriebssystem          |         Das Betriebssystem des virtuellen Computers, entweder „Linux“ oder „Windows“.          |
|         PortNo           |         Die Nummer des Ports, der für das Herstellen der Verbindung mit dem virtuellen Computer geöffnet ist. Die Nummer des Ports ist in der Regel „22“ für Linux und „5986“ für Windows.          |
...
Die folgende Bildschirmaufnahme zeigt ein Beispiel für JSON-Testergebnisse, die in einem Online-JSON-Viewer angezeigt werden.
...
3. Geben Sie unter **Erstellen** die erforderlichen Informationen für die folgenden Felder ein:
   ...
   - **Anmelde-URL**: Geben Sie „https://isvapp.azurewebsites.net/selftest“ ein.
...
Nachdem Sie Ihre Azure-SaaS-Anwendung erfolgreich getestet haben, können Sie [das Angebot veröffentlichen](./cpp-publish-offer.md).