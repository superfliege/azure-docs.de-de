...
| Storefronteinstellungen | Bewährte Methode |
|:--- |:--- |  
| Branchen: Nur AppSource-Apps und Beratungsdienste | Wählen Sie Branchen aus, wenn Ihr Angebot branchenspezifische Anforderungen erfüllt:<br>Führen Sie diese branchenspezifischen Funktionen in Ihrer Angebotsbeschreibung auf.<br><br>**Hinweis:** Die maximale Anzahl von Optionen hängt vom Angebotstyp ab und ist im Cloud-Partnerportal angegeben. |
| Categories | Wählen Sie Kategorien aus, zu denen Ihr Angebot am besten passt:<br>Wählen Sie diese Kategorien sorgfältig aus, da die Kunden sie für die Suche nach relevanten Apps nutzen. Stellen Sie sicher, dass Sie in der Angebotsbeschreibung angeben, wie Ihr Angebot kategoriespezifische Anforderungen berücksichtigt.<br><br> **Hinweis:** Die maximale Anzahl von Optionen hängt vom Angebotstyp ab und ist im Cloud-Partnerportal angegeben. |
| Produkte, mit denen Ihre App zusammenarbeitet (maximal&nbsp;3): nur AppSource-Apps | Listen Sie weitere Produkte und Technologien auf, die Ihre Lösung nutzt oder erweitert:<br>Beispiele: Azure IoT Hub oder Azure Machine Learning. |
| Suchbegriffe (maximal&nbsp;3) | Suchbegriffe helfen geschäftlichen Benutzern, Ihr Angebot bei einer Suche im Azure Marketplace, in AppSource oder in Suchmaschinen zu finden:<br>Bestimmen Sie die drei wichtigsten Suchbegriffe für Ihr Angebot, fügen Sie sie in Ihre Angebotsübersicht und -beschreibung ein, und listen Sie sie hier auf. |
...
| Dokumente mit weiteren Informationen | Fügen Sie ergänzende Vertriebs- und Marketingressourcen unter „Weitere Informationen“ hinzu:<br>Beispiele: Whitepaper, Broschüren, Checklisten oder PowerPoint-Präsentationen. Speichern Sie alle Dateien im PDF-Format. Ihr Ziel sollte sein, die Kunden zu informieren, nicht ihnen etwas zu verkaufen.<br><br>Fügen Sie allen Ihren Dokumenten den Link zu Ihrer App-Angebotsseite hinzu. Fügen Sie außerdem URL-Parameter hinzu, damit Sie Besucher und Tests verfolgen können. |
| Videos: nur AppSource, Beratungsdienste und SaaS-Angebote | Die besten Videos kommunizieren den Nutzen Ihres Angebots in erzählerischer Form:<br>Stellen Sie Ihre Kunden und nicht Ihre Firma in den Mittelpunkt der Story. Ihr Video sollte die wichtigsten Herausforderungen und Ziele der Zielkunden ansprechen.<br><br>Empfohlene Länge: 60 bis 90 Sekunden.<br><br>Binden Sie wichtige Suchbegriffe in den Namen der Videos ein.<br><br>Erwägen Sie das Hinzufügen weiterer Videos, wie z.B. eines Anleitungsvideos, eines Videos für den Einstieg oder eines Videos mit Kundenstimmen. |
...
* Optimieren Sie Ihre Listung zum Verbessern des Suchmaschinenrankings.<br>Integrieren Sie Suchbegriffe in den Namen, die Zusammenfassung und die Listung Ihrer App. 
...
Die Zielgruppe ist für jede Branche, jeden vertikalen Markt oder jede Kategorie anders. Informiert sich Ihre Zielgruppe online, per E-Mail, auf Messen, über soziale Medien oder in Gesprächen mit vertrauenswürdigen Ratgebern? Abhängig davon, wo und wie Ihre Zielgruppe sich informiert, sollten Sie Ihre Aktivitäten gestalten und Ihr Marketingbudget entsprechend verteilen. Die Kombination dieser Taktiken wird Ihre Kampagnenstrategie.
...
Als im Marketplace ausgewählte Angebote qualifizieren sich Angebote, die ein herausragendes Kundenerlebnis bieten und hochwertige Partnermarketingfunktionen nutzen. Die folgenden Kriterien erhöhen die Wahrscheinlichkeit, dass Ihre Lösung zu den im Marketplace ausgewählten Angeboten gehört:
