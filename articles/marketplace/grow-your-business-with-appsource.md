...
## <a name="how-to-grow-your-business-with-appsource"></a>Ausbauen Ihres Geschäfts mit AppSource  
...
Ihre Listung in AppSource kann die erste Interaktion mit einem potenziellen Kunden sein. Wie jeder erste Eindruck soll auch dieser positiv sein und weiteres Interesse Ihrer Zielgruppe wecken. Arbeiten Sie eng mit Ihrem Marketingteam zusammen, um sicherzustellen, dass die Botschaften und unterstützenden Inhalte in Ihrer Listung sich von anderen unterscheiden und Ihr Angebot herausstellen. 

Es gibt einige grundlegende Dinge, die Sie tun können, um einen guten ersten Eindruck zu vermitteln. 

![Erster Eindruck](./media/marketplace-appsource/appsourcefirstimpression.png)

Der nächste Abschnitt führt Sie durch die verschiedenen Schritte, die erforderlich sind, um Ihr Angebot im Marketplace einzustellen. Lesen Sie ihn sorgfältig durch, da er bewährte Methoden enthält, die helfen können, Ihre App herauszustellen und Suchmaschinenrankings zu verbessern. 

In den folgenden Tabellen sind die einzelnen Schritte zum Ausfüllen Ihrer Angebotslistung aufgeführt.
...
| Einstellungen der digitalen Ladenzeile | Bewährte Methoden | 
|:--- |:--- |
| **Branchen (max. 2)** | Wählen Sie bis zu zwei Branchen, wenn Ihr Angebot branchenspezifische Anforderungen erfüllt. Achten Sie darauf, diese branchenspezifischen Besonderheiten in der Angebotsbeschreibung aufzuführen. |
| **Kategorien (max. 3)** | Wählen Sie bis zu drei Kategorien, zu denen Ihr Angebot am besten passt. Wählen Sie diese Kategorien sorgfältig aus, da die Benutzer sie für die Suche nach relevanten Apps nutzen. Stellen Sie sicher, dass Sie in der Angebotsbeschreibung angeben, wie Ihr Angebot kategoriespezifische Anforderungen berücksichtigt. |
| **Produkte, mit denen Ihre App zusammenarbeitet (max. 3)** | Listen Sie weitere Produkte und Technologien auf, die Ihre Lösung nutzt. Beispiele: Azure IOT Hub, Azure Machine Learning usw. |
| **Suchbegriffe (max. 3)** | Suchbegriffe helfen geschäftlichen Benutzer bei der Suche auf AppSource oder in Suchmaschinen, Ihr Angebot zu finden. Bestimmen Sie die 3 wichtigsten Suchbegriffe für Ihr Angebot, fügen Sie sie in Ihre Angebotsübersicht und -beschreibung ein, und listen Sie sie hier auf. |

**Details der digitalen Ladenzeile: Marketing-Artefakte**  

| Einstellungen der digitalen Ladenzeile | Bewährte Methoden | 
|:--- |:--- |
| **Angebotslogo (PNG-Format, 48x48)** | Ihr Logo muss für ein digitales Medium konzipiert und optimiert sein.<br />Laden Sie das Logo im PNG-Format auf die Suchseite des Angebots hoch. |
...
### <a name="link-to-landing-page"></a>Link zur Angebotsseite
