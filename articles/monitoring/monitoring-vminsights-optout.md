---
title: Deaktivieren der Überwachung mit Azure Monitor für VMs (Vorschau) | Microsoft-Dokumentation
...
ms.locfileid: "51219943"
---
# <a name="how-to-disable-monitoring-of-your-virtual-machines-with-azure-monitor-for-vms-preview"></a>Deaktivieren der Überwachung Ihrer virtuellen Computer mit Azure Monitor für VMs (Vorschau)
...
* Zwei Azure-VM-Erweiterungen – **MicrosoftMonitoringAgent** und **DepenendencyAgent** –, die Daten sammeln und an den Arbeitsbereich senden.
...
Die folgenden Schritte beschreiben, wie Sie Azure Monitor für VMs vollständig entfernen, wenn Sie den Log Analytics-Arbeitsbereich weiterhin benötigen. Sie werden die Lösungen **InfastructureInsights** und **ServiceMap** aus dem Arbeitsbereich entfernen.  
...
Wenn Sie vor der Integration von Azure Monitor für VMs die [aktivierten Leistungsindikatoren](monitoring-vminsights-onboard.md?toc=/azure/azure-monitor/toc.json#performance-counters-enabled) für die Windows- oder Linux-basierten VMs in Ihrem Arbeitsbereich nicht gesammelt haben, müssen Sie diese Regeln deaktivieren. Führen Sie dazu die [hier](../log-analytics/log-analytics-data-sources-performance-counters.md?toc=/azure/azure-monitor/toc.json#configuring-performance-counters) beschriebenen Schritte für Windows bzw. Linux aus.
