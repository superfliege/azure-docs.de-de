...
![Runbook bearbeiten](media/monitoring-runbook-datacollect/edit-runbook.png)
...
![Testen des Runbooks](media/monitoring-runbook-datacollect/test-runbook.png)
...
4. Stellen Sie sicher, dass die Ausgabe keine Fehler im POST-Befehl an Log Analytics anzeigt.  Es wird eine Meldung ähnlich der folgenden angezeigt.
    ...
    ![POST-Ausgabe](media/monitoring-runbook-datacollect/post-output.png)

## <a name="5-verify-records-in-log-analytics"></a>5. Überprüfen Sie die Datensätze in Log Analytics
Sobald das Runbook im Test abgeschlossen wurde und Sie den erfolgreichen Empfang der Ausgabe überprüft haben, können Sie überprüfen, ob die Datensätze mit einer [Protokollsuche in Log Analytics](../log-analytics/log-analytics-queries.md) erstellt wurden.

![Protokollausgabe](media/monitoring-runbook-datacollect/log-output.png)
...
![Runbook veröffentlichen](media/monitoring-runbook-datacollect/publish-runbook.png)
...
![Protokollierung und Nachverfolgung](media/monitoring-runbook-datacollect/logging.png)
...
![Planen des Runbooks](media/monitoring-runbook-datacollect/schedule-runbook.png)
...
![Aufträge](media/monitoring-runbook-datacollect/jobs.png)
...
5. Scrollen Sie nach unten, um einen Eintrag ähnlich der folgenden Abbildung zu suchen.<br>![Ausführlich](media/monitoring-runbook-datacollect/verbose.png)
...
- Packen Sie Ihr Runbook in einer [Verwaltungslösung](monitoring-solutions-creating.md), um sie an Kunden zu verteilen.
