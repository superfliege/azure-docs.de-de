...
Dieser Artikel enthält bewährte Methoden für das [Erstellen einer Verwaltungslösungsdatei](monitoring-solutions-solution-file.md) in Azure.  Diese Informationen werden aktualisiert, sobald weitere bewährte Methoden ermittelt wurden.
...
- Konfigurieren Sie die Lösung so, dass sie die Ansicht [enthält](monitoring-solutions-solution-file.md#solution-resource), damit diese beim Entfernen der Lösung entfernt wird.
...
- Konfigurieren Sie die Lösung so, dass auf Warnungsregeln [verwiesen](monitoring-solutions-solution-file.md#solution-resource) wird, damit die Benutzer ihre Konfiguration ändern können.  Möglicherweise möchten die Benutzer die Empfängerliste oder den Schwellenwert der Warnung ändern oder die Warnungsregel deaktivieren. 


## <a name="next-steps"></a>Nächste Schritte
* Durchlaufen Sie die grundlegenden Schritte zum [Entwerfen und Erstellen einer Verwaltungslösung](monitoring-solutions-creating.md).
* Lesen Sie die Informationen zum [Erstellen einer Verwaltungslösungsdatei](monitoring-solutions-solution-file.md).
...
* [Hinzufügen von Automation-Runbooks und anderen Ressourcen](monitoring-solutions-resources-automation.md) zu Ihrer Verwaltungslösung
