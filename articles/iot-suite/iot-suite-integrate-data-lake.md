...
Für diese schrittweise Vorgehensweise ist Folgendes erforderlich:
...
* [Bereitstellen eines Azure Data Lake Store](/data-lake-store/data-lake-store-get-started-portal)
  * Ihr Data Lake Store sollte in der gleichen Region wie Ihre Remoteüberwachungslösung bereitgestellt werden.
  * [Erstellen Sie einen Ordner](/data-lake-store/data-lake-store-get-started-portal#createfolder) mit dem Namen „streaming“ in Ihrem Konto.
...
1. Klicken Sie im Azure-Portal auf die Schaltfläche **Cloud Shell**.
    ...
    ![Symbol für den Portalstart](media/iot-suite-integrate-data-lake/portal-launch-icon.png)
...
1. Klicken Sie auf **Ressource erstellen**, wählen Sie Internet der Dinge (IoT) aus Marketplace aus, und klicken Sie dann auf **Stream Analytics-Auftrag**.
    ...
    ![Neuer Stream Analytics-Auftrag](media/iot-suite-integrate-data-lake/new-stream-analytics-job.png)
...
1. Klicken Sie auf **Erstellen**.
    ...
    ![Erstellen eines Stream Analytics-Auftrags](media/iot-suite-integrate-data-lake/create-stream-analytics-job.png)
...
1. Klicken Sie auf der Seite „Übersicht“ auf **Eingaben**.
    ...
    ![Seite „Übersicht“](media/iot-suite-integrate-data-lake/stream-analytics-overview.png)

1. Klicken Sie auf **Datenstromeingabe hinzufügen**, und wählen Sie dann **IoT Hub** aus der Dropdownliste aus.

    ![Hinzufügen der Eingabe](media/iot-suite-integrate-data-lake/stream-analytics-add-input.png)
...
1. Wählen Sie aus der Dropdownliste „Consumergruppe“ die Consumergruppe aus, die Sie zuvor erstellt haben. Hier verwenden wir **streamanalyticsjob**.
    ...
    ![Auswählen der Eingabe](media/iot-suite-integrate-data-lake/stream-analytics-new-input.png)

1. Klicken Sie auf **Speichern**.

1. Klicken Sie auf der Seite „Übersicht“ auf **Ausgaben**.

    ![Hinzufügen von Data Lake Store](media/iot-suite-integrate-data-lake/stream-analytics-overview-2.png)

1. Klicken Sie auf **Hinzufügen**, und wählen Sie **Data Lake Store** aus der Dropdownliste aus.

    ![Hinzufügen der Ausgabe](media/iot-suite-integrate-data-lake/stream-analytics-output.png)
...
1. Geben Sie im Feld Datumsformat **/streaming/ {Datum}/{Uhrzeit}** ein. Behalten Sie das Standarddatumsformat JJJJ/MM/TT und das Uhrzeitformat HH bei.
    ...
    ![Bereitstellen der Ordnerstruktur](media/iot-suite-integrate-data-lake/stream-analytics-new-output.png)
...
1. Klicken Sie auf **Autorisieren**.
    ...
    ![Autorisieren von Stream Analytics für Data Lake Store](media/iot-suite-integrate-data-lake/stream-analytics-out-authorize.png)
...
1. Klicken Sie auf der Registerkarte „Übersicht“ auf **Abfrage bearbeiten**.
    ...
    ![Abfrage bearbeiten](media/iot-suite-integrate-data-lake/stream-analytics-edit-query.png)
...
1. Ersetzen Sie im Abfrage-Editor die Platzhalter [YourOutputAlias] und [YourInputAlias] durch die zuvor definierten Werte.
    ...
    ![Stream Analytics-Abfrage](media/iot-suite-integrate-data-lake/stream-analytics-query.png)
...
1. Klicken Sie auf der Registerkarte „Übersicht“ auf **Start**.
    ...
    ![Starten des Stream Analytics-Auftrags](media/iot-suite-integrate-data-lake/stream-analytics-start.png)
...
1. Klicken Sie auf **Start**.
    ...
    ![Auswählen des benutzerdefinierten Datums](media/iot-suite-integrate-data-lake/stream-analytics-start-custom.png)
    ...
    ![Auftrag wird ausgeführt](media/iot-suite-integrate-data-lake/stream-analytics-running.png)
...
1. Führen Sie im Daten-Explorer einen Drilldown zum Ordner **/streaming** aus. Es wurden Ordner mit dem Format „JJJJ/MM/TT/HH“ erstellt.
    ...
    ![Untersuchen der Streamingdaten](media/iot-suite-integrate-data-lake/data-lake-store-data-explorer.png)

    Es werden JSON-Dateien (eine Datei pro Stunde) erstellt.

    ![Untersuchen der Streamingdaten](media/iot-suite-integrate-data-lake/data-lake-store-file-preview.png)
