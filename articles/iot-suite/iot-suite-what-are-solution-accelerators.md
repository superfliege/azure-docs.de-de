...
| [Predictive Maintenance](iot-suite-predictive-overview.md)   |Ja |Ja |-   |-   |Ja |Ja |Ja |
...
| Solution Accelerator | Architektur  | Sprachen     |
| ---------------------- | ------------- | ------------- |
