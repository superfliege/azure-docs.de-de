...
* [Implementieren des Gerätemodellverhaltens](iot-suite-remote-monitoring-device-behavior.md) beschreibt die JavaScript-Dateien, mit denen Sie das Verhalten eines simulierten Geräts implementieren.
* [Erstellen eines neuen simuliertes Geräts](iot-suite-remote-monitoring-test.md) zeigt, wie Sie einen neuen simulierten Gerätetyp in Ihrer Lösung bereitstellen.
...
Weitere Informationen zu der JavaScript-Datei, die das Gerätestatusobjekt aktualisiert, finden Sie unter [Grundlegendes zum Gerätemodellverhalten](iot-suite-remote-monitoring-device-behavior.md).
...
Weitere Informationen zu der JavaScript-Datei, die das Geräteverhalten implementiert, finden Sie unter [Grundlegendes zum Gerätemodellverhalten](iot-suite-remote-monitoring-device-behavior.md).
...
Nachdem Sie nun mit dem JSON-Schema vertraut sind, sollten Sie mehr über das [Implementieren des Verhaltens Ihres simulierten Geräts](iot-suite-remote-monitoring-device-behavior.md) erfahren.
