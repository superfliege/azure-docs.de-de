...
ms.locfileid: "46993883"
---
# <a name="tutorial-configure-kafka-policies-in-hdinsight-with-enterprise-security-package"></a>Tutorial: Konfigurieren von Kafka-Richtlinien in HDInsight mit dem Enterprise-Sicherheitspaket
