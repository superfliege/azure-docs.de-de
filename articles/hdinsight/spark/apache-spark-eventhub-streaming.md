...
5. Klicken Sie auf dem Blatt „Namespace“ auf **Event Hubs** und dann auf **+ Event Hub**, um einen neuen Event Hub zu erstellen.
    ...
    ![Erstellen einer Event Hub-Instanz für das Spark-Streamingbeispiel](./media/apache-spark-eventhub-streaming/hdinsight-open-event-hubs-blade-for-spark-streaming-example.png "Erstellen einer Event Hub-Instanz für das Spark-Streamingbeispiel")
...
7. Der neu erstellte Event Hub wird auf dem Blatt „Event Hub“ aufgeführt.
     ...
     ![Anzeigen der Event Hub-Instanz für das Spark-Streamingbeispiel](./media/apache-spark-eventhub-streaming/hdinsight-view-event-hub-for-spark-streaming-example.png "Anzeigen der Event Hub-Instanz für das Spark-Streamingbeispiel")
...
1. Starten Sie IntelliJ IDEA, und wählen Sie auf dem Startbildschirm **Check out from Version Control**. Klicken Sie dann auf **Git**.
    ...
    ![Apache Spark-Streamingbeispiel: Abrufen der Quellen von Git](./media/apache-spark-eventhub-streaming/spark-streaming-example-get-source-from-git.png "Apache Spark-Streamingbeispiel: Abrufen der Quellen von Git")
...
2. Geben Sie im Dialogfeld **Clone Repository** die URL des zu klonenden Git-Repositorys an, geben Sie das Verzeichnis an, in dem der Klon gespeichert werden soll, und klicken Sie dann auf **Clone**.
    ...
    ![Apache Spark-Streamingbeispiel: Klonen von Git](./media/apache-spark-eventhub-streaming/spark-streaming-example-clone-from-git.png "Apache Spark-Streamingbeispiel: Klonen von Git")
3. Befolgen Sie die Anweisungen, bis das Projekt vollständig geklont ist. Drücken Sie **ALT + 1**, um die **Projektansicht** zu öffnen. Die Ansicht sollte wie folgt aussehen:
    ...
    ![Apache Spark-Streamingbeispiel: Projektansicht](./media/apache-spark-eventhub-streaming/spark-streaming-example-project-view.png "Apache Spark-Streamingbeispiel: Projektansicht")
4. Stellen Sie sicher, dass der Anwendungscode mit Java8 kompiliert wird. Klicken Sie hierzu auf **File** und **Project Structure**, und vergewissern Sie sich, dass auf der Registerkarte **Project** die Projektsprachebene auf **8 - Lambdas, type annotations, etc.** festgelegt ist.
    ...
    ![Apache Spark-Streamingbeispiel: Festlegen des Compilers](./media/apache-spark-eventhub-streaming/spark-streaming-example-java-8-compiler.png "Apache Spark-Streamingbeispiel: Festlegen des Compilers")
...
7. Erstellen Sie die JAR-Ausgabedatei. Führen Sie die folgenden Schritte aus:
   ...
   1. Klicken Sie im Dialogfeld **Project Structure** auf **Artifacts** und anschließend auf das Pluszeichen. Klicken Sie im Popupdialogfeld auf **JAR** und anschließend auf **From modules with dependencies** (Aus Modulen mit Abhängigkeiten).      
       ...
       ![Apache Spark-Streamingbeispiel: Erstellen der JAR-Datei](./media/apache-spark-eventhub-streaming/spark-streaming-example-create-jar.png "Apache Spark-Streamingbeispiel: Erstellen der JAR-Datei")
   2. Klicken Sie im Dialogfeld **Create JAR from Modules** auf die Auslassungspunkte (![Ellipse](./media/apache-spark-eventhub-streaming/ellipsis.png)) für die **Hauptklasse**.
   3. Wählen Sie im Dialogfeld **Select Main Class** eine der verfügbaren Klassen aus, und klicken Sie dann auf **OK**.
      
       ![Apache Spark-Streamingbeispiel: Auswählen der Klasse für JAR-Datei](./media/apache-spark-eventhub-streaming/spark-streaming-example-select-class-for-jar.png "Apache Spark-Streamingbeispiel: Auswählen der Klasse für JAR-Datei")
   ...
   6. Auf der Registerkarte **Output Layout** am Ende der Spalte **Available Elements** werden die beiden SQL JDBC-JAR-Abhängigkeitsdateien aufgeführt, die Sie zuvor der Projektbibliothek hinzugefügt haben. Sie müssen diese der Registerkarte **Output Layout** hinzufügen. Klicken Sie mit der rechten Maustaste auf die JAR-Datei, und klicken Sie dann auf **Extract Into Output Root**.
       ...
       ![Apache Spark-Streamingbeispiel: abschließende Ausgaberegisterkarte](./media/apache-spark-eventhub-streaming/spark-streaming-example-final-output-tab.png "Apache Spark-Streamingbeispiel: abschließende Ausgaberegisterkarte")        
   ...
   7. Klicken Sie auf der Menüleiste auf **Build** und anschließend auf **Make Project**. Die JAR-Datei kann auch durch Klicken auf **Build Artifacts** erstellt werden. Die JAR-Ausgabedatei wird unter **\out\artifacts** erstellt.
       ...
       ![Apache Spark-Streamingbeispiel: JAR-Ausgabedatei](./media/apache-spark-eventhub-streaming/spark-streaming-example-output-jar.png "Apache Spark-Streamingbeispiel: JAR-Ausgabedatei")
...
Um sicherzustellen, dass die Hive-Tabelle erfolgreich erstellt wurde, verwenden Sie die [Ambari Hive-Ansicht](../hadoop/apache-hadoop-use-hive-ambari-view.md). Sie können eine SELECT-Abfrage zum Anzeigen des Tabelleninhalts ausführen.
