...
7. Wenn das laufende Protokoll nicht im rechten Bereich angezeigt werden soll, können Sie auf die Schaltfläche **Disconnect** (Trennen) klicken. Es wird jedoch weiterhin im Back-End ausgeführt, und das Ergebnis wird im linken Bereich angezeigt.
