...
Weitere Informationen finden Sie im [SQLLine-Handbuch](http://sqlline.sourceforge.net/#manual) sowie unter [Apache Phoenix Grammar](http://phoenix.apache.org/language/index.html) (Apache Phoenix-Grammatik).
