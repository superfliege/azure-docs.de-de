...
Wenn Sie Tez mit Hive verwenden, finden Sie im folgenden Dokument Informationen zum Debuggen: [Verwenden der Apache Ambari-Tez-Ansicht in Linux-basiertem HDInsight](../hdinsight-debug-ambari-tez-view.md)
