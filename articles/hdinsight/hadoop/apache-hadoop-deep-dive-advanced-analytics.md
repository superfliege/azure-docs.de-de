---
title: Tief eintauchen – Advanced Analytics – Azure HDInsight | Microsoft-Dokumentation
...
* [Machine Learning und Spark](#machine-learning-and-spark)
* [R und R Server](#r-and-r-server)
* [Azure Machine Learning und Hive](#azure-machine-learning-and-hive)
* [Spark und Deep Learning](#spark-and-deep-learning)

### <a name="machine-learning-and-spark"></a>Machine Learning und Spark
...
3. Hochladen eines Jupyter Notebooks in Ihren HDInsight Spark-Cluster, um ein trainiertes Microsoft Cognitive Toolkit Deep Learning-Modell mithilfe der Spark Python-API (PySpark) auf Dateien in einem Azure Blob Storage-Konto anzuwenden. 
...
Hive und Azure Machine Learning
