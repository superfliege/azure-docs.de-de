...
Verwenden Sie zum Entfernen der Ressourcengruppe den Befehl [Remove-AzResourceGroup](https://docs.microsoft.com/powershell/module/az.resources/remove-azresourcegroup). $resourceGroup wurde zu Beginn des Tutorials auf **ContosoIoTRG1** festgelegt.
