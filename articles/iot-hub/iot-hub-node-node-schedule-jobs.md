...
* Gerätezwillinge und Eigenschaften: [Erste Schritte mit Gerätezwillingen][lnk-get-started-twin] und [Tutorial: Verwenden der Eigenschaften von Gerätezwillingen][lnk-twin-props]
* Direkte Methoden: [Verstehen und Aufrufen direkter Methoden von IoT Hub][lnk-dev-methods] und [Schnellstart: Steuern eines mit einer IoT Hub-Instanz verbundenen Geräts (Node.js)][lnk-c2d-methods]
