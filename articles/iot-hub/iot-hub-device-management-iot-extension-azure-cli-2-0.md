...
* Schließen Sie das Tutorial [Einrichten Ihres Geräts](iot-hub-raspberry-pi-kit-node-get-started.md) ab, in dem die folgenden Anforderungen behandelt werden:
