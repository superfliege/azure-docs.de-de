...
* Ein aktives Azure-Konto. (Wenn Sie nicht über ein Konto verfügen, können Sie in nur wenigen Minuten ein [kostenloses Azure-Konto](http://azure.microsoft.com/pricing/free-trial/) erstellen.)
* Einen IoT Hub.
