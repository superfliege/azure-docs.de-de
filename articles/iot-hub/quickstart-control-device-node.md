...
* Eine Anwendung zur Simulation eines Geräts, die auf direkte Methoden reagiert, die von einer Back-End-Anwendung aufgerufen werden. Um die direkten Methodenaufrufe zu empfangen, stellt diese Anwendung eine Verbindung mit einem gerätespezifischen Endpunkt in Ihrer IoT Hub-Instanz her.
...
Die Anwendung zur Simulation eines Geräts stellt eine Verbindung mit einem gerätespezifischen Endpunkt in Ihrer IoT Hub-Instanz her, sendet simulierte Telemetriedaten und lauscht auf direkte Methodenaufrufe aus Ihrem Hub. In dieser Schnellstartanleitung teilt der direkte Methodenaufruf aus dem Hub dem Gerät mit, das Intervall zu ändern, in dem es Telemetriedaten sendet. Das simulierte Gerät sendet eine Bestätigung an Ihren Hub, nachdem es die direkte Methode ausgeführt hat.
...
1. Führen Sie im Terminalfenster die folgenden Befehle aus, um die erforderlichen Bibliotheken zu installieren und die Back-End-Anwendung auszuführen:
    ...
    ![Änderungen im simulierten Client](media/quickstart-control-device-node/SimulatedDevice-2.png)
...
In dieser Schnellstartanleitung haben Sie von einer Back-End-Anwendung aus eine direkte Methode auf einem Gerät aufgerufen und in einer Anwendung zur Simulation eines Geräts auf den direkten Methodenaufruf geantwortet.
