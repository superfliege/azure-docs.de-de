...
description: In diesem Schnellstart führen Sie eine dienstseitige C-Anwendung aus, die über einen Gerätestream mit einem IoT-Gerät kommuniziert.
author: rezasherafat
manager: briz
ms.service: iot-hub
services: iot-hub
...
2. Führen Sie die folgenden Befehle in Azure Cloud Shell aus, um die *Geräteverbindungszeichenfolge* für das soeben registrierte Gerät abzurufen:
...
Wie bereits erwähnt, unterstützt das IoT Hub C SDK nur geräteseitige Gerätestreams. Wenn Sie die dienstseitige Anwendung erstellen und ausführen möchten, befolgen Sie die verfügbaren Schritte in den folgenden Schnellstart:

* [Kommunizieren mit einer Geräte-App in C# über IoT Hub-Gerätestreams](./quickstart-device-streams-echo-csharp.md)

* [Kommunizieren mit einer Geräte-App in Node.js über IoT Hub-Gerätestreams](./quickstart-device-streams-echo-nodejs.md)
