...
Weitere Informationen finden Sie in den technischen Angaben zur [API für Bilanzen](https://docs.microsoft.com/rest/api/consumption/getbalancesbybillingaccount).
