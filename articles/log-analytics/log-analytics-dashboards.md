...
* Erstellen Sie [Warnungen](../monitoring-and-diagnostics/monitoring-overview-unified-alerts.md) in Log Analytics, um Benachrichtigungen zu generieren und Probleme zu beheben.
