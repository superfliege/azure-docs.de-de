...
| Malware Assessment |Konfigurationsdaten und Metadaten |
...
* [HIPAA und HITECH](https://www.microsoft.com/TrustCenter/Compliance/HIPAA) für Unternehmen mit einem HIPAA-Geschäftspartnervertrag
* Windows Common Engineering Criteria
* Vertrauenswürdige Datenverarbeitung von Microsoft
* Als Azure-Dienst müssen die Komponenten, die von Log Analytics verwendet werden, die Azure-Konformitätsbestimmungen einhalten. Weitere Informationen erhalten Sie unter [Microsoft Trust Center – Compliance](https://www.microsoft.com/TrustCenter/Compliance/default.aspx).
...
In der folgenden Abbildung sind eine Cloudsicherheitsarchitektur sowie der Fluss der Informationen von Ihrem Unternehmen und deren Schutz auf dem Weg zum Log Analytics-Dienst dargestellt, wo Sie sie letztlich im Azure-Portal oder klassischen OMS-Portal anzeigen können. Weitere Informationen zu den einzelnen Schritten finden Sie nach dem Diagramm.
...
Die Beibehaltungsdauer der gesammelten Daten, die in der Datenbank gespeichert sind, hängt von dem bei der Erstellung des Arbeitsbereichs ausgewählten Plan ab.  Im kostenpflichtigen Tarif sind die gesammelten Daten standardmäßig 31 Tage verfügbar, dies kann jedoch auf 365 Tage verlängert werden.  Diese Daten sind noch nicht im Ruhezustand verschlüsselt. Dies ist jedoch für Mitte 2018 geplant. 
