...
Erstellen Sie zunächst eine [Protokollsuche](log-analytics-queries.md), welche die Daten von Log Analytics zurückgibt, mit denen das Power BI-Dataset aufgefüllt werden soll.  Anschließend exportieren Sie die Abfrage in der [Power Query-Sprache (M)](https://msdn.microsoft.com/library/mt807488.aspx), die von Power BI Desktop verwendet werden kann.
...
* Erfahren Sie mehr zu [Protokollsuchvorgängen](log-analytics-queries.md) zum Erstellen von Abfragen, die nach Power BI exportiert werden können.
