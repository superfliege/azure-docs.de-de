...
* Besuchen Sie die Log Analytics-Feedbackseite unter [http://aka.ms/opinsightsfeedback](http://aka.ms/opinsightsfeedback), um bereits eingereichte Vorschläge und gemeldete Fehler einzusehen oder ein neues Problem zu melden.  
...
### <a name="resolution"></a>Lösung
* Überprüfen Sie, ob die Konfiguration im Log Analytics-Arbeitsbereich für Syslog alle Facilities und die richtigen Protokollebenen enthält. Lesen Sie die Informationen zum [Konfigurieren der Syslog-Sammlung im Azure-Portal](log-analytics-data-sources-syslog.md#configure-syslog-in-the-azure-portal).
...
2. Installieren Sie den Agent gemäß den [Anweisungen](log-analytics-quick-collect-linux-computer.md).
