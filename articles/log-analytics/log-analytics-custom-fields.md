...
1. Wechseln **Sie zur Protokollsuche**, und verwenden Sie eine [Abfrage zum Abrufen der Datensätze](log-analytics-queries.md) , die über das benutzerdefinierte Feld verfügen sollen.
