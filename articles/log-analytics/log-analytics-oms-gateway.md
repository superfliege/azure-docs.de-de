...
1. Herunterladen aus dem Azure-Portal.  Gehen Sie folgendermaßen vor, nachdem Sie sich am Azure-Portal angemeldet haben:  
   ...
   1. Klicken Sie auf dem Blatt **Direkt-Agent** auf **Log Analytics-Gateway herunterladen**.<br><br> ![Log Analytics-Gateway herunterladen](./media/log-analytics-oms-gateway/download-gateway.png)
...
1. Klicken Sie auf der Seite **Willkommen**auf **Weiter**.<br><br> ![Gateway-Setup-Assistent](./media/log-analytics-oms-gateway/gateway-wizard01.png)<br> 
...
1. Nachdem Setup abgeschlossen ist, klicken Sie auf **Fertig stellen**. Sie können überprüfen, ob der Dienst ausgeführt wird. Öffnen Sie dazu das Snap-In „services.msc“, und vergewissern Sie sich, dass **Log Analytics-Gateway** in der Liste der Dienste angezeigt wird und den Status **Wird ausgeführt** aufweist.<br><br> ![Dienste – Log Analytics-Gateway](./media/log-analytics-oms-gateway/gateway-service.png)  
...
1. Geben Sie die IP-Adresse des Gatewayservers ein, mit dem Sie eine Verbindung herstellen möchten.<br><br> ![Netzwerklastenausgleich-Manager – Host dem Cluster hinzufügen: Verbinden](./media/log-analytics-oms-gateway/nlb03.png) 
...
Informationen zu den Anforderungen und Schritten zum Installieren des Log Analytics-Agents auf Windows-Computern mit Log Analytics-Direktverbindung finden Sie unter [Verbinden von Windows-Computern mit Log Analytics](log-analytics-windows-agents.md). Entsprechende Informationen für Linux-Computer finden Sie unter [Verbinden von Linux-Computern mit Log Analytics](log-analytics-quick-collect-linux-computer.md). Statt einen Proxyserver bei der Konfiguration des Agents anzugeben, ersetzen Sie diesen Wert durch die IP-Adresse und die Portnummer des Log Analytics-Gatewayservers.  Wenn Sie mehrere Gatewayserver hinter einem Netzwerklastenausgleich bereitgestellt haben, handelt es sich bei der Log Analytics-Agent-Proxykonfiguration um die virtuelle IP-Adresse des NLB.  
...
1. Zeigen Sie seine Region unter **Speicherort** an.<br><br> ![Azure-Portal – Speicherort des Automation-Kontos](./media/log-analytics-oms-gateway/location.png)  
...
Um die vom Gateway protokollierten Ereignisse zu erfassen, muss auch der Log Analytics-Agent installiert sein.<br><br> ![Ereignisanzeige – Log Analytics-Gatewayprotokoll](./media/log-analytics-oms-gateway/event-viewer.png)
...
![Leistungsindikatoren für das Log Analytics-Gateway](./media/log-analytics-oms-gateway/counters.png)
