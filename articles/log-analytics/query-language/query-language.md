...
- [Erste Schritte mit Log Analytics im Azure-Portal](get-started-analytics-portal.md) erläutert das Schreiben von Abfragen und das Arbeiten mit Ergebnissen im Azure Portal.
...
- [Analysieren von Log Analytics-Daten in Azure Monitor](../log-analytics-queries.md) gibt einen kurzen Überblick über Protokollabfragen und beschreibt, wie Log Analytics-Daten strukturiert sind.
- [Anzeigen und Analysieren von Daten in Log Analytics](../log-analytics-log-search-portals.md) erklärt die Portale, in denen Sie Log Analytics-Abfragen erstellen und ausführen.
...
- [Standardeigenschaften in Log Analytics-Datensätzen](../log-analytics-standard-properties.md) beschreibt Standardeigenschaften aller Log Analytics-Daten.
- [Ausführen ressourcenübergreifender Protokollsuchen in Log Analytics](../log-analytics-cross-workspace-search.md) beschreibt, wie Sie Abfragen schreiben, die Daten aus mehreren Log Analytics-Arbeitsbereichen und Application Insights-Anwendungen verwenden.
