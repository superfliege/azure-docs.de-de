---
title: 'Azure PowerShell-Skript: Löschen einer Datenbank aus einem Azure Cosmos-Konto'
description: 'Beispiel eines Azure PowerShell-Skripts: Löschen einer Datenbank aus einem Azure Cosmos-Konto'
author: markjbrown
...
ms.locfileid: "65080478"
---
# <a name="delete-a-database-in-an-azure-cosmos-account-in-an-azure-cosmos-account-using-powershell"></a>Löschen einer Datenbank aus einem Azure Cosmos-Konto mithilfe von PowerShell
...
| [Remove-AzResource](https://docs.microsoft.com/powershell/module/az.resources/remove-azresource) | Dient zum Löschen einer Ressource. |
