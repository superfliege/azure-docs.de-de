---
title: 'Azure CLI-Skript: Erstellen eines Cassandra-API-Kontos, einer Datenbank und einer Tabelle für Azure Cosmos DB | Microsoft-Dokumentation'
