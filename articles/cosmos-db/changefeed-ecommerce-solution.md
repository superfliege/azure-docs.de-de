...
2. Navigieren Sie zur Datei **App.config**. Fügen Sie im <appSettings>-Block den URI und den eindeutigen **PRIMÄRSCHLÜSSEL** Ihres Azure Cosmos DB-Kontos hinzu, den Sie zuvor abgerufen haben.  
