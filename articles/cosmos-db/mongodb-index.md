---
title: 'Azure Cosmos DB: MongoDB-API-Artikel | Microsoft-Dokumentation'
description: Eine Liste aller Artikel zum Erstellen von Dokumentdatenbanken mit der MongoDB-API in Azure Cosmos DB
services: cosmos-db
author: SnehaGunda
manager: kfile
documentationcenter: ''
...
Machen Sie sich zunächst mit den hier angegebenen Themen und Ressourcen vertraut, bevor Sie sich mit der MongoDB-API für Azure Cosmos DB auseinandersetzen.
...
- Videobasiert: [Erstellen einer MongoDB-App mit Angular und Azure Cosmos DB](tutorial-develop-mongodb-nodejs.md)
- Videobasiert: [Erstellen einer MongoDB-App mit React und Azure Cosmos DB](tutorial-develop-mongodb-react.md)

### <a name="migrate-mongodb-data"></a>Migrieren von MongoDB-Daten

- [Azure Cosmos DB: Importieren von MongoDB-Daten](mongodb-migrate.md)
