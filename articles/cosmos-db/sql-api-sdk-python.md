---
title: Azure Cosmos DB SQL Python-API, SDK und Ressourcen | Microsoft-Dokumentation
...
<tr><td>**API-Dokumentation**</td><td>[Python-API-Referenzdokumentation](https://docs.microsoft.com/python/api/overview/azure/cosmosdb?view=azure-python)</td></tr>
