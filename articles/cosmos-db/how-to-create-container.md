...
![Erstellung einer Sammlung durch die MongoDB-API](./media/how-to-create-container/partitioned-collection-create-mongodb.png)
...
### <a id="cli-sql"></a>SQL-API (Core-API)
...
> [!Note]
> MongoDB verfügt über kein Konzept für Anforderungseinheiten. Wenn Sie eine neue Sammlung mit Durchsatz erstellen möchten, verwenden Sie das Azure-Portal oder die SQL-API, wie in den vorherigen Beispielen gezeigt.
