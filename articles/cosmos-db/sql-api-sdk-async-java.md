...
<tr><td>**API-Dokumentation**</td><td>[Java-API-Referenzdokumentation](https://docs.microsoft.com/java/api/cosmosdb/client/async?view=azure-java-stable)</td></tr>
