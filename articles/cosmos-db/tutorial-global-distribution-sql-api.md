---
title: Tutorial zur globalen Verteilung von Azure Cosmos DB mit der SQL-API | Microsoft-Dokumentation
description: Erfahren Sie, wie Sie die globale Verteilung von Azure Cosmos DB mithilfe der SQL-API einrichten.
services: cosmos-db
keywords: globale Verteilung
documentationcenter: ''
author: rafats
manager: kfile
...
---
# <a name="how-to-setup-azure-cosmos-db-global-distribution-using-the-sql-api"></a>Einrichten der globalen Verteilung von Azure Cosmos DB mithilfe der SQL-API
