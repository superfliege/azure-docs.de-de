...
In diesem Artikel wird gezeigt, wie Sie für eine ASP.NET-Anwendung eine CI-Pipeline in Azure DevOps einrichten, die den Buildtask des Cosmos DB-Emulators zum Ausführen von Tests nutzt. 
