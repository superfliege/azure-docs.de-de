...
Die IP-Adresse eines Netzwerkadapters auf dem virtuellen Computer ist erforderlich. Rufen Sie mit dem folgenden Befehl die Netzwerkadapter für einen virtuellen Computer ab. Wenn Sie die IP-Adresse bereits kennen, die Sie auf dem virtuellen Computer testen möchten, können Sie diesen Schritt überspringen.
...
Führen Sie das Cmdlet `network watcher ip-flow-verify` aus, um den Datenverkehr zu testen. In diesem Beispiel wird die erste IP-Adresse des ersten Netzwerkadapters verwendet:
