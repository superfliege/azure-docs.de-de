...
#### [4. Erstellen von Beziehungen](tutorials/aas-lesson-4-create-relationships.md) 
#### [5. Erstellen berechneter Spalten](tutorials/aas-lesson-5-create-calculated-columns.md)
#### [6. Erstellen von Measures](tutorials/aas-lesson-6-create-measures.md)  
#### [7. Erstellen von Key Performance Indicators](tutorials/aas-lesson-7-create-key-performance-indicators.md)  
#### [8. Erstellen von Perspektiven](tutorials/aas-lesson-8-create-perspectives.md) 
#### [9. Erstellen von Hierarchien](tutorials/aas-lesson-9-create-hierarchies.md) 
#### [10. Erstellen von Partitionen](tutorials/aas-lesson-10-create-partitions.md) 
#### [11. Erstellen von Rollen](tutorials/aas-lesson-11-create-roles.md)
#### [12. Analysen in Excel](tutorials/aas-lesson-12-analyze-in-excel.md)
#### [13. Bereitstellen](tutorials/aas-lesson-13-deploy.md)
...
## [Resource Manager: Vorlage](/azure/templates/microsoft.analysisservices/servers)
