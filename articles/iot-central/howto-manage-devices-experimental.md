...
1. Wählen Sie im **Device Explorer** auf der linken Seite die Option Explorer aus. Hier sehen Sie eine Liste Ihrer [Gerätevorlagen](howto-set-up-template-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json).
...
1. Im rechten Bereich der Seite **Device Explorer** sehen Sie eine Liste von Geräten, die anhand dieser Gerätevorlage erstellt wurden. Wählen Sie ein einzelnes Gerät aus, um die Seite „Gerätedetails“ für dieses Gerät anzuzeigen:
    ...
    ![Seite „Gerätedetails“](./media/howto-manage-devices-experimental/devicelist.png)
...
1. Klicken Sie auf **Importieren**.
    ...
    ![Importaktion](./media/howto-manage-devices-experimental/BulkImport1.png)
...
1. Nach Abschluss des Imports wird eine Erfolgsmeldung auf dem Geräteraster angezeigt.
    ...
    ![Import erfolgreich](./media/howto-manage-devices-experimental/BulkImport3.png)
...
1. Wählen Sie im linken Navigationsmenü die Option **Device Explorer** aus.

1. Wählen Sie im linken Bereich **Nicht zugeordnete Geräte** aus:

    ![Nicht zugeordnete Geräte](./media/howto-manage-devices-experimental/UnassociatedDevices1.png)

1. Wählen Sie die Geräte aus, die Sie mit einer Vorlage verknüpfen möchten:

1. Klicken Sie auf **Zuordnen**:

    ![Zuordnen von Geräten](./media/howto-manage-devices-experimental/UnassociatedDevices2.png)
...
Wenn Sie ein echtes Gerät mit IoT Central verbinden möchten, benötigen Sie dessen Verbindungszeichenfolge. Sie können einen Massenexport von Gerätedetails ausführen, um Verbindungszeichenfolgen und andere Eigenschaften abzurufen. Durch den Exportvorgang wird eine CSV-Datei mit der Geräteidentität, dem Gerätenamen und der primären Verbindungszeichenfolge für alle ausgewählten Geräte erstellt.
...
1. Klicken Sie auf die **Erfolgsmeldung**, um die Datei in einen lokalen Ordner auf dem Datenträger herunterzuladen.
    ...
    ![Export erfolgreich](./media/howto-manage-devices-experimental/Export2.png)
