...
2. Klicken Sie zum Erstellen einer leeren Vorlage auf **+**, und geben Sie einen Namen wie z.B. **Kühlschrank** für Ihre neue Gerätevorlage ein. Wählen Sie anschließend **Erstellen** aus:

   ![Seite mit Gerätedetails mit „Refrigerator“ als Name der Vorlage](./media/howto-set-up-template-experimental/devicedetailspage.png)

4. Sie befinden sich jetzt auf der Seite **Gerätedetails** für eine neue Gerätevorlage. IoT Central erstellt automatisch ein simuliertes Gerät, wenn Sie eine Gerätevorlage erstellen. Mit einem simulierten Gerät können Sie das Verhalten Ihrer Anwendung testen, bevor Sie eine Verbindung mit einem echten Gerät herstellen.
...
Um eine neue Telemetriemessung hinzuzufügen, klicken Sie auf **+ Neue Messung**, wählen Sie **Telemetrie** als Messungstyp aus, und geben Sie die Details im Formular ein.
...
![Formular „Telemetrie erstellen“ mit Details zur Temperaturmessung](./media/howto-set-up-template-experimental/measurementsform.png)
...
Um eine neue Ereignismessung hinzuzufügen, klicken Sie auf **+ Neue Messung**, und wählen Sie **Ereignis** als Messungstyp aus. Geben Sie die Details im Formular **Ereignis erstellen** ein.
...
![Formular „Ereignis erstellen“ mit Details zu einem Lüftermotorereignis](./media/howto-set-up-template-experimental/eventmeasurementsform.png)
...
Klicken Sie im Diagramm auf das Ereignissymbol, um zusätzliche Details anzuzeigen:

![Details für das Ereignis „Lüftermotorfehler“](./media/howto-set-up-template-experimental/eventmeasurementsdetail.png)
...
Um eine neue Zustandsmessung hinzuzufügen, klicken Sie auf **+ Neue Messung**, und wählen Sie **Zustand** als Messungstyp aus. Geben Sie die Details im Formular **Zustand erstellen** ein.
...
![Formular „Zustand bearbeiten“ mit Details zum Lüftermodus](./media/howto-set-up-template-experimental/statemeasurementsform.png)
...
Wenn das Gerät in einer kleinen Zeitspanne zu viele Datenpunkte sendet, wird die Zustandsmessung mit einem anderen visuellen Element angezeigt. Klicken Sie auf das Diagramm, um alle Datenpunkte innerhalb dieses Zeitraums in chronologischer Reihenfolge anzuzeigen. Sie können den Zeitbereich auch einschränken, um die Messung im Diagramm anzuzeigen.
...
Sie können zum Beispiel eine neue Einstellung für die Lüfterdrehzahl hinzufügen, indem Sie auf **Einstellungen** klicken und die neue Einstellung für die **Drehzahl** eingeben:

| Anzeigename  | Feldname    |  Units  | Dezimalstellen |Initial|
| --------------| ------------- |---------| ---------|---- |
| Lüfterdrehzahl     | fanSpeed      | U/Min     | 2        | 0   |

![Formular „Drehzahl konfigurieren“ mit Details zu Geschwindigkeitseinstellungen](./media/howto-set-up-template-experimental/settingsform.png)
...
![Formular zum Konfigurieren des Datums der letzten Wartung auf der Registerkarte „Eigenschaften“](./media/howto-set-up-template-experimental/propertiesform.png)
...
3. Konfigurieren Sie den **Anzeigenamen**, **Feldnamen** und (optional) den **Anfangswert** des Standorts.
   ...
   ![Formular „Standort konfigurieren“ mit Details zum Standort](./media/howto-set-up-template-experimental/locationcloudproperty2.png)

   Es gibt zwei unterstützte Formate zum Hinzufügen eines Standorts:
   - **Standort als Adresse**
   - **Standort als Koordinaten**

4. Klicken Sie auf **Speichern**. Ein Bediener kann den Standortwert im **Device Explorer** aktualisieren.
...
3. Konfigurieren Sie den Anzeigenamen und den Feldnamen, und wählen Sie **Standort** als Datentyp:
   ...
   ![Formular „Geräteeigenschaften konfigurieren“ mit Details zum Standort](./media/howto-set-up-template-experimental/locationdeviceproperty2.png)
...
Sie können z.B. einen neuen **Echo**-Befehl hinzufügen, indem Sie die Registerkarte **Befehle** auswählen, auf **+ Neuer Befehl** klicken und die neuen Befehlsdetails eingeben:

| Anzeigename  | Feldname | Standardzeitlimit | Datentyp |
| --------------| -----------|---------------- | --------- |
| Echo-Befehl  | Echo       |  30             | text      |

![Formular „Befehl konfigurieren“ mit Details zu „Echo“](./media/howto-set-up-template-experimental/commandsecho.png)
...
- Eine **Telemetrieregel** wird ausgelöst, wenn die ausgewählten Gerätetelemetriedaten einen angegebenen Schwellenwert überschreiten. [Weitere Informationen zu Telemetrieregeln](howto-create-telemetry-rules-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json).
...
![Formular „Gerätedetails konfigurieren“ mit Details zu Einstellungen und Eigenschaften](./media/howto-set-up-template-experimental/dashboardsettingsandpropertiesform.png)
...
1. Geben Sie der Karte einen Titel. Das folgende Beispiel hat den Titel **Installationsstandort**. Wählen Sie dann die Standorteigenschaft aus, die Sie zuvor auf der Registerkarte **Eigenschaften** konfiguriert haben. Im folgenden Beispiel wird **Installationsadresse** ausgewählt.
   ...
   ![Formular „Karte konfigurieren“ mit Details zu Titel und Eigenschaften](./media/howto-set-up-template-experimental/locationcloudproperty5map.png)
...
> [Erstellen einer neuen Gerätevorlagenversion](howto-version-devicetemplate.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)
