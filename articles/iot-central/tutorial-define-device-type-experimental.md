...
ms.locfileid: "55810115"
---
# <a name="tutorial-define-a-new-device-type-in-your-azure-iot-central-application-new-ui-design"></a>Tutorial: Definieren eines neuen Gerätetyps in Ihrer Azure IoT Central-Anwendung (neues Benutzeroberflächendesign)
...
2. Geben Sie die E-Mail-Adresse und das Kennwort für den Zugriff auf Ihr Azure-Abonnement ein:
    ...
    ![Eingeben Ihres Organisationskontos](./media/tutorial-define-device-type-experimental/sign-in.png)

3. Klicken Sie auf **Neue Anwendung**, um mit der Erstellung einer neuen Azure IoT Central-Anwendung zu beginnen:

    ![Azure IoT Central-Seite „Application Manager“ (Anwendungs-Manager)](./media/tutorial-define-device-type-experimental/iotcentralhome.png)
...
4. So erstellen Sie eine neue Azure IoT Central-Anwendung:
    ...
    * Wählen Sie **Testversion** aus. Sie benötigen kein Azure-Abonnement zum Erstellen einer Testanwendung.
       ...
       Weitere Informationen zu Verzeichnissen und Abonnements finden Sie unter [Erstellen einer Azure IoT Central-Anwendung](quick-deploy-iot-central-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json).
    ...
    * Klicken Sie auf **Create**.
    ...
    ![Azure IoT Central-Seite „Anwendung erstellen“](./media/tutorial-define-device-type-experimental/iotcentralcreate.png)

    Weitere Informationen finden Sie unter [Schnellstart: Erstellen einer Anwendung](quick-deploy-iot-central-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json).
...
Wenn Sie Ihrer Anwendung eine neue Gerätevorlage hinzufügen möchten, navigieren Sie zur Seite **Gerätevorlagen**. Klicken Sie hierzu im linken Navigationsmenü auf **Gerätevorlagen**.

![Seite „Gerätevorlagen“](./media/tutorial-define-device-type-experimental/devicetemplates.png)
...
1. Klicken Sie auf der Seite **Gerätevorlagen** auf **+ Neu**:

    ![Seite „Gerätevorlagen“: Erstellen einer Gerätevorlage](./media/tutorial-define-device-type-experimental/newtemplate.png)

3. Geben Sie auf der Seite **Benutzerdefinierte Gerätevorlage** den Gerätenamen **Connected Air Conditioner** ein, und klicken Sie anschließend auf **Erstellen**. Sie können auch ein Bild Ihres Geräts hochladen, das Bedienern im Device Explorer angezeigt wird:

    ![Benutzerdefiniertes Gerät](./media/tutorial-define-device-type-experimental/createcustomdevice.png)
...
4. Vergewissern Sie sich in der Gerätevorlage **Connected Air Conditioner**, dass Sie sich auf der Registerkarte **Messungen** befinden, um die Telemetriedaten zu definieren. Jede Gerätevorlage, die Sie definieren, verfügt über individuelle Registerkarten für Folgendes:
    ...
    * Anpassen des _Dashboards_ des Geräts für die Bediener
    ...
    ![Messungen für die Klimaanlage](./media/tutorial-define-device-type-experimental/airconmeasurements.png)

    > [!NOTE]
    > Wenn Sie den Namen der Gerätevorlage ändern möchten, klicken Sie oben auf der Seite auf den Vorlagennamen.

5. Klicken Sie auf **+ Neue Messung**, um die Messung für die Temperaturtelemetrie hinzuzufügen. Wählen Sie **Telemetrie** als Messungstyp aus:

    ![Messungen für die verbundene Klimaanlage](./media/tutorial-define-device-type-experimental/airconmeasurementsnew.png)

6. Jede Art von Telemetrie, die Sie für eine Gerätevorlage definieren, beinhaltet [Konfigurationsoptionen](howto-set-up-template-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json) wie etwa:
    ...
    * Simulationsparameter
    ...
    ![Konfigurieren der Temperatursimulation](./media/tutorial-define-device-type-experimental/temperaturesimulation.png)
...
7. Nach kurzer Zeit wird auf der Registerkarte **Messungen** ein Diagramm der Temperaturtelemetriedaten Ihrer simulierten verbundenen Klimaanlage angezeigt. Mithilfe der Steuerelemente können Sie die Sichtbarkeit sowie die Aggregation verwalten und die Telemetriedefinition bearbeiten:
    ...
    ![Anzeigen der Temperatursimulation](./media/tutorial-define-device-type-experimental/viewsimulation.png)

8. Darüber hinaus können Sie das Diagramm mithilfe der Steuerelemente **Linie**, **Gestapelt** und **Zeitbereich bearbeiten** anpassen:

    ![Anpassen des Diagramms](./media/tutorial-define-device-type-experimental/customizechart.png)
...
1. Klicken Sie auf **+ Neue Messung**, um die Ereignismessung **Fan Motor Error** (Lüftermotorfehler) hinzuzufügen. Wählen Sie dann **Ereignis** als Messungstyp aus:

    ![Messungen für die verbundene Klimaanlage](./media/tutorial-define-device-type-experimental/eventnew.png)

2. Jede Art von Ereignis, das Sie für eine Gerätevorlage definieren, beinhaltet [Konfigurationsoptionen](howto-set-up-template-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json) wie etwa:
   ...
   * Schweregrad
    ...
    ![Konfigurieren der Ereignismessung](./media/tutorial-define-device-type-experimental/eventconfiguration.png)
...
3. Nach kurzer Zeit wird auf der Registerkarte **Messungen** ein Diagramm der Ereignisse angezeigt, die nach dem Zufallsprinzip auf der Grundlage Ihrer simulierten verbundenen Klimaanlage generiert wurden. Mithilfe der Steuerelemente können Sie die Sichtbarkeit verwalten und die Ereignisdefinition bearbeiten:
    ...
    ![Anzeigen der Ereignissimulation](./media/tutorial-define-device-type-experimental/eventview.png)

1. Klicken Sie im Diagramm auf das Ereignis, um zusätzliche Ereignisdetails anzuzeigen:

    ![Anzeigen von Ereignisdetails](./media/tutorial-define-device-type-experimental/eventviewdetail.png)
...
1. Klicken Sie auf **+ Neue Messung**, um die Zustandsmessung **Fan Mode** (Lüftermodus) hinzuzufügen. Wählen Sie dann **Zustand** als Messungstyp aus:

    ![Zustandsmessungen für die verbundene Klimaanlage](./media/tutorial-define-device-type-experimental/statenew.png)

2. Jede Art von Zustand, den Sie für eine Gerätevorlage definieren, beinhaltet [Konfigurationsoptionen](howto-set-up-template-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json) wie etwa:
   ...
   * Wertspezifische Farben
    ...
    ![Konfigurieren der Zustandsmessung](./media/tutorial-define-device-type-experimental/stateconfiguration.png)
...
3. Nach kurzer Zeit wird auf der Registerkarte **Messungen** ein Diagramm der Zustände angezeigt, die nach dem Zufallsprinzip auf der Grundlage Ihrer simulierten verbundenen Klimaanlage generiert wurden. Mithilfe der Steuerelemente können Sie die Sichtbarkeit verwalten und die Zustandsdefinition bearbeiten:
    ...
    ![Anzeigen der Zustandssimulation](./media/tutorial-define-device-type-experimental/stateview.png)

4. Sollte das Gerät innerhalb kurzer Zeit zu viele Datenpunkte senden, wird die Zustandsmessung anders dargestellt. Klicken Sie auf das Diagramm, um alle Datenpunkte innerhalb dieses Zeitraums in chronologischer Reihenfolge anzuzeigen. Sie können den Zeitbereich auch einschränken, um detailliertere Messungen anzuzeigen.
...
* _Eigenschaften_ dienen zum Definieren von Metadaten, die mit Ihrem Gerät verknüpft sind. Es gibt zwei Kategorien von Eigenschaften:
    ...
    * _Geräteeigenschaften_ dienen dazu, einem Gerät das Senden von Eigenschaftswerten an Ihre Anwendung zu ermöglichen. Diese Eigenschaften können nur durch das Gerät geändert werden. Für Bediener sind Geräteeigenschaften schreibgeschützt. In diesem Szenario für eine verbundene Klimaanlage werden vom Gerät die Geräteeigenschaften „Firmwareversion“ und „Seriennummer des Geräts“ gemeldet.
    ...
    Weitere Informationen finden Sie in der Schrittanleitung zum Einrichten einer Gerätevorlage unter [Eigenschaften](howto-set-up-template-experimental.md#properties).
...
2. Sie können Einstellungen unterschiedlicher Art erstellen – beispielsweise Zahlen oder Text. Klicken Sie auf **Zahl**, um Ihrem Gerät eine Zahleneinstellung hinzuzufügen.
...
3. Verwenden Sie zum Konfigurieren der Einstellung **Set Temperature** (Sollwerttemperatur) die Informationen aus der folgenden Tabelle:
    ...
    ![Konfigurieren der Einstellung für die Sollwerttemperatur](./media/tutorial-define-device-type-experimental/configuresetting.png)
...
4. Sie können die Einstellungskacheln verschieben und ihre Größe ändern, um das Layout der Registerkarte **Einstellungen** anzupassen:
    ...
    ![Anpassen des Layouts der Einstellungen](./media/tutorial-define-device-type-experimental/settingslayout.png)
...
1. Sie können Geräteeigenschaften unterschiedlicher Art erstellen, wie Zahlen oder Text. Klicken Sie auf **Standort**, um Ihrer Gerätevorlage eine Standorteigenschaften hinzuzufügen. Verwenden Sie zum Konfigurieren der Standorteigenschaft die Informationen aus der folgenden Tabelle:
    ...
    ![Konfigurieren der Geräteeigenschaften](./media/tutorial-define-device-type-experimental/configureproperties.png)
...
1. Verwenden Sie zum Konfigurieren der Eigenschaft für das Datum der letzten Wartung die Informationen aus der folgenden Tabelle:
    ...
    ![Konfigurieren der Geräteeigenschaften](./media/tutorial-define-device-type-experimental/configureproperties2.png)
...
1. Verwenden Sie zum Konfigurieren der Firmwareversion die Informationen aus der folgenden Tabelle:
    ...
    ![Konfigurieren der Firmwareversion](./media/tutorial-define-device-type-experimental/configureproperties3.png)
...
1. Verwenden Sie zum Konfigurieren der Seriennummer die Informationen aus der folgenden Tabelle:
    ...
    ![Konfigurieren der Seriennummer](./media/tutorial-define-device-type-experimental/configureproperties4.png)
...
1. Um Ihren neuen Befehl zu konfigurieren, verwenden Sie die Informationen aus der folgenden Tabelle:
    ...
    ![Vorbereiten des Hinzufügens einer Einstellung](./media/tutorial-define-device-type-experimental/commandsecho1.png)
...
1. Konfigurieren Sie die Komponente **Liniendiagramm** mit den Informationen aus der folgenden Tabelle:
    ...
    | Measures     | Temperature (Klicken Sie neben **Temperature** (Temperatur) auf **Sichtbarkeit**.) |

    ![Einstellungen für Liniendiagramm](./media/tutorial-define-device-type-experimental/linechartsettings.png)
...
1. Konfigurieren Sie die Komponente **Ereignisverlauf** mit den Informationen aus der folgenden Tabelle:
    ...
    | Zeitbereich   | Letzte 30 Minuten |
    | Measures     | Fan Motor Error (Klicken Sie neben **Fan Motor Error** (Lüftermotorfehler) auf **Sichtbarkeit**.) |

    ![Einstellungen für Liniendiagramm](./media/tutorial-define-device-type-experimental/dashboardeventchartsetting.png)
...
1. Konfigurieren Sie die Komponente **Statusverlauf** mit den Informationen aus der folgenden Tabelle:
    ...
    | Titel        | Fan Mode |
    | Zeitbereich   | Letzte 30 Minuten |
    | Measures | Fan Mode (Klicken Sie neben **Fan Mode** (Lüftermodus) auf **Sichtbarkeit**.) |

    ![Einstellungen für Liniendiagramm](./media/tutorial-define-device-type-experimental/dashboardstatechartsetting.png)

    Klicken Sie anschließend auf **Speichern**.

1. Klicken Sie auf **Einstellungen und Eigenschaften**, um dem Dashboard die Geräteeinstellungen und -eigenschaften hinzuzufügen. Klicken Sie auf **Hinzufügen/Entfernen**, um dem Dashboard die gewünschten Einstellungen oder Eigenschaften hinzuzufügen.
...
1. Konfigurieren Sie die Komponente **Settings and Properties** (Einstellungen und Eigenschaften) mit den Informationen aus der folgenden Tabelle:
    ...
    **Einstellungen und Eigenschaften**, die Sie zuvor auf den entsprechenden Seiten definiert haben, werden unter **Verfügbare Spalten** angezeigt.
    ...
    ![Eigenschaftseinstellungen für „Set Temperature“](./media/tutorial-define-device-type-experimental/propertysettings4.png)
...
1. Nun werden simulierte Daten für Ihre verbundene Klimaanlage auf dem Dashboard angezeigt. Sie können die Kacheln und das Layout für das Dashboard bearbeiten:
    ...
    ![Anzeigen des Dashboards](./media/tutorial-define-device-type-experimental/dashboard.png)
