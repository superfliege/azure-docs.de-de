...
```
Ausgabe: ![Ausgabe des Befehls „monitor-messages“](media/howto-use-iotc-explorer/monitormessages.PNG)
...
Ausgabe: ![Ausgabe des Befehls"get-twin"](media/howto-use-iotc-explorer/getdevicetwin.PNG)
