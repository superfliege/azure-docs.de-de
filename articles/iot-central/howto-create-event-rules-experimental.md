...
1. Wenn Sie noch keine Regeln erstellt haben, gelangen Sie auf folgenden Bildschirm:
    ...
    ![Noch keine Regeln](media/howto-create-event-rules-experimental/Rules_Landing_Page.png)
...
1. Um die Regel sofort für alle Geräte zu aktivieren, die mit dieser Vorlage erstellt wurden, aktivieren Sie die Option **Regel für alle Geräte für diese Vorlage aktivieren**.
    ...
    ![Regeldetails](media/howto-create-event-rules-experimental/Rule_Detail.png)
...
1. Wählen Sie in der Dropdownliste „Messung“ das Ereignis aus, das Sie überwachen möchten. In diesem Beispiel wurde das Ereignis **Fan Motor Error** (Lüftermotorfehler) ausgewählt.
   ...
   ![Bedingung](media/howto-create-event-rules-experimental/Condition_Filled_Out.png)
...
1. Optional können Sie auch **Anzahl** als **Aggregation** festlegen und den entsprechenden Schwellenwert angeben.
    ...
    ![Hinzufügen einer Ereignisbedingung](media/howto-create-event-rules-experimental/Aggregate_Condition_Filled_Out.png)
...
1. Wählen Sie **+** neben der Option **Aktionen**. Hier sehen Sie die Liste der verfügbaren Aktionen.
    ...
    ![Hinzufügen einer Aktion](media/howto-create-event-rules-experimental/Add_Action.png)
...
1. Wählen Sie die Aktion **E-Mail**, geben Sie eine gültige E-Mail-Adresse in das Feld **An** ein, und geben Sie eine Notiz ein, die im Text der E-Mail erscheint, wenn die Regel ausgelöst wird.
    ...
    > [!NOTE]
    > E-Mails werden nur an die Benutzer gesendet, die der Anwendung hinzugefügt wurden und sich mindestens einmal angemeldet haben. Erfahren Sie mehr über die [Benutzerverwaltung](howto-administer-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json) in Azure IoT Central.

   ![Konfigurieren einer Aktion](media/howto-create-event-rules-experimental/Configure_Action.png)
...
- [Microsoft Flow-Aktion](howto-add-microsoft-flow-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json) zum Initiieren eines Workflows in Microsoft Flow bei Auslösung einer Regel 
- [Webhookaktion](howto-create-webhooks-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json) zum Benachrichtigen anderer Dienste bei Auslösung einer Regel
...
- [Hinzufügen einer Microsoft Flow-Aktion in Regeln](howto-add-microsoft-flow-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)
- [Hinzufügen einer Webhookaktion in Regeln](howto-create-webhooks-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)
