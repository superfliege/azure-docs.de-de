...
Wenn Sie das Befehlszeilentool auf einer anderen Plattform ausführen möchten, laden Sie Azure Cache for Redis von [http://redis.io/download](https://redis.io/download) herunter.
