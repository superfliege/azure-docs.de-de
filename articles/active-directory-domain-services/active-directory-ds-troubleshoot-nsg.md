...
## <a name="create-a-nsg-for-azure-ad-domain-services-using-powershell"></a>Erstellen einer NSG für Azure AD Domain Services mithilfe von PowerShell
