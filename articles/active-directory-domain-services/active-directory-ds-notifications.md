...
Es wird sofort eine Benachrichtigung gesendet, wenn eine [neue Warnung](active-directory-ds-troubleshoot-alerts.md) in Ihrer verwalteten Domäne auftritt. Wenn die Warnung nicht behoben wird, wird alle vier Tage eine E-Mail-Benachrichtigung zur Erinnerung gesendet.
