---
title: "Azure-Verwaltungslösungen | Microsoft-Dokumentation"
description: "Verwaltungslösungen beinhalten in Azure gebündelte Verwaltungsszenarien, die Kunden zu ihrem Log Analytics-Arbeitsbereich hinzufügen können.  Dieser Artikel enthält Details, wie benutzerdefinierte Lösungen von Kunden und Partnern erstellt werden können."
...
8. Sie werden aufgefordert, erforderliche Informationen wie z.B. den [Log Analytics-Arbeitsbereich und das Automation-Konto](#log-analytics-workspace-and-automation-account) zusätzlich zu den Werten für Parameter in der Lösung anzugeben.
...
3. Auf der Seite des OMS-Lösungskatalogs finden Sie Informationen zu jeder der verfügbaren Lösungen. Klicken Sie auf den Namen der Lösung, die Sie hinzufügen möchten.
...
5. Auf der Übersichtsseite im Portal wird eine neue Kachel für die hinzugefügte Lösung angezeigt, und Sie können die Lösung verwenden, nachdem Log Analytics Ihre Daten verarbeitet hat.
...
Lösungen, die Sie von der Community erhalten oder die Sie [selbst erstellen](#creating-a-solution), werden als Resource Manager-Vorlage implementiert, und Sie können die Standardmethoden für das [Bereitstellen einer Vorlage](../azure-resource-manager/resource-group-template-deploy-portal.md) verwenden.  Beachten Sie, dass Sie vor der Installation der Lösung den [Log Analytics-Arbeitsbereich und das Automation-Konto](#log-analytics-workspace-and-automation-account) erstellen und verknüpfen müssen.

## <a name="log-analytics-workspace-and-automation-account"></a>Log Analytics-Arbeitsbereich und Automation-Konto
Die meisten Verwaltungslösungen erfordern einen [Log Analytics-Arbeitsbereich](../log-analytics/log-analytics-manage-access.md) für Ansichten und ein [Automation-Konto](../automation/automation-security-overview.md#automation-account-overview) für Runbooks und zugehörige Ressourcen. Der Arbeitsbereich und das Konto müssen den folgenden Anforderungen entsprechen.

* Eine Lösung kann nur einen Log Analytics-Arbeitsbereich und nur ein Automation-Konto verwenden.  
* Der Log Analytics-Arbeitsbereich und das Automation-Konto, die von einer Lösung verwendet werden, müssen miteinander verknüpft sein. Ein Log Analytics-Arbeitsbereich kann nur mit einem Automation-Konto verknüpft werden, und ein Automation-Konto kann nur mit einem Log Analytics-Arbeitsbereich verknüpft werden.
* Damit sie verknüpft werden können, müssen sich der Log Analytics-Arbeitsbereich und das Automation-Konto in der gleichen Ressourcengruppe und im gleichen Bereich befinden.  Die Ausnahme ist ein Arbeitsbereich in der Region „USA, Osten“ und ein Automation-Konto in der Region „USA, Osten 2“.
...
* Wenn Sie eine Microsoft-Lösung über das OMS-Portal installieren, wird sie im aktuellen Arbeitsbereich installiert und es wird kein Automation-Konto benötigt.
* Wenn Sie die Lösung über den Azure Marketplace installieren, erhalten Sie eine Aufforderung zur Angabe eines Arbeitsbereichs und eines Automation-Kontos, und die Verknüpfung zwischen beiden wird für Sie erstellt.  
* Für Lösungen außerhalb des Azure Marketplace müssen Sie den Log Analytics-Arbeitsbereich und das Automation-Konto miteinander verknüpfen, bevor Sie die Lösung installieren.  Hierzu wählen Sie eine Lösung im Azure Marketplace aus und dann den Log Analytics-Arbeitsbereich und das Automation-Konto.  Sie müssen die Lösung nicht wirklich installieren, da die Verknüpfung erstellt wird, sobald der Log Analytics-Arbeitsbereich und das Automation-Konto ausgewählt wurden.  Nachdem die Verknüpfung erstellt wurde, können Sie diesen Log Analytics-Arbeitsbereich und dieses Automation-Konto für jede Lösung verwenden. 
...
2. Wenn im Abschnitt **Verwandte Ressourcen** des Menüs die Einstellung **Arbeitsbereich** aktiviert ist, wird dieses Konto mit einem Log Analytics-Arbeitsbereich verknüpft.  Wenn Sie die Details des Arbeitsbereichs anzeigen möchten, klicken Sie auf **Arbeitsbereich**.
