...
Um die Schritte in diesem Artikel ausführen zu können, müssen Sie [die Azure CLI für macOS, Linux und Windows installieren](https://docs.microsoft.com/cli/azure/install-az-cli2).
