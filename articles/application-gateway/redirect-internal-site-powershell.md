...
Fügen Sie mit [Add-AzureRmApplicationGatewayHttpListener](/powershell/module/azurerm.network/add-azurermapplicationgatewayhttplistener) den Listener namens *contosoOrgListener* hinzu, der zum Umleiten des Datenverkehrs benötigt wird.
...
Sie können die neue Umleitungskonfiguration mit [Add-AzureRmApplicationGatewayRequestRoutingRule](/powershell/module/azurerm.network/add-azurermapplicationgatewayrequestroutingrule) einer neuen Regel namens *contosoOrgRule* zuordnen.
