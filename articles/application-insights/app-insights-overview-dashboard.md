...
![Vorschauversion des Übersichtsbereichs](.\media\app-insights-overview-dashboard\overview-0001.png)

## <a name="better-performance"></a>Bessere Leistung

Die Auswahl des Zeitbereichs wurde zu einer 1-Klick-Oberfläche vereinfacht.

![Zeitbereich](.\media\app-insights-overview-dashboard\app-insights-overview-dashboard-03.png)
...
![Fehler](.\media\app-insights-overview-dashboard\app-insights-overview-dashboard-04.png)
...
![Dashboardansicht](.\media\app-insights-overview-dashboard\app-insights-overview-dashboard-05.png)
...
![Schaltfläche „Übersicht“](.\media\app-insights-overview-dashboard\app-insights-overview-dashboard-07.png)

## <a name="access-the-classic-overview-dashboard"></a>Zugriff auf das klassische Übersichtsdashboard

Wenn Sie die alte Übersicht vermissen, wählen Sie **Klassische Übersicht** aus.

![Klassische Übersicht](.\media\app-insights-overview-dashboard\overview-classic.png)
