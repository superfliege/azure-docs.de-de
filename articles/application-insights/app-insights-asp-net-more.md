...
|[Fügen Sie den JavaScript-Codeausschnitt zu Webseiten hinzu](app-insights-javascript.md).|[Seitenleistung](app-insights-usage-overview.md), Browserausnahmen, AJAX-Leistung. Benutzerdefinierte clientseitige Telemetriedaten.|
