...
Bei Verwendung des fortlaufenden Exports können zusätzliche Gebühren anfallen. Überprüfen Sie Ihr [Preismodell](https://azure.microsoft.com/pricing/details/application-insights/).
