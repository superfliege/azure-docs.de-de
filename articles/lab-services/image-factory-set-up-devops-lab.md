...
Der nächste Schritt bei der Einführung der Image Factory für Ihr Team besteht darin zu verstehen, was alles verfügbar ist. Die Image Factory-Skripts und -Vorlagen stehen öffentlich im [DevTest Labs-GitHub-Repository](https://github.com/Azure/azure-devtestlab/tree/master/Scripts/ImageFactory) zur Verfügung. Hier ist ein Überblick über die einzelnen Teile:
