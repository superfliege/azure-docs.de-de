...
1. Klicken Sie nach der Erstellung des Labs auf **Go to my lab** (Zum Lab wechseln). 

    ![Go to my lab (Zum Lab wechseln)](../media/tutorial-setup-classroom-lab/go-to-my-lab.png)
