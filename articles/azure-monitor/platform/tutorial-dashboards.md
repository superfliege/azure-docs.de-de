...
* [Streamen von Diagnoseprotokollen für Ressourcen an **Event Hubs**](../../monitoring-and-diagnostics/monitoring-stream-diagnostic-logs-to-event-hubs.md)
