...
## <a name="configuring-log-analytics-to-collect-azure-diagnostics-from-storage"></a>Konfigurieren von Log Analytics zum Erfassen der Azure-Diagnose aus dem Speicher
