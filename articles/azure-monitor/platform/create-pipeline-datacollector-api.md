...
Erfahren Sie mehr zur [Datensammler-API](../../azure-monitor/platform/data-collector-api.md), um Daten von jedem REST-API-Client in die Log Analytics-Instanz zu schreiben.
