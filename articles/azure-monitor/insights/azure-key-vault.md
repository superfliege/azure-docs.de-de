...
1. Aktivieren Sie die Azure Key Vault-Lösung mithilfe des [Azure Marketplace](https://azuremarketplace.microsoft.com/marketplace/apps/Microsoft.KeyVaultAnalyticsOMS?tab=Overview) oder des unter [Hinzufügen von Log Analytics-Lösungen aus dem Lösungskatalog](../../azure-monitor/insights/solutions.md) beschriebenen Prozesses.
...
* Verwenden Sie [Protokollsuchen in Log Analytics](../../log-analytics/log-analytics-queries.md), um ausführliche Azure Key Vault-Daten anzuzeigen.
