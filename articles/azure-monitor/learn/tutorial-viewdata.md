...
![Einfache Abfrage](media/tutorial-viewdata/log-analytics-portal-eventlist-01.png)
...
![Menü „Zu Filtern hinzufügen“](media/tutorial-viewdata/log-analytics-portal-eventlist-03.png)
...
![Gruppieren nach „Computer“](media/tutorial-viewdata/log-analytics-portal-eventlist-04.png)
...
![Tabellenansicht](media/tutorial-viewdata/log-search-portal-table-01.png)

Klicken Sie auf den Pfeil neben einem Datensatz, um die Details für diesen Datensatz anzuzeigen.

![Ergebnisse sortieren](media/tutorial-viewdata/log-search-portal-table-02.png)

Sortieren Sie nach einem Feld, indem Sie auf den entsprechenden Spaltenkopf klicken.

![Ergebnisse sortieren](media/tutorial-viewdata/log-search-portal-table-03.png)
...
![Ergebnisse filtern](media/tutorial-viewdata/log-search-portal-table-04.png)
...
![Ergebnisse gruppieren](media/tutorial-viewdata/log-search-portal-table-05.png)
...
![Leistungsdaten](media/tutorial-viewdata/log-analytics-portal-perfsearch-01.png)
...
![Prozessorauslastung](media/tutorial-viewdata/log-analytics-portal-perfsearch-02.png)
...
![Leistungsdatendiagramm](media/tutorial-viewdata/log-analytics-portal-perfsearch-03.png)
...
![Liniendiagramm](media/tutorial-viewdata/log-analytics-portal-linechart-01.png)
...
> [Erstellen und Freigeben von Log Analytics-Dashboards](tutorial-logs-dashboards.md)
