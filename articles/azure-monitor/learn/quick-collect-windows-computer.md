...
3. Wählen Sie **Erweiterte Einstellungen**.
    ...
    ![Erweiterte Einstellungen für Log Analytics](media/quick-collect-windows-computer/log-analytics-advanced-settings-01.png)
...
1. Wählen Sie im Anschluss an die vorherigen Schritte auf der Seite **Windows-Server** die entsprechende Version für **Windows-Agent herunterladen** aus, um in Abhängigkeit von der Prozessorarchitektur Ihres Windows-Betriebssystems herunterzuladen.
...
7. Klicken Sie auf **Weiter**, nachdem Sie die Bereitstellung der erforderlichen Konfigurationseinstellungen abgeschlossen haben.
    ...
    ![Arbeitsbereichs-ID und Primärschlüssel einfügen](media/quick-collect-windows-computer/log-analytics-mma-setup-laworkspace.png)
...
8. Wenn Sie die Windows-Leistungsindikatoren zum ersten Mal für einen neuen Log Analytics-Arbeitsbereich konfigurieren, haben Sie die Möglichkeit, schnell mehrere allgemeine Indikatoren zu erstellen. Diese werden in einer Liste aufgeführt, und neben jedem Indikator finden Sie ein Kontrollkästchen.
    ...
    ![Standardmäßige Windows-Leistungsindikatoren ausgewählt](media/quick-collect-windows-computer/windows-perfcounters-default.png).
...
2. Geben Sie im Bereich „Protokollsuche“ im Abfragefeldtyp `Perf` ein, und drücken Sie dann auf EINGABE, oder klicken Sie auf die Suchschaltfläche rechts neben dem Abfragefeld.
...
![Löschen von Log Analytics-Ressourcen](media/quick-collect-windows-computer/log-analytics-portal-delete-resource.png)
