...
In der folgenden Tabelle werden Konzepte und Datenstrukturen von Splunk und Log Analytics miteinander verglichen.
 ...
 | Konzept  | Splunk | Log Analytics |  Comment
 | --- | --- | --- | ---
 ...
 | Strukturierte Ereignismetadaten | N/V | Tabelle |  Bei Splunk wird das Konzept der Suchsprache für Ereignismetadaten nicht verfügbar gemacht. Log Analytics weist das Konzept einer Tabelle mit Spalten auf. Jede Ereignisinstanz ist einer Zeile zugeordnet. |
 | Datensatz | event | row |  Nur Terminologieänderung. |
 | Datensatzattribut | Feld |  column |  In Log Analytics ist dies als Teil der Tabellenstruktur vordefiniert. In Splunk hat jedes Ereignis einen eigenen Satz von Feldern. |
