...
Überprüfen Sie die Funktionsfähigkeit Ihrer Livewebanwendung in der Produktion mithilfe von Live Metrics Stream von [Application Insights](../../application-insights/app-insights-overview.md). Wählen und filtern Sie Metriken und Leistungsindikatoren für die Überwachung in Echtzeit, ohne dass der Dienst beeinträchtigt wird. Überprüfen Sie Stapelüberwachungen von fehlerhaften Anforderungen und Ausnahmen. In Kombination mit [Profiler](../../application-insights/app-insights-profiler.md), [Snapshot Debugger](../../application-insights/app-insights-snapshot-debugger.md) und [Leistungstests](../../azure-monitor/app/monitor-web-app-availability.md#performance-tests) bietet Live Metrics Stream ein leistungsfähiges und nicht invasives Diagnosetool für Ihre Livewebsite.
...
1. Wenn Sie [Application Insights](../../azure-monitor/app/asp-net.md) noch nicht in Ihrer ASP.NET-Web-App oder [Windows-Server-App](../../application-insights/app-insights-windows-services.md) installiert haben, holen Sie dies jetzt nach. 
...
![Klicken Sie auf dem Blatt „Übersicht“ auf „Livedatenstrom“.](./media/live-stream/live-stream-2.png)
