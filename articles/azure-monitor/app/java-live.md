...
2. Erstellen Sie eine neue Application Insights-Ressource, und legen Sie den Anwendungstyp auf Java-Webanwendung fest.
    ...
    ![Geben Sie einen Namen ein, wählen Sie "Java-Web-App", und klicken Sie auf "Erstellen"](./media/java-live/02-create.png)
...
4. Öffnen Sie neue Ressource, und rufen Sie den Instrumentierungsschlüssel ab. Dieser Schlüssel muss in Kürze in das Codeprojekt eingefügt werden.
    ...
    ![Klicken Sie in der Übersicht über neue Ressourcen auf "Eigenschaften", und kopieren Sie den Instrumentationsschlüssel](./media/java-live/03-key.png)
...
Gegebenenfalls müssen Sie [Ausnahmen für das Senden ausgehender Daten festlegen](../../azure-monitor/app/ip-addresses.md).
...
![Beispieldaten](./media/java-live/5-results.png)
...
* [Fügen Sie Ihren Webseiten Telemetrie hinzu](javascript.md) , um Seitenaufrufe und Benutzermetriken zu überwachen.
* [Richten Sie Webtests ein](../../azure-monitor/app/monitor-web-app-availability.md) , um sicherzustellen, dass die Anwendung online und reaktionsfähig bleibt.
* [Erfassen von Protokollablaufverfolgungen](java-trace-logs.md)
* [Durchsuchen Sie Ereignisse und Protokolle](../../azure-monitor/app/diagnostic-search.md) , um Probleme besser zu diagnostizieren.
