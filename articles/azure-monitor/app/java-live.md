...
Wenn Sie eine Webanwendung haben, die bereits auf dem J2EE-Server ausgeführt wird, können Sie mit der Überwachung mit [Application Insights](../../application-insights/app-insights-overview.md) beginnen, ohne Codeänderungen vornehmen oder das Projekt neu kompilieren zu müssen. Mit dieser Option erhalten Sie Informationen zu an Ihre Server gesendeten HTTP-Anforderungen, nicht behandelten Ausnahmen und Leistungsindikatoren.
