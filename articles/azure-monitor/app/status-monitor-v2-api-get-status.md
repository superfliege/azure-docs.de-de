...
ms.locfileid: "65147500"
---
# <a name="status-monitor-v2-api-get-applicationinsightsmonitoringstatus-v021-alpha"></a>API für Statusmonitor v2: Get-ApplicationInsightsMonitoringStatus (v0.2.1-alpha)
