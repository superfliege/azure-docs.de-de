...
Sie können [Application Insights](../../azure-monitor/app/app-insights-overview.md) für die Überwachung einer Vielzahl verschiedener Anwendungen oder Anwendungsrollen, Komponenten oder Microservices konfigurieren. Für Web-Apps und Dienste bietet Visual Studio [eine Konfiguration mit wenigen Klicks](../../azure-monitor/app/asp-net.md). Bei anderen Arten von .NET-Anwendungen, wie z.B. Back-End-Serverrollen oder Desktopanwendungen, können Sie Application Insights manuell konfigurieren.

![Beispiel für Leistungsüberwachungsdiagramm](./media/windows-services/10-perf.png)
...
![Klicken Sie auf "Neu > Application Insights"](./media/windows-services/01-new-asp.png)
...
![Klicken Sie auf "Eigenschaften", wählen Sie den Schlüssel aus, und drücken Sie STRG+C](./media/windows-services/02-props-asp.png)
...
1. Klicken Sie in Visual Studio mit der rechten Maustaste auf Ihr Projekt, und wählen Sie **NuGet-Pakete verwalten**.
    ...
    ![Klicken Sie mit der rechten Maustaste auf das Projekt, und wählen Sie "NuGet-Pakete verwalten".](./media/windows-services/03-nuget.png)
2. Installieren Sie das Application Insights-Paket für Windows Server-Apps: „Microsoft.ApplicationInsights.WindowsServer“.
   
    ![Suchen Sie nach "Application Insights".](./media/windows-services/04-ai-nuget.png)
...
* [Schreiben Sie mithilfe der API eigene Telemetrie.](../../azure-monitor/app/api-custom-events-metrics.md#ikey)
...
Es ist nützlich, den Instrumentierungsschlüssel im Code festzulegen, wenn Sie [den Schlüssel für verschiedene Buildkonfigurationen wechseln möchten](../../azure-monitor/app/separate-resources.md). Wenn Sie den Schlüssel im Code festlegen, müssen Sie ihn nicht in der Datei `.config` festlegen.
...
![Ereignisanzahl in Visual Studio](./media/windows-services/appinsights-09eventcount.png)
...
![Klicken Sie, um weitere Daten anzuzeigen.](./media/windows-services/12-first-perf.png)

Klicken Sie sich durch ein beliebiges Diagramm, um ausführlichere Metriken anzuzeigen. [Weitere Informationen zu Metriken.](../../azure-monitor/app/web-monitor-performance.md)
...
* Öffnen Sie die Kachel [Suche](../../azure-monitor/app/diagnostic-search.md) , um einzelne Ereignisse anzuzeigen. Manchmal dauert es eine Weile, bis Ereignisse über die Metrikpipeline übertragen werden.
...
* Informationen hierzu finden Sie unter [Problembehandlung](../../azure-monitor/app/troubleshoot-faq.md).
...
![Veröffentlichen Sie die App mit Visual Studio.](./media/windows-services/15-publish.png)
...
Weitere Informationen finden Sie in [diesem Artikel zur Problembehandlung](../../azure-monitor/app/asp-net-troubleshoot-no-data.md#NuGetBuild).
...
* [Fügen Sie weitere Telemetriefunktionen hinzu](../../azure-monitor/app/asp-net-more.md) , um eine Rundumansicht Ihrer Anwendung zu erhalten:
