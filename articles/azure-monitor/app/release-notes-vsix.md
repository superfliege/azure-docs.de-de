...
![Ausnahmen in CodeLens](./media/release-notes-vsix/ExceptionsCodeLens.png)
...
![Unterstützung für ASP.NET Core](./media/release-notes-vsix/NetCoreSupport.png)
...
![Unterstützung für Diagnosetools](./media/release-notes-vsix/DiagnosticTools.png)
...
![Kontextmenü des Projekts für universelle Windows-Apps](./media/release-notes-vsix/UniversalContextMenu.png)
...
![Dialogfeld „Upload“ für universelle Windows-Apps](./media/release-notes-vsix/UniversalUploadDialog.png)
...
![Benachrichtigung „Upload abgeschlossen“](./media/release-notes-vsix/UploadComplete.png)
...
![Kontextmenü des Projekts für Windows Forms-Apps](./media/release-notes-vsix/WinFormContextMenu.png)

Das Dialogfeld für den HockeyApp-Upload wird geöffnet. Es ähnelt dem Dialogfeld in einer universellen Windows-App.

![Dialogfeld „Upload“ für Windows Forms-Apps](./media/release-notes-vsix/WinFormsUploadDialog.png)
...
![Upload abgeschlossen](./media/release-notes-vsix/LocalSearch.png)
...
![Benachrichtigung über Protokollierung](./media/release-notes-vsix/LoggingToast.png)
...
![Ablaufverfolgungen](./media/release-notes-vsix/Traces.png)
...
![Übereinstimmung suchen](./media/release-notes-vsix/FindMatch.png)
...
![Fenster „Suchen“](./media/release-notes-vsix/SearchWindow.png)
...
![Verwandte Elemente](./media/release-notes-vsix/RelatedItems.png)
...
![Zurück navigieren](./media/release-notes-vsix/GoBAck.png)
...
![Auf Ausnahmedetails klicken](./media/release-notes-vsix/jumptocode.png)
...
![Suche im Projektmappen-Explorer](./media/release-notes-vsix/searchentry.png)
...
![Benachrichtigung „Veröffentlichung abgeschlossen“](./media/release-notes-vsix/publishtoast.png)
...
![Fenster „Suchen“](./media/release-notes-vsix/search.png)
...
![Seite „Diagnosetools“](./media/release-notes-vsix/diagtools.png)
...
![Dialogfeld "Neues Projekt"](./media/release-notes-vsix/newproject.png)
