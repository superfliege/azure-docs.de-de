...
![DevOps-Zyklus](./media/detect-triage-diagnose/00-devcycle.png)
...
![Erkennung-Eingrenzung-Diagnose](./media/detect-triage-diagnose/01-pipe1.png)

## <a name="detect-poor-availability"></a>Erkennen schlechter Verfügbarkeit
Marcela Markova ist leitende Entwicklerin im OBS-Team, und ist für Tests sowie für die Überwachung der Onlineleistung zuständig. Sie richtet mehrere [Verfügbarkeitstests](../../azure-monitor/app/monitor-web-app-availability.md) ein:
...
![Anzeigen von Webtests, die im vorherigen Zeitraum erfolgt sind](./media/detect-triage-diagnose/04-webtests.png)
...
![Verschiedene Metriken](./media/detect-triage-diagnose/002-servers.png)
...
Also richtet sie eine [Warnung](../../azure-monitor/app/metrics-explorer.md) für Antwortzeiten ein, die länger sind als der typische Schwellenwert. Dies gibt ihr Zuversicht, dass Bescheid weiß, wenn Antwortzeiten zu langsam sind.

![Blatt "Warnung hinzufügen"](./media/detect-triage-diagnose/07-alerts.png)
...
![Proaktive Diagnose-E-Mail](./media/detect-triage-diagnose/21.png)
...
Mit nur wenigen Einrichtungsschritten werden [Ausnahmen](../../azure-monitor/app/asp-net-exceptions.md) automatisch an Application Insights gemeldet. Die Ausnahmen können auch explizit aufgezeichnet werden, indem Aufrufe von [TrackException()](../../azure-monitor/app/api-custom-events-metrics.md#trackexception) in den Code eingefügt werden:  
...
Ausnahmen und Ereignisse werden auf dem Blatt [Diagnosesuche](diagnostic-search.md) angezeigt. Sie können eine Detailsuche durchführen, um die weiteren Eigenschaften und die Stapelüberwachung anzuzeigen.

![Verwenden Sie bei der Diagnosesuche Filter, um bestimmte Datentypen anzeigen](./media/detect-triage-diagnose/appinsights-333facets.png)
...
![Diagramme von Abhängigkeitsfehlern und Dauer von Aufrufen von Abhängigkeiten](./media/detect-triage-diagnose/11-dependencies.png)
...
![Anzahl von Seitenaufrufen](./media/detect-triage-diagnose/funnel.png)
...
* Bereits bereitgestellte Apps, die über [IIS](../../azure-monitor/app/monitor-web-app-availability.md), [Java EE](../../azure-monitor/app/java-live.md) oder [Azure](../../azure-monitor/app/app-insights-overview.md) gehostet werden.
