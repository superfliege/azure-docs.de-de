...
![Bildschirm „Unerwarteter Fehler“](media/analytics-troubleshooting/010.png)
...
![403 ... Überprüfen Sie die Sicherheitszone](media/analytics-troubleshooting/030.png)
...
5. Dieser Fehler kann auch bei Microsoft Edge und Internet Explorer auftreten, wenn die Einstellungen für vertrauenswürdige Zonen nicht unterstützt werden.
   ...
   * Öffnen Sie in Internet Explorer **Internetoptionen**, **Sicherheit**, **Vertrauenswürdige Sites**, **Sites**:
     ...
     ![Dialogfeld „Internetoptionen“, Hinzufügen einer Website zu den vertrauenswürdigen Websites](media/analytics-troubleshooting/033.png)
...
![404 ... Ressource nicht gefunden](media/analytics-troubleshooting/040.png)
...
![403 ... nicht autorisiert](media/analytics-troubleshooting/050.png)
...
* Internet Explorer: Internetoptionen, Registerkarte „Erweitert“, Sicherheit, DOM-Storage aktivieren

![403 ... Versuchen Sie, HTML5 Storage zu aktivieren](media/analytics-troubleshooting/060.png)

## <a name="e-g"></a>404 ... Abonnement nicht gefunden
![404 ... Abonnement nicht gefunden](media/analytics-troubleshooting/070.png)
...
![404 ... Seite ist nicht vorhanden](media/analytics-troubleshooting/080.png)
...
## <a name="cookies"></a>Aktivieren von Drittanbietercookies
  Informationen zum Deaktivieren von Drittanbietercookies finden Sie [hier](https://www.digitalcitizen.life/how-disable-third-party-cookies-all-major-browsers). Beachten Sie jedoch, dass die Cookies in diesem Fall **aktiviert** werden müssen.
