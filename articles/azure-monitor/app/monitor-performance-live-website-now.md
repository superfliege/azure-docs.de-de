...
* Wählen Sie in der Systemsteuerung der App in Azure „Application Insights“ aus.
    ...
    ![Einrichten von Application Insights für eine Azure-Web-App](./media/monitor-performance-live-website-now/azure-web-setup.png)
* Klicken Sie auf der Zusammenfassungsseite von Application Insights auf den Link am unteren Rand, um die vollständige Application Insights-Ressource zu öffnen.
    ...
    ![Öffnen von Application Insights](./media/monitor-performance-live-website-now/azure-web-view-more.png)

[Überwachen von Cloud- und VM-Apps](../../application-insights/app-insights-overview.md)
...
* Die Protokolle des Statusmonitors finden Sie standardmäßig hier: „C:\Program Files\Microsoft Application Insights\Status Monitor\diagnostics.log“
