...
Weitere Informationen zu den Funktionen und Anwendungsfällen von Avere vFXT finden Sie unter [Avere vFXT für Azure](https://azure.microsoft.com/services/storage/avere-vfxt/).
