...
Verwenden Sie das Cmdlet **Install-AzureRmProfile** mit dem API-Versionsprofil **2017-03-09-profile**, um die von Azure Stack benötigten AzureRM-Module zu installieren. Beachten Sie, dass die Azure Stack-Cloudadministratormodule nicht mit diesem API-Versionsprofil installiert werden. Sie sollten wie in Schritt 3 des Artikels [Install PowerShell for Azure Stack](azure-stack-powershell-install.md) (Installieren von PowerShell für Azure Stack) separat installiert werden.
