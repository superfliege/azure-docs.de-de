...
Sie können Ihre Metriken von Azure Monitor in Azure Stack auf die gleiche Weise abrufen wie in der allgemeinen Azure-Umgebung. Sie können Ihre Measures im Portal anzeigen, über die REST-API abrufen oder per PowerShell oder Befehlszeilenschnittstelle abfragen.
