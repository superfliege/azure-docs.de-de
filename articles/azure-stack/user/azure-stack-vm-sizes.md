...
|Größe – Größe\Name |vCPU     |Arbeitsspeicher | Max. Größe der temporären Datenträger | Max. Durchsatz des Betriebssystem-Datenträgers: (IOPS) | Maximaler Durchsatz (temporärer Speicher): (IOPS) | Max. Datenträgerdurchsatz: (IOPS) |
|-----------------|-----|---------|---------|-----|------|-----------|
...
|**Standard_D4_v2** |8   |28  |400  |500 |24.000 |32/32 x 500 |8/6000 |
