...
* **Ein Linux-Image im Azure Stack-Marketplace**
   ...
   Ein Linux-Image ist standardmäßig nicht im Azure Stack-Marketplace enthalten. Bevor Sie einen virtuellen Linux-Computer erstellen können, stellen Sie also sicher, dass der Azure Stack-Operator das **Ubuntu Server 16.04 LTS**-Image mithilfe der im Artikel [Herunterladen von Marketplace-Elementen von Azure in Azure Stack](../azure-stack-download-azure-marketplace-item.md) beschriebenen Schritte heruntergeladen hat.
