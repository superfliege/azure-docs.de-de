 ---
Titel: Häufig gestellte Fragen zur Nutzungs-API | Microsoft-Dokumentation Beschreibung: Liste der Azure Stack-Verbrauchseinheiten, Vergleich mit der Azure Nutzungs-API, Nutzungszeit und gemeldete Zeit, Fehlercodes.
