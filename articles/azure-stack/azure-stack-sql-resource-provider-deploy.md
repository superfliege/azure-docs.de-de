...
3. [Laden Sie die Binärdatei des SQL-Ressourcenanbieters herunter](https://aka.ms/azurestacksqlrp), und extrahieren Sie sie in einem temporären Verzeichnis.
...
2. Überprüfen Sie, ob die Bereitstellung erfolgreich war. Suchen Sie nach **Ressourcengruppen** &gt;, klicken Sie auf die Ressourcengruppe **system.<location>.sqladapter**, und überprüfen Sie, ob alle fünf Bereitstellungen erfolgreich waren.
