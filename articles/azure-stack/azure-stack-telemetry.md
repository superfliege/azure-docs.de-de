...
### <a name="asdk-set-telemetry-level-in-the-windows-registry"></a>ASDK: Festlegen der Telemetrieebene in der Windows-Registrierung
...
### <a name="asdk-and-multinode-enable-or-disable-telemetry-after-deployment"></a>ASDK und mehrere Knoten: Aktivieren oder Deaktivieren der Telemetrie nach der Bereitstellung
