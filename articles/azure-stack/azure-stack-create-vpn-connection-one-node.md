...
* Zwei Server und andere erforderliche Komponenten, die die ASDK-Hardwareanforderungen erfüllen, wie hier beschrieben [Schnellstart: Evaluieren des Azure Stack Development Kit](azure-stack-deploy-overview.md).
...
> [!NOTE]
> Führen Sie für jedes bereitgestellte ASDK die folgenden [Bereitstellungsanweisungen](azure-stack-run-powershell-script.md) aus. In diesem Artikel werden die ASDK-Umgebungen als **POC1** und **POC2** bezeichnet.
