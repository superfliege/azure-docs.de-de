...
Dieses Beispielskript erstellt eine Ressourcengruppe, einen Linux App Service-Plan und eine Web-App. Anschließend wird eine ASP.NET Core-Anwendung mit einem Docker-Container aus der Azure Container Registry bereitgestellt.
...
| [`az webapp config container set`](/cli/azure/webapp/config/container?view=azure-cli-latest#az-webapp-config-container-set) | Legt den Docker-Container für die Azure-Web-App fest. |
