---
title: Azure CLI-Skriptbeispiel – Erstellen einer ASP.NET Core-Web-App in Azure Container Registry | Microsoft-Dokumentation
description: 'Azure CLI-Skriptbeispiel: Erstellen einer ASP.NET Core-App in einem Docker-Container in App Service über Azure Container Registry'
services: appservice
