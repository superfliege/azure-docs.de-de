...
Laden Sie das Startskript in `/home/site/deployments/tools` in Ihrer App Service-Instanz hoch. Anweisungen zum Abrufen der FTP-Anmeldeinformationen finden Sie in [diesem Dokument](/azure/app-service/deploy-configure-credentials#userscope). 
