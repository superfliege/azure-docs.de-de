...
Es wird empfohlen, den lokalen Cache gemeinsam mit dem Feature [Stagingumgebungen](../app-service/web-sites-staged-publishing.md) zu verwenden.
...
* Wenn Sie bereit dazu sind, wechseln Sie über einen [swap-Vorgang](../app-service/web-sites-staged-publishing.md#Swap) zwischen Ihrem Staging- und Ihrem Produktionsslot.  
