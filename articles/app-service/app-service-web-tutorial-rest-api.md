...
Aktivieren Sie CORS in Cloud Shell mithilfe des Befehls [`az resource update`](/cli/azure/resource#az_resource_update) für die URL Ihres Clients. Ersetzen Sie den Platzhalter _&lt;appname>_.
