...
Eine App Service-Umgebung ist eine Option des [Premium][PremiumTier]-Tarifs von [Azure App Service](../app-service-web-overview.md), die eine vollständig isolierte und dedizierte Umgebung zur sicheren Ausführung zahlreicher Azure App Service-Apps mit hoher Skalierung einschließlich Web-Apps, Mobile Apps und API-Apps bereitstellt.  
