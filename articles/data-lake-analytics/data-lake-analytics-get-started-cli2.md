---
title: Erste Schritte mit Azure Data Lake Analytics mithilfe von Azure CLI 2.0
description: Hier erfahren Sie, wie Sie mithilfe der Azure-Befehlszeilenschnittstelle 2.0 ein Data Lake Analytics-Konto erstellen und einen U-SQL-Auftrag übermitteln.
...
In diesem Artikel erfahren Sie, wie Sie mithilfe der Azure CLI 2.0 (Befehlszeilenschnittstelle) Data Lake Analytics-Konten erstellen und U-SQL-Aufträge und Kataloge übermitteln. Der Auftrag liest eine Datei mit tabulatorgetrennten Werten (TSV) und konvertiert sie in eine Datei mit kommagetrennten Werten (CSV). 
