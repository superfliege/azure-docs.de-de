...
## <a name="saving-authenticaiton-context"></a>Kontext der Serverauthentifizierung
...
### <a name="log-in-using-a-service-principle-identity-spi"></a>Anmelden per Service Principle Identity (SPI)
