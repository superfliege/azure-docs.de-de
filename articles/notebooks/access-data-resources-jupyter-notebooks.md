...
- [Build a Flask app with the MongoDB API](https://docs.microsoft.com/azure/cosmos-db/create-mongodb-flask) (Erstellen einer Flask-App mit der MongoDB-API)
