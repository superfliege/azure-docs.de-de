---
title: RSS-Connector in Azure Logic Apps | Microsoft-Dokumentation
...
Zeigen Sie die in Swagger definierten Trigger und Aktionen sowie mögliche Beschränkungen in den [Connectordetails](/connectors/rss/) an.
