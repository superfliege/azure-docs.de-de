...
Der zweite Codeblock verwendet die Fuzzysuche ([Azure Maps-API für die Fuzzysuche](https://docs.microsoft.com/rest/api/maps/search/getsearchfuzzy)) für die Point of Interest-Suche. Die API für die Fuzzysuche kann eine beliebige Kombination von Fuzzyeingaben verarbeiten. Die Antwort des Diensts für die Fuzzysuche wird dann im GeoJSON-Format analysiert, und auf der Karte werden Stecknadeln hinzugefügt, um die Points of Interest anzuzeigen. 
