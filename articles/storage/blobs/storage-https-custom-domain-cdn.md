...
> [!NOTE]  
> Zusätzlich zur Bereitstellung von SSL-Unterstützung für benutzerdefinierte Domänennamen kann Sie Azure CDN bei der Skalierung Ihrer Applikation unterstützen, damit diese Inhalte mit hoher Bandbreite in die gesamte Welt liefern kann. Weitere Informationen finden Sie im [Überblick über das Azure CDN](../../cdn/cdn-overview.md).
...
1.  [Integrieren eines Azure-Speicherkontos in CDN](../../cdn/cdn-create-a-storage-account-with-cdn.md).
    ...
    > [!NOTE]  
    > Wählen Sie während der Vorschauphase der Unterstützung statischer Websites in Azure Storage im Dropdownmenü „Ursprungstyp“ die Option „Benutzerdefinierte Domäne“ aus, um Ihren Speicher-Webendpunkt hinzuzufügen. Im Azure-Portal müssen Sie diesen Schritt über Ihr CDN-Profil ausführen (nicht direkt in Ihrem Speicherkonto).
...
Sie können HTTP-Datenverkehr an HTTPS umleiten. Dies erfordert die Verwendung des Azure CDN-Premiumangebots von Verizon. Sie müssen das [HTTP-Verhalten mithilfe der Azure-CDN-Regel-Engine](../../cdn/cdn-rules-engine.md) mit der folgenden Regel überschreiben:

![](./media/storage-https-custom-domain-cdn/redirect-to-https.png)

„cdn-endpoint-name“ bezieht sich auf den Namen, den Sie für Ihren CDN-Endpunkt konfiguriert haben. Diesen Wert können Sie aus der Dropdownliste auswählen. „origin-path“ bezieht sich auf den Pfad in Ihrem Ursprungsspeicherkonto, an dem sich Ihr statischer Inhalt befindet. Wenn Sie alle statischen Inhalte in einem einzelnen Container hosten, ersetzen Sie „origin-path“ durch den entsprechenden Containernamen.
