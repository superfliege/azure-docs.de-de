...
ms.locfileid: "49387207"
---
# <a name="quickstart-upload-download-and-list-blobs-by-using-the-java-storage-sdk-v10-preview"></a>Schnellstart: Hochladen, Herunterladen und Auflisten von Blobs mit dem Java Storage-SDK v10 (Vorschauversion)
...
1. Erstellen Sie eine Instanz des Objekts **StorageURL**, das auf das Speicherkonto verweist.
    ...
    * Das Objekt [StorageURL](https://docs.microsoft.com/java/api/com.microsoft.azure.storage.blob._storage_u_r_l?view=azure-java-preview) ist eine Darstellung Ihres Speicherkontos. Sie generieren damit eine neue Pipeline. 
    ...
    * Erstellen Sie mithilfe der Pipeline eine Instanz des [ServiceURL](https://docs.microsoft.com/java/api/com.microsoft.azure.storage.blob._service_u_r_l?view=azure-java-preview)-Objekts.
    * Erstellen Sie mithilfe des **ServiceURL**-Objekts eine Instanz von [ContainerURL](https://docs.microsoft.com/java/api/com.microsoft.azure.storage.blob._container_u_r_l?view=azure-java-preview).
...
2. Erstellen Sie eine Instanz des **ContainerURL**-Objekts, das den Container darstellt, auf den Sie zugreifen. Container organisieren Ihre Blobs, so wie auf Ihrem Computer Ordner zum Organisieren von Dateien verwendet werden.
    ...
    * Erstellen Sie mithilfe des [ServiceURL](https://docs.microsoft.com/java/api/com.microsoft.azure.storage.blob._blob_u_r_l?view=azure-java-preview)-Objekts eine Instanz des [BlobURL](https://docs.microsoft.com/java/api/com.microsoft.azure.storage.blob._container_u_r_l?view=azure-java-preview)-Objekts.
...
Laden Sie mithilfe von [BlobURL.download](https://docs.microsoft.com/java/api/com.microsoft.azure.storage.blob._blob_u_r_l.download?view=azure-java-preview) Blobs auf Ihren lokalen Datenträger herunter.
...
> [API-Referenz](https://docs.microsoft.com/java/api/overview/azure/storage/client?view=azure-java-preview)
