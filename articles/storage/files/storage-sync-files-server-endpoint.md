...
Informationen zur End-to-End-Bereitstellung von Azure File Sync finden Sie unter [Bereitstellen von Azure File Sync](storage-sync-files-deployment-guide.md).
