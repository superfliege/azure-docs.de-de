...
Um von Kunden-verwaltete Schlüssel mit SSE verwenden zu können, müssen Sie dem Speicherkonto eine Speicherkontoidentität zuweisen. Sie können die Identität durch Ausführen des folgenden PowerShell- oder Azure CLI-Befehls festlegen:
...
Wenn Sie nicht über einen Schlüsseltresor verfügen, können Sie ihn mit Portal, PowerShell oder CLI erstellen:
...
Wenn Sie einen vorhandenen Schlüsseltresor verwenden, müssen Sie „Vorläufig löschen“ und „Nicht bereinigen“ in Ihrem Tresor mit den folgenden PowerShell- oder Azure CLI-Befehlen aktivieren:
...
Sie benötigen einen Schlüsseltresor und einen zugehörigen Schlüssel. Gehen Sie wie folgt vor, um Ihren Schlüssel aus einem Schlüsseltresor anzugeben:
