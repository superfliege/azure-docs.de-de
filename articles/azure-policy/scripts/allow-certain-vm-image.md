---
title: 'Azure Policy: JSON-Beispiel – Zulassen von nur einem bestimmten VM-Plattformimage | Microsoft-Dokumentation'
description: Diese JSON-Beispielrichtlinie erfordert, dass virtuelle Computer eine bestimmte Version von UbuntuServer verwenden.
...
ms.locfileid: "34602294"
---
# <a name="only-allow-a-certain-vm-platform-image"></a>Zulassen von nur einem bestimmten VM-Plattformimage
