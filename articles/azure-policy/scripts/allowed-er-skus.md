---
title: 'Azure Policy: JSON-Beispiel – Zulässige ExpressRoute-SKUs | Microsoft-Dokumentation'
description: Diese JSON-Beispielrichtlinie erfordert, dass ExpressRoutes eine zulässige SKU verwenden.
...
ms.locfileid: "34604759"
---
# <a name="allowed-express-route-skus"></a>Zulässige ExpressRoute-SKUs

Diese Richtlinie erfordert, dass ExpressRoutes eine zulässige SKU verwenden. Sie geben ein Array von zulässigen SKUs an.
