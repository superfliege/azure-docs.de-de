---
title: 'Azure Policy: JSON-Beispiel – Überwachung, wenn keine Erweiterung vorhanden ist | Microsoft-Dokumentation'
description: Diese JSON-Beispielrichtlinie überwacht, wenn eine Erweiterung nicht mit einem virtuellen Computer bereitgestellt wird.
