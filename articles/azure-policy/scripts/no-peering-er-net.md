---
title: "Azure Policy: JSON-Beispiel – Kein Netzwerkpeering an ein ER-Netzwerk | Microsoft-Dokumentation"
description: Diese JSON-Beispielrichtlinie verhindert, dass ein Netzwerkpeering einem Netzwerk in einer angegebenen Ressourcengruppe zugeordnet wird.
...
---
# <a name="no-network-peering-to-er-network"></a>Kein Netzwerkpeering an ein ER-Netzwerk
