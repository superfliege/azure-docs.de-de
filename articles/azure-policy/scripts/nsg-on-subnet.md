---
title: 'Azure Policy: JSON-Beispiel – Netzwerksicherheitsgruppe x auf jedem Subnetz | Microsoft-Dokumentation'
description: Diese JSON-Beispielrichtlinie erfordert, dass eine bestimmte Netzwerksicherheitsgruppe für jedes Subnetz verwendet wird.
