...
Sie können diese Vorlage über das [Azure-Portal](#deploy-with-the-portal), mit [PowerShell](#deploy-with-powershell) oder mit [Azure CLI](#deploy-with-azure-cli) bereitstellen.
