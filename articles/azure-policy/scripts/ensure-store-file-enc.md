---
title: 'Azure Policy: JSON-Beispiel – Speicherkontoverschlüsselung erforderlich | Microsoft-Dokumentation'
description: Diese JSON-Beispielrichtlinie erfordert, dass die Dateiverschlüsselung für Speicherkonten aktiviert ist.
