...
ms.locfileid: "34602610"
---
# <a name="azure-policy-samples"></a>Azure Policy-Beispiele

In der folgenden Tabelle sind Links zu JSON-Vorlagen für Azure Policy enthalten. Diese Beispiele befinden sich auch im [Azure Policy-Beispielrepository](https://github.com/Azure/azure-policy).
...
- Sehen Sie sich die [Struktur von Richtliniendefinitionen](policy-definition.md) an.
- Lesen Sie die Informationen unter [Grundlegendes zu Richtlinienauswirkungen](policy-effects.md).