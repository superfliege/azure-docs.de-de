...
Verwenden Sie für Marketplace-Images [Set-AzureRmVMPlan](https://docs.microsoft.com/powershell/module/azurerm.compute/set-azurermvmplan?view=azurermps-6.7.0) zum Festlegen der Planinformationen.
```powershell
