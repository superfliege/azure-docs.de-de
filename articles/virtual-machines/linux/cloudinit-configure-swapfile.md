...
Erstellen Sie nun mit dem Befehl [az vm create](/cli/azure/vm#create) eine VM, und geben Sie mit `--custom-data cloud_init_swapfile.txt` die cloud-init-Datei an, wie im Folgenden gezeigt wird:
