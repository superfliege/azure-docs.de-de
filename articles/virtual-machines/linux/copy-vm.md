...
In diesem Artikel erfahren Sie, wie Sie eine Kopie des virtuellen Azure-Computers (VM) unter Linux mit Azure CLI 2.0 und dem Azure Resource Manager-Bereitstellungsmodell erstellen. 
