# Übersicht
## [Informationen zu SQL Server-VMs unter Linux](sql-server-linux-virtual-machines-overview.md)

# Schnellstarts
## [Erstellen eines virtuellen SQL-Computers – Portal](provision-sql-server-linux-virtual-machine.md)
