---
title: Verwenden der Azure DSC-Erweiterung für Linux | Microsoft-Dokumentation
...
Die DSC Linux-Erweiterung unterstützt alle [von Erweiterungen unterstützten Betriebssysteme](https://azurewiki.cloudapp.netVMAgentExtension/extensionSupportedOSs) außer:

| Distribution | Version |
|---|---|
| CentOS Linux | SQL Server 6.5 oder höher |
| Ubuntu| 12.04 LTS, 14.04 LTS, 16.04 LTS  |
| RHEL| SQL Server 6.5 oder höher  |
| openSUSE| 13.1 und höher  |
