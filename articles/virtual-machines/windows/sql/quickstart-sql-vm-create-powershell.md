...
---
# <a name="create-a-sql-server-windows-virtual-machine-with-azure-powershell"></a>Erstellen eines virtuellen Windows-Computers mit SQL Server unter Verwendung von Azure PowerShell
