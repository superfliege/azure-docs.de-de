---
title: Storage Premium-Hochleistungsspeicher und verwaltete Azure-Datenträger für Windows-VMs | Microsoft-Dokumentation
...
* [Hohe Anwendungsleistung mit Storage Premium](premium-storage-performance.md)
* [Using Blob Service Operations with Azure Premium Storage](https://go.microsoft.com/fwlink/?LinkId=521969) (Verwenden von Blob-Dienstvorgängen mit Azure Storage Premium)

### <a name="operational-guidance"></a>Leitfaden
* [Migrieren zu Azure Storage Premium (Nicht verwaltete Datenträger)](../../storage/common/storage-migration-to-premium-storage.md)
