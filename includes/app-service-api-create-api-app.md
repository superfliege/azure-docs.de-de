...
Erstellen Sie mithilfe des Befehls [az webapp create](/cli/azure/webapp?view=azure-cli-latest#az_webapp_create) eine App im App Service-Plan `myAppServicePlan`. 
