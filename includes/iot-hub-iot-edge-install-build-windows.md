...
1. Installieren Sie [Python 2.7](https://www.python.org/downloads/release/python-27). Stellen Sie sicher, dass Sie Ihrer `PATH`-Umgebungsvariable Python hinzufügen. Wechseln Sie zu **Systemsteuerung** > **System und Sicherheit** > **System** > **Erweiterte Systemeinstellungen** > **Umgebungsvariablen**. Fügen Sie `C:\Python27` Ihrem Pfad hinzu. 
...
1. Öffnen Sie abhängig von Ihrer Version eine **Entwicklereingabeaufforderung für VS 2015** oder eine **Entwicklereingabeaufforderung für VS 2017**.
