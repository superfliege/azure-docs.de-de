...
1. Verwenden Sie die URL mit dem Präfix *scott.s* für die Navigation zu Ihrer Anwendung. Beachten Sie, dass auch diese aktualisierte URL aufgelöst wird. Diese URL ist eindeutig für den Bereich _dev/scott_. Die spezielle URL bewirkt, dass bei Anforderungen, die an die „Scott-URL“ gesendet werden, zuerst versucht wird, diese an Dienste im Bereich _dev/scott_ weiterzuleiten. Ist dies nicht möglich, erfolgt ein Fallback auf Dienste im Bereich _dev_.
