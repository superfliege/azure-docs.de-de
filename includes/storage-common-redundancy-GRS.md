...
Bei einem Speicherkonto mit aktiviertem GRS wird für ein Update zuerst ein Commit in der primären Region ausgeführt. Anschließend wird das Update asynchron in der sekundären Region repliziert, wo es ebenfalls repliziert wird.
