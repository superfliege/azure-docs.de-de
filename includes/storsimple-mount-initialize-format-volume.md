...
8. In der **Datenträgerverwaltung** Fenster, die bereitgestellten Volumes werden angezeigt, wie in der folgenden Abbildung dargestellt. Mit der rechten Maustaste des ermittelten Volumes (klicken Sie auf den Datenträgernamen), und klicken Sie dann auf **Online**.
     ...
     ![Volumeformatieren einleiten](./media/storsimple-mount-initialize-format-volume/HCS_InitializeFormatVolume-include.png) 
...
![Video zur Verfügung](./media/storsimple-mount-initialize-format-volume/Video_icon.png) **Video verfügbar**

Um ein Video zu beobachten, die veranschaulicht, wie bereitstellen, initialisieren und Formatieren eines StorSimple-Volumes, klicken Sie auf [hier](https://azure.microsoft.com/documentation/videos/mount-initialize-and-format-a-storsimple-volume/).
