...
3. Geben Sie in das Suchfeld des Microsoft Update-Katalogs, die Anzahl von Knowledge Base (KB) für den Hotfix heruntergeladen werden können, z. B. sollen **3121901**, und klicken Sie dann auf **Suche**.
   
    Der Hotfix Liste angezeigt wird, z. B. **kumulative Software Bundle-Update 2.0 für StorSimple 8000-Serie**.
...
5. Suchen Sie nach zusätzlichen Hotfixes in der obigen Tabelle aufgeführten (**3121900**, **3080728**, **3090322**, und **3121899**), und jede Warenkorb hinzufügen.
...
6. Nachdem das Update abgeschlossen ist, wiederholen Sie Schritte 3 bis 5 zum Installieren und der SaaS-Agent und der MDS-Agent zu überwachen. Sicherstellen, dass `all-hcsmdssoftwareupdate_0b438ddf0d5b686aada2378b754fac8c7f2160e9.exe` installiert wurde, bevor `all-cismdsagentupdatebundle_f98e62f4d56c79e2a6644d027af7a2393a93827a.exe`.
7. Überprüfen Sie die System-Software-Versionen. Type:
...
8. Wiederholen Sie Schritte 3 bis 5, um die verbleibenden im normalen Modus Hotfixes zu installieren.
   
   * Die LSI-Treiber - KB3121900
