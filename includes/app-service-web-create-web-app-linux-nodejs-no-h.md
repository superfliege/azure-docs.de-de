...
Die Runtime im folgenden Befehl ist auf `NODE|8.1` festgelegt. Führen Sie zum Anzeigen aller unterstützten Runtimes den Befehl [az webapp list-runtimes](/cli/azure/webapp#list-runtimes) aus. 
