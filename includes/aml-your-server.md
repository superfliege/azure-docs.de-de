...
ms.locfileid: "55302187"
---
1. Führen Sie die Schritte unter [Schnellstart: Verwenden von Python für die ersten Schritte mit Azure Machine Learning](../articles/machine-learning/service/quickstart-create-workspace-with-python.md) aus, um das SDK zu erstellen und einen Arbeitsbereich zu erstellen.  Wenn Sie möchten, können Sie den Abschnitt zum **Verwenden des Notebooks** überspringen.
