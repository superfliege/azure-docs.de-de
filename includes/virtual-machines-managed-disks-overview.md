...
**Speichertyp:** Managed Disks bietet 3 Leistungsebenen: [Standard-HDD](../articles/virtual-machines/windows/standard-storage.md), Standard-SSD (Vorschau) und [Premium](../articles/virtual-machines/windows/premium-storage.md). Die Abrechnung für einen verwalteten Datenträger richtet sich danach, welchen Speichertyp Sie für den Datenträger ausgewählt haben.
...
| **Verwalteter Standard-SSD-<br>Datenträgertyp** | **E10** | **E15** | **E20** | **E30** | **E40** | **E50** |
|------------------|--------|--------|--------|----------------|----------------|----------------| 
| Datenträgergröße        | 128 GB | 256 GiB | 512 GB | 1.024 GiB (1 TiB) | 2.048 GiB (2 TiB) | 4.096 GiB (4 TiB) | 
