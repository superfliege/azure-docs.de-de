...
Darüber hinaus stehen noch zahlreiche weitere Features zur Verfügung. Es werden regelmäßig neue VM-Erweiterungsfeatures veröffentlicht. Dieser Artikel beschreibt die Azure-VM-Agents für Windows und Linux und deren Unterstützung der Funktionalität von VM-Erweiterungen. Eine Liste mit VM-Erweiterungen nach Featurekategorie finden Sie unter [Azure-VM-Erweiterungen und Features](../articles/virtual-machines/extensions/features-windows.md).
