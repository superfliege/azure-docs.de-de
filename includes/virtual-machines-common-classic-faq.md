...
Sie müssen über eine Remotedesktopverbindung (für virtuelle Windows-Computer) oder über SSH (Secure Shell, für virtuelle Linux-Computer) eine Remoteverbindung herstellen, um sich beim virtuellen Computer anzumelden. Anweisungen dazu finden Sie unter:
