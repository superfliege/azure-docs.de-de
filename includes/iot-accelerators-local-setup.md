...
In diesem Artikel wird davon ausgegangen, dass Sie die .NET-Microservices verwenden. Es stehen auch Java-Implementierungen zur Verfügung. Um die neueste Version der Java-Microservice-Implementierungen herunterzuladen, führen Sie Folgendes aus:
