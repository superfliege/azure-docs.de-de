...
IIS | - Keine bereits vorhandene Standardwebsite <br> - Keine bereits vorhandene Website/Anwendung sollte an Port 443 lauschen <br>- [Anonyme Authentifizierung](https://technet.microsoft.com/library/cc731244(v=ws.10).aspx) aktiviert <br> - Einstellung [FastCGI](https://technet.microsoft.com/library/cc753077(v=ws.10).aspx) aktiviert
